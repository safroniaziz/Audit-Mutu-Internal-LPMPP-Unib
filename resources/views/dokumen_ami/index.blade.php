                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody id="fileTableBody">
                                                    @foreach($dokumenAmis as $index => $file)
                                                        <tr data-id="{{ $file->id }}">
                                                            <td>{{ $index + 1 }}</td>
                                                            <td>{{ $file->nama_dokumen }}</td>
                                                            <td class="text-nowrap">
                                                                <div class="d-flex">
                                                                    <a href="{{ asset('storage/' . $file->file_dokumen) }}" target="_blank" class="btn btn-sm btn-primary me-2" title="Lihat File">
