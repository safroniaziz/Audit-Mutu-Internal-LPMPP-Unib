...
class AddS1FarmasiSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        DB::transaction(function () {
            $now = now();
            $indicatorName = 'INDIKATOR S1 FARMASI';
            $indikatorInstrumenId = 20;
            ...
            $criteriaList = [
                ...
                [
                    ...
                    'items' => [
                        $it('Bagaimana rumusan visi, misi, dan unggulan program studi ditetapkan?', 'PS merumuskan visi, misi, dan unggulan.'),
                        $it('Bagaimana rumusan visi, misi, dan unggulan program studi ditetapkan?', 'Keterkaitan visi, misi, dan unggulan unit pengelola program studi dengan visi, misi, dan unggulan program studi.'),

                        $it('Bagaimana mekanisme penyusunan visi, misi, dan unggulan program studi dan alasannya?', 'Mekanisme untuk mengidentifikasi keterlibatan pemangku kepentingan internal dan eksternal dalam penyusunan visi, misi, dan unggulan.'),
                        $it('Bagaimana mekanisme penyusunan visi, misi, dan unggulan program studi dan alasannya?', 'Kontribusi dari pemangku kepentingan tersebut dan manfaat yang mereka dapatkan.'),
                        $it('Bagaimana mekanisme penyusunan visi, misi, dan unggulan program studi dan alasannya?', 'Permasalahan kesehatan di tingkat nasional dan lokal dipertimbangkan dalam penyusunan visi, misi, dan unggulan.'),

                        $it('Bagaimana visi, misi, dan keunggulan menentukan peran program studi di dalam masyarakat?', 'Peran PS dalam upaya meningkatkan derajat kesehatan masyarakat.'),
                        $it('Bagaimana visi, misi, dan keunggulan menentukan peran program studi di dalam masyarakat?', 'UPPS dan PS bekerja sama dengan fasilitas layanan kesehatan, pemerintah daerah, dan kelompok masyarakat dalam menjalankan peran tersebut.'),

                        $it('Bagaimana peran visi, misi, dan unggulan dalam perencanaan, implementasi, monitoring, penjaminan mutu, dan manajemen di program studi?', 'Visi, misi, dan unggulan diintegrasikan dalam perencanaan program dan kegiatan.'),
                        $it('Bagaimana peran visi, misi, dan unggulan dalam perencanaan, implementasi, monitoring, penjaminan mutu, dan manajemen di program studi?', 'Ada strategi dan implementasi dari perencanaan tersebut.'),
                        $it('Bagaimana peran visi, misi, dan unggulan dalam perencanaan, implementasi, monitoring, penjaminan mutu, dan manajemen di program studi?', 'Struktur organisasi dirancang sesuai dengan tata kelola untuk mencapai visi, misi, dan unggulan.'),
                        $it('Bagaimana peran visi, misi, dan unggulan dalam perencanaan, implementasi, monitoring, penjaminan mutu, dan manajemen di program studi?', 'Sistem penjaminan mutu internal dikembangkan sesuai dengan visi, misi, dan unggulan.'),
                        $it('Bagaimana peran visi, misi, dan unggulan dalam perencanaan, implementasi, monitoring, penjaminan mutu, dan manajemen di program studi?', 'Monitoring dan evaluasi dilakukan untuk menilai pencapaian visi, misi, dan unggulan.'),
                        $it('Bagaimana peran visi, misi, dan unggulan dalam perencanaan, implementasi, monitoring, penjaminan mutu, dan manajemen di program studi?', 'Ada tindak lanjut dari hasil monitoring dan evaluasi tersebut.'),
                        $it('Bagaimana peran visi, misi, dan unggulan dalam perencanaan, implementasi, monitoring, penjaminan mutu, dan manajemen di program studi?', 'Visi, misi, dan unggulan dievaluasi dan diperbarui secara berkala.'),

                        $it('Bagaimana kesesuaian visi, misi, dan unggulan dengan standar dan peraturan nasional tentang pendidikan tinggi bidang kesehatan?', 'PS menerjemahkan peraturan dan standar nasional yang relevan ke dalam peraturan dan standar mutu yang dimiliki.'),
                        $it('Bagaimana kesesuaian visi, misi, dan unggulan dengan standar dan peraturan nasional tentang pendidikan tinggi bidang kesehatan?', 'PS mempertimbangkan kondisi dan kearifan lokal dalam menerapkan peraturan dan Standar Nasional Pendidikan Tinggi (SN Dikti).'),

                        $it('Bagaimana cara menyosialisasikan visi, misi, dan unggulan program studi, analisis hasil dan tindaklanjutnya?', 'PS menyosialisasikan visi, misi, dan unggulan melalui pemanfaatan berbagai media.'),
                        $it('Bagaimana cara menyosialisasikan visi, misi, dan unggulan program studi, analisis hasil dan tindaklanjutnya?', 'Pihak-pihak yang terlibat dalam kegiatan sosialisasi tersebut.'),
                        $it('Bagaimana cara menyosialisasikan visi, misi, dan unggulan program studi, analisis hasil dan tindaklanjutnya?', 'UPPS dan PS melakukan analisis hasil sosialisasi dan tindaklanjutnya.'),
                    ],
                ],
                ...
                [
                    ...
                    'items' => [
                        ...
                        $it('Bagaimana cara merancang dan mengembangkan capaian pembelajaran lulusan dan capaian pembelajaran mata kuliah?', 'PS merumuskan capaian pembelajaran mengacu pada peraturan yang berlaku (KKNI level 6 (sarjana kefarmasian) dan 7 (profesi apoteker)), capaian pembelajaran yang ditetapkan oleh APTFI dan standar profesi serta tertuang dalam kurikulum.'),
                        ...
                        $it('Bagaimana memastikan capaian pembelajaran lulusan yang dipilih sesuai dengan konteks sosial?', 'PS menggunakan metode analisis kebutuhan dikaitkan dengan prioritas masalah kesehatan untuk memastikan capaian pembelajaran sesuai dengan konteks sosial.'),
                    ],
                ],
                [
                    'kode' => '2.2',
                ...
                [
                    ...
                    'items' => [
                        ...
                        $it('Bagaimana isi kurikulum ditentukan?', 'PS menggunakan referensi tingkat internasional, nasional, dan lokal untuk menentukan isi kurikulum.'),

                        $it('Elemen apa saja dari ilmu biomedis dan sains farmasi yang dimasukkan dalam kurikulum? Bagaimana pilihan-pilihan yang dibuat dan waktu yang dialokasikan untuk elemen ini?', 'PS mengidentifikasi ilmu biomedis dan sains farmasi yang relevan dengan capaian pembelajaran lulusan dengan memasukkan konten ilmu biomedis dan sains farmasi, beserta alokasi waktu, dan nilai kredit yang sesuai.'),

                        $it('Elemen ilmu pengetahuan dan keterampilan profesional apa saja yang tercakup dalam kurikulum? Dalam disiplin keterampilan kefarmasian apa saja mahasiswa diwajibkan untuk mendapatkan pengalaman praktis? Bagaimana pilihan yang dibuat dan waktu yang dialokasikan untuk elemen ini?', 'PS memastikan isi kurikulum mencakup muatan ilmu pengetahuan dan keterampilan profesional yang sesuai dengan capaian pembelajaran lulusan dengan mengedepankan keselamatan pasien, mahasiswa dan lingkungan.'),
                        $it('Elemen ilmu pengetahuan dan keterampilan profesional apa saja yang tercakup dalam kurikulum? Dalam disiplin keterampilan kefarmasian apa saja mahasiswa diwajibkan untuk mendapatkan pengalaman praktis? Bagaimana pilihan yang dibuat dan waktu yang dialokasikan untuk elemen ini?', 'PS menentukan keterlibatan pemangku kepentingan internal dan eksternal dalam menentukan isi muatan ilmu pengetahuan dan keterampilan profesional.'),
                        $it('Elemen ilmu pengetahuan dan keterampilan profesional apa saja yang tercakup dalam kurikulum? Dalam disiplin keterampilan kefarmasian apa saja mahasiswa diwajibkan untuk mendapatkan pengalaman praktis? Bagaimana pilihan yang dibuat dan waktu yang dialokasikan untuk elemen ini?', 'PS menggunakan referensi tingkat internasional, nasional, dan lokal untuk menentukan isi muatan ilmu pengetahuan dan keterampilan profesional.'),
                        ...
                        $it('Elemen ilmu pengetahuan dan keterampilan profesional apa saja yang tercakup dalam kurikulum? Dalam disiplin keterampilan kefarmasian apa saja mahasiswa diwajibkan untuk mendapatkan pengalaman praktis? Bagaimana pilihan yang dibuat dan waktu yang dialokasikan untuk elemen ini?', 'PS menentukan metode yang digunakan untuk mengajarkan mahasiswa membuat penilaian profesional sesuai dengan bukti terbaik (best evidence) yang tersedia.'),
                        $it('Elemen ilmu pengetahuan dan keterampilan profesional apa saja yang tercakup dalam kurikulum? Dalam disiplin keterampilan kefarmasian apa saja mahasiswa diwajibkan untuk mendapatkan pengalaman praktis? Bagaimana pilihan yang dibuat dan waktu yang dialokasikan untuk elemen ini?', 'PS memiliki jenis bukti praktik dan penilaian profesional dalam pembelajaran praktik sesuai dengan peta kompetensi.'),
                        $it('Elemen ilmu pengetahuan dan keterampilan profesional apa saja yang tercakup dalam kurikulum? Dalam disiplin keterampilan kefarmasian apa saja mahasiswa diwajibkan untuk mendapatkan pengalaman praktis? Bagaimana pilihan yang dibuat dan waktu yang dialokasikan untuk elemen ini?', 'PS mengelola waktu yang dialokasikan untuk pembelajaran praktik yang berbeda sesuai dengan peta kompetensi.'),

                        $it('Elemen apa saja dari ilmu perilaku dan sosial yang dimasukkan dalam kurikulum? Bagaimana pilihan dan alokasi waktu untuk elemen tersebut?', 'PS menetapkan elemen ilmu perilaku dan sosial dalam kurikulum yang sesuai dengan capaian pembelajaran lulusan.'),
                        $it('Elemen apa saja dari ilmu perilaku dan sosial yang dimasukkan dalam kurikulum? Bagaimana pilihan dan alokasi waktu untuk elemen tersebut?', 'PS menentukan pilihan dan alokasi waktu untuk elemen perilaku dan sosial.'),
                        ...
                        $it('Elemen apa saja (jika ada) dari ilmu sistem kesehatan yang dimasukkan ke dalam kurikulum? Bagaimana pilihan yang dibuat dan waktu yang dialokasikan untuk elemen ini?', 'PS menetapkan pilihan dan alokasi waktu untuk ilmu sistem kesehatan sesuai peta kompetensi.'),

                        $it('Elemen apa saja (jika ada) dari humaniora dan seni yang dimasukkan ke dalam kurikulum? Bagaimana pilihan yang dibuat dan waktu yang dialokasikan untuk elemen tersebut?', 'PS mengidentifikasi isi kurikulum yang berkaitan dengan ilmu humaniora dan seni.'),
                        $it('Elemen apa saja (jika ada) dari humaniora dan seni yang dimasukkan ke dalam kurikulum? Bagaimana pilihan yang dibuat dan waktu yang dialokasikan untuk elemen tersebut?', 'Komite/Tim kurikulum/kelompok keilmuan menetapkan alokasi waktu untuk ilmu humaniora dan seni.'),

                        $it('Bagaimana mahasiswa mengenal bidang tertentu yang tidak banyak dibahas atau tidak tercakup dalam kurikulum?', 'PS mengembangkan program berbasis masyarakat, kesehatan, dan keselamatan mahasiswa selama penempatan mereka di lapangan. (seperti: early-exposure, diskusi kelompok, refleksi, magang, dll)'),

                        $it('Bagaimana penyesuaian isi kurikulum yang berkaitan dengan kemajuan dan perkembangan ilmu pengetahuan dan teknologi?', 'PS menetapkan proses evaluasi isi kurikulum dengan melibatkan pemangku kepentingan internal dan eksternal.'),
                        $it('Bagaimana penyesuaian isi kurikulum yang berkaitan dengan kemajuan dan perkembangan ilmu pengetahuan dan teknologi?', 'PS menggunakan hasil evaluasi untuk menyesuaikan isi kurikulum dalam kaitannya dengan kemajuan dan perkembangan ilmu dan praktik kefarmasian.'),
                ...
                [
                    ...
                    'items' => [
                        ...
                        $it('Bagaimana program studi menentukan penempatan mahasiswa profesi pada wahana praktik?', 'PS menentukan perpaduan rotasi penempatan mahasiswa di wahana praktik.'),
                        $it('Bagaimana program studi menentukan penempatan mahasiswa profesi pada wahana praktik?', 'Pihak yang terlibat dalam pengambilan keputusan rotasi mahasiswa.'),

                        $it('Bagaimana program studi melibatkan dosen dan preseptor dalam praktik profesional mahasiswa profesi?', 'PS merekrut dosen dan preseptor dalam rangkaian praktik profesional yang dibutuhkan dan mempertahankan keterlibatannya.'),
                        $it('Bagaimana program studi melibatkan dosen dan preseptor dalam praktik profesional mahasiswa profesi?', 'PS memastikan bahwa dosen dan preseptor memahami peran dan tanggung jawabnya dalam kaitannya dengan pembelajaran mahasiswa dalam lingkungan praktik.'),

                        $it('Bagaimana program studi memastikan penerapan dan pelaksanaan kurikulum dalam lingkungan wahana praktik secara konsisten?', 'PS memastikan bahwa semua dosen dan preseptor memahami kurikulum.'),
                        $it('Bagaimana program studi memastikan penerapan dan pelaksanaan kurikulum dalam lingkungan wahana praktik secara konsisten?', 'PS memastikan bahwa penerapan dan pelaksanaan kurikulum dilakukan secara efektif dan konsisten.'),
                    ],
                ],
                [
                    'kode' => '2.5',
                    ...
                    'items' => [
                        ...
                        $it('Bagaimana UPPS menetapkan kelompok atau individu yang bertanggung jawab untuk memantau kesalahan mahasiswa dan keselamatan pasien di tingkat manajemen program di dalam pendidikan dan layanan kesehatan?', 'UPPS memiliki panduan etika dan perilaku yang harus dipatuhi oleh mahasiswa untuk mempersiapkan mahasiswa dan lulusan pendidikan profesi melakukan praktik yang aman dan beretika.'),
                        ...
                        $it('Bagaimana risiko keselamatan pasien ditinjau, diidentifikasi, dicatat, dan dilaporkan secara berkala dalam pelaksanaan pembelajaran praktik profesional?', 'UPPS menyediakan sistem evaluasi untuk menilai dan memantau penerapan keselamatan pasien.'),
                        $it('Bagaimana risiko keselamatan pasien ditinjau, diidentifikasi, dicatat, dan dilaporkan secara berkala dalam pelaksanaan pembelajaran praktik profesional?', 'UPPS bekerjasama dengan wahana praktik dalam menangani bidang praktik profesional terkait evaluasi dan pemantauan penerapan keselamatan pasien.'),
                        $it('Bagaimana risiko keselamatan pasien ditinjau, diidentifikasi, dicatat, dan dilaporkan secara berkala dalam pelaksanaan pembelajaran praktik profesional?', 'UPPS menindaklanjuti hasil pemantauan dan evaluasi keselamatan pasien.'),
                        $it('Bagaimana risiko keselamatan pasien ditinjau, diidentifikasi, dicatat, dan dilaporkan secara berkala dalam pelaksanaan pembelajaran praktik profesional?', 'UPPS menyosialisasikan hasil pemantauan dan evaluasi keselamatan pasien secara terbuka kepada pemangku kepentingan.'),
                ...
                [
                    ...
                    'items' => [
                        $it('Bagaimana penilaian yang dilakukan kepada mahasiswa dalam mencapai capaian pembelajaran?', 'PS memberikan umpan balik kepada mahasiswa berdasarkan hasil penilaian capaian pembelajaran mata kuliah (CPMK) dan capaian pembelajaran lulusan (CPL).'),
                        $it('Bagaimana penilaian yang dilakukan kepada mahasiswa dalam mencapai capaian pembelajaran?', 'PS menggunakan penilaian naratif seperti portofolio atau buku catatan (logbook), laporan pencatatan tentang standar operasional prosedur (SOP) keselamatan pasien, mahasiswa dan lingkungan untuk memberikan umpan balik langsung dari dosen kepada mahasiswa pada waktu yang tepat.'),

                        $it('Bagaimana mahasiswa mendapatkan supervisi dan pengarahan oleh pembimbing praktik profesional dalam mencapai capaian pembelajaran keterampilan profesional?', 'PS merancang sistem untuk menjamin bahwa semua mahasiswa pendidikan profesi mempunyai kesempatan untuk memperoleh pengalaman belajar dan umpan balik langsung dari pembimbing praktik profesional.'),
                        $it('Bagaimana mahasiswa mendapatkan supervisi dan pengarahan oleh pembimbing praktik profesional dalam mencapai capaian pembelajaran keterampilan profesional?', 'PS memiliki sistem pembimbingan akademik untuk memantau kemajuan belajar mahasiswa dengan menggunakan sistem terpusat (learning management system).'),
                ...
                [
                    ...
                    'items' => [
                        $it('Bagaimana blueprint (cetak biru) dikembangkan untuk ujian?', 'PS mengembangkan cetak biru ujian.'),
                        $it('Bagaimana blueprint (cetak biru) dikembangkan untuk ujian?', 'Pihak yang terlibat mengembangkan cetak biru ujian.'),
                        $it('Bagaimana blueprint (cetak biru) dikembangkan untuk ujian?', 'PS menetapkan tim pengembangan cetak biru ujian.'),

                        $it('Bagaimana standar (nilai kelulusan) ditetapkan pada ujian sumatif?', 'UPPS menetapkan standar dan PS menerapkan standar untuk menetapkan nilai kelulusan pada ujian sumatif.'),
                        $it('Bagaimana standar (nilai kelulusan) ditetapkan pada ujian sumatif?', 'PS membuat keputusan terkait kemajuan dan kelulusan sesuai capaian pembelajaran.'),
                        ...
                        $it('Bagaimana cara memberikan informasi kepada mahasiswa dan pemangku kepentingan lainnya, mengenai isi, metode, kualitas penilaian, dan mekanisme banding penilaian?', 'PS memastikan soal sudah melalui analisis soal dan tervalidasi.'),
                        ...
                        $it('Bagaimana penilaian digunakan sebagai pedoman untuk menentukan perkembangan pembelajaran mahasiswa?', 'PS memberikan umpan balik tentang pencapaian dalam seluruh proses pembelajaran mahasiswa.'),
                    ],
                ],
                [
                    'kode' => '3.4',
                ...
                [
                    ...
                    'items' => [
                        $it('Bagaimana layanan akademik dan non akademik termasuk layanan konseling pribadi tersedia sesuai dengan kebutuhan mahasiswa?', 'UPPS menyediakan program dukungan yang tepat untuk mahasiswa dalam memenuhi kebutuhan akademik dan non-akademik mahasiswa.'),

                        $it('Bagaimana layanan akademik dan non-akademik direkomendasikan dan dikomunikasikan kepada mahasiswa, dosen, dan tendik?', 'PS menyediakan informasi mengenai layanan akademik dan non-akademik mahasiswa, dosen, dan tendik.'),
                        $it('Bagaimana layanan akademik dan non-akademik direkomendasikan dan dikomunikasikan kepada mahasiswa, dosen, dan tendik?', 'PS memastikan bahwa mahasiswa, dosen, dan tendik mengetahui ketersediaan layanan mahasiswa.'),
                        ...
                        $it('Seberapa tepatkah layanan akademik dan non akademik yang dibuat, baik secara prosedural maupun budaya?', 'PS memastikan bahwa layanan kemahasiswaan telah memenuhi kebutuhan keberagaman mahasiswa, dan memenuhi kebutuhan kearifan lokal/nasional.'),
                        $it('Seberapa tepatkah layanan akademik dan non akademik yang dibuat, baik secara prosedural maupun budaya?', 'PS menetapkan pihak yang terlibat dalam penyediaan layanan kemahasiswaan yang peka budaya.'),

                        $it('Bagaimana kelayakan layanan dinilai, dari segi sumber daya manusia, keuangan, serta sarana dan prasarana?', 'PS memastikan bahwa layanan akademik dan non akademik layak dilakukan dari segi sumber daya manusia, keuangan, serta sarana dan prasarana.'),

                        $it('Bagaimana layanan dikaji secara berkala bersama perwakilan mahasiswa untuk memastikan relevansi, aksesibilitas, dan kerahasiaan?', 'PS memiliki prosedur untuk mengevaluasi efektivitas layanan akademik dan non akademik dilakukan melalui berbagai metode, misalnya survei, pengaduan, kelompok perwakilan.'),
                        $it('Bagaimana layanan dikaji secara berkala bersama perwakilan mahasiswa untuk memastikan relevansi, aksesibilitas, dan kerahasiaan?', 'PS memiliki cara untuk mengakomodasi perubahan yang terjadi (jika diperlukan).'),
                    ],
                ],
                [
                    'kode' => '4.3',
                    ...
                    'items' => [
                        $it('Bagaimana institusi pendidikan/UPPS memastikan bahwa lingkungan kerja dan belajar mahasiswa memenuhi standar mutu dan keselamatan mahasiswa?', 'PS memiliki mekanisme dan prosedur untuk memastikan bahwa lingkungan kerja dan belajar memenuhi standar mutu dan keselamatan mahasiswa.'),

                        $it('Bagaimana PS menghitung dan menentukan beban dan jam kerja pembelajaran/praktik profesi?', 'PS menghitung dan menetapkan rumusan beban dan jam belajar mahasiswa/praktik profesi.'),

                        $it('Bagaimana PS menerapkan rencana kerja kegiatan mahasiswa, penyediaan layanan, pendidikan, dan program keselamatan kepada mahasiswa ditetapkan, disosialisasikan, dan dilaksanakan?', 'PS membuat rencana kerja kegiatan mahasiswa yang bebas dari kekerasan seksual, perundungan dan intoleransi (penerapan kampus sehat).'),
                        $it('Bagaimana PS menerapkan rencana kerja kegiatan mahasiswa, penyediaan layanan, pendidikan, dan program keselamatan kepada mahasiswa ditetapkan, disosialisasikan, dan dilaksanakan?', 'PS menyosialisasikan rencana kerja penyediaan layanan, pendidikan, dan program keselamatan kepada mahasiswa.'),

                        $it('Bagaimana UPPS/PS menetapkan jumlah jam kerja minimum dan maksimum yang diperlukan, serta pengaturan hari libur bagi mahasiswa?', 'UPPS/PS menetapkan standar jam kerja maksimum dan minimum, serta pengaturan libur sesuai peraturan yang berlaku.'),

                        $it('Bagaimana UPPS/PS mengatur pelaksanaan beban kerja dan tanggung jawab praktik profesi bagi mahasiswa?', 'UPPS/PS mengelola beban kerja praktik profesi dan tanggung jawab mahasiswa sesuai peraturan yang berlaku.'),
                ...
                [
                    ...
                    'items' => [
                        $it('Bagaimana UPPS memberikan perlindungan hukum/peraturan mahasiswa sehubungan dengan proses pembelajaran, termasuk praktikum di laboratorium, dan praktik profesi?', 'UPPS mempunyai kebijakan perlindungan hukum/peraturan terhadap mahasiswa sehubungan dengan proses pembelajaran, termasuk praktikum di laboratorium, dan praktik profesi.'),
                        ...
                        $it('Bagaimana UPPS mempersiapkan tim/kelompok atau individu yang mempunyai tanggung jawab terhadap keselamatan mahasiswa baik di dalam kampus, di wahana praktik, dan lingkungan lainnya?', 'UPPS mempunyai unit yang ditugaskan untuk menjamin keselamatan mahasiswa baik di dalam kampus dan wahana praktik maupun di lingkungan lainnya.'),

                        $it('Bagaimana UPPS mencegah risiko yang membahayakan keselamatan mahasiswa dengan mekanisme mengidentifikasi, memitigasi, mencatat, dan melaporkan?', 'PS menerapkan mekanisme pencegahan risiko yang membahayakan keselamatan mahasiswa dalam praktik profesi dengan mengidentifikasi, memitigasi, mencatat, dan melaporkannya.'),
                ...
                [
                    ...
                    'items' => [
                        ...
                        $it('Bagaimana UPPS dan PS membuat mekanisme untuk menetapkan, mengatur, dan mengevaluasi kinerja dan perilaku dosen?', 'UPPS memiliki kebijakan dan prosedur untuk mempertahankan keberadaan dosen, pemberian penghargaan, penurunan pangkat, pemberhentian, dan sanksi.'),
                ...
                [
                    ...
                    'items' => [
                        $it('Bagaimana upaya UPPS/PS menjamin relevansi Pengabdian Kepada Masyarakat (PkM) dosen dalam mendukung pencapaian visi misi dan unggulan Program Studi?', 'UPPS memiliki kebijakan pelaksanaan PkM dan disosialisasikan.'),
                        $it('Bagaimana upaya UPPS/PS menjamin relevansi Pengabdian Kepada Masyarakat (PkM) dosen dalam mendukung pencapaian visi misi dan unggulan Program Studi?', 'PS memastikan ketersediaan dan kesesuaian PkM dengan roadmap PkM, visi, misi dan unggulan PS.'),

                        $it('Bagaimana UPPS/PS mengimplementasikan, monitoring, evaluasi, dan tindak lanjut kegiatan pengabdian kepada masyarakat (PkM) di PS?', 'UPPS/PS memiliki prosedur dan mekanisme dukungan dana PkM.'),
                        $it('Bagaimana UPPS/PS mengimplementasikan, monitoring, evaluasi, dan tindak lanjut kegiatan pengabdian kepada masyarakat (PkM) di PS?', 'UPPS/PS memfasilitasi publikasi ilmiah dosen pada jurnal ilmiah terakreditasi atau bereputasi.'),
                        $it('Bagaimana UPPS/PS mengimplementasikan, monitoring, evaluasi, dan tindak lanjut kegiatan pengabdian kepada masyarakat (PkM) di PS?', 'UPPS/PS memiliki prosedur, mekanisme, dan fasilitasi program studi dalam pengajuan hibah PkM.'),
                        $it('Bagaimana UPPS/PS mengimplementasikan, monitoring, evaluasi, dan tindak lanjut kegiatan pengabdian kepada masyarakat (PkM) di PS?', 'UPPS memiliki kebijakan keterlibatan mahasiswa dalam pelaksanaan PkM dosen.'),
                        $it('Bagaimana UPPS/PS mengimplementasikan, monitoring, evaluasi, dan tindak lanjut kegiatan pengabdian kepada masyarakat (PkM) di PS?', 'UPPS memiliki kebijakan dalam mendukung PkM kolaborasi dosen dengan pihak lain (Nasional dan Internasional).'),
                        $it('Bagaimana UPPS/PS mengimplementasikan, monitoring, evaluasi, dan tindak lanjut kegiatan pengabdian kepada masyarakat (PkM) di PS?', 'UPPS memiliki sistem monitoring dan evaluasi pelaksanaan PkM dan tindak lanjutnya.'),
                        ...
                        $it('Bagaimana penghargaan dan pengakuan terhadap hasil PkM dosen?', 'UPPS memiliki mekanisme pemberian penghargaan atau pengakuan atas hasil PkM (termasuk menerima: Hibah PkM, HaKi, dan Paten).'),
                    ],
                ],
                ...
                [
                    ...
                    'items' => [
                        ...
                        $it('Bagaimana UPPS menentukan kecukupan infrastruktur fisik (sarana dan prasarana) yang disediakan untuk pembelajaran teori dan praktik yang ditentukan dalam kurikulum?', 'UPPS dan PS memiliki sekurangnya Laboratorium bidang kimia farmasi dan mikrobiologi, bidang farmasetika/teknologi farmasi, bidang biologi farmasi, bidang farmakologi-toksikologi, bidang farmasi klinik dan sosial/komunitas (keputusan APTFI).'),
                        $it('Bagaimana UPPS menentukan kecukupan infrastruktur fisik (sarana dan prasarana) yang disediakan untuk pembelajaran teori dan praktik yang ditentukan dalam kurikulum?', 'UPPS dan PS memiliki laboratorium dan peralatan utama yang mutakhir dalam kondisi baik/terpelihara, tersedia, dan dapat digunakan secara efektif, minimal berupa spektrofotometer UV-VIS, spektrofotometer infra merah, KCKT, mesin kempa tablet, dissolution tester, rotary evaporator, KLT densitometer, plastisometer, human anatomy model, blood analyzer, alat bedah hewan, apotek simulasi, dan software pendukung layanan kefarmasian (sesuai dengan keputusan APTFI).'),
                        $it('Bagaimana UPPS menentukan kecukupan infrastruktur fisik (sarana dan prasarana) yang disediakan untuk pembelajaran teori dan praktik yang ditentukan dalam kurikulum?', 'UPPS dan PS memastikan jumlah fasilitas laboratorium disesuaikan dengan jumlah mahasiswa.'),
                ...
                [
                    ...
                    'items' => [
                        $it('Bagaimana prodi memberikan mahasiswa kesempatan untuk studi bagi pembelajaran keterampilan profesional?', 'PS memastikan bahwa semua mahasiswa memiliki akses yang sama terhadap kesempatan belajar keterampilan profesional di kampus dan di wahana praktik.'),
                        $it('Bagaimana prodi memberikan mahasiswa kesempatan untuk studi bagi pembelajaran keterampilan profesional?', 'PS memastikan sarana dan prasarana pembelajaran keterampilan profesional terpelihara dengan baik dan mutakhir.'),

                        $it('Bagaimana UPPS menyediakan skill lab (laboratorium keterampilan), simulasi kasus, dan kasus sebenarnya untuk pembelajaran keterampilan profesional?', 'PS menetapkan keterampilan profesional yang dipelajari menggunakan skill lab, simulasi kasus, dan kasus sebenarnya.'),
                        $it('Bagaimana UPPS menyediakan skill lab (laboratorium keterampilan), simulasi kasus, dan kasus sebenarnya untuk pembelajaran keterampilan profesional?', 'PS memastikan bahwa skill lab memenuhi standar sarana dan prasarana sesuai dengan keputusan APTFI.'),
                        $it('Bagaimana UPPS menyediakan skill lab (laboratorium keterampilan), simulasi kasus, dan kasus sebenarnya untuk pembelajaran keterampilan profesional?', 'PS memastikan simulasi kasus dan kasus sebenarnya mendukung perolehan keterampilan profesional mahasiswa.'),

                        $it('Bagaimana program studi menetapkan kebijakan penggunaan simulasi kasus dan kasus sebenarnya dalam pembelajaran keterampilan profesional?', 'PS menetapkan kebijakan yang menjadi dasar penggunaan simulasi kasus dan kasus sebenarnya.'),
                        $it('Bagaimana program studi menetapkan kebijakan penggunaan simulasi kasus dan kasus sebenarnya dalam pembelajaran keterampilan profesional?', 'PS menetapkan tim yang merumuskan dan terlibat dalam mengembangkan kebijakan mengenai penggunaan simulasi kasus dan kasus sebenarnya.'),

                        $it('Bagaimana program studi memastikan bahwa mahasiswa memiliki akses yang memadai terhadap fasilitas skill lab dan fasilitas wahana praktik?', 'PS menetapkan fasilitas skill lab dan fasilitas wahana praktik yang dapat dimanfaatkan oleh mahasiswa untuk praktik profesional.'),
                        $it('Bagaimana program studi memastikan bahwa mahasiswa memiliki akses yang memadai terhadap fasilitas skill lab dan fasilitas wahana praktik?', 'PS menjamin bahwa mahasiswa dapat mengakses fasilitas skill lab dan fasilitas wahana praktik secara berkelanjutan untuk mendukung capaian pembelajaran.'),
                        $it('Bagaimana program studi memastikan bahwa mahasiswa memiliki akses yang memadai terhadap fasilitas skill lab dan fasilitas wahana praktik?', 'PS memonitor, mengevaluasi, dan melakukan tindak lanjut keberadaan fasilitas skill lab dan fasilitas wahana praktik.'),

                        $it('Bagaimana dasar UPPS/PS dalam menetapkan penempatan pelatihan mahasiswa berbasis layanan masyarakat (rumah sakit, puskesmas, dan apotek) dan industri?', 'UPPS/PS menentukan perpaduan rotasi penempatan mahasiswa berbasis layanan masyarakat (rumah sakit, puskesmas, dan apotek) dan industri.'),
                        $it('Bagaimana dasar UPPS/PS dalam menetapkan penempatan pelatihan mahasiswa berbasis layanan masyarakat (rumah sakit, puskesmas, dan apotek) dan industri?', 'UPPS/PS menentukan pihak yang terlibat dalam pengambilan keputusan rotasi mahasiswa.'),

                        $it('Bagaimana UPPS/PS melibatkan dosen dan preseptor dalam rangkaian praktik profesional sesuai capaian pembelajaran lulusan?', 'UPPS/PS mengatur jumlah dan kualifikasi dosen dan preseptor dalam praktik profesional sesuai capaian pembelajaran lulusan.'),
                        $it('Bagaimana UPPS/PS melibatkan dosen dan preseptor dalam rangkaian praktik profesional sesuai capaian pembelajaran lulusan?', 'UPPS/PS memastikan bahwa dosen dan preseptor memahami peran dan tanggung jawabnya dalam pembelajaran praktik profesional farmasi.'),

                        $it('Bagaimana UPPS/PS memastikan penyampaian kurikulum dalam lingkungan praktik profesional secara konsisten?', 'UPPS/PS memastikan bahwa semua dosen dan preseptor memahami isi kurikulum.'),
                        $it('Bagaimana UPPS/PS memastikan penyampaian kurikulum dalam lingkungan praktik profesional secara konsisten?', 'UPPS/PS memastikan bahwa penyampaian kurikulum pada praktik profesional terlaksana secara efektif dan konsisten.'),
                    ],
                ],
                [
                    'kode' => '6.3',
                ...
                [
                    ...
                    'items' => [
                        ...
                        $it('Bagaimana dukungan pendanaan untuk UPPS dan keberlanjutannya?', 'UPPS memiliki sumber daya keuangan untuk mencukupi dan mendukung program di semua lokasi.'),

                        $it('Bagaimana UPPS mengelola sumber dan/atau jumlah keuangan yang dapat berubah dari waktu ke waktu?', 'UPPS melakukan rencana anggaran perubahan baik sumber dan atau jumlahnya yang disesuaikan dengan aktivitas program prioritas dari waktu ke waktu.'),
