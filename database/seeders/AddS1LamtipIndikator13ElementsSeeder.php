            ...
            $criteriaList = [
                [
                    ...
                    'items' => [
                        ...
                        [
                            'elemen' => 'Luaran',
                            'indikator' => 'Prestasi mahasiswa di bidang akademik dalam 3 tahun terakhir',
                        ...
                        [
                            'elemen' => 'Luaran',
                            'indikator' => 'Prestasi mahasiswa di bidang non akademik dalam 3 tahun terakhir',
                            'indikator_penilaian' => "4: Jika RI ≥ a , maka Skor = 4\n3:\n   - Jika RI < a dan RN ≥ b , maka Skor = 3 + (RI / a)\n   - Jika 0 < RI < a dan 0 < RN < b , maka Skor = 2 + (2 x (RI/a)) + (RN/b) - ((RI x RN)/(a x b))\n2: -\n1:\n   - Jika RI = 0 dan RN = 0 dan RW ≥ c , maka Skor = 2\n   - Jika RI = 0 dan RN = 0 dan RW < c , maka Skor = (2 x RW) / c\n0: -"
                        ],
                        [
                            'elemen' => 'Luaran',
                        ...
                        [
                            'elemen' => 'Luaran',
                            'indikator' => 'UPPS menunjukkan hasil analisis terhadap luaran program pendidikan yang terdiri dari penyelesaian studi lulusan sebagai berikut; A. Kelulusan tepat masa tempuh kurikulum (Mahasiswa Sarjana masuk TS-3 lulus sampai TS)',
                            'indikator_penilaian' => "4: Jika PTW ≥ 50% , maka Skor = 4\n3: Jika PTW < 50% , maka Skor = 1 + (6 x PTW)\n2: -\n1: -\n0: Tidak ada Skor kurang dari 1."
                        ],
                        [
                            'elemen' => 'Luaran',
                            'indikator' => 'B. Kelulusan tepat 2x waktu tempuh kurikulum (mahasiswa Sarjana masuk TS-7 lulus sampai TS).',
