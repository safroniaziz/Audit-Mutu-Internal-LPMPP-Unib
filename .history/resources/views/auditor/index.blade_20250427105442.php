        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    <div class="w-100 ">
                        <div class="alert alert-danger alert-dismissible fade show d-flex align-items-center shadow-lg" role="alert" style="background: linear-gradient(135deg, #ff4d4d, #ff1a1a); border-radius: 8px;">
                            <i class="fas fa-exclamation-triangle fs-2 me-3 text-white"></i>
                            <div class="text-white">
                                <strong>Perhatian!</strong> Jika Anda ingin menghapus data Administrator, harap pastikan data tersebut telah dinonaktifkan terlebih dahulu.
                            </div>
