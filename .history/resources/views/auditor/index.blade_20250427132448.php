                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-auditor-table-toolbar="base">
                            <button type="button" id="addAuditorButton" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_auditor" style="padding-top: .8rem; padding-bottom: .8rem;">
                                    ...
                                    <td class="text-center">
                                        <div class="button-container">
                                            <button type="button" class="btn btn-sm btn-light-success editauditorButton"
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#kt_modal_auditor">
