                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <span class="text-gray-800 text-hover-primary">{{ $auditor->name }}</span>
                                            </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-circle symbol-35px overflow-hidden me-3">
                                                    <div class="symbol-label">
                                                        @if ($auditor->ttd)
                                                            <img src="{{ Storage::url($auditor->ttd) }}" alt="{{ $auditor->name }}" class="w-100" />
                                                        @else
                                                            -
                                                        @endif
                                                    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.data.ttd_url) {
                        const dropZone = document.getElementById('dragDropZone');
                        dropZone.innerHTML = `
                            <img src="${response.data.ttd_url}" class="preview-img">
                            <div class="position-absolute top-0 end-0 m-2">
                                <button type="button" class="btn btn-sm btn-danger btn-icon" onclick="resetUpload()">
                                    <i class="ki-duotone ki-cross fs-2">
                                        <span class="path1"></span>
