...
@push('scripts')
    ...
    <script>
        ...
        function makeFilterable(selectElement) {
        const searchBox = document.createElement("input");
        searchBox.classList.add("form-control", "mb-2");
        searchBox.setAttribute("type", "text");
        searchBox.setAttribute("placeholder", "Cari auditor...");

        // Insert search box before select
    ...
    // Apply to all select elements after loading options
    function applyFilterable() {
        document.querySelectorAll('select.filterable').forEach(function(select) {
            makeFilterable(select);
        });
    }
