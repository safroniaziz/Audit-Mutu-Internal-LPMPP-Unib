    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderCards(penugasanAuditors) {
                ...
                // Check audit activities for all penugasan auditors
                const auditActivityChecks = penugasanAuditors.map(penugasanAuditor =>
                    fetch(`/penugasan-auditor/check-audit-activities/${penugasanAuditor.id}`)
                        .then(response => response.json())
                        .then(data => ({
                ...
                Promise.all(auditActivityChecks).then(results => {
                    ...
                    console.log('Audit status map:', auditStatusMap);
