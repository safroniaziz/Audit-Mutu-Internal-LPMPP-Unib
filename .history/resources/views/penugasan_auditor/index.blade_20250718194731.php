                ...
                <div class="card-body p-0">
                    ...
                    <div class="py-5 px-10 bg-light-primary">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-3">
                                <select id="periodFilter" class="form-select form-select-solid">
                                    ...
                                    @foreach($allPeriods as $period)
                                        <option value="{{ $period->nomor_surat }}"
                            ...
                            <div class="col-lg-2">
                                <button type="button" id="clearFilters" class="btn btn-light-secondary w-100">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderCards(penugasanAuditors) {
                console.log('Rendering cards with data:', penugasanAuditors); // Debug log
                ...
                penugasanAuditors.forEach((penugasanAuditor, index) => {
                    console.log(`Processing penugasan ${index}:`, penugasanAuditor); // Debug log
                    ...
                    console.log(`Auditee:`, auditee); // Debug log
                    console.log(`Auditors:`, auditors); // Debug log
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        ${auditors.length > 0 ?
                                            auditors.map((auditor, auditorIndex) => {
                                                console.log(`Processing auditor ${auditorIndex}:`, auditor); // Debug log
                                                ...
                                                console.log(`Auditor data:`, auditorData); // Debug log
                                                console.log(`Auditor name:`, auditorName); // Debug log
