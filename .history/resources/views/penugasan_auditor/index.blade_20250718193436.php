                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-3">
                                <select id="periodFilter" class="form-select form-select-solid">
                                    ...
                                    @foreach($penugasanAuditors->pluck('periodeAktif.nomor_surat')->unique()->filter() as $nomorSurat)
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const penugasanCards = document.querySelectorAll('.penugasan-card');
            ...
            function applyFilters() {
                ...
                penugasanCards.forEach(card => {
                    ...
                    if (searchMatch && statusMatch && periodMatch) {
            ...
            function updateResultsCount() {
                const visibleCards = document.querySelectorAll('.penugasan-card[style*="block"], .penugasan-card:not([style*="none"])');
                const totalCards = penugasanCards.length;

                // You can add a results counter element if needed
                console.log(`Showing ${visibleCards.length} of ${totalCards} results`);
            }
