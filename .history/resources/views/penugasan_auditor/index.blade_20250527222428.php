...
@section('content')
    ...
    @forelse ($penugasanAuditor->auditors as $auditor)
        <div class="d-flex align-items-center mb-2">
            <div class="symbol symbol-30px symbol-circle bg-light-primary me-3">
                <i class="fas fa-user text-primary"></i>
            </div>
            <div>
                <div class="fw-semibold text-dark">{{ $auditor->auditor->name }}</div>
                <span class="badge bg-secondary text-capitalize mt-1">
