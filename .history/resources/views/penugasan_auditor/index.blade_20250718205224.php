    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateAuditStatus(pengajuanId) {
                ...
                checkAuditActivities(pengajuanId).then(hasActivities => {
                    if (hasActivities) {
                        statusBadge.className = 'badge badge-light-warning fs-8';
                        statusBadge.innerHTML = '<i class="fas fa-lock me-1"></i>Audit Aktif';
                    } else {
        ...
        function setPenugasanId(id) {
            ...
            checkAuditActivities(id).then((hasActivities) => {
                if (hasActivities) {
                    // Make form readonly if there are audit activities
                    makeFormReadonly();
                    showAuditActivityWarning();
                } else {
                    // Enable form if no audit activities
                    enableForm();
                }
        ...
        function makeFormReadonly() {
            ...
            if (submitBtn) {
                ...
                submitBtn.innerHTML = '<i class="fas fa-lock me-2"></i>Form Terkunci';
        ...
        // Function to show audit activity warning
        function showAuditActivityWarning() {
            ...
            warning.innerHTML = `
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="alert-heading mb-1">Form Terkunci</h6>
                        <p class="mb-0">Form tidak dapat diedit karena auditor sudah melakukan aktivitas audit (desk evaluation, visitasi, atau evaluasi AMI).</p>
                    </div>
                </div>
            `;
