                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-12">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                ${$penugasanAuditor->auditors->count() > 0 ? `<span class="badge badge-light-primary fs-8 ms-auto">${$penugasanAuditor->auditors->count()} Auditor</span>` : ''}
                                            </div>
                                            ${$penugasanAuditor->auditors->count() > 0 ?
                                                $penugasanAuditor->auditors->map(auditor => `
                                                    <div class="d-flex align-items-center mb-2">
                                                        <div class="symbol symbol-30px me-2">
