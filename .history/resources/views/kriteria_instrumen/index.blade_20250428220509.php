                                    ...
                                    <td class="text-center">
                                        <div class="button-container">
                                            <button type="button" class="btn btn-sm btn-light-success edit-kriteriaInstrumen"
                                                ...
                                                data-url="{{ route('kriteriaInstrumen.edit', $indikator->id) }}"
                                            ...
                                            @else
                                                <button type="button" class="btn btn-sm btn-light-danger nonaktifkan-kriteriaInstrumen" data-id="{{ $indikator->id }}">
