        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-auto">
                                            <div class="rounded-4 px-4 py-3 shadow-lg" style="background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(15px); border: 1px solid rgba(255, 255, 255, 0.3);">
                                                ...
                                                <div class="text-white fs-5 fw-bold">{{ $stats['active_periods'] ?? 0 }}</div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="rounded-4 px-4 py-3 shadow-lg" style="background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(15px); border: 1px solid rgba(255, 255, 255, 0.3);">
                                ...
                                <div class="col-lg-4">
                                    <div class="text-end">
                                        ...
                                        <div class="rounded-4 p-5 mb-4 shadow-lg" style="background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(15px); border: 1px solid rgba(255, 255, 255, 0.3);">
                                            ...
                                            <div class="text-white fs-5 fw-semibold mb-2" style="text-shadow: 0 1px 2px rgba(0,0,0,0.2);">{{ now()->format('M Y') }}</div>
                                            <div class="text-white fs-7 fw-medium" style="opacity: 0.9;">{{ now()->format('l, H:i') }}</div>
                                        </div>
            ...
            <div class="row g-5 g-xl-8">
                ...
                <div class="col-xl-6">
                    <div class="card card-flush border-0 bg-white shadow-sm">
                        <div class="card-header pt-5">
                            <h3 class="card-title fw-bold text-dark">Recent Evaluasi</h3>
                        </div>
                        <div class="card-body pt-0">
                            <div class="d-flex flex-column gap-3">
                                @forelse($recentEvaluasi as $evaluasi)
                                <div class="d-flex align-items-center p-3 rounded-3" style="background: #f8f9fa;">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="fw-bold text-gray-800">{{ $evaluasi['evaluator_name'] ?? 'N/A' }}</div>
                                        <div class="text-gray-600 fs-7">{{ $evaluasi['unit_kerja'] ?? 'N/A' }}</div>
                                        <div class="text-gray-500 fs-8">Score: {{ $evaluasi['score'] ?? 'N/A' }}</div>
                                    </div>
                                    <span class="badge badge-light-success fs-8 fw-bold">{{ $evaluasi['created_at'] ?? 'N/A' }}</span>
                                </div>
                                @empty
                                <div class="text-center py-8">
                                    <i class="ki-duotone ki-shield-tick fs-3x text-gray-400 mb-4">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                    </i>
                                    <div class="text-gray-600">Belum ada evaluasi terbaru</div>
                                </div>
                                @endforelse
                            </div>
                        </div>
                ...
                <!-- Distribusi Indikator per Unit Kerja Chart -->
                <div class="col-xl-6">
                    <div class="card card-flush border-0 bg-white shadow-sm">
                        <div class="card-header pt-5">
