            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        console.log("Data dari server:", data.jenis_auditee);
                        ...
                        // Set CKEditor content menggunakan instance yang sudah disimpan
                        editorFields.forEach(id => {
                            const fieldName = id.replace('kt_docs_ckeditor_', '');
                            if (editorInstances[id]) {
                                editorInstances[id].setData(data[fieldName] || '');
                            }
                        });
                    }
                },
