...
@section('content')
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-indikatorKinerja-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Cari Instrumen IKSS" />
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_indikatorKinerja_table">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                @forelse ($instrumenIksss as $index => $instrumenIkss)
                                    <tr>
                                        ...
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $instrumenIkss->satuanStandar->sasaran }}</td>
                                        <td>{{ $instrumenIkss->kode_ikss }}</td>
                                        <td>{{ $instrumenIkss->tujuan }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="button-container">
                                                <button type="button" class="btn btn-sm btn-light-success edit-indikatorKinerja"
                                                    ...
                                                    data-url="{{ route('indikatorKinerja.edit', $instrumenIkss->id) }}"
                                                ...
                                                @else
                                                    <button type="button" class="btn btn-sm btn-light-danger nonaktifkan-indikatorKinerja" data-id="{{ $instrumenIkss->id }}">
            ...
            @include('layouts.partials._modal_indikator_kinerja')
        </div>
    </div>
@endsection
