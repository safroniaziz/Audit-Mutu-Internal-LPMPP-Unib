    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                // A much simpler approach for CKEditor 5
                // We'll find the CKEditor instances directly using the internal API
                editorFields.forEach(id => {
                    ...
                    if (editorElement) {
                        // CKEditor 5 stores its instance in an internal property
                        // We can access it via the element's "ckeditorInstance" getter
