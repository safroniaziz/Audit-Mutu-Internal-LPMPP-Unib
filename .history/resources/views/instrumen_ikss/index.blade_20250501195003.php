            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#kt_modal input[name="satuan"]').val(data.satuan);
                        $('#kt_modal input[name="pertanyaan"]').val(data.pertanyaan);
                        $('#kt_modal input[name="target"]').val(data.target);
                        $('#kt_modal input[name="sumber"]').val(data.sumber);
                        $('#kt_modal input[name="uraian"]').val(data.uraian);
                        $('#kt_modal input[name="penilaian"]').val(data.penilaian);
