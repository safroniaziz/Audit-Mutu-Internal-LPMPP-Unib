    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                // Handle regular form fields with jQuery
                ...
                // Handle CKEditor fields using their instances
                if (editorInstances.indikator) editorInstances.indikator.setData(data.indikator || '');
                if (editorInstances.satuan) editorInstances.satuan.setData(data.satuan || '');
                if (editorInstances.pertanyaan) editorInstances.pertanyaan.setData(data.pertanyaan || '');
                if (editorInstances.sumber) editorInstances.sumber.setData(data.sumber || '');
                if (editorInstances.uraian) editorInstances.uraian.setData(data.uraian || '');
                if (editorInstances.penilaian) editorInstances.penilaian.setData(data.penilaian || '');
                if (editorInstances.tujuan) editorInstances.tujuan.setData(data.tujuan || '');
            }
        },
        error: function() {
