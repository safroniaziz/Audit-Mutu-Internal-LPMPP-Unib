...
@push('scripts')
    ...
    // Reset dropdown indikator_instrumen_kriteria_id
    $('select[name="indikator_instrumen_kriteria_id"]')
        .empty()
        .append('<option disabled selected>-- pilih kriteria instrumen --</option>');

    // Reset variabel tersimpan
    savedKriteriaId = null;

    // Kosongkan semua CKEditor instance
