...
@section('content')
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row mb-8">
                <div class="col-12">
                    <div class="card card-flush border-0 position-relative overflow-hidden">
                        <!-- Background Pattern -->
                        <div class="position-absolute top-0 end-0 opacity-10">
                            <i class="ki-duotone ki-shield-tick fs-15x text-primary">
                        ...
                        <div class="card-body p-8 position-relative">
                            <div class="row align-items-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Subtitle -->
                                    <h2 class="text-white-75 fs-4 fw-semibold mb-3">Sistem Audit Mutu Internal Universitas Bengkulu</h2>

                                    <!-- Description -->
                                    <p class="text-white-50 fs-6 mb-4 lh-base">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-auto">
                                            <div class="bg-white bg-opacity-15 rounded-3 px-3 py-2">
                                                <div class="text-white-75 fs-8 fw-semibold">PERIODE AKTIF</div>
                                                <div class="text-white fs-6 fw-bold">{{ $stats['active_periods'] ?? 0 }}</div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="bg-white bg-opacity-15 rounded-3 px-3 py-2">
                                                <div class="text-white-75 fs-8 fw-semibold">AUDITOR</div>
                                                <div class="text-white fs-6 fw-bold">{{ $stats['total_auditors'] ?? 0 }}</div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="bg-white bg-opacity-15 rounded-3 px-3 py-2">
                                                <div class="text-white-75 fs-8 fw-semibold">AUDITEE</div>
                                                <div class="text-white fs-6 fw-bold">{{ $stats['total_auditees'] ?? 0 }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="text-end">
                                        ...
                                        <div class="bg-white bg-opacity-15 rounded-3 p-4 mb-4">
                                            <div class="text-white-75 fs-8 fw-semibold mb-1">TANGGAL & WAKTU</div>
                                            <div class="text-white fs-2hx fw-bold mb-1">{{ now()->format('d') }}</div>
                                            <div class="text-white fs-6 fw-semibold mb-2">{{ now()->format('M Y') }}</div>
                                            <div class="text-white-75 fs-7">{{ now()->format('l, H:i') }}</div>
                                        </div>

                                        <!-- System Status -->
                                        <div class="bg-white bg-opacity-15 rounded-3 p-3">
                                            <div class="d-flex align-items-center justify-content-end mb-2">
                                                <div class="bg-success rounded-circle w-8px h-8px me-2"></div>
                                                <span class="text-white fs-8 fw-semibold">SISTEM AKTIF</span>
                                            </div>
                                            <div class="text-white-75 fs-7">Real-time monitoring</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex flex-column gap-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="text-gray-600 fs-8 mb-2">Auditor & Auditee login dalam 30 hari terakhir</div>
                                        <div class="progress h-6px w-100">
