...
<head>
    ...
    <title>Sedang Penyesuaian - SIntamu</title>
    <meta name="description" content="Aplikasi SIntamu sedang dalam proses penyesuaian. Mohon maaf atas ketidaknyamanan ini.">
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="maintenance-container">
        ...
        <p class="subtitle">Aplikasi SIntamu</p>

        <div class="description">
            <p>Kami sedang melakukan penyesuaian dan perbaikan pada sistem SIntamu untuk memberikan pengalaman yang lebih baik kepada Anda.</p>
        ...
        <div class="maintenance-schedule">
            <h3>📅 Jadwal Penyesuaian</h3>
            <p><strong>Tanggal Selesai:</strong> 8 September 2024</p>
            <p><strong>Waktu Selesai:</strong> 23:59 WIB</p>
            <p class="note">Aplikasi akan kembali normal setelah waktu tersebut</p>
        </div>
        ...
        <div class="footer">
            <p>&copy; {{ date('Y') }} SIntamu - Sistem Informasi Audit Mutu Internal</p>
