...
<div class="w-full max-w-md">
    ...
    <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">SINTAMU</h1>
        <p class="text-gray-600">LPMPP Universitas Bengkulu</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <form action="{{ route('auditee.password.update.post') }}" method="POST">
            @csrf
