                            ...
                            <div class="col-lg-6">
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <span class="bullet bullet-vertical bg-primary me-5"></span>
                                        <div class="flex-grow-1">
                                            <span class="text-muted d-block">Jumlah Penilaian</span>
                                            <span class="fw-bold fs-5">{{ $sortedGrouped->where('has_data', true)->sum('jumlah_penilaian') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <span class="fw-bold fs-5">{{ number_format($sortedGrouped->where('has_data', true)->avg('rata_rata'), 2) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
