        ...
        <div class="card-body p-9">
            ...
            <div class="alert alert-warning d-flex align-items-center p-5 mb-10">
                ...
                <div class="d-flex flex-column">
                    ...
                    <!--begin::Content-->
                    <span class="text-gray-700 fw-semibold">Untuk melihat detail hasil audit, Anda harus mengisi evaluasi terlebih dahulu. Silakan klik tombol "Isi Evaluasi" pada setiap unit kerja yang telah selesai diaudit.</span>
                    <!--end::Content-->
                </div>
                <!--end::Wrapper-->
            </div>
