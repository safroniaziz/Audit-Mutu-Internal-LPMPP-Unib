                        ...
                        <div class="card card-xl-stretch mb-xl-8 shadow-sm hover-elevate-up">
                            ...
                            <div class="card-footer">
                                <div class="d-flex gap-2">
                                    ...
                                    @else
                                        <button type="button" class="btn btn-primary flex-grow-1" disabled data-bs-toggle="tooltip" data-bs-placement="top" title="Anda harus mengisi evaluasi terlebih dahulu">
                                            <i class="fas fa-info-circle me-2"></i>
                                            Lihat Detail
                                        </button>
                                    @endif
