    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="px-10 pt-10 pb-5">
                        <div class="d-flex flex-stack mb-5">
                            ...
                            <div class="d-flex gap-3">
                                <a href="{{ route('auditee.laporan.laporanAmi', [$pengajuanAmis->id]) }}" target="_blank"
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="text-muted d-block fs-8">{{ $pengajuanAmis->auditee->jenjang ?? 'S1' }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
            ...
            <div class="row g-5 g-xl-8">
                ...
                <div class="col-xl-6">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            <div style="position: relative; width: 100%; max-width: 400px; aspect-ratio: 1; margin: 0 auto;">
                        ...
                        <div class="card-body">
                            ...
                            @else
                                <div class="text-center py-8">
                                    ...
                                    <p class="text-muted">Data instrumen prodi belum tersedia</p>
                                </div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="row g-5 g-xl-8">
                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    <thead>
                                        <tr class="fw-bold text-muted bg-light">
                                            ...
                                            <th class="w-200px">Sasaran</th>
                                            <th class="w-100px text-center">Rata-Rata</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php $nomor = 1; @endphp
                                        @foreach ($sortedGrouped as $index => $group)
                                            @if($group['has_data'])
                                                <tr>
                                                    <td class="w-25px">
                                                        <span class="text-dark fw-semibold">{{ $nomor }}</span>
                                                    </td>
                                                    <td class="w-100px">
                                                    ...
                                                    <td class="w-100px text-center">
                                                        <span class="badge badge-light-primary fw-bold">{{ number_format($group['rata_rata'], 2) }}</span>
                                                    </td>
                                                </tr>
                                                @php $nomor++; @endphp
                                            @endif
                ...
                <!-- Instrumen Prodi Table -->
                <div class="col-xl-6">
                    <div class="card shadow-sm border-0">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title fw-bold text-dark">
                                <i class="fas fa-table me-2 text-success"></i>
                                Detail Instrumen Prodi
                            </h3>
                        </div>
                        <div class="card-body">
                            @if(isset($kriteriaScores) && count($kriteriaScores) > 0)
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($kriteriaScores as $kriteria)
                                                <tr>
                                                    ...
                                                    <td class="w-100px">
                                                        <span class="text-dark fw-semibold text-hover-success">{{ $kriteria['kode_kriteria'] }}</span>
                                                    </td>
                                                    <td class="w-200px">
                                                        <span class="text-dark fw-semibold">{{ $kriteria['nama_kriteria'] }}</span>
                                                    </td>
                                                    <td class="w-100px text-center">
                                                        <span class="badge badge-light-success fw-bold">{{ number_format($kriteria['rata_rata'], 2) }}</span>
                                                    </td>
                                                </tr>
                                                @php $nomor++; @endphp
                                            @endforeach
                            ...
                            @else
                                <div class="text-center py-8">
                                    <i class="fas fa-table fs-2x text-muted mb-3"></i>
                                    <p class="text-muted">Data instrumen prodi belum tersedia</p>
                                </div>
                            @endif
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            sortedGrouped.forEach(item => {
                ...
                if (item.has_data) {
                    ...
                    labelsSasaran.push(item.kode_satuan);
                    // Use the rata_rata as the value
                    valuesSasaran.push(item.rata_rata);
                }
            });

            // Data for Sasaran Strategis Radar Chart
            const dataSasaran = {
                labels: labelsSasaran,
                datasets: [{
            ...
            const ctxRadarSasaran = document.getElementById('kt_radar_chart');
            if (ctxRadarSasaran) {
                new Chart(ctxRadarSasaran, configRadarSasaran);
            }
            ...
            if (kriteriaScores.length > 0) {
                ...
                kriteriaScores.forEach(item => {
                    labelsProdi.push(item.kode_kriteria);
                    valuesProdi.push(item.rata_rata);
                });
