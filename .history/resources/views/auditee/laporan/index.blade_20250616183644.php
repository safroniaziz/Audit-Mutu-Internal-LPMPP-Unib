...
@push('styles')
    <style>
        ...
        .audit-card:hover {
            ...
            box-shadow: 0 0 20px rgba(76, 87, 125, 0.1);
        }
        ...
        .detail-btn:hover {
            ...
            box-shadow: 0 0 20px rgba(114, 57, 234, 0.3);
        }
                ...
                @forelse ($penugasanAuditors as $penugasanAuditor)
                    <div class="audit-card">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('auditee.laporan.detail', $penugasanAuditor->id) }}" class="btn detail-btn">
