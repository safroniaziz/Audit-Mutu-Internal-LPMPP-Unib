                                                    ...
                                                    <div class="mb-8">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered border-gray-300">
                                                                ...
                                                                <tr>
                                                                    <td class="fw-semibold bg-light">Sumber Data/Bukti <a class="text-danger text-xs">(Data kerja sama, MoU, IA, dan laporan kerjasama UPPS)</a></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number"
                                                                            class="form-control"
                                                                            name="realisasi[{{ $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id }}]"
                                                                            min="0"
                                                                            max="100"
                                                                            value="{{ $instrumenProdi->submission ? $instrumenProdi->submission->realisasi : '' }}"
                                                                            >
                                                                        <div class="form-text">Masukkan realisasi dalam bentuk angka (0-100)</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
