    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateProgress() {
                ...
                // Count all instruments and checked ones
                wizardContents.forEach(content => {
                    ...
                    totalInstruments += stepInstruments;
                ...
                const overallProgress = (totalChecked / totalInstruments) * 100;
                ...
                document.querySelector('.progress-percentage').textContent = `${Math.round(overallProgress)}%`;

                // Update status text to show both overall and current SS progress
                ...
                document.querySelector('.progress-status').textContent =
                    `Progress Keseluruhan: ${totalChecked} dari ${totalInstruments} instrumen (${Math.round(overallProgress)}%) | ` +
                    `${currentSS}: ${currentStepChecked} dari ${currentStepInstruments} instrumen (${Math.round(currentStepProgress)}%)`;
