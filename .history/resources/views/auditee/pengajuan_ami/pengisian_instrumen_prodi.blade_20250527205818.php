                                            ...
                                            <div class="card card-bordered shadow-sm mb-10">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-8">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered border-gray-300">
                                                                ...
                                                                <tr>
                                                                    <td class="fw-semibold bg-light">Sumber Data</td>
                                                                    <td>{{ $instrumenProdi->sumber_data }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fw-semibold bg-light">Metode Perhitungan</td>
                                                                    <td>{{ $instrumenProdi->metode_perhitungan }}</td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $instrumenProdi->realisasi }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fw-semibold bg-light">Standar yang Digunakan</td>
                                                                    <td>{{ $instrumenProdi->standar_digunakan }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fw-semibold bg-light">Dokumen</td>
                                                                    <td>
                                                                        ...
                                                                        @endif
                                                                        <div class="mt-2">
                                                                            <input type="file" name="dokumen[{{ $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id }}][]" class="form-control">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number"
                                                                            class="form-control"
                                                                            name="nilai[{{ $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id }}]"
                                                                            min="0"
                                                                            max="100"
                                                                ...
                                                                <tr>
                                                                    <td class="fw-semibold bg-light">Realisasi</td>
                                                                    <td>
                                                                        <textarea class="form-control" name="realisasi[{{ $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id }}]" rows="3">{{ $instrumenProdi->submission ? $instrumenProdi->submission->realisasi : '' }}</textarea>
                                                                        <div class="form-text">Masukkan realisasi yang telah dicapai</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fw-semibold bg-light">Akar Penyebab</td>
                                                                    <td>
                                                                        <textarea class="form-control" name="akar_penyebab[{{ $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id }}]" rows="3">{{ $instrumenProdi->submission ? $instrumenProdi->submission->akar_penyebab : '' }}</textarea>
                                                                        <div class="form-text">Masukkan akar penyebab jika ada</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fw-semibold bg-light">Rencana Perbaikan</td>
                                                                    <td>
                                                                        <textarea class="form-control" name="rencana_perbaikan[{{ $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id }}]" rows="3">{{ $instrumenProdi->submission ? $instrumenProdi->submission->rencana_perbaikan : '' }}</textarea>
                                                                        <div class="form-text">Masukkan rencana perbaikan jika ada</div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    ...
                                                    <div class="mb-8">
                                                        ...
                                                        <textarea class="form-control" name="deskripsi[{{ $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id }}]" rows="4" >{{ $instrumenProdi->submission ? $instrumenProdi->submission->deskripsi : '' }}</textarea>
