                            ...
                            <div class="card bg-light-primary shadow-sm mb-5">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <span class="fs-6 fw-bold text-gray-800">Progress {{ $satuanStandar->kode_satuan }}</span>
                                        <span class="fs-6 fw-bolder text-primary progress-percentage-ss-{{ $loop->iteration }}">0%</span>
                                    </div>
                                    <div class="progress h-5px bg-light">
                                        <div class="progress-bar bg-primary progress-bar-ss-{{ $loop->iteration }}" role="progressbar" style="width: 0%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <span class="fs-7 fw-semibold text-gray-600 mt-2 d-block progress-status-ss-{{ $loop->iteration }}">Instrumen yang telah dipilih: 0 dari 0 instrumen</span>
                                </div>
                            </div>
