            ...
            @else
                <div class="alert alert-danger d-flex align-items-center p-5 mb-10">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        <h4 class="fw-semibold text-gray-900">Informasi Pengisian Instrumen</h4>
                ...
                <div class="card-body pt-9 pb-0">
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center mb-2">
                                        <span class="text-gray-800 text-hover-primary fs-2 fw-bold me-1">Progress Pengisian Instrumen</span>
                                    </div>
                                    <!--begin::Info-->
                                    <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                        <span class="d-flex align-items-center text-gray-400 me-5 mb-2">
                                            <span class="fw-bold text-gray-700">Total Instrumen: {{ array_sum(array_column($ssCompletionStatus, 'total')) }}</span>
                                        </span>
                                    </div>
                                    <!--end::Info-->
                                </div>
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold flex-nowrap">
                            <li class="nav-item">
                                <div class="nav-link text-active-primary me-6 active">
                                    Progress
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="min-w-100 mt-2">
                        ...
                        <div class="d-flex align-items-center w-100 flex-column mt-3">
                            <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                <span class="fw-semibold fs-6 text-gray-400">Progress Pengisian</span>
                                <span class="fw-bold fs-6">{{ number_format($progressPercentage, 1) }}%</span>
                            </div>
