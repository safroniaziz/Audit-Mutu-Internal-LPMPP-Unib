    ...
    foreach ($dataIkssProdi as $unit) {
        foreach ($unit->indikatorKinerjas as $indikator) {
            ...
            foreach ($indikator->instrumen as $instrumen) {
                ...
                // Check if this instrumen is completed - allow 0 as valid value for realisasi
                if (isset($ikssAuditeeData[$instrumen->id]) &&
                    ($ikssAuditeeData[$instrumen->id]->realisasi !== null && $ikssAuditeeData[$instrumen->id]->realisasi !== '') &&
