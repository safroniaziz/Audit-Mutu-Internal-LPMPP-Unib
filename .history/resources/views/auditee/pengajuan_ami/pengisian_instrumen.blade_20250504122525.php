        ...
        @foreach ($dataIkssProdi as $unit)
            @foreach ($unit->indikatorKinerjas as $indikatorIndex => $indikator)
                @if($indikator->instrumen->isNotEmpty())
                    <div class="card mb-4">
                        <!-- Header using jQuery selector -->
                        <div class="card-header bg-light pt-4 pb-3 collapse-header" data-target="collapse-content-{{ $indikatorIndex }}">
                        ...
                        <!-- Content container -->
                        <div class="collapse-content" id="collapse-content-{{ $indikatorIndex }}">
                            <div class="card-body">
