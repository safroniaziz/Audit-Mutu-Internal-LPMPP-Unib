                        ...
                        <div class="mb-8">
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                @if($completionPercentage == 100)
                                    ...
                                    <span class="fs-7 text-muted">Terakhir diperbarui: {{ \Carbon\Carbon::parse($user->updated_at)->translatedFormat('d F Y H:i') }}</span>
                                @endif
                            </div>
                        </div>
                        <!--end::Profile Progress-->

                        <div class="alert {{ $completionPercentage < 100 ? 'alert-info' : 'alert-success' }} d-flex align-items-start p-5 position-relative">
                            <div class="me-4">
                                <i class="bi {{ $completionPercentage < 100 ? 'bi-info-circle-fill fs-2 text-primary' : 'bi-check-circle-fill fs-2 text-success' }}"></i>
                            </div>
                            <div class="flex-grow-1">
                                ...
                                @else
                                    <h4 class="fw-bold text-dark mb-2">✨ Profil Lengkap!</h4>
                                    <div class="fs-6 text-gray-700">
                                        <p class="mt-4">
                            ...
                            <div class="ms-auto">
                                <a
                                    href="{{ $completionPercentage < 100 ? '#' : route('auditee.pengajuanAmi.perjanjianKinerja') }}"
