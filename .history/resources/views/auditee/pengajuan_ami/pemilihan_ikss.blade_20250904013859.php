...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            console.log('Wizard nav scroll width:', wizardNav[0].scrollWidth);
            console.log('Wizard nav client width:', wizardNav[0].clientWidth);
            console.log('Can scroll:', wizardNav[0].scrollWidth > wizardNav[0].clientWidth);
        });
    </script>
@endpush
