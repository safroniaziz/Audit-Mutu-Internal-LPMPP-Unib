    ...
    <div class="card mb-5">
        <div class="card-body">
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    <h3 class="text-gray-800 fw-bold mb-0">👋 Selamat Datang Kaprodi,</h3>
                    <span class="text-gray-600">Silakan isi instrumen prodi berikut ini</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card bg-light-success mb-5">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h3 class="text-success fw-bold mb-1">✨ Pengisian Instrumen Selesai</h3>
                    <p class="text-success mb-0">Selamat! Semua instrumen telah diisi dengan lengkap. Silakan lanjut ke tahap Unggah Siklus.</p>
                </div>
            </div>
        </div>
    </div>
