        ...
        <div class="card-body">
            <div class="alert alert-primary d-flex align-items-center p-5 mb-10">
                ...
                <div class="d-flex flex-column">
                    ...
                    <span>Silakan unggah dokumen Perjanjian Kinerja program studi Anda. Dokumen ini akan menjadi dasar untuk proses audit mutu internal selanjutnya.</span>
                </div>
            </div>

            <div class="row justify-content-center">
                <div class="col-xl-8">
                    @if($perjanjianKinerja && $perjanjianKinerja->file_perjanjian_kinerja)
                        <div class="text-center mb-10">
                            <div class="file-info p-8">
                                ...
                                <p class="text-gray-600 mb-5">Dokumen terakhir diunggah pada: {{ $perjanjianKinerja->waktu_upload_perjanjian->format('d F Y H:i') }}</p>
                                <div class="d-flex justify-content-center gap-3">
                                    <a href="{{ Storage::url($perjanjianKinerja->file_perjanjian_kinerja) }}" class="btn btn-sm btn-primary" target="_blank">
                    ...
                    <form id="uploadForm" class="form {{ $perjanjianKinerja && $perjanjianKinerja->file_perjanjian_kinerja ? 'd-none' : '' }}" action="{{ route('auditee.pengajuanAmi.uploadPerjanjianKinerja') }}" method="POST" enctype="multipart/form-data">
                        @csrf
