                                        ...
                                        <div class="card mb-5">
                                            ...
                                            <div class="card-body">
                                                @foreach ($indikator->instrumen as $instrumen)
                                                    <form action="{{ route('auditee.submit.instrumen') }}" method="POST" enctype="multipart/form-data" class="mb-5">
                                                        @csrf
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="mt-2">
                                                                                <input type="file" name="bukti_file" class="form-control" id="buktiFile_{{ $instrumen->id }}">
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <textarea class="form-control" name="uraian" rows="3">{{ isset($ikssAuditeeData[$instrumen->id]) ? $ikssAuditeeData[$instrumen->id]->uraian : '' }}</textarea>
                                                        </div>

                                                        <div class="mb-4">
                                                            <h6>Pengukuran</h6>
                                                            <h6 class="text-muted fs-7">Akar Penyebab (target tidak tercapai)/ Akar Penunjang (target tercapai)</h6>
                                                            <textarea class="form-control" name="akar_penyebab" rows="4">{{ isset($ikssAuditeeData[$instrumen->id]) ? $ikssAuditeeData[$instrumen->id]->akar_penyebab : '' }}</textarea>
                                                        </div>

                                                        <div class="mb-4">
                                                            <h6>Rencana Perbaikan dan Tindak lanjut</h6>
                                                            <textarea class="form-control" name="rencana_perbaikan" rows="4">{{ isset($ikssAuditeeData[$instrumen->id]) ? $ikssAuditeeData[$instrumen->id]->rencana_perbaikan : '' }}</textarea>
                                                        </div>
