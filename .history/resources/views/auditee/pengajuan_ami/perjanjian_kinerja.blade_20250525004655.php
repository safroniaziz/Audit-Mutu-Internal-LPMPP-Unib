        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-dark">Perjanjian Kinerja</span>
                    <span class="text-gray-400 mt-1 fw-semibold fs-6">Unggah dokumen perjanjian kinerja program studi</span>
                </h3>
            </div>
        </div>
