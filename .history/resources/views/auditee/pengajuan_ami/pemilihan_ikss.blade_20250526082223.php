...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Calculate and update progress for current SS
            function updateProgress() {
                ...
                if (statusText) {
                    statusText.textContent = `Progress: ${selectedCount}/${totalInstruments} instrumen dipilih`;
                }
            ...
            function calculateOverallProgress() {
                ...
                // Count all instruments across all SS
            ...
            function initializeProgress() {
                ...
                // Update both main progress and current SS progress
                updateMainProgress();
                updateProgress();
            }
