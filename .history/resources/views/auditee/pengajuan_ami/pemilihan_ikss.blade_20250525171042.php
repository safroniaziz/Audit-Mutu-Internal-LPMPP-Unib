            ...
            <div class="mb-8">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <span class="text-gray-600">Apakah IKSS Anda sudah lengkap?</span>
                    </div>
    ...
    <script>
         ...
         $(document).ready(function() {
            ...
            function updateProgress() {
                // Dapatkan semua grup radio button yang bukan wajib (yang tidak disabled)
                const radioGroups = new Set();
                $('input[type="radio"]:not(:disabled)').each(function() {
                    radioGroups.add($(this).attr('name'));
                });
                const totalInstruments = radioGroups.size; // Jumlah instrumen non-wajib

                // Hitung berapa grup yang sudah dipilih (Ya/Tidak)
                ...
                // Hitung persentase
                const progressPercentage = totalInstruments > 0 ? Math.round((selectedGroups / totalInstruments) * 100) : 0;
                ...
                if (progressPercentage === 100) {
                    $('.progress-status').html(`<span class="text-success">Seluruh instrumen telah dipilih (${selectedGroups} dari ${totalInstruments} instrumen)</span>`);
                    ...
                    $('.progress-status').html(`Instrumen yang telah dipilih: ${selectedGroups} dari ${totalInstruments} instrumen`);
