                                    ...
                                    <form class="kriteria-form" data-kriteria-id="{{ $kriteriaId }}">
                                        ...
                                        @foreach($kriteriaData['instrumens'] as $instrumenProdi)
                                            <div class="card card-bordered shadow-sm mb-10">
                                                ...
                                                <div class="card-body">
                                                    <input type="hidden" name="instrumen_ids[]" value="{{ $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id }}">
                                                    <div class="mb-8">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered border-gray-300">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @php
                                                                            $submission = \App\Models\InstrumenProdiSubmission::where('indikator_instrumen_id', $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id)
                                                                                ->where('unit_kerja_id', Auth::user()->unit_kerja_id)
                                                                                ->first();
                                                                        @endphp
                                                                        @if($submission && $submission->dokumen->count() > 0)
                                                                            <ul class="list-unstyled mb-0">
                                                                                @foreach($submission->dokumen as $dokumen)
                                                                                    <li>
                                                                        ...
                                                                        @endif
                                                                        <div class="mt-2">
                                                                            <input type="file" name="dokumen[{{ $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id }}][]" class="form-control" multiple>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number"
                                                                            ...
                                                                            min="0"
                                                                            max="100"
                                                                            value="{{ $submission ? $submission->nilai : '' }}"
                                                                            >
                                                    ...
                                                    <div class="mb-8">
                                                        ...
                                                        <textarea class="form-control" name="deskripsi[{{ $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id }}]" rows="4" >{{ $submission ? $submission->deskripsi : '' }}</textarea>
