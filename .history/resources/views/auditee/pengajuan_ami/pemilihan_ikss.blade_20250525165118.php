    ...
    <script>
         ...
         $(document).ready(function() {
            ...
            function updateProgress() {
                const totalInstruments = $('input[type="radio"]:not(:disabled)').length / 2; // Dibagi 2 karena setiap instrumen punya 2 radio (Ya/Tidak)
                const selectedInstruments = $('input[type="radio"]:checked:not(:disabled)').length;
                const progressPercentage = totalInstruments > 0 ? Math.round((selectedInstruments / (totalInstruments / 2)) * 100) : 0;
