...
$(document).ready(function() {
    ...
    function showIndikatorContent(indikatorId) {
        ...
        // Show selected indikator's kriteria group
        $(`#kriteria-group-${indikatorId}`).show();

        // Update active state of indikator buttons
        ...
        const firstKriteriaId = $(`#kriteria-group-${indikatorId} .kriteria-btn`).first().data('kriteria-id');
        if (firstKriteriaId) {
            showKriteriaContent(indikatorId, firstKriteriaId);
        }
    }
    ...
    function showKriteriaContent(indikatorId, kriteriaId) {
        ...
        // Show selected kriteria's instrumen group
        $(`#instrumen-group-${indikatorId}-${kriteriaId}`).show();

        // Update active state of kriteria buttons
        $(`#kriteria-group-${indikatorId} .kriteria-btn`).removeClass('active');
