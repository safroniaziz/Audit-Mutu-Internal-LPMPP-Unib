                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Bisa menambahkan tombol delete jika perlu -->
                                            <a href="{{ route('file.delete', $file->id) }}" class="btn btn-sm btn-outline-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus file ini?')">Hapus</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
