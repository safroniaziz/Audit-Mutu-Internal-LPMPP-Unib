            ...
            <div class="card-body border-top p-9">
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-12 fv-row">
                                <input type="text" name="nama_lengkap" disabled class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Nama Auditee" value="{{ Auth::user()->name }}" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="fakultas" disabled class="form-control form-control-lg form-control-solid" placeholder="Nama Fakultas" value="{{ Auth::user()->unitKerja->fakultas }}" />
                    </div>
                </div>
                <!--end::Input group-->
