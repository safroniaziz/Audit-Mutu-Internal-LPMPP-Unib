            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                @if (session('success'))
                    <div class="alert alert-success d-flex align-items-center p-5 mb-10">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="fs-6 text-gray-700">{{ session('success') }}</span>
                        </div>
                    </div>
                @endif
                ...
                @if ($errors->any())
                    <div class="alert alert-danger d-flex align-items-center p-5 mb-10">
                        ...
                        <div class="d-flex flex-column">
                            <h4 class="mb-1 text-dark">Terdapat Kesalahan!</h4>
            ...
            function highlightErrorFields(errors) {
                ...
                $.each(errors, function(field, messages) {
                    ...
                    if (fieldElement.length) {
                        ...
                        const errorMessage = '<div class="invalid-feedback">' + messages[0] + '</div>';
                        fieldElement.after(errorMessage);
                    }
                });
            }

            // AJAX form submission dengan SweetAlert
            $('#kt_account_profile_details_form').on('submit', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        // AJAX request
                        console.log('Sending AJAX request to:', '{{ route("auditee.pengajuanAmi.lengkapiProfil") }}');
                        $.ajax({
                            url: '{{ route("auditee.pengajuanAmi.lengkapiProfil") }}',
                            type: 'POST',
                            data: formData,
                            processData: false,
                            contentType: false,
                        ...
                        if (xhr.responseJSON) {
                            ...
                            if (xhr.responseJSON.errors) {
                                ...
                                $.each(xhr.responseJSON.errors, function(key, value) {
                                    errorList += '<li class="text-left mb-1">' + value[0] + '</li>';
                                });
                                errorMessage = '<div class="text-left"><ul class="list-unstyled mb-0">' + errorList + '</ul></div>';

                                // Highlight error fields
                                highlightErrorFields(xhr.responseJSON.errors);
                            }
                        }
