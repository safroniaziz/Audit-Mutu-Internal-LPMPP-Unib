            ...
            <div class="alert alert-{{ $perjanjianKinerja && $perjanjianKinerja->file_path ? 'success' : 'danger' }} d-flex align-items-center p-5 mb-10">
                <div class="d-flex flex-column flex-grow-1 pe-3">
                    <div class="d-flex align-items-center mb-1">
                        <span class="svg-icon svg-icon-2hx {{ $perjanjianKinerja && $perjanjianKinerja->file_path ? 'svg-icon-success' : 'svg-icon-danger' }} me-3">
                            <i class="bi {{ $perjanjianKinerja && $perjanjianKinerja->file_path ? 'bi-check-circle-fill' : 'bi-exclamation-triangle-fill' }} fs-2hx"></i>
                        </span>
                ...
                <div class="d-flex align-items-center">
                    <a href="{{ route('auditee.pengajuanAmi.pemilihanIkss') }}" class="btn btn-sm btn-success px-3">
                        Proses Selanjutnya
