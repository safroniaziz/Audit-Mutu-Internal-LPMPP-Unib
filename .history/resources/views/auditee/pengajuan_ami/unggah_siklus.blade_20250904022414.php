                                            ...
                                            @else
                                                <div class="file-upload-wrapper">
                                                    <div class="custom-file-upload" id="dropzone">
                                                        ...
                                                        <button type="button" id="browseFilesBtn" class="btn btn-sm btn-primary" @if($siklus && $siklus->is_desetujui) disabled @endif>
                                                            <i class="bi bi-folder2-open me-2"></i>Pilih File
                                                        </button>
                                                        <input type="file" name="files[]" id="fileInput" multiple style="display: none;" @if($siklus && $siklus->is_desetujui) disabled @endif>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                                                ...
                                                <tr data-id="{{ $file->id }}">
                                                    ...
                                                    <td class="text-nowrap">
                                                        <div class="d-flex">
                                                            ...
                                                            @if(!isset($siklus->is_disetujui) || !$siklus->is_disetujui)
                            ...
                            @if(!$siklus || !isset($siklus->siklus) || (is_countable($siklus->siklus) && count($siklus->siklus) == 0))
            ...
            $('#uploadFilesForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            title: 'Berhasil!',
                            text: 'Dokumen siklus AMI berhasil diunggah.',
                            icon: 'success',
