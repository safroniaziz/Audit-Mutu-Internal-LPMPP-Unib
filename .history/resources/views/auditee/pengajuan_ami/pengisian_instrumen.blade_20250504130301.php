                                                    ...
                                                    @foreach ($indikator->instrumen as $instrumen)
                                                        <div class="mb-5">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                @if(isset($ikssAuditeeData[$instrumen->id]) && $ikssAuditeeData[$instrumen->id]->bukti_file)
                                                                                    <div class="mb-2">
                                                                                        <a href="{{ asset('storage/'.$ikssAuditeeData[$instrumen->id]->bukti_file) }}" target="_blank" class="btn btn-sm btn-outline-info">
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <textarea class="form-control" name="akar_penyebab[{{ $instrumen->id }}]" rows="4">{{ isset($ikssAuditeeData[$instrumen->id]) ? $ikssAuditeeData[$instrumen->id]->akar_peakanyebab : '' }}</textarea>
                                                            </div>
