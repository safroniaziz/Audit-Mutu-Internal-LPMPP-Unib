            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <form id="kt_account_profile_details_form" action="{{ route('auditee.pengajuanAmi.lengkapiProfil') }}" class="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit" style="cursor: pointer; pointer-events: auto; z-index: 1000; position: relative;">
...
@push('scripts')
    <script>
            ...
            console.log('Document ready - Profile form script loaded');
            ...
            submitBtn.on('click', function(e) {
                ...
                // Test if we can trigger the form submission
                ...
                $.ajax({
                    ...
                    beforeSend: function(xhr) {
                        ...
                        if (typeof response === 'string') {
                            // Check if it's HTML response (error case)
                            if (response.includes('<!DOCTYPE html>') || response.includes('<html')) {
                                console.log('Received HTML response instead of JSON - likely an error');
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Server Error!',
                                    html: `<div style="text-align: left;">
                                            <div style="font-size: 16px; color: #ff0000; margin-bottom: 10px; font-weight: bold;">
                                                <i class="fas fa-server me-2"></i>Server mengembalikan halaman HTML alih-alih JSON
                                            </div>
                                            <div style="margin-top: 15px; padding: 10px; background: #f8f9fa; border-radius: 5px; font-size: 12px; color: #666;">
                                                <strong>Debug Info:</strong><br>
                                                Response Type: HTML<br>
                                                Response Length: ${response.length} characters<br>
                            ...
                            try {
                                ...
                                Swal.fire({
                                    ...
                                    html: `<div style="text-align: left;">
                                            <div style="font-size: 16px; color: #ff0000; margin-bottom: 10px; font-weight: bold;">
                                                <i class="fas fa-exclamation-triangle me-2"></i>Gagal memparse response dari server
                                            </div>
                                            <div style="margin-top: 15px; padding: 10px; background: #f8f9fa; border-radius: 5px; font-size: 12px; color: #666;">
                                                <strong>Debug Info:</strong><br>
                                                Error: ${e.message}<br>
                        ...
                        if (response && response.success) {
                            ...
                            Swal.fire({
                                ...
                                html: `<div style="text-align: left;">
                                        <div style="font-size: 16px; color: #ff0000; margin-bottom: 10px; font-weight: bold;">
                                            <i class="fas fa-exclamation-triangle me-2"></i>${response.message || 'Terjadi kesalahan saat menyimpan profil.'}
                                        </div>
                                        <div style="margin-top: 15px; padding: 10px; background: #f8f9fa; border-radius: 5px; font-size: 12px; color: #666;">
                                            <strong>Debug Info:</strong><br>
                    ...
                    error: function(xhr, status, error) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            if (errors) {
                                $.each(errors, function(field, messages) {
                                    $.each(messages, function(index, message) {
                                        errorMessage += `<div style="font-size: 16px; color: #ff0000; margin-bottom: 10px; font-weight: bold;">
                            ...
                            errorDetails = `<div style="margin-top: 15px; padding: 10px; background: #f8f9fa; border-radius: 5px; font-size: 12px; color: #666;">
                                                <strong>Debug Info:</strong><br>
                            ...
                            errorMessage = `<div style="font-size: 16px; color: #ff0000; margin-bottom: 10px;">
                                                <i class="fas fa-server me-2"></i>Terjadi kesalahan pada server
                                            </div>`;
                            errorDetails = `<div style="margin-top: 15px; padding: 10px; background: #f8f9fa; border-radius: 5px; font-size: 12px; color: #666;">
                                                <strong>Debug Info:</strong><br>
                                                Status: ${xhr.status}<br>
                            ...
                            // Not found
                            errorTitle = 'Route Tidak Ditemukan!';
                            errorMessage = `<div style="font-size: 16px; color: #ff0000; margin-bottom: 10px;">
                                                <i class="fas fa-route me-2"></i>URL tidak ditemukan
                                            </div>`;
                            errorDetails = `<div style="margin-top: 15px; padding: 10px; background: #f8f9fa; border-radius: 5px; font-size: 12px; color: #666;">
                                                <strong>Debug Info:</strong><br>
                                                Status: ${xhr.status}<br>
                            ...
                            errorMessage = `<div style="font-size: 16px; color: #ff0000; margin-bottom: 10px;">
                                                <i class="fas fa-wifi me-2"></i>Tidak dapat terhubung ke server
                                            </div>`;
                            errorDetails = `<div style="margin-top: 15px; padding: 10px; background: #f8f9fa; border-radius: 5px; font-size: 12px; color: #666;">
                                                <strong>Debug Info:</strong><br>
                                                Status: ${xhr.status}<br>
                            ...
                            // Other errors
                            errorTitle = 'Error Tidak Dikenal!';
                            errorMessage = `<div style="font-size: 16px; color: #ff0000; margin-bottom: 10px;">
                                                <i class="fas fa-question-circle me-2"></i>Terjadi kesalahan yang tidak diketahui
                                            </div>`;
                            errorDetails = `<div style="margin-top: 15px; padding: 10px; background: #f8f9fa; border-radius: 5px; font-size: 12px; color: #666;">
                                                <strong>Debug Info:</strong><br>
                                                Status: ${xhr.status}<br>
                                                StatusText: ${xhr.statusText}<br>
                                                Response: ${xhr.responseText || 'No response text'}<br>
                                                ResponseJSON: ${JSON.stringify(xhr.responseJSON || {})}
                                            </div>`;
                        }

                        // Menampilkan SweetAlert dengan pesan error yang detail
                        Swal.fire({
                            icon: 'error',
                            title: errorTitle,
