        ...
        <form id="kt_account_profile_details_form" action="{{ route('auditee.pengajuanAmi.lengkapiProfil') }}" class="form" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <textarea name="alamat" class="form-control form-control-lg form-control-solid" rows="3" placeholder="Alamat">{{ Auth::user()->unitKerja->alamat }}</textarea>
                    </div>
                </div>
                <!--end::Input group-->
    ...
    <script>
        $(document).ready(function() {
            $("#kt_account_profile_details_form").submit(function(e) {
                ...
                $.ajax({
                    url: $(this).attr('action'), // Use form action as URL
                    type: 'POST',
                    data: formData,
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.location.href = response.redirect_url || '/auditee/dashboard'; 
                        } else {
