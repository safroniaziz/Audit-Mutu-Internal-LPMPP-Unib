                                ...
                                <div class="card-body">
                                    <form id="uploadFilesForm" action="{{ route('auditee.uploadFiles') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            @if($siklus->is_desetujui)
    <div class="alert alert-info d-flex align-items-center" role="alert">
        <i class="bi bi-check-circle-fill text-success fs-2 me-3"></i>
        <div>
            <strong>Pengajuan Anda Telah Disetujui!</strong>
            Anda tidak dapat mengunggah dokumen lagi karena pengajuan Anda sudah disetujui.
            <br>
            Jika Anda membutuhkan bantuan lebih lanjut, silakan hubungi administrator.
        </div>
    </div>
@endif
