                ...
                <div class="wizard-nav">
                    @foreach ($dataIkssProdi as $unit)
                        ...
                        @php
                            ...
                            // Count all instruments and check their status
                            foreach ($indikators as $indikator) {
                                foreach ($indikator->instrumen as $instrumen) {
                                    $totalInstruments++;

                                    // Check if instrument is selected (either mandatory or by choice)
                                    if ($instrumen->is_wajib == 1 &&
                            ...
                            // Step is completed if ALL instruments have been selected
