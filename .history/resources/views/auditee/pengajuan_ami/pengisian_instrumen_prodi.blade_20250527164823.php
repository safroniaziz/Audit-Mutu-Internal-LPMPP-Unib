                                            ...
                                            <div class="card card-bordered shadow-sm mb-10">
                                                ...
                                                <div class="card-body">
                                                            ...
                                                            <table class="table table-bordered border-gray-300">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @endif
                                                                        <div class="mt-2">
                                                                            <input type="file" name="dokumen[{{ $instrumenProdi->id }}][]" class="form-control" multiple>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number"
                                                                            ...
                                                                            >
                                                                        <div class="form-text">Masukkan nilai antara 0-100 (hanya angka)</div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    ...
                                                    <div class="mb-8">
                                                        ...
                                                        <textarea class="form-control" name="deskripsi[{{ $instrumenProdi->id }}]" rows="4" required>{{ $instrumenProdi->submission ? $instrumenProdi->submission->deskripsi : '' }}</textarea>
                                        ...
                                        <div class="d-flex justify-content-between mt-5">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <span class="indicator-label">
                                                    <i class="fas fa-save me-2"></i>Simpan & {{ $loop->last ? 'Selesai' : 'Lanjutkan' }}
                                                </span>
...
$(document).ready(function() {
    ...
    $('.kriteria-form').on('submit', function(e) {
        ...
        // Convert FormData to object for manipulation
        const data = {};
        formData.forEach((value, key) => {
            // Extract the field name and ID from array notation
            const matches = key.match(/^(.+?)\[(\d+)\](\[\])?$/);
            if (matches) {
                const [, field, id, isArray] = matches;
                if (!data[id]) {
                    data[id] = {};
                }
                if (isArray) {
        ...
        Swal.fire({
                ...
                <div class="mb-7">
                    <div class="text-center">
                        <span class="svg-icon svg-icon-5tx svg-icon-warning mb-5">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.3" d="M20.5543 4.37824L12.1798 2.02473C12.0626 1.99176 11.9376 1.99176 11.8203 2.02473L3.44572 4.37824C3.18118 4.45258 3 4.6807 3 4.93945V13.569C3 14.6914 3.48509 15.8404 4.4417 16.984C5.17231 17.8575 6.18314 18.7345 7.446 19.5909C9.56752 21.0295 11.6566 21.912 11.7445 21.9488C11.8258 21.9829 11.9129 22 12.0001 22C12.0872 22 12.1744 21.983 12.2557 21.9488C12.3435 21.912 14.4326 21.0295 16.5541 19.5909C17.8169 18.7345 18.8277 17.8575 19.5584 16.984C20.515 15.8404 21 14.6914 21 13.569V4.93945C21 4.6807 20.8189 4.45258 20.5543 4.37824Z" fill="currentColor"/>
                                <path d="M14.8 10.8L14 10L11 13L9 11L8.2 11.8L11 14.6L14.8 10.8Z" fill="currentColor"/>
                            </svg>
                        </span>
                    </div>

                    <div class="text-center">
                        <h1 class="mb-5">Konfirmasi Pengisian</h1>
                        <div class="fw-semibold fs-6 text-gray-500">
                            ${isLastStep ?
                            'Apakah Anda yakin ingin menyimpan dan menyelesaikan pengisian instrumen? Data yang sudah disimpan tidak dapat diubah kembali.' :
                            'Apakah Anda yakin ingin menyimpan dan melanjutkan ke kriteria berikutnya? Data yang sudah disimpan tidak dapat diubah kembali.'}
                        </div>
                    </div>
                </div>
            `,
            ...
            confirmButtonText: isLastStep ? 'Ya, Simpan & Selesai' : 'Ya, Simpan & Lanjutkan',
            cancelButtonText: 'Batal',
            reverseButtons: true,
            customClass: {
                confirmButton: 'btn btn-primary fw-semibold',
                cancelButton: 'btn btn-light fw-semibold'
            }
        }).then((result) => {
                ...
                Swal.fire({
                    html: `
                        <div class="mb-7">
                            ...
                            <div class="text-center">
                                <h1 class="mb-5">Menyimpan Data</h1>
                                <div class="fw-semibold fs-6 text-gray-500">Mohon tunggu sebentar</div>
                            </div>
                        </div>
                    `,
