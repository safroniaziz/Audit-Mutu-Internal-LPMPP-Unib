                                    ...
                                    <form id="uploadFilesForm" action="{{ route('auditee.uploadFiles') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-5">
                                            @if($siklus->is_disetujui)
                                                <div class="alert alert-light border-left-4 border-left-info">
                                                    <div class="d-flex align-items-center">
                                                        <i class="bi bi-info-circle-fill text-info fs-3 me-3"></i>
                                                        <div>
                                                            <strong>Perhatian!</strong> Pengajuan Anda telah disetujui dan tidak dapat melakukan unggahan dokumen lebih lanjut.
                                                            <br>
                                                            Untuk pertanyaan lebih lanjut, Anda dapat menghubungi administrator.
                                                        </div>
                                                    </div>
                                                </div>
                                            @else
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <!-- Data file akan di-generate di sini -->
