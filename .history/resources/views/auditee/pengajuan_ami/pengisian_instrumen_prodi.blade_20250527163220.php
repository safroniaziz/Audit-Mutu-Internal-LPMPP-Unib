                                                ...
                                                <div class="card-header bg-light">
                                                    <div class="card-title">
                                                        <h3 class="card-label text-gray-800 fw-bold">
                                                            ...
                                                            <span class="d-block text-muted pt-2 font-size-xs">{{ $instrumenProdi->indikator }}</span>
                                                        </h3>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered border-gray-300">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" class="form-control" name="nilai[{{ $instrumenProdi->id }}]" min="0" max="100"
