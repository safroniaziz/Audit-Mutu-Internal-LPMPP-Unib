        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateOverallProgress() {
                ...
                wizardContents.forEach((content, index) => {
                    ...
                    // Calculate SS progress as percentage
                    if (stepTotalInstruments > 0) {
                        ssProgress += (stepSelectedInstruments / stepTotalInstruments);
                    }
                });
                ...
                if (progressBar && progressPercentage && progressStatus) {
                    ...
                    // Calculate SS progress percentage
                    const ssPercentage = Math.round((ssProgress / totalSteps) * 100);
                    ...
                    if (overallPercentage === 100) {
                        ...
                        progressStatus.textContent = `${selectedInstrumentsAll}/${totalInstrumentsAll} instrumen telah dipilih (Progress SS: ${ssPercentage}%)`;
                    } else {
