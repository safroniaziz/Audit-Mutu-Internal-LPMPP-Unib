    ...
    <div class="row g-5 g-xl-8">
        <div class="col-xl-7">
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <form id="kt_account_profile_details_form" action="{{ route('auditee.pengajuanAmi.lengkapiProfil') }}" class="form" method="POST" enctype="multipart/form-data" target="_self">
                    @csrf
                    @method('PUT')
...
@push('scripts')
    <script>
        $(document).ready(function() {
                ...
                // Ensure _method field is set for PUT request
