    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        <div class="card-header cursor-pointer">
            <div class="card-title m-0">
                <h3 class="fw-semibold m-0 text-primary d-flex align-items-center gapAA-2">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateProgress() {
                ...
                if (statusText) {
                    statusText.textContent = `Progress: ${selectedCount}/${totalInstruments} instrumen`;
                }
            ...
            // Initial progress calculation for all sections
            updateAllProgress();
        });
    </script>
@endpush
