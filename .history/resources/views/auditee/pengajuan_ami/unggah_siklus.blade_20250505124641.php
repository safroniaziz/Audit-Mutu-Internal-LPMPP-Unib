...
@push('styles')
    <style>
        ...
        /* Empty state style */
        .table td.text-center.text-muted.py-5 {
            padding: 3rem 0;
        }
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <!-- Updated file list table with sequence numbers and better styling -->
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title align-items-start flex-column">
                        ...
                        <div class="card-body">
                            <table class="table table-rounded table-striped border gy-4 gs-4" id="uploadedFilesTable">
                                <thead>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Function to refresh the uploaded files table
            function refreshFileTable() {
                $.ajax({
                    url: '/auditee/get-uploaded-files', // Create this route to return the updated files
                    type: 'GET',
                    success: function(response) {
                        // Replace the table body with updated content
                        $('#uploadedFilesTable tbody').html(response.html);
                    },
                    error: function() {
                        toastr.error('Gagal memperbarui daftar file');
                    }
                });
            }
