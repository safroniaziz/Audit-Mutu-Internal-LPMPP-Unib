        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateOverallProgress() {
                ...
                wizardContents.forEach((content, index) => {
                    ...
                    // Step is completed if all its instruments have been selected
                    if (stepTotalInstruments > 0 && stepSelectedInstruments === stepTotalInstruments) {
                        completedStepsCount++;
                ...
                if (progressBar && progressPercentage && progressStatus) {
                    ...
                    if (overallPercentage === 100) {
                        ...
                        progressStatus.textContent = `${selectedInstrumentsAll}/${totalInstrumentsAll} instrumen telah dipilih (${completedStepsCount}/${totalSteps} SS selesai)`;
                    } else {
