                                                ...
                                                <div class="d-flex align-items-start border border-dashed border-gray-300 rounded px-6 py-4 mb-3">
                                                    ...
                                                    <div class="d-flex gap-4 flex-wrap mt-3" style="max-width: 400px;">
                                                        ...
                                                        @if($isWajibAndApplicable)
                                                            {{-- Untuk instrumen wajib, tidak perlu hidden input karena radio button "Ya" sudah ter-check dan ter-disable --}}
                                                            {{-- Hidden input malah akan menimpa pilihan user di instrumen lain --}}
                                                        @endif
                                                    </div>
                                                </div>
                                            @endforeach
