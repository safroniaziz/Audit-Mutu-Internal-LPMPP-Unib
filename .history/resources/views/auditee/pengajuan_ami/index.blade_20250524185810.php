            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <form id="kt_account_profile_details_form" action="{{ route('auditee.pengajuanAmi.lengkapiProfil') }}" class="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        @if($completionPercentage == 100)
                            <div class="alert alert-{{ $hasPerjanjianKinerja ? 'success' : 'warning' }} d-flex align-items-start p-5 position-relative">
                                <div class="me-4">
                                    <i class="bi {{ $hasPerjanjianKinerja ? 'bi-check-circle-fill text-success' : 'bi-exclamation-circle-fill text-warning' }} fs-2"></i>
                                </div>
                                <div class="flex-grow-1">
                                    <h4 class="fw-bold text-dark mb-2">{{ $hasPerjanjianKinerja ? '✨ Perjanjian Kinerja Telah Diunggah' : '📢 Unggah Perjanjian Kinerja' }}</h4>
                                    <div class="fs-6 {{ $hasPerjanjianKinerja ? 'text-success' : 'text-warning' }}">
                                ...
                                <div class="ms-auto">
                                    @if($hasPerjanjianKinerja)
                                        <a href="{{ route('auditee.pengajuanAmi.pemilihanIkss') }}" class="btn btn-sm btn-success">
                                            <i class="fas fa-arrow-right me-2"></i> Proses Selanjutnya
                                        </a>
                                    @else
                                        <a href="{{ route('auditee.pengajuanAmi.perjanjianKinerja') }}" class="btn btn-sm btn-warning">
