    ...
    <div class="row g-5 g-xl-8">
        <div class="col-xl-7">
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <form id="kt_account_profile_details_form" action="{{ route('test.lengkapiProfil') }}" class="form" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    ...
    <script>
        $(document).ready(function() {
            $('#kt_account_profile_details_form').submit(function(event) {
                ...
                console.log('User Name:', '{{ Auth::user()->name ?? "Not logged in" }}');
                console.log('User Email:', '{{ Auth::user()->email ?? "Not logged in" }}');
                console.log('User Roles:', '{{ Auth::user()->getRoleNames() ?? "No roles" }}');
                console.log('Has Role Auditee:', '{{ Auth::user()->hasRole("Auditee") ? "Yes" : "No" }}');
                console.log('Unit Kerja ID:', '{{ Auth::user()->unit_kerja_id ?? "No unit" }}');
                console.log('Is Authenticated:', '{{ Auth::check() ? "Yes" : "No" }}');
                ...
                console.log('Route name:', '{{ route("auditee.pengajuanAmi.lengkapiProfil") }}');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        console.log('Response substring (first 200 chars):', response.substring(0, 200));
                    ...
                    error: function(xhr, status, error) {
                        ...
                        console.log('Error type:', typeof xhr.responseText);
