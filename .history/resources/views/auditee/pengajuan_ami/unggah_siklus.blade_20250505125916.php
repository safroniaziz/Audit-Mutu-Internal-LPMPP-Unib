                                ...
                                <tbody id="fileTableBody">
                                    ...
                                    <tr data-id="{{ $file->id }}">
                                        ...
                                        <td>
                                            ...
                                            @if(!$siklus->is_disetujui)
                                                <button type="button" class="btn btn-sm btn-icon btn-danger delete-file" data-id="{{ $file->id }}" title="Hapus File">
            ...
            function addFileToTable(fileData) {
                ...
                const row = `
                    <tr class="new-row" data-id="${fileData.id}">
                        ...
                        <td>
                            <a href="${fileData.view_url}" target="_blank" class="btn btn-sm btn-icon btn-primary me-2" title="Lihat File">
                                <i class="bi bi-eye-fill"></i>
                            </a>
                            <button type="button" class="btn btn-sm btn-icon btn-danger delete-file" data-id="${fileData.id}" title="Hapus File">
                                <i class="bi bi-trash-fill"></i>
                            </button>
                        </td>
                    </tr>
