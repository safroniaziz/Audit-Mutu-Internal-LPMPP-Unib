        ...
        Swal.fire({
            html: `
                <div class="mb-7">
                    ...
                    <div class="text-center">
                        <h1 class="mb-5">Konfirmasi Simpan</h1>
                        <div class="fw-semibold fs-6 text-gray-500">
                            ${isLastStep ?
                            'Apakah Anda yakin ingin menyimpan dan menyelesaikan pengisian instrumen?' :
                            'Apakah Anda yakin ingin menyimpan dan melanjutkan ke kriteria berikutnya?'}
                        </div>
                    </div>
                </div>
            `,
