        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function validateCurrentStep() {
                ...
                instrumentGroups.forEach(group => {
                    ...
                    if (instrumenId) {
                        // Jika instrumen wajib (ada hidden input), skip validation
                        if (hiddenInput) {
                            return; // Skip validation for wajib items
                        } else {
                            // Tandai bahwa ada instrumen non-wajib
                            hasNonWajib = true;
                ...
                // Hanya tampilkan pesan error jika ada instrumen non-wajib yang belum dipilih
                if (!allValid && hasNonWajib) {
                    Swal.fire({
