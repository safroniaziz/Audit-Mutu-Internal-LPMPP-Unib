                                    ...
                                    <form class="kriteria-form" data-kriteria-id="{{ $kriteriaId }}">
                                        ...
                                        @foreach($kriteriaData['instrumens'] as $instrumenProdi)
                                            <div class="card card-bordered shadow-sm mb-10">
                                                ...
                                                <div class="card-body">
                                                    <input type="hidden" name="instrumen_ids[]" value="{{ $instrumenProdi->indikator_instrumen_id }}">
                                                    <div class="mb-8">
                                                            ...
                                                            <table class="table table-bordered border-gray-300">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @endif
                                                                        <div class="mt-2">
                                                                            <input type="file" name="dokumen[{{ $instrumenProdi->indikator_instrumen_id }}][]" class="form-control" multiple>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number"
                                                                            class="form-control"
                                                                            name="nilai[{{ $instrumenProdi->indikator_instrumen_id }}]"
                                                                            min="0"
                                                                            max="100"
                                                    ...
                                                    <div class="mb-8">
                                                        ...
                                                        <textarea class="form-control" name="deskripsi[{{ $instrumenProdi->indikator_instrumen_id }}]" rows="4" >{{ $instrumenProdi->submission ? $instrumenProdi->submission->deskripsi : '' }}</textarea>
