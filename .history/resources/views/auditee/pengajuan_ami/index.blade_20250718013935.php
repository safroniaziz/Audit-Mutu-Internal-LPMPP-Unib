...
@push('scripts')
    <script>
        $(document).ready(function() {
            // Form akan di-submit secara normal (non-AJAX)
            // Hapus event.preventDefault() agar form bisa di-submit secara tradisional
            $('#kt_account_profile_details_form').submit(function(event) {
                // Tidak ada event.preventDefault() - form akan di-submit secara normal
                // Session akan otomatis terbawa karena ini adalah traditional form submission
            });
        });
