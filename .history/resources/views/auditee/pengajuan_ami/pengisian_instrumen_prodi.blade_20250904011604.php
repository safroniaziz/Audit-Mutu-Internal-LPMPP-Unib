...
@php
    ...
    foreach ($groupedData as $indikatorData) {
        foreach ($indikatorData['kriterias'] as $kriteriaData) {
            ...
            // Count completed submissions - Fixed validation logic
            foreach ($kriteriaData['instrumens'] as $instrumenProdi) {
                if ($instrumenProdi->submission &&
                    ($instrumenProdi->submission->realisasi !== null && $instrumenProdi->submission->realisasi !== '') &&
                    !empty(trim($instrumenProdi->submission->akar_penyebab)) &&
                    !empty(trim($instrumenProdi->submission->rencana_perbaikan))) {
                    $completedInstrumen++;
                }
            }
        }
                                    ...
                                    <form class="kriteria-form" data-kriteria-id="{{ $kriteriaId }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <table class="table table-bordered border-gray-300">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number"
                                                                            ...
                                                                            required>
                                                                        <div class="form-text text-muted italic text-xs">Masukkan realisasi dalam bentuk angka (dapat berupa desimal)</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="form-text text-muted italic text-xs">Masukkan akar penyebab (wajib diisi)</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="form-text text-muted italic text-xs">Masukkan rencana perbaikan (wajib diisi)</div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            @php
                                                ...
                                                foreach ($allKriterias as $index => $k) {
                                                    if ($k['id'] == $kriteriaId) {
                                            ...
                                            @if($currentKriteriaIndex < count($allKriterias) - 1)
...
$(document).ready(function() {
    ...
    $('.kriteria-form').on('submit', function(e) {
        ...
        // Find current and next kriteria
        const allKriterias = @json($allKriterias->values());
        const currentIndex = allKriterias.findIndex(k => k.id == kriteriaId);
        const nextKriteria = currentIndex < allKriterias.length - 1 ? allKriterias[currentIndex + 1] : null;
        const isLastStep = !nextKriteria;

        // Improved validation - check required fields
                    ...
                    success: function(response) {
                        if (response.success) {
                            Swal.fire({
                                ...
                                // If not the last step, move to next kriteria
                                if (nextKriteria) {
                                    // Force reload to get updated data and progress
                                    window.location.reload();
                                } else {
                                    // Last step - reload to show completion status
                                    window.location.reload();
                                }
                            });
                        } else {
