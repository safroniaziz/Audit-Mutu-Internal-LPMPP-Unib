                            ...
                            <div class="card-body py-4">
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div>
                                            <h3 class="text-gray-800 fw-semibold fs-4 mb-1">{{ $group['satuan_standar']->kode_satuan }}</h3>
                                            <span class="text-gray-600 fw-semibold d-block">{{ $group['satuan_standar']->sasaran }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
