                        ...
                        if (response.success) {
                            Swal.fire({
                                ...
                                if (nextKriteriaId) {
                                    ...
                                    updateWizardStepStatus(kriteriaId, nextKriteriaId);

                                    // Show success message for next step
                                    Swal.fire({
                                        title: 'Lanjut ke Kriteria Berikutnya',
                                        text: 'Data berhasil disimpan. Silakan lanjutkan pengisian kriteria berikutnya.',
                                        icon: 'info',
                                        confirmButtonText: 'OK',
                                        buttonsStyling: false,
                                        customClass: {
