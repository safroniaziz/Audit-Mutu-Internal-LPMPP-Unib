                                        ...
                                        <td class="text-center">
                                            <div class="button-container">
                                                ...
                                                <button type="button" class="btn btn-sm btn-light-success edit-instrumenProdi"
                                                    data-id="{{ $prodi->id }}"
                                                    data-url="{{ route('instrumenProdi.edit', $prodi->id) }}"
                                                    data-bs-toggle="modal" data-bs-target="#kt_modal">
                                                    <i class="fas fa-edit fa-sm"></i>&nbsp;</i> Edit
                                                </button>
                                                @if ($prodi->deleted_at)
                                                    <button type="button" class="btn btn-sm btn-light-primary restore-data" data-id="{{ $prodi->id }}">
                                                        <i class="fas fa-sync-alt fa-sm"></i>&nbsp;Aktifkan
                                                    </button>

                                                    <button type="button" class="btn btn-sm btn-light-danger delete-permanent" data-id="{{ $prodi->id }}">
                                                        <i class="fas fa-trash-alt fa-sm"></i>&nbsp;Hapus
                                                    </button>
                                                @else
                                                    <button type="button" class="btn btn-sm btn-light-danger nonaktifkan-instrumenProdi" data-id="{{ $prodi->id }}">
