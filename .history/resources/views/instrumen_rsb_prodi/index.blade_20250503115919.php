    ...
    <script>
        ...
        function updateMainTable(unitKerjaId) {
                ...
                */
                ...
                // Opsi 3: Jika menggunakan DataTables
                if ($.fn.DataTable && $.fn.DataTable.isDataTable('#kt_rsbProdi_table')) {
                    $('#kt_rsbProdi_table').DataTable().ajax.reload(null, false);
                } else {
                    // Jika tidak menggunakan DataTables, refresh halaman saja
                    window.location.reload();
                }
