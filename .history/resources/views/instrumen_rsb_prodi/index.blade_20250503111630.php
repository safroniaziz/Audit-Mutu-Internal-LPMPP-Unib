                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modelTambahInstrumenRsbLabel">Instrumen RSB Program Studi: <span id="prodi-name"></span></h5>
            ...
            $(document).on('click', '.detail-rsbProdi', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        // Set nama prodi
                        $('#prodi-name').text(response.prodi.nama);
                        ...
                        semuaInstrumen.forEach(instrumen => {
                            if (!terpasangIds.includes(instrumen.id)) {
                                $('#instrumen_ikss_id').append(
                                    `<option value="${instrumen.id}">${instrumen.kode_unit_kerja} - ${instrumen.nama_unit_kerja}</option>`
                                );
                            }
                        });
                            ...
                            instrumenTerpasang.forEach((instrumen, index) => {
                                $('#instrumen-list').append(`
                                    <tr>
                                        ...
                                        <td>${instrumen.kode}</td>
                                        <td>${instrumen.nama}</td>
                                        <td class="text-center">
