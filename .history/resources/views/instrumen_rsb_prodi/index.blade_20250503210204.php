                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_rsbProdi_table">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                @forelse ($programStudis as $index => $prodi)
                                    <tr style="background-color: {{ $prodi->instrumen_ikss_count == 0 ? '#FFEEF3' : '' }}">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modelTambahIndikatorKinerjaLabel">Instrumen Program Studi: <span id="prodi-name"></span></h5>
