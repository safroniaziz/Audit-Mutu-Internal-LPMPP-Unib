...
@push('scripts')
    ...
    $('#form-tambah-instrumen').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Refresh data tanpa menutup modal
                refreshModalData(unitKerjaId, url);
    ...
    $(document).on('click', '.hapus-instrumen', function() {
        ...
        const url = $('.detail-rsbProdi[data-id="' + unitKerjaId + '"]').data('url');
    ...
    // Fungsi untuk refresh data modal tanpa menutup modal
    function refreshModalData(unitKerjaId, url) {
        // Jika URL tidak tersedia, coba ambil dari button
        if (!url) {
            url = $('.detail-rsbProdi[data-id="' + unitKerjaId + '"]').data('url');
        }
