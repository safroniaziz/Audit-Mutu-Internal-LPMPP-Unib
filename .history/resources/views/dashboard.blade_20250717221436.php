...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const chartData = unitKerjaData.map(item => item.indikator_instrumen_count);
    ...
    const pengajuanLabels = Object.keys(pengajuanData).map(key => key.charAt(0).toUpperCase() + key.slice(1));
