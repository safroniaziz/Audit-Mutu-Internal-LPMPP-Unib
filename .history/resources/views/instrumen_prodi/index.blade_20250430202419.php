                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_instrumenProdi_table">
                        <thead>
                            <tr class="text-start text-dark fw-bolder fs-7 text-uppercase gs-0 bg-light-primary">
                                ...
                                <th class="min-w-200px">Elemen</th>
                                <th class="min-w-100px text-center">Sumber Data/Bukti</th>
                                <th class="min-w-100px text-center">Metode Perhitungan</th>
                                <th class="min-w-100px text-center">Pengukuran (Target)</th>
                                <th class="min-w-200px">Standar Nasional/Unib</th>
                                <th class="min-w-200px">Uraian</th>
                                <th class="min-w-200px">Penyebab Tidak Tercapai</th>
                                <th class="min-w-200px">Indikator Penilaian</th>
                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @forelse ($instrumens as $index => $instrumen)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $instrumen->sumber_data }}</td>
                                    <td class="text-center">{{ $instrumen->metode_perhitungan }}</td>
                                    <td class="text-center">{{ $instrumen->target }}</td>
                                    <td class="text-center">{{ $instrumen->standar_digunakan }}</td>
                                    <td class="text-center">{{ $instrumen->uraian }}</td>
                                    <td class="text-center">{{ $instrumen->penyebab_tidak_tercapai }}</td>
                                    <td>{{ $instrumen->indikator_penilaian }}</td>
