                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Detail Instrumen Prodi</h5>
        ...
        $(document).on('click', '.detail-instrumenProdi', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    // Contoh: Anda bisa menyesuaikan ini sesuai respon dari controller
                    let html = `
                        <div class="mb-3"><strong>Kriteria:</strong> ${res.kriteria}</div>
                        <div class="mb-3"><strong>Indikator:</strong> ${res.indikator}</div>
                        <div class="mb-3"><strong>Elemen:</strong> ${res.elemen}</div>
                        <div class="mb-3"><strong>Uraian:</strong> ${res.uraian}</div>
                        <div class="mb-3"><strong>Sumber Data:</strong> ${res.sumber_data}</div>
                        <div class="mb-3"><strong>Standar Digunakan:</strong> ${res.standar_digunakan}</div>
                        <div class="mb-3"><strong>Metode Perhitungan:</strong> ${res.metode_perhitungan}</div>
                        <div class="mb-3"><strong>Target:</strong> ${res.target}</div>
                        <div class="mb-3"><strong>Indikator Penilaian:</strong> ${res.indikator_penilaian}</div>
                    `;
