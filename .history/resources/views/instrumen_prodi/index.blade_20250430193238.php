                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_instrumenProdi_table">
                        <thead>
                            <tr class="text-start text-dark fw-bolder fs-7 text-uppercase gs-0 bg-light-primary">
                                ...
                                <th class="min-w-125px">Indikator Instrumen ID</th>
            <th class="min-w-125px">Kriteria ID</th>
            <th class="min-w-200px">Nama Indikator</th>
            <th class="min-w-200px">Deskripsi</th>
            <th class="min-w-100px text-center">Target</th>
            <th class="min-w-100px text-center">Unit</th>
