                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @forelse ($indikators as $index => $indikator)
                                <tr>
                                    ...
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $indikator->kriteriaInstrumen->nama_kriteria }}</td>
                                    <td>{{ $indikator->indikator }}</td>
                                    <td>{{ $indikator->elemen }}</td>
                                    <td class="text-center">{{ $indikator->sumber_data }}</td>
                                    <td class="text-center">{{ $indikator->metode_perhitungan }}</td>
                                    <td class="text-center">{{ $indikator->target }}</td>
                                    <td class="text-center">{{ $indikator->standar_digunakan }}</td>
                                    <td class="text-center">{{ $indikator->uraian }}</td>
                                    <td class="text-center">{{ $indikator->penyebab_tidak_tercapai }}</td>
