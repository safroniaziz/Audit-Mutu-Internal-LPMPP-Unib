    ...
    <script>
        ...
        $('#modalEditElemen').on('shown.bs.modal', function() {
            ...
            if (window.editKriteriaId) {
                // First set the value while enabled
                ...
                // Ensure the selected option is properly displayed
                const selectElement = document.getElementById('edit_kriteria_id');
                if (selectElement) {
                    const selectedOption = selectElement.querySelector(`option[value="${window.editKriteriaId}"]`);
                    if (selectedOption) {
                        selectedOption.selected = true;
                    }
                }

                // Then disable it after a short delay to ensure the value is displayed
                setTimeout(() => {
