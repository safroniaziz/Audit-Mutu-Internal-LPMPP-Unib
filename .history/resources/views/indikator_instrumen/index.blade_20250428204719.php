                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-unker-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Cari Indikator Instrumen" />
                        </div>
                    </div>
                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @forelse ($indikators as $index => $indikator)
                                <tr>
                                    ...
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $indikator->kode_unit_kerja }}</td>
                                    <td>{{ $indikator->nama_unit_kerja }}</td>
                                    <td>
                                        @if ($indikator->jenis_unit_kerja == "prodi")
                                            <div class="badge badge-light-success">Program Studi</div>
                                        @elseif ($indikator->jenis_unit_kerja == "fakultas")
                                            <div class="badge badge-light-primary">Fakultas</div>
                                        @elseif ($indikator->jenis_unit_kerja == "upt")
                                            <div class="badge badge-light-warning">Unit Pelayanan Terpadu (UPT)</div>
                                        @elseif ($indikator->jenis_unit_kerja == "lembaga")
                                            <div class="badge badge-light-warning">Lembaga</div>
                                        @endif
                                    </td>
                                    <td>{{ $indikator->jenjang ?? '-' }}</td>
                                    <td>{{ $indikator->fakultas ?? '-' }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="button-container">
                                            <button type="button" class="btn btn-sm btn-light-success edit-unitkerja"
                                                ...
                                                data-url="{{ route('unitKerja.edit', $indikator->id) }}"
                                            ...
                                            @else
                                                <button type="button" class="btn btn-sm btn-light-danger nonaktifkan-unitKerja" data-id="{{ $indikator->id }}">
