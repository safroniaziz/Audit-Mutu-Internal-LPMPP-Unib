    ...
    <script>
        ...
        $('#modalEditElemen').on('shown.bs.modal', function() {
            ...
            if (window.editKriteriaId) {
                ...
                // First, try to set value using jQuery
                $('#edit_kriteria_id').val(window.editKriteriaId);

                // Check if value was set
                console.log('jQuery value after setting:', $('#edit_kriteria_id').val());
                ...
                if (selectElement) {
                    ...
                    if (option) {
                        ...
                        console.log('Option found and selected via DOM:', option.textContent);
                    } else {
                        console.log('Option not found via DOM for value:', window.editKriteriaId);
                    }
                }
