    ...
    <script>
        ...
        $('#modalEditElemen').on('shown.bs.modal', function() {
            ...
            if (window.editKriteriaId) {
                // Multiple attempts to ensure value is set
                const setKriteriaValue = () => {
                ...
                // Try after 50ms
                setTimeout(setKriteriaValue, 50);

                // Try after 100ms
                setTimeout(setKriteriaValue, 100);

                // Try after 200ms
                setTimeout(setKriteriaValue, 200);
            }
