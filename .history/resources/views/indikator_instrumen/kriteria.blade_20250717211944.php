                ...
                <form id="formTambahElemen">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="metode_perhitungan" name="metode_perhitungan" required></textarea>
                        </div>
                        <div class="mb-3">
                ...
                <form id="formEditElemen">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="edit_metode_perhitungan" name="metode_perhitungan" required></textarea>
                        </div>
                        <div class="mb-3">
...
@endpush
    ...
    <script>
        ...
        $('#formTambahElemen').on('submit', function(e) {
            ...
            const ckEditorFields = ['uraian', 'penyebab_tidak_tercapai', 'rencana_perbaikan', 'indikator_penilaian', 'metode_perhitungan'];
        ...
        $('#formEditElemen').on('submit', function(e) {
            ...
            // Validate CKEditor fields
            const ckEditorFields = ['edit_uraian', 'edit_penyebab_tidak_tercapai', 'edit_rencana_perbaikan', 'edit_indikator_penilaian', 'edit_metode_perhitungan'];
            ckEditorFields.forEach(fieldId => {
                if (elemenEditorInstances[fieldId]) {
                    const content = elemenEditorInstances[fieldId].getData();
                    const textarea = document.getElementById(fieldId);
