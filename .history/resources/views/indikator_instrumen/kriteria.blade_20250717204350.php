                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-kriteria-table-toolbar="base">
                            <button type="button" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#modalTambahElemen">
                                            ...
                                            <div class="d-flex flex-column gap-1">
                                                @foreach($kriteria->instrumenProdi->take(3) as $instrumen)
                                                    <div class="elemen-item">
                                                        ...
                                                        <button type="button" class="btn btn-xs btn-light-warning edit-elemen"
                                                        ...
                                                        <button type="button" class="btn btn-xs btn-light-danger delete-elemen"
                                                                data-id="{{ $instrumen->id }}"
                                                                data-elemen="{{ $instrumen->elemen }}"
                                                                title="Hapus Elemen">
                                                ...
                                                @if($kriteria->instrumenProdi->count() > 3)
                                                    <div class="more-elements">
                                                        <small class="text-muted mb-2 d-block">Elemen lainnya:</small>
                                                        @foreach($kriteria->instrumenProdi->skip(3) as $instrumen)
                                                            <div class="elemen-item">
                                                                <span class="badge badge-light-info elemen-badge">{{ $instrumen->elemen }}</span>
                                                                <button type="button" class="btn btn-xs btn-light-warning edit-elemen"
                                                                        data-id="{{ $instrumen->id }}"
                                                                        data-elemen="{{ $instrumen->elemen }}"
            ...
            <div class="modal-content">
                ...
                <form id="formTambahElemen">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="indikator_instrumen_kriteria_id" class="form-label">Pilih Kriteria</label>
