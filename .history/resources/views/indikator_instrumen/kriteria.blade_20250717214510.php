...
@endpush
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        // Set kriteria value BEFORE opening modal
                        console.log('Setting kriteria ID:', data.indikator_instrumen_kriteria_id);
                        $('#edit_kriteria_id').prop('disabled', false).val(data.indikator_instrumen_kriteria_id);
                        $('#edit_hidden_kriteria_id').val(data.indikator_instrumen_kriteria_id);
                        console.log('Select value after setting:', $('#edit_kriteria_id').val());
        ...
        $('#modalEditElemen').on('shown.bs.modal', function() {
            // Debug: check if value is still set
            console.log('Modal shown - Select value:', $('#edit_kriteria_id').val());
            console.log('Modal shown - Hidden value:', $('#edit_hidden_kriteria_id').val());

            // Disable kriteria field after modal is shown (value already set)
