                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-indikatirInstrumen-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Cari Indikator Instrumen" />
                        </div>
                    </div>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-indikatirInstrumen-table-toolbar="base">
                        ...
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-indikatirInstrumen-table-toolbar="selected">
                            <div class="fw-bold me-5">
                            <span class="me-2" data-kt-indikatirInstrumen-table-select="selected_count"></span>Dipilih</div>
                            <button type="button" class="btn btn-danger" data-kt-indikatirInstrumen-table-select="delete_selected">Nonaktifkan Data Terpilih</button>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="indikatirInstrumen">
                        <thead>
                            <tr class="text-start text-dark fw-bolder fs-7 text-uppercase gs-0 bg-light-primary">
                                <th class="w-10px pe-2 ps-4">
                                    <div class="form-check form-check-sm form-check-custom form-check-solid ms-3 me-3">
                                        <input class="form-check-input bg-white" type="checkbox" data-kt-check="true" data-kt-check-target="#indikatirInstrumen .form-check-input" value="1" />
                                    </div>
                                </th>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '[data-kt-indikatirInstrumen-table-select="delete_selected"]', function() {
            const checkboxes = document.querySelectorAll('#indikatirInstrumen tbody input[type="checkbox"]:checked');
