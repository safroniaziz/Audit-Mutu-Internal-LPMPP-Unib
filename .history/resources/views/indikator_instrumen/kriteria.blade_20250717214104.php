    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        console.log('Edit elemen data:', data);
                        ...
                        // Try different possible field names for kriteria ID
                        window.editKriteriaId = data.indikator_instrumen_kriteria_id || data.kriteria_id || data.indikator_instrumen_kriteria_id;
                        console.log('Selected kriteria ID:', window.editKriteriaId);
        ...
        $('#modalEditElemen').on('shown.bs.modal', function() {
            ...
            if (window.editKriteriaId) {
                ...
                console.log('Available options:', $('#edit_kriteria_id option').map(function() { return $(this).val(); }).get());
                $('#edit_kriteria_id').val(window.editKriteriaId).prop('disabled', true);
                $('#edit_hidden_kriteria_id').val(window.editKriteriaId);
                console.log('After setting, selected value:', $('#edit_kriteria_id').val());
