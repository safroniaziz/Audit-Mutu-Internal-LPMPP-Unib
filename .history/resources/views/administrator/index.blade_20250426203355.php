                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @forelse ($administrators as $index => $administrator)
                                <tr>
                                    ...
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $administrator->kode_unit_kerja }}</td>
                                    <td>{{ $administrator->nama_unit_kerja }}</td>
                                    <td>
                                        @if ($administrator->jenis_unit_kerja == "prodi")
                                            <div class="badge badge-light-success">Program Studi</div>
                                        @elseif ($administrator->jenis_unit_kerja == "fakultas")
                                            <div class="badge badge-light-primary">Fakultas</div>
                                        @elseif ($administrator->jenis_unit_kerja == "upt")
                                            <div class="badge badge-light-warning">Unit Pelayanan Terpadu (UPT)</div>
                                        @elseif ($administrator->jenis_unit_kerja == "lembaga")
                                            <div class="badge badge-light-warning">Lembaga</div>
                                        @endif
                                    </td>
                                    <td>{{ $administrator->jenjang ?? '-' }}</td>
                                    <td>{{ $administrator->fakultas ?? '-' }}</td>
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-light-danger delete-unitKerja" data-id="{{ $administrator->id }}">
