                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-administrator-table-toolbar="selected">
                            ...
                            <button type="button" class="btn btn-danger" data-kt-administrator-table-select="delete_selected">Hapus Data Terpilih</button>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    $.ajax({
        ...
        $(document).on('click', '[data-kt-administrator-table-select="delete_selected"]', function() {
            ...
            Swal.fire({
                title: 'Apakah Anda yakin?',
                text: `Anda akan menonaktifkan ${ids.length} data yang dipilih. Data yang dihapus tidak dapat dikembalikan!`,
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
