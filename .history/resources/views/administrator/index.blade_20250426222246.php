                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-administrator-table-toolbar="base">
                            <button type="button" id="addAdministratorButton" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal" style="padding-top: 1rem; padding-bottom: 0.5rem;>
