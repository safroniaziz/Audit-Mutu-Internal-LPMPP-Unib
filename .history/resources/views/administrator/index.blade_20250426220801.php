                                    ...
                                    <td class="text-center">
                                        @if ($administrator->deleted_at)
                                            ...
                                            <span class="badge badge-danger">
                                                <i class="fas fa-times-circle fs-5" style="color: white;"></i> Tidak Aktif
                                            </span>
                                        @else
                                            <!-- Aktif (Label Hijau) -->
                                            <span class="badge badge-success">
                                                <i class="fas fa-check-circle fs-5" style="color: white;"></i> Aktif
                                            </span>
                                        @endif
                                    </td>
                                    <td class="text-center">
