                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_administrator_table">
                        <thead>
                            <tr class="text-start text-dark fw-bolder fs-7 text-uppercase gs-0 bg-light-primary">
                                ...
                                <th class="min-w-100px text-center">StatuAktif</th> <!-- Kolom Aktif Ditambahkan -->
                                    ...
                                    <td class="text-center">
                                        @if ($administrator->deleted_at)
                                            ...
                                            <span class="badge badge-danger">
                                                <i class="ki-duotone ki-cross fs-5"></i> Tidak Aktif
                                            </span>
                                        @else
                                            <!-- Aktif (Label Hijau) -->
                                            <span class="badge badge-success">
                                                <i class="ki-duotone ki-check fs-5"></i> Aktif
                                            </span>
                                        @endif
                                    </td>
                                    <td class="text-center">
