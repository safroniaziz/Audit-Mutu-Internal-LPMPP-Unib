                            ...
                            @forelse ($administrators as $index => $administrator)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-light-success edit-data editAdministratorButton"
...
@push('scripts')
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#kt_modal input[name="name"]').val(data.name);
                        $('#kt_modal input[name="email"]').val(data.email);
                    }
                },
                error: function() {
                    Swal.fire("Error", "Gagal mengambil data administrator", "error");
                }
            });
        });
        ...
        $('button[data-bs-target="#kt_modal"]:not(.edit-data)').click(function() {
            ...
            $('#kt_modal .modal-title').text('Tambah Administrator');
