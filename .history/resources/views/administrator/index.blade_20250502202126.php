        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card">
                            ...
                            @forelse ($administrators as $index => $administrator)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-primary change-password-btn" data-id="{{ $administrator->id }}" data-name="{{ $administrator->name }}">
                ...
                <div class="modal fade" id="ubahPasswordModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg"> <!-- Ubah dari default ke modal-lg -->
...
@push('scripts')
    ...
    <script>
        ...
        $('#changePasswordForm').submit(function (e) {
            ...
            $.ajax({
                url: `/administrator/${id}/change-password`,
                type: 'POST',
                data: formData,
                success: function (response) {
