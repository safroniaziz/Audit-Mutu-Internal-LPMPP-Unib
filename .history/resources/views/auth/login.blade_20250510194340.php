        ...
        <div class="flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden shadow-2xl max-w-7xl mx-auto" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="w-full md:w-3/5 bg-gradient-to-br from-blue-600 to-blue-900 text-white p-8 relative overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col h-full">
                    <h2 class="text-3xl font-bold mb-6">Dokumen Terkait</h2>

                    <!-- Gunakan overflow-y-auto untuk menangani jumlah dokumen yang banyak -->
                    <div class="flex-grow overflow-y-auto pr-2 documents-container" data-aos="fade-up" data-aos-delay="300">
                        <div class="space-y-3" id="documents-list">
                            <!-- Dokumen akan diisi secara dinamis dengan JavaScript -->
                        </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderDocuments(docs) {
                ...
                if (totalDocs > 5) {
                    containerElement.style.maxHeight = '340px';
