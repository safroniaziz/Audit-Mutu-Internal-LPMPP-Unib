                    ...
                    <div class="mt-auto pt-6" data-aos="fade-up" data-aos-delay="350">
                        ...
                        <div class="space-y-3">
                                ...
                                if (!$admin) {
                                    ...
                                    // Ambil nomor telepon dari unit kerja jika ada
                                    $phone = $admin->unitKerja?->no_hp ?? '6281234567890';
                                    $admin->phone = $phone;
                                }
                            @endphp
                            <a href="https://wa.me/{{ $admin->phone }}" class="help-btn inline-flex items-center w-full px-4 py-3 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg hover:bg-opacity-30 transition">
                                <i class="fab fa-whatsapp text-lg mr-3"></i>
                                <div>
                                    <span class="font-medium block">{{ $admin->name }}</span>
                                    <span class="text-xs text-blue-100">+62 {{ substr($admin->phone, 1) }}</span>
                                </div>
                            </a>
                        </div>
                    </div>
