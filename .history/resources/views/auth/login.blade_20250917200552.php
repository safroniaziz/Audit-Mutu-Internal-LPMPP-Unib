    ...
    <main class="container mx-auto px-4 py-8">
        <div class="flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden shadow-2xl max-w-7xl mx-auto" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="w-full md:w-2/5 p-8 flex flex-col justify-center space-y-6">
                ...
                <!-- Pengumuman AMI -->
                <div class="bg-gradient-to-r from-orange-50 to-orange-100 border-l-4 border-orange-500 p-5 rounded-lg shadow-md mb-6" data-aos="fade-down" data-aos-delay="200">
                    <div class="flex items-start">
                        <div class="bg-orange-500 rounded-full p-2 mr-4 text-white flex-shrink-0">
                        ...
                        <div>
                            ...
                            <div class="space-y-2 text-orange-700">
                                <p class="font-semibold">📅 Perpanjangan Waktu Pengisian AMI:</p>
                                <p class="ml-4">• Pengisian AMI diperpanjang sampai dengan <strong>21 September 2025</strong></p>
                                <p class="font-semibold mt-3">🔍 Jadwal Desk Evaluasi:</p>
                                <p class="ml-4">• Desk Evaluasi dilaksanakan pada <strong>18-26 September 2025</strong></p>
                            </div>
                            <div class="mt-3 text-sm text-orange-600 bg-orange-50 p-2 rounded border-l-2 border-orange-300">
                ...
                @endif
                    ...
                    @foreach ($errors->all() as $error)
                        <div class="custom-error">
                            ...
                            <div class="custom-error-content">
                                <div>
                                    <div class="custom-error-title">Akses Dibatasi</div>
                                    <div class="custom-error-message">{{ $error }}</div>
                                    <div class="custom-error-time">
            ...
            <div class="w-full md:w-3/5 bg-gradient-to-br from-blue-600 to-blue-900 text-white p-8 relative overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col h-full justify-between">
                    ...
                    <div class="mt-auto pt-6" data-aos="fade-up" data-aos-delay="350">
                        ...
                        <div class="space-y-3">
                                                                                    @php
                                // Ambil admin yang memiliki role administrator
                                $admin = \App\Models\User::role('administrator')
                                    ->inRandomOrder()
                                    ->first();

                                // Jika tidak ada admin, gunakan default
                                if (!$admin) {
                                    $admin = (object) [
                                        'name' => 'Admin SIAMI',
                                        'email' => 'admin@siami.unib.ac.id'
                                    ];
                                } else {
                                    // Gunakan email admin dari database
                                    $admin->email = $admin->email ?? 'admin@siami.unib.ac.id';
                                }
                            @endphp
                            <a href="mailto:{{ $admin->email }}" class="help-btn inline-flex items-center w-full px-4 py-3 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg hover:bg-opacity-30 transition">
                                <i class="fas fa-envelope text-lg mr-3"></i>
                                <div>
                                    <span class="font-medium block">{{ $admin->name }}</span>
                                    <span class="text-xs text-blue-100">{{ $admin->email }}</span>
                                </div>
                            </a>
                        </div>
                    </div>
