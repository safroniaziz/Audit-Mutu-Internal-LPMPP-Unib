                ...
                <div class="bg-gradient-to-r from-blue-50 to-blue-100 border-l-4 border-blue-500 p-5 rounded-lg shadow-md" data-aos="fade-right" data-aos-delay="400">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-blue-700 leading-relaxed">Selamat datang di Sistem Informasi Audit Mutu Internal LPPM UNIB. Mohon masukkan kredensial Anda untuk mengakses dashboard dan fitur sistem.</p>
                        </div>
                    </div>
                </div>
