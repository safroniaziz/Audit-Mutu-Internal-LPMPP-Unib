    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderDocuments(docs) {
                ...
                if (totalDocs > 4) {
                    paddingClass = 'p-3'; // Kurangi padding jika ada banyak dokumen
                }
                if (totalDocs > 6) {
                    paddingClass = 'p-2'; // Kurangi padding lebih banyak
                }
                ...
                const containerHeight = documentsContainer.closest('.documents-container');
                if (totalDocs > 4) {
                    containerHeight.style.maxHeight = '300px'; // Set max height jika dokumen banyak
                } else {
                    containerHeight.style.maxHeight = 'none'; // Tidak ada batasan jika dokumen sedikit
                }
            }
