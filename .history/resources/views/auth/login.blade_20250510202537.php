...
<body class="m-0 font-sans antialiased font-normal text-slate-600 bg-pattern min-h-screen flex items-center justify-center">
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden shadow-2xl max-w-7xl mx-auto" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="w-full md:w-3/5 bg-gradient-to-br from-blue-600 to-blue-900 text-white p-8 relative overflow-hidden">
                ...
                <!-- Network SVG with animation remains unchanged -->
                ...
                <div class="relative z-10 flex flex-col h-full justify-between">
                    ...
                    <div class="mt-auto pt-8" data-aos="fade-up" data-aos-delay="350">
    ...
    if (window.innerWidth >= 768) { // MD breakpoint Tailwind
        ...
        // Calculate available height for documents container
        const helpSection = document.querySelector('.mt-auto');
        const documentsTitle = document.querySelector('.text-3xl.font-bold');
        const documentsContainer = document.querySelector('.documents-container');

        // Get height of right section minus padding and other elements
        const availableHeight = rightSection.offsetHeight -
                               (documentsTitle.offsetHeight + helpSection.offsetHeight + 100); // 100px for padding

        // Apply max-height only if content exceeds available space
        if (documentsContainer.scrollHeight > availableHeight) {
            documentsContainer.style.maxHeight = availableHeight + 'px';
        ...
        document.querySelector('.documents-container').style.maxHeight = 'none';
    }
}
