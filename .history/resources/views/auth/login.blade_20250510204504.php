...
<div class="w-full md:w-3/5 bg-gradient-to-br from-blue-600 to-blue-900 text-white p-8 relative overflow-hidden">
    ...
    <div class="floating-bg">
        <!-- Existing bubbles code remains unchanged -->
    </div>

    <!-- Network SVG with animation -->
    <div class="absolute top-0 left-0 w-full h-full opacity-20">
        <svg width="100%" height="100%" viewBox="0 0 1000 600" preserveAspectRatio="none">
            <!-- Animated connecting lines -->
            <path class="network-path" d="M100,150 C200,50 300,250 400,150 S600,50 700,150 S900,250 900,350"
                  stroke="rgba(255,255,255,0.3)" stroke-width="1.5" fill="none" />
            <path class="network-path" d="M150,400 C250,300 350,500 450,400 S650,300 750,400"
                  stroke="rgba(255,255,255,0.3)" stroke-width="1.5" fill="none" style="animation-delay: 5s" />
            <path class="network-path" d="M200,250 C300,350 400,150 500,250 S700,350 800,250"
                  stroke="rgba(255,255,255,0.3)" stroke-width="1.5" fill="none" style="animation-delay: 10s" />
            <path class="network-path" d="M250,350 C350,450 450,250 550,350"
                  stroke="rgba(255,255,255,0.3)" stroke-width="1.5" fill="none" style="animation-delay: 15s" />

            <!-- Animated dots -->
            <circle class="network-dot" cx="100" cy="150" r="4" fill="rgba(255,255,255,0.6)" />
            <circle class="network-dot" cx="400" cy="150" r="5" fill="rgba(255,255,255,0.7)" />
            <circle class="network-dot" cx="700" cy="150" r="4" fill="rgba(255,255,255,0.6)" />
            <circle class="network-dot" cx="900" cy="350" r="6" fill="rgba(255,255,255,0.8)" />
            <circle class="network-dot" cx="150" cy="400" r="5" fill="rgba(255,255,255,0.7)" />
            <circle class="network-dot" cx="450" cy="400" r="4" fill="rgba(255,255,255,0.6)" />
            <circle class="network-dot" cx="750" cy="400" r="5" fill="rgba(255,255,255,0.7)" />
            <circle class="network-dot" cx="200" cy="250" r="6" fill="rgba(255,255,255,0.8)" />
            <circle class="network-dot" cx="500" cy="250" r="4" fill="rgba(255,255,255,0.6)" />
            <circle class="network-dot" cx="800" cy="250" r="5" fill="rgba(255,255,255,0.7)" />
            <circle class="network-dot" cx="250" cy="350" r="4" fill="rgba(255,255,255,0.6)" />
            <circle class="network-dot" cx="550" cy="350" r="6" fill="rgba(255,255,255,0.8)" />
        </svg>
    </div>

    <!-- The main change is here - rearranging the content to use space efficiently -->
    <div class="relative z-10 flex flex-col h-full justify-between">
        <div>
            <h2 class="text-3xl font-bold mb-5">Dokumen Terkait</h2>

            <!-- Documents container - remove max-height restrictions -->
        ...
        <!-- Help section moved to bottom with margin-top auto to push it down -->
