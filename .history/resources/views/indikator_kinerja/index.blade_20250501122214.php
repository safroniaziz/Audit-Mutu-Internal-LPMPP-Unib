...
@section('link')
    ...
    <li class="breadcrumb-item text-muted">Data I</li>
@endsection
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    <div class="w-100 mb-2">
                        <div class="alert alert-danger d-flex align-items-center p-5">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span>Jika Anda ingin menghapus data I, harap pastikan data tersebut telah dinonaktifkan terlebih dahulu.</span>
                            </div>
                        </div>
                    </div>
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-instrumenProdi-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Cari I" />
                        </div>
                    </div>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-instrumenProdi-table-toolbar="base">
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal" style="padding-top: .8rem; padding-bottom: .8rem;">
                                <i class="fas fa-plus fa-sm"></i> Tambah I
                            </button>
                        </div>
...
@push('scripts')
    ...
    <script>
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            Swal.fire({
                                title: 'Dipulihkan!',
                                text: 'Data I berhasil dipulihkan.',
                                icon: 'success'
                            }).then(() => {
                                location.reload();
                            });
        ...
        $('.edit-instrumenProdi').click(function() {
            ...
            $('#kt_modal .modal-title').text('Edit I');
            $('#kt_modal button[type=submit]').text('Update Data');

            // Ambil data I berdasarkan ID
            $.ajax({
                url: url,
                type: 'GET',
                success: function(response) {
                ...
                error: function() {
                    Swal.fire("Error", "Gagal mengambil data I", "error");
                }
            });
        });
        ...
        $('.add-instrumenProdi').click(function() {
            ...
            $('#kt_modal .modal-title').text('Tambah I');
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            Swal.fire({
                                title: 'Dinonaktifkan!',
                                text: 'Data I berhasil dinonaktifkan.',
                                icon: 'success'
                            }).then(() => {
                                location.reload();
                            });
