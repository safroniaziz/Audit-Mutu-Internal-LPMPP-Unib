                                        ...
                                        <td class="text-center">
                                            <div class="button-container">
                                                <button type="button"
                                                    ...
                                                    data-url="{{ route('indikatorKinerja.show', $instrumen->id) }}"
                                                ...
                                                <button type="button" class="btn btn-sm btn-light-success edit-indikatorKinerja"
                                                    data-id="{{ $instrumen->id }}"
                                                    data-url="{{ route('indikatorKinerja.edit', $instrumen->id) }}"
                                                ...
                                                @else
                                                    <button type="button" class="btn btn-sm btn-light-danger nonaktifkan-indikatorKinerja" data-id="{{ $instrumen->id }}">
