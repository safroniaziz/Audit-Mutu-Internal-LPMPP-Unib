...
@section('content')
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            @include('layouts.partials._modal_indikatorKinerja_prodi')
        </div>
    </div>
@endsection

@push('scripts')
    <script src="{{ asset('assets/src/js/custom/apps/indikatorKinerja_prodi/list/list.js') }}"></script>
    ...
    <script>
        ...
        $(document).on('click', '.detail-indikatorKinerja', function () {
            const url = $(this).data('url');

            $('#detailindikatorKinerjaContent').html('<div class="text-center">Memuat data...</div>');
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    `;
                    $('#detailindikatorKinerjaContent').html(html);
                    $('#modalDetailindikatorKinerja').modal('show');
                },
                error: function () {
                    $('#detailindikatorKinerjaContent').html('<div class="text-danger text-center">Gagal memuat data.</div>');
                }
            });
        });
