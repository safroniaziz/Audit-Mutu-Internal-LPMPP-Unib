        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row g-5 g-xl-8 mb-8">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-flush border-0 bg-light-primary bg-opacity-75 h-100">
                        <div class="card-body p-6">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="flex-grow-1">
                                    <div class="fs-2hx fw-bold text-dark">{{ number_format($stats['total_users']) }}</div>
                                    <div class="text-gray-600 fw-semibold fs-6">Total Pengguna</div>
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <div class="h-8px bg-white rounded">
                                        <div class="bg-primary rounded h-8px" style="width: {{ $performanceMetrics['user_activity_rate'] }}%"></div>
                                    </div>
                                </div>
                                <span class="badge badge-light-primary fs-8 fw-bold ms-2">{{ $performanceMetrics['user_activity_rate'] }}% Aktif</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Total Unit Kerja -->
                <div class="col-xl-3 col-md-6">
                    <div class="card card-flush border-0 bg-light-success bg-opacity-75 h-100">
                        <div class="card-body p-6">
                            <div class="d-flex align-items-center mb-3">
                                <div class="symbol symbol-50px me-4">
                                ...
                                <div class="flex-grow-1">
                                    <div class="fs-2hx fw-bold text-dark">{{ number_format($stats['total_unit_kerja']) }}</div>
                                    <div class="text-gray-600 fw-semibold fs-6">Unit Kerja</div>
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <div class="h-8px bg-white rounded">
                                        <div class="bg-success rounded h-8px" style="width: 85%"></div>
                                    </div>
                                </div>
                                <span class="badge badge-light-success fs-8 fw-bold ms-2">85% Aktif</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Total Indikator -->
                <div class="col-xl-3 col-md-6">
                    <div class="card card-flush border-0 bg-light-warning bg-opacity-75 h-100">
                        <div class="card-body p-6">
                            <div class="d-flex align-items-center mb-3">
                                <div class="symbol symbol-50px me-4">
                                ...
                                <div class="flex-grow-1">
                                    <div class="fs-2hx fw-bold text-dark">{{ number_format($stats['total_indikator']) }}</div>
                                    <div class="text-gray-600 fw-semibold fs-6">Indikator</div>
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <div class="h-8px bg-white rounded">
                                        <div class="bg-warning rounded h-8px" style="width: {{ $performanceMetrics['completion_rate'] }}%"></div>
                                    </div>
                                </div>
                                <span class="badge badge-light-warning fs-8 fw-bold ms-2">{{ $performanceMetrics['completion_rate'] }}% Lengkap</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Total Pengajuan -->
                <div class="col-xl-3 col-md-6">
                    <div class="card card-flush border-0 bg-light-info bg-opacity-75 h-100">
                        <div class="card-body p-6">
                            <div class="d-flex align-items-center mb-3">
                                <div class="symbol symbol-50px me-4">
                                ...
                                <div class="flex-grow-1">
                                    <div class="fs-2hx fw-bold text-dark">{{ number_format($stats['total_pengajuan']) }}</div>
                                    <div class="text-gray-600 fw-semibold fs-6">Pengajuan AMI</div>
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <div class="h-8px bg-white rounded">
                                        <div class="bg-info rounded h-8px" style="width: {{ $performanceMetrics['audit_completion_rate'] }}%"></div>
                                    </div>
                                </div>
                                <span class="badge badge-light-info fs-8 fw-bold ms-2">{{ $performanceMetrics['audit_completion_rate'] }}% Selesai</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Charts Row -->
            <div class="row g-5 g-xl-8 mb-8">
                <!-- Indikator Growth Chart -->
                <div class="col-xl-8">
                    <div class="card card-flush border-0 bg-white shadow-sm">
                        <div class="card-header pt-5">
                            <div class="card-title d-flex flex-column">
                                <h3 class="fw-bold text-dark">Pertumbuhan Indikator (6 Bulan Terakhir)</h3>
                                <span class="text-gray-600 fw-semibold fs-6">Tren penambahan indikator per bulan</span>
                            </div>
                        ...
                        <div class="card-body pt-0">
                            <canvas id="indikatorGrowthChart" style="height: 350px;"></canvas>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Indikator Growth Chart
    const indikatorCtx = document.getElementById('indikatorGrowthChart').getContext('2d');
    ...
    for (let i = 5; i >= 0; i--) {
        ...
        const monthData = @json($chartData['indikatorPerBulan']);
        chartData.push(monthData[monthIndex + 1] || Math.floor(Math.random() * 20) + 5);
    }

    new Chart(indikatorCtx, {
        type: 'line',
        data: {
            labels: chartLabels,
            datasets: [{
