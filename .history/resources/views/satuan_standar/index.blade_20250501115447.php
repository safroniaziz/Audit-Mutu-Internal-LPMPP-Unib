                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @forelse ($satuanStandars as $index => $satuanStandar)
                                <tr>
                                    ...
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $satuanStandar->kode_unit_kerja }}</td>
                                    <td>{{ $satuanStandar->nama_unit_kerja }}</td>
                                    <td>
                                        @if ($satuanStandar->jenis_unit_kerja == "prodi")
                                            <div class="badge badge-light-success">Program Studi</div>
                                        @elseif ($satuanStandar->jenis_unit_kerja == "fakultas")
                                            <div class="badge badge-light-primary">Fakultas</div>
                                        @elseif ($satuanStandar->jenis_unit_kerja == "upt")
                                            <div class="badge badge-light-warning">Unit Pelayanan Terpadu (UPT)</div>
                                        @elseif ($satuanStandar->jenis_unit_kerja == "lembaga")
                                            <div class="badge badge-light-warning">Lembaga</div>
                                        @endif
                                    </td>
                                    <td>{{ $satuanStandar->jenjang ?? '-' }}</td>
                                    <td>{{ $satuanStandar->fakultas ?? '-' }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="button-container">
                                            <button type="button" class="btn btn-sm btn-light-success edit-unitkerja"
                                                ...
                                                data-url="{{ route('unitKerja.edit', $satuanStandar->id) }}"
                                            ...
                                            @else
                                                <button type="button" class="btn btn-sm btn-light-danger nonaktifkan-unitKerja" data-id="{{ $satuanStandar->id }}">
