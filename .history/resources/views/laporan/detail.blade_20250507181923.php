                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle">
                                <thead>
                                    <tr class="fw-bold text-muted">
                                        ...
                                        <th class="min-w-120px text-center">Total Nilai Ketua</th>
                                        <th class="min-w-120px text-center">Total Nilai Anggota</th>
                                        <th class="min-w-120px text-center">Rata-rata</th>
                                        <th class="min-w-120px text-center">Jumlah Penilaian</th>
                                        <th class="min-w-120px text-center">Total Nilai</th>
                                    </tr>
                                </thead>
                                <tbody>
