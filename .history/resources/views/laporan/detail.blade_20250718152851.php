                    ...
                    <div class="card bg-primary bg-opacity-10 border-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <span class="text-muted d-block fs-7 fw-semibold">Total Sasaran</span>
                                    <span class="fw-bold fs-3 text-dark">{{ $totalSasaran }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span class="fw-bold fs-3 text-dark">{{ number_format($avgRataRata, 2) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span class="fw-bold fs-3 text-dark">{{ number_format($maxRataRata, 2) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span class="fw-bold fs-3 text-dark">{{ number_format($minRataRata, 2) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title fw-bold text-dark">
                                ...
                                Hasil Penilaian Instrumen Prodi
                            </h3>
                            <div class="card-toolbar">
                                <button type="button" class="btn btn-sm btn-light-primary" onclick="exportProdiTable()">
                                    <i class="fas fa-download me-2"></i>Export
                                </button>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($kriteriaScores as $index => $kriteria)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span class="badge badge-light-primary fw-bold">{{ number_format($kriteria['total_nilai'], 2) }}</span>
                                                </td>
                                                <td class="text-center">
