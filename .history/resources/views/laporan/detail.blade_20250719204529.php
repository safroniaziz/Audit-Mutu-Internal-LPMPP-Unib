            ...
            <div class="card-body">
                <div class="bg-light-info rounded p-6">
                    <div class="d-flex align-items-start">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="text-dark fw-bold mb-3">Hasil Visitasi Audit</h5>
                            <div class="bg-white rounded p-4 border-start border-4 border-info">
                                <p class="mb-0 text-dark" style="white-space: pre-wrap; line-height: 1.6; font-size: 14px;">
