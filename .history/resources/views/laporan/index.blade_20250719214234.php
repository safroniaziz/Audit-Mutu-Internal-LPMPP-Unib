...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderCards(penugasanAuditors) {
        ...
        penugasanAuditors.forEach(penugasanAuditor => {
            ...
            console.log('Pengajuan ID:', penugasanAuditor.id, 'Audit Status:', auditStatus);
            ...
            if (penugasanAuditor.auditors && penugasanAuditor.auditors.length > 0) {
                penugasanAuditor.auditors.forEach(auditor => {
                    // Debug: log raw auditor data
                    console.log('Raw auditor data:', auditor);
            ...
            if (penugasanAuditor.auditors && penugasanAuditor.auditors.length > 0) {
                penugasanAuditor.auditors.forEach(auditor => {
                    // Check if auditor has completed all stages based on approval fields
                    const auditorCompleted = auditor.is_setuju && auditor.is_setuju_visitasi && auditor.is_setuju_indikator_prodi;

                    // Debug: log auditor data
                    console.log('Auditor:', auditor.auditor ? auditor.auditor.name : 'N/A', {
                    ...
                    const auditorStatus = auditorCompleted
