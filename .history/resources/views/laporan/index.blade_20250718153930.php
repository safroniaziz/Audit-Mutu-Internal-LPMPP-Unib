                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 audit-card"
                        ...
                        <div class="card h-100 shadow-sm hover-elevate-up">
                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="d-flex flex-column">
                                    <span class="text-muted fw-semibold fs-8 mb-2">Tim Auditor</span>
                                    @forelse ($penugasanAuditor->auditors->take(2) as $auditor)
                                        @php
                                            $sudahNilai = false;
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            @else
                                                <span class="badge badge-light-warning fs-8">Proses</span>
                                            @endif
                                        </div>
                                    @empty
                                        <div class="text-muted fst-italic fs-8">Belum ada auditor</div>
                                    @endforelse

                                    @if($penugasanAuditor->auditors->count() > 2)
                                        <div class="text-muted fs-8 mt-1">
                                            <i class="fas fa-plus-circle me-1"></i>
                                            +{{ $penugasanAuditor->auditors->count() - 2 }} auditor lainnya
                                        </div>
                                    @endif
                                </div>
                                <!--end::Auditors-->
