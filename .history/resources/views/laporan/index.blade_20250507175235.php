                                    ...
                                    <td>
                                        @forelse ($penugasanAuditor->auditors as $auditor)
                                            <div class="mb-2">
                                                ...
                                                <span class="fw-semibold">{{ $auditor->ikssAuditee->nilai->auditor_id }}</span>

                                                @if ($auditor->ikssAuditee && $auditor->ikssAuditee->nilai)
                                                    <i class="fas fa-check-circle text-success ms-2"></i> <!-- Menampilkan ikon checklist jika sudah memberikan nilai -->
                                                @endif
