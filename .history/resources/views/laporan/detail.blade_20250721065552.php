                                        ...
                                        @if($group['has_data'])
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                        @if($group['total_nilai_ketua'] > 0)
                                                            <span class="badge badge-light-info fw-bold">{{ number_format($group['total_nilai_ketua'], 2) }}</span>
                                                        @else
                                                            <span class="badge badge-light-danger fw-bold text-danger">-</span>
                                                        @endif
                                                </td>
                                                <td class="text-center">
                                                        @if($group['total_nilai_anggota'] > 0)
                                            ...
                                            @foreach($evaluasiAuditee as $evaluasi)
                                                @if($evaluasi->is_nilai)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if(isset($evaluasiSubmissionsAuditee[$evaluasi->id]) && $evaluasiSubmissionsAuditee[$evaluasi->id]->nilai > 0)
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body pt-0" style="text-align: left !important;">
                            <p class="text-dark mb-1" style="text-align: left !important; line-height: 1.5;">
                                {!! nl2br(e($pengajuanAmis->catatan_visitasi)) !!}
                            </p>
