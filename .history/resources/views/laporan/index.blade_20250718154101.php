                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <span class="text-muted fw-semibold fs-8">Tim Auditor</span>
                                        @php
                                            ...
                                            $statusAudit = $totalAuditor > 0 ? ($auditorSelesai == $totalAuditor ? 'Selesai' : 'Dalam Proses') : 'Belum Dimulai';
                                        @endphp
                                        @if($totalAuditor > 0)
                                            @if($auditorSelesai == $totalAuditor)
                                                <span class="badge badge-light-success fs-8">
                                                    <i class="fas fa-check-circle me-1"></i>
                                                    {{ $auditorSelesai }}/{{ $totalAuditor }} Selesai
                                                </span>
                                            @else
