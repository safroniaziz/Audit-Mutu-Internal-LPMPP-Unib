                    ...
                    <div class="w-100 mb-2">
                        <div class="alert alert-danger d-flex align-items-center p-5">
                            ...
                            <div class="d-flex flex-column">
                                <h4 class="mb-1 text-danger">Laporan Hasil Audit Mutu Internal</h4>
                                <span>Daftar lengkap hasil audit mutu internal yang telah selesai dilakukan. Klik tombol "Detail" untuk melihat laporan lengkap dan download dokumen terkait.</span>
                            </div>
                        </div>
                    </div>
