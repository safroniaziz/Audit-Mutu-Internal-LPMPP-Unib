                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 audit-card">
                        ...
                        <div class="card h-100 shadow-sm hover-elevate-up">
                            ...
                            <div class="card-header border-0 pt-4 pb-2">
                                ...
                                <div class="mt-3">
                                    <div class="badge badge-light-{{ $penugasanAuditor->audit_status['color'] }} fs-7 mb-1 shadow-sm px-3 py-2" style="background-color: white; border: 1px solid #e4e6ea;">
                            ...
                            <div class="card-footer pt-0">
                                <a href="{{ route('laporan.detail', $penugasanAuditor->id) }}" class="btn btn-sm btn-primary w-100">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderCards(penugasanAuditors) {
        ...
        penugasanAuditors.forEach(penugasanAuditor => {
            ...
            if (auditStatus) {
                statusBadge = `<div class="badge badge-light-${auditStatus.color} fs-7 mb-1 shadow-sm px-3 py-2" style="background-color: white; border: 1px solid #e4e6ea;"><i class="${auditStatus.icon} me-1"></i>${auditStatus.label}</div>`;
                ...
                statusBadge = '<div class="badge badge-light-secondary fs-7 mb-1 shadow-sm px-3 py-2" style="background-color: white; border: 1px solid #e4e6ea;"><i class="fas fa-question me-1"></i>Status Tidak Diketahui</div>';
