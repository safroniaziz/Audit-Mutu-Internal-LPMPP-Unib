            ...
            <div class="row g-5 g-xl-8 mt-8">
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body pt-0">
                            @php
                                // Debug: Cek data kuisioner
                                $debugInfo = [
                                    'total_auditor_data' => count($auditorKuisionerData ?? []),
                                    'auditor_data' => $auditorKuisionerData ?? []
                                ];
                            @endphp
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    @if(config('app.debug'))
                                        <small class="text-muted">Debug: auditorKuisionerData is empty or not set</small>
                                    @endif
                                </div>
                            @endif
                        </div>
