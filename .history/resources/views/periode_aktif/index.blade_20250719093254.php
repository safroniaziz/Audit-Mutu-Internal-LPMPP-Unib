                            ...
                            <div class="card-body py-3">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            ...
                                            @if ($dataJadwal && $dataJadwal->waktu_mulai && $dataJadwal->waktu_selesai)
                                                <span class="text-success fs-8 mt-1">
                                                    <i class="fas fa-calendar-check me-1"></i>
                                                    {{ \Carbon\Carbon::parse($dataJadwal->waktu_mulai)->translatedFormat('d M Y') }} - {{ \Carbon\Carbon::parse($dataJadwal->waktu_selesai)->translatedFormat('d M Y') }}
                                                </span>
                                            @endif
                                        </div>
                                        @if ($dataJadwal)
                                ...
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <span class="text-muted fs-8">Dibuat: {{ $periodeAktif->created_at ? \Carbon\Carbon::parse($periodeAktif->created_at)->translatedFormat('d M Y') : 'Tidak diketahui' }}</span>
                                    </div>
