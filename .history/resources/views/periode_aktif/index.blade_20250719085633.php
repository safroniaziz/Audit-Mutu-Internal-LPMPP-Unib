            ...
            <div class="row g-4" id="periode-cards-container">
                @forelse ($periodeAktifs as $index => $periodeAktif)
                    <div class="col-xl-4 col-lg-6 col-md-6 periode-card" data-status="{{ $periodeAktif->deleted_at ? 'inactive' : 'active' }}">
                        <div class="card h-100 shadow-sm hover-elevate-up {{ $periodeAktif->deleted_at ? 'border-danger' : 'border-success' }}" style="border-left: 4px solid {{ $periodeAktif->deleted_at ? '#dc3545' : '#28a745' }};">
                            <!--begin::Header-->
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="text-end">
                                        @if ($periodeAktif->deleted_at)
                                            <div class="badge badge-danger fs-7 mb-1">
                                                <i class="fas fa-times-circle me-1"></i>
                                                Tidak Aktif
                                            </div>
                                        @else
                                            <div class="badge badge-success fs-7 mb-1">
                                ...
                                <div class="d-flex flex-column mb-4">
                                    <div class="d-flex align-items-center mb-2">
                                        <div class="symbol symbol-25px me-2">
                                            <span class="symbol-label bg-light-success">
                                                <i class="fas fa-clock text-success fs-7"></i>
                                            </span>
                                        </div>
                                        <span class="text-muted fw-semibold fs-8">Jadwal Teratur</span>
                                    </div>
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <div class="badge badge-light-primary fs-8">
                                            <i class="fas fa-user-tick me-1"></i>
                                            Login {{ $loginJadwal ? '✓' : '✗' }}
                                        </div>
                                        <div class="badge badge-light-warning fs-8">
                                            <i class="fas fa-shield-tick me-1"></i>
                                            Audit {{ $auditJadwal ? '✓' : '✗' }}
                                        </div>
                            ...
                            <div class="card-footer border-0 pt-0">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-icon btn-light-secondary" type="button" data-bs-toggle="dropdown">
