                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="aturJadwalForm">
                                    ...
                                    <div>
                                        <label for="dateRange" class="form-label">Tanggal Jadwal</label>
...
@push('scripts')
    ...
    $('#aturJadwalForm').on('submit', function (e) {
        e.preventDefault();

        // Kosongkan alert sebelumnya
        ...
        $.ajax({
            ...
            error: function (xhr) {
                // Jika ada kesalahan (misalnya validasi)
