                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <div class="d-flex flex-column gap-1">
                                            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#aturJadwalModal" data-jadwal="login" data-periode-id="{{ $periodeAktif->id }}">
                                                <i class="fas fa-user-tick me-1"></i>
                                                Jadwal Login
                                            </button>
                                            <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#aturJadwalModal" data-jadwal="audit" data-periode-id="{{ $periodeAktif->id }}">
                                                <i class="fas fa-shield-tick me-1"></i>
                                                Jadwal Audit
                                            </button>
                                            <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#aturJadwalModal" data-jadwal="data" data-periode-id="{{ $periodeAktif->id }}">
