                                        ...
                                        <div style="background-color: #ffecec; border-top: 2px dashed #dee2e6; padding: 1rem 1.25rem;">
                                            <div class="row">
                                                <div class="col-md-4 mb-2">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-primary mt-1" data-bs-toggle="modal" data-bs-target="#aturJadwalLoginModal">Atur</button>
                                                </div>
                                                <div class="col-md-4 mb-2">
                                                    <div class="fw-bold">↳ Jadwal Audit Oleh Auditor:</div>
                                                    <div class="text-muted">Belum diatur</div>
                                                    <button class="btn btn-sm btn-outline-primary mt-1" data-bs-toggle="modal" data-bs-target="#aturJadwalAuditModal">Atur</button>
                                                </div>
                                                <div class="col-md-4 mb-2">
                                                    <div class="fw-bold">↳ Jadwal Pengisian Data Oleh Auditee:</div>
                                                    <div class="text-muted">Belum diatur</div>
                                                    <button class="btn btn-sm btn-outline-primary mt-1" data-bs-toggle="modal" data-bs-target="#aturJadwalAuditorModal">Atur</button>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
