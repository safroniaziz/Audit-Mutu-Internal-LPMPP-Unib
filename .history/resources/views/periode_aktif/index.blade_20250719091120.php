                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <span class="text-muted fs-8">Dibuat: {{ $periodeAktif->created_at ? $periodeAktif->created_at->translatedFormat('d M Y') : 'N/A' }}</span>
                                    </div>
                                    @if($periodeAktif->updated_at != $periodeAktif->created_at)
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-edit text-muted fs-8 me-2"></i>
                                            <span class="text-muted fs-8">Diupdate: {{ $periodeAktif->updated_at ? $periodeAktif->updated_at->translatedFormat('d M Y') : 'N/A' }}</span>
                                        </div>
                                    @endif
                                </div>
                                <!--end::Meta Info-->
