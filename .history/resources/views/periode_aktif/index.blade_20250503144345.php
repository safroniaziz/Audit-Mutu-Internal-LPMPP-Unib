        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card">
                                        ...
                                        <div style="background-color: #ffecec; border-top: 2px dashed #dee2e6; padding: 1rem 1.25rem;">
                                            <div class="row">
                                                <div class="col-md-4 mb-2">
                                                    <div class="fw-bold">↳ Jadwal Auditor:</div>
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <div class="fw-bold">↳ Jadwal Auditee:</div>
                                                    <div class="text-muted">Belum diatur</div>
                                                </div>
                                                <div class="col-md-4 mb-2">
                                                    <div class="fw-bold">↳ Jadwal Admin:</div>
                                                    <div class="text-muted">Belum diatur</div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal fade" id="aturJadwalAuditorModal" tabindex="-1">
                    ...
                    <form method="POST" action="{{ route('periode.aturJadwalAuditor', $periode->id) }}">
                        @csrf
