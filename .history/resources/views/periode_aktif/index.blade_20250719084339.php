                                                ...
                                                @if($loginJadwal)
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <span class="text-success fw-semibold fs-7">
                                                            {{ $loginJadwal->waktu_mulai ? \Carbon\Carbon::parse($loginJadwal->waktu_mulai)->translatedFormat('d F Y') : 'N/A' }} -
                                                            {{ $loginJadwal->waktu_selesai ? \Carbon\Carbon::parse($loginJadwal->waktu_selesai)->translatedFormat('d F Y') : 'N/A' }}
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                @if($auditJadwal)
                                                    <div class="d-flex align-items-center mb-3">
                                                        <i class="fas fa-calendar-check text-success me-2"></i>
                                                        <span class="text-success fw-semibold fs-7">
                                                            {{ $auditJadwal->waktu_mulai ? \Carbon\Carbon::parse($auditJadwal->waktu_mulai)->translatedFormat('d F Y') : 'N/A' }} -
                                                            {{ $auditJadwal->waktu_selesai ? \Carbon\Carbon::parse($auditJadwal->waktu_selesai)->translatedFormat('d F Y') : 'N/A' }}
                                                        </span>
                                                    </div>
                                                    <button type="button" class="btn btn-sm btn-outline-primary w-100"
                                                        data-bs-toggle="modal"
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                @if($dataJadwal)
                                                    <div class="d-flex align-items-center mb-3">
                                                        <i class="fas fa-calendar-check text-success me-2"></i>
                                                        <span class="text-success fw-semibold fs-7">
                                                            {{ $dataJadwal->waktu_mulai ? \Carbon\Carbon::parse($dataJadwal->waktu_mulai)->translatedFormat('d F Y') : 'N/A' }} -
                                                            {{ $dataJadwal->waktu_selesai ? \Carbon\Carbon::parse($dataJadwal->waktu_selesai)->translatedFormat('d F Y') : 'N/A' }}
                                                        </span>
                                                    </div>
                                                    <button type="button" class="btn btn-sm btn-outline-primary w-100"
                                                        data-bs-toggle="modal"
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-6 pt-4 border-top">
                                    <div class="d-flex align-items-center gap-4">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class="text-gray-600 fs-7">Dibuat: {{ $periodeAktif->created_at ? $periodeAktif->created_at->translatedFormat('d F Y H:i') : 'N/A' }}</span>
                                        </div>
                                        @if($periodeAktif->updated_at != $periodeAktif->created_at)
                                            <div class="d-flex align-items-center gap-2">
                                                <i class="fas fa-edit text-gray-500"></i>
                                                <span class="text-gray-600 fs-7">Diupdate: {{ $periodeAktif->updated_at ? $periodeAktif->updated_at->translatedFormat('d F Y H:i') : 'N/A' }}</span>
                                            </div>
                                        @endif
                                    </div>
