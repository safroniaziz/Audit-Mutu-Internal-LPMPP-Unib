                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="button-container">
                                            ...
                                            @else
                                                <button type="button" class="btn btn-sm btn-light-danger nonaktifkan-periodeAktif" data-id="{{ $periodeAktif->id }}">
