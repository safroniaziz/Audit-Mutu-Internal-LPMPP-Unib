...
@push('scripts')
    ...
    <script>
        ...
        modal.addEventListener('show.bs.modal', function (event) {
            ...
            if (jadwal === 'login') {
                content = `
                    <label for="jadwal_login">Tanggal & Waktu Login Auditee & Auditor</label>
                    <input type="datetime-local" name="jadwal_login" class="form-control" required>
                `;
            } else if (jadwal === 'audit') {
                content = `
                    <label for="jadwal_audit">Tanggal & Waktu Audit Oleh Auditor</label>
                    <input type="datetime-local" name="jadwal_audit" class="form-control" required>
                `;
            } else if (jadwal === 'data') {
                content = `
                    <label for="jadwal_data">Tanggal & Waktu Pengisian Data Oleh Auditee</label>
                    <input type="datetime-local" name="jadwal_data" class="form-control" required>
                `;
            }
