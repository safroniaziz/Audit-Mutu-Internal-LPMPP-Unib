                                        ...
                                        <div style="background-color: #ffecec; border-top: 2px dashed #dee2e6; padding: 1rem 1.25rem;">
                                            <div class="row">
                                                <div class="col-md-4 mb-2">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-outline-primary mt-1" data-bs-toggle="modal" data-bs-target="#aturJadwalModal" data-jadwal="login" data-periode-id="{{ $periodeAktif->id }}">
                                                        Atur
                                                    </button>
                                                </div>
                                                <div class="col-md-4 mb-2">
                                                    ...
                                                    <div class="text-muted">Belum diatur</div>
                                                    <button class="btn btn-sm btn-outline-primary mt-1" data-bs-toggle="modal" data-bs-target="#aturJadwalModal" data-jadwal="audit" data-periode-id="{{ $periodeAktif->id }}">
                                                        Atur
                                                    </button>
                                                </div>
                                                <div class="col-md-4 mb-2">
                                                    ...
                                                    <div class="text-muted">Belum diatur</div>
                                                    <button class="btn btn-sm btn-outline-primary mt-1" data-bs-toggle="modal" data-bs-target="#aturJadwalModal" data-jadwal="data" data-periode-id="{{ $periodeAktif->id }}">
                                                        Atur
                                                    </button>
                                                </div>
                                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('periodeAktif.aturJadwal') }}">
                                    @csrf
                                    <input type="hidden" id="periodeId" name="periode_id" value="">

                                    <div class="mb-3">
                                        <label for="jadwal" class="form-label">Jadwal</label>
                                        <input type="text" id="jadwalType" name="jadwal" class="form-control" disabled>
                                    </div>
                                    ...
                                    <!-- Tombol Simpan dan Batal sejajar -->
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#aturJadwalModal').on('show.bs.modal', function (event) {
                ...
                var jadwal = button.data('jadwal'); // Data jadwal (login, audit, data)
                var periodeId = button.data('periode-id'); // ID periodeAktif

                // Isi data pada modal
                $('#jadwalType').val(jadwal); // Menampilkan jenis jadwal
                $('#periodeId').val(periodeId); // Mengisi ID periode di form
