                                        ...
                                        <div style="background-color: #ffecec; border-top: 2px dashed #dee2e6; padding: 1rem 1.25rem;">
                                            <div class="row">
                                                <div class="col-md-4 mb-2">
                                                   ...
                                                   <button type="button" class="btn btn-primary btn-xs rounded-pill px-3 py-2 mt-2"
                                               ...
                                               @else
                                                   ...
                                                   <button type="button" class="btn btn-success btn-xs rounded-pill px-3 py-2 mt-2"
                                                       data-bs-toggle="modal"
                                                       data-bs-target="#aturJadwalModal"
                                                       data-jadwal="login"
                                                       data-periode-id="{{ $periodeAktif->id }}">
