        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row g-6" id="periode-cards-container">
                @forelse ($periodeAktifs as $index => $periodeAktif)
                    <div class="col-xl-6 col-lg-8 col-md-10 periode-card" data-status="{{ $periodeAktif->deleted_at ? 'inactive' : 'active' }}">
                                        ...
                                        @if($loginJadwal)
                                            <div class="jadwal-status active">
                                                <div class="status-indicator">
                                                    ...
                                                    <span>{{ $loginJadwal->waktu_mulai ? \Carbon\Carbon::parse($loginJadwal->waktu_mulai)->translatedFormat('d M Y') : 'N/A' }} - {{ $loginJadwal->waktu_selesai ? \Carbon\Carbon::parse($loginJadwal->waktu_selesai)->translatedFormat('d M Y') : 'N/A' }}</span>
                                                </div>
                                    ...
                                    <div class="jadwal-card audit-jadwal">
                                        ...
                                        @if($auditJadwal)
                                            <div class="jadwal-status active">
                                                <div class="status-indicator">
                                                    <i class="fas fa-calendar-check"></i>
                                                    <span>{{ $auditJadwal->waktu_mulai ? \Carbon\Carbon::parse($auditJadwal->waktu_mulai)->translatedFormat('d M Y') : 'N/A' }} - {{ $auditJadwal->waktu_selesai ? \Carbon\Carbon::parse($auditJadwal->waktu_selesai)->translatedFormat('d M Y') : 'N/A' }}</span>
                                                </div>
                                                <button type="button" class="jadwal-btn edit"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#aturJadwalModal"
                                    ...
                                    <div class="jadwal-card data-jadwal">
                                        ...
                                        @if($dataJadwal)
                                            <div class="jadwal-status active">
                                                <div class="status-indicator">
                                                    <i class="fas fa-calendar-check"></i>
                                                    <span>{{ $dataJadwal->waktu_mulai ? \Carbon\Carbon::parse($dataJadwal->waktu_mulai)->translatedFormat('d M Y') : 'N/A' }} - {{ $dataJadwal->waktu_selesai ? \Carbon\Carbon::parse($dataJadwal->waktu_selesai)->translatedFormat('d M Y') : 'N/A' }}</span>
                                                </div>
                                                <button type="button" class="jadwal-btn edit"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#aturJadwalModal"
