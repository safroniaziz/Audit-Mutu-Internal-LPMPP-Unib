                        ...
                        <div class="card h-100 shadow-sm hover-elevate-up">
                            ...
                            <div class="card-body py-3">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            ...
                                            @if ($loginJadwal)
                                                <span class="text-success fs-8 mt-1">
                                                    ...
                                                    {{ $loginJadwal->waktu_mulai ? \Carbon\Carbon::parse($loginJadwal->waktu_mulai)->translatedFormat('d M Y') : 'N/A' }} - {{ $loginJadwal->waktu_selesai ? \Carbon\Carbon::parse($loginJadwal->waktu_selesai)->translatedFormat('d M Y') : 'N/A' }}
                                                </span>
                                            @endif
                                        </div>
                                        @if ($loginJadwal)
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            ...
                                            @if ($auditJadwal)
                                                <span class="text-success fs-8 mt-1">
                                                    <i class="fas fa-calendar-check me-1"></i>
                                                    {{ $auditJadwal->waktu_mulai ? \Carbon\Carbon::parse($auditJadwal->waktu_mulai)->translatedFormat('d M Y') : 'N/A' }} - {{ $auditJadwal->waktu_selesai ? \Carbon\Carbon::parse($auditJadwal->waktu_selesai)->translatedFormat('d M Y') : 'N/A' }}
                                                </span>
                                            @endif
                                        </div>
                                        @if ($auditJadwal)
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            ...
                                            @if ($dataJadwal)
                                                <span class="text-success fs-8 mt-1">
                                                    <i class="fas fa-calendar-check me-1"></i>
                                                    {{ $dataJadwal->waktu_mulai ? \Carbon\Carbon::parse($dataJadwal->waktu_mulai)->translatedFormat('d M Y') : 'N/A' }} - {{ $dataJadwal->waktu_selesai ? \Carbon\Carbon::parse($dataJadwal->waktu_selesai)->translatedFormat('d M Y') : 'N/A' }}
                                                </span>
                                            @endif
                                        </div>
                                        @if ($dataJadwal)
                                ...
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center mb-1">
                                        ...
                                        <span class="text-muted fs-8">Dibuat: {{ $periodeAktif->created_at ? \Carbon\Carbon::parse($periodeAktif->created_at)->translatedFormat('d M Y') : 'N/A' }}</span>
                                    </div>
                                    @if($periodeAktif->updated_at && $periodeAktif->updated_at != $periodeAktif->created_at)
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-edit text-muted fs-8 me-2"></i>
                                            <span class="text-muted fs-8">Diupdate: {{ \Carbon\Carbon::parse($periodeAktif->updated_at)->translatedFormat('d M Y') }}</span>
                                        </div>
                                    @endif
                                </div>
                                <!--end::Meta Info-->
                            ...
                            <div class="card-footer pt-0">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="d-flex gap-2">
                                        @if (!$periodeAktif->deleted_at)
                                            <button type="button" class="btn btn-sm btn-warning flex-grow-1" onclick="nonaktifkanPeriode({{ $periodeAktif->id }})">
