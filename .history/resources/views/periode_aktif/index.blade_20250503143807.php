                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_unker_table">
                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @foreach ($periodeAktifs as $index => $periodeAktif)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($periodeAktif->deleted_at)
                                        <span class="badge badge-danger">
                                            <i class="fas fa-times-circle fa-sm text-white"></i> Tidak Aktif
                                        </span>
                                    @else
                                        <span class="badge badge-success">
                                            <i class="fas fa-check-circle fa-sm text-white"></i> Aktif
                                        </span>
                                    @endif
                                </td>
                                <td class="text-center">
                                    {{-- Aksi tombol seperti biasa --}}
                                </td>
                            </tr>
                            {{-- Baris Tambahan --}}
                            <tr>
