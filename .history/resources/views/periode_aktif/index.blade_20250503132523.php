                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @forelse ($unitKerjas as $index => $unitKerja)
                                <tr>
                                    ...
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $unitKerja->nomor_surat }}</td>
                                    <td>{{ $unitKerja->siklus }}</td>
                                    <td>{{ $unitKerja->tahun_ami }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="button-container">
                                            <button type="button" class="btn btn-sm btn-light-success edit-periode"
                                                data-id="{{ $unitKerja->id }}"
                                                data-url="{{ route('periodeAktif.edit', $unitKerja->id) }}"
...
@push('scripts')
    ...
    <script>
        ...
        $('button[data-bs-target="#kt_modal"]:not(.edit-periode)').click(function() {
            $('#kt_modal form')[0].reset();
