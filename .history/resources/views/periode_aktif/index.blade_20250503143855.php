                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_unker_table">
                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @forelse ($periodeAktifs as $index => $periodeAktif)
                                ...
                                <tr>
                                    <td colspan="6" class="bg-light text-muted p-3">
                                        <div class="d-flex justify-content-between flex-wrap">
                                            <div><strong>Jadwal Auditor:</strong> Belum diatur</div>
                                            <div><strong>Jadwal Auditee:</strong> Belum diatur</div>
                                            <div><strong>Jadwal Admin:</strong> Belum diatur</div>
                                        </div>
                                    </td>
                                </tr>
                                @empty
