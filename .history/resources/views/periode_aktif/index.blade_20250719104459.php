...
@section('content')
                            ...
                            <div class="card-footer pt-0">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        @else
                                            <!-- Tombol nonaktifkan dihapus karena sudah nonaktif -->
                                        @endif
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#aturJadwalModal" data-jadwal="audit" data-periode-id="{{ $periodeAktif->id }}">
                                                        <i class="fas fa-shield-tick me-2 text-warning"></i>
                                                        Jadwal Audit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#aturJadwalModal" data-jadwal="data" data-periode-id="{{ $periodeAktif->id }}">
                                                        <i class="fas fa-document me-2 text-success"></i>
                                                        Jadwal Data
                                                    </a>
                                                </li>
                                            </ul>
    ...
    <script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            let message = 'Terjadi kesalahan saat menonaktifkan periode.';
        ...
        function hapusPermanen(id) {
            // Fungsi ini sudah tidak digunakan, dihapus untuk membersihkan kode
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#aturJadwalModal').on('show.bs.modal', function (event) {
                ...
                const jadwalType = button.data('jadwal');
                const periodeId = button.data('periode-id');

                // Set form data
                $('#periodeId').val(periodeId);
                $('#jadwalType').val(jadwalType);

                // Set modal title based on jadwal type
                let jadwalTitle = '';
                switch(jadwalType) {
                    case 'login':
                    ...
                    case 'audit':
                        ...
                        break;
                    case 'data':
                        jadwalTitle = 'Data (Pengisian Auditee)';
                        break;
                }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status === 'success' && response.data) {
                            ...
                            // If jadwal exists, use existing dates
                            if (jadwal.waktu_mulai && jadwal.waktu_selesai) {
                                startDate = moment(jadwal.waktu_mulai);
                                endDate = moment(jadwal.waktu_selesai);

                                // Update preview
                                $('#jadwalPreview').html(`
                                    <div class="alert alert-success border-0">
                                        <i class="fas fa-check-circle me-2"></i>
                                        <strong>Jadwal sudah diatur:</strong><br>
                                        <span class="text-success">${startDate.format('DD MMMM YYYY')} - ${endDate.format('DD MMMM YYYY')}</span>
                                    </div>
                                `);
                            } else {
                                $('#jadwalPreview').html(`
                                    <div class="alert alert-info border-0">
                                        ...
                                        <strong>Jadwal belum diatur</strong><br>
                                        Silakan pilih rentang tanggal untuk mengatur jadwal
                                    </div>
                                `);
                            }

                            // Initialize date range picker with existing data
                            ...
                            $('#dateRange').on('apply.daterangepicker', function(ev, picker) {
                                ...
                                $('#jadwalPreview').html(`
                                    <div class="alert alert-primary border-0">
                                        ...
                                        <strong>Preview Jadwal:</strong><br>
