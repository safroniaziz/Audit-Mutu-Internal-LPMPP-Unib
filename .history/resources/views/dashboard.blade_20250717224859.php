...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Chart Data Length:', chartData.length); // Debug log
    console.log('Chart Data Sum:', chartData.reduce((a, b) => a + b, 0)); // Debug log

            // Check if we have data
    console.log('Checking chart data...'); // Debug log
    console.log('Chart data length:', chartData.length); // Debug log
    console.log('Chart data every zero:', chartData.every(val => val === 0)); // Debug log

    if (chartData.length === 0 || chartData.every(val => val === 0)) {
        console.log('No data found, showing empty message'); // Debug log
        ...
        console.log('Data found, creating chart'); // Debug log
    ...
    console.log('Pengajuan Data:', pengajuanData); // Debug log
    ...
    console.log('Pengajuan Labels:', pengajuanLabels); // Debug log
    console.log('Pengajuan Values:', pengajuanValues); // Debug log

    // Check if pengajuan data exists
    if (pengajuanValues.length === 0 || pengajuanValues.every(val => val === 0)) {
        document.getElementById('pengajuanStatusChart').parentElement.innerHTML =
            '<div class="text-center py-8"><i class="ki-duotone ki-document fs-2hx text-muted mb-4"></i><p class="text-muted">Belum ada data pengajuan AMI</p></div>';
    } else {
    ...
    // Check if jenis unit kerja data exists
    if (jenisUnitValues.length === 0 || jenisUnitValues.every(val => val === 0)) {
        document.getElementById('jenisUnitKerjaChart').parentElement.innerHTML =
            '<div class="text-center py-8"><i class="ki-duotone ki-bank fs-2hx text-muted mb-4"></i><p class="text-muted">Belum ada data unit kerja</p></div>';
    } else {
