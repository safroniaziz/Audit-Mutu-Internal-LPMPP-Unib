...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            console.log('Setting up delete button event handlers...');
            $('.btn-delete-dokumen').on('click', function(e) {
                console.log('Delete button clicked! Event object:', e);
            ...
            console.log('Delete button event handlers set up. Found', $('.btn-delete-dokumen').length, 'delete buttons');
