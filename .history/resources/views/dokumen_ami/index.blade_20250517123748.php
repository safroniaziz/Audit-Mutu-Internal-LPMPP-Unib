                                    ...
                                    @if($dokumenAuditor && count([$dokumenAuditor]) > 0)
                                        <tr class="dokumen-item">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" class="btn btn-sm btn-light btn-active-light-primary btn-edit-dokumen"
...
<div class="modal fade" id="modalEditDokumen" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form id="formEditDokumen" action="{{ route('dokumenAmi.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-edit-dokumen', function (e) {
                ...
                const modalEdit = new bootstrap.Modal(document.getElementById('modalEditDokumen'));
                modalEdit.show();
            });
