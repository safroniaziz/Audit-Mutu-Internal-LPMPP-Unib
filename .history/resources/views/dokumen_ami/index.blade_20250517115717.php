...
@push('scripts')
    <script>
        // Updated script for handling tab navigation and persistence
$(document).ready(function() {
    ...
    // Handle tab clicks - modified from your existing code
    $('.dokumen-tabs .nav-link').on('click', function() {
        ...
        // Update URL with hash - this is the key change
    ...
    // (File size validation, toastr initialization, etc...)
});
    </script>
@endpush
