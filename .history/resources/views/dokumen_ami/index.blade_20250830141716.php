                                        ...
                                        @foreach ($dokumenUmums as $dokumenUmum)
                                            <tr class="dokumen-item">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-icon btn-danger btn-delete-dokumen" data-id="{{ $dokumenUmum->id }}" title="Hapus">
                                        ...
                                        @foreach ($dokumenAuditees as $dokumenAuditee)
                                            <tr class="dokumen-item">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-icon btn-danger btn-delete-dokumen" data-id="{{ $dokumenAuditee->id }}" title="Hapus">
                                                        <i class="bi bi-trash-fill fs-4"></i>
                                                    </button>
                                                </td>
                                            </tr>
