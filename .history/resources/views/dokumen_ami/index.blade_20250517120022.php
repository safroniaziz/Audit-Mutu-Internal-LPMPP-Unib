            ...
            <div class="card-body pt-0">
                ...
                <ul class="nav nav-tabs nav-line-tabs mb-5 fs-6 dokumen-tabs border-0">
                    <li class="nav-item me-2">
                        <a class="nav-link active px-5 py-3" data-bs-toggle="tab" href="#tab_auditor">
                    ...
                    <li class="nav-item mx-2">
                        <a class="nav-link px-5 py-3" data-bs-toggle="tab" href="#tab_umum">
                            <span class="svg-icon svg-icon-4 me-1">
...
<div class="modal fade" id="modalAddDokumen" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form id="formAddDokumen" action="" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.dokumen-tabs .nav-link').on('click', function() {
                ...
                history.replaceState(null, null, '#' + target.substring(1));
            });

            // Check for hash in URL on page load
            if(window.location.hash) {
                $('.dokumen-tabs .nav-link[href="' + window.location.hash + '"]').tab('show');
            }

            function activateTabFromHash() {
                let hash = window.location.hash;
                if (hash) {
                    // Find tab matching the hash and show it
            ...
            $('.dokumen-tabs .nav-link').on('click', function() {
                ...
                // Update URL with hash - key change here
                window.history.pushState(null, null, window.location.pathname + target);
            });

            // Activate correct tab on initial page load
            activateTabFromHash();
            ...
            function showFilePreview(file) {
                ...
                $('#filePreview i').removeClass().addClass('bi ' + iconClass + ' fs-2 text-primary me-3');
            ...
            $('.btn-edit-dokumen').on('click', function() {
                ...
                $('#edit_tanggal_berlaku').val(tanggal);
