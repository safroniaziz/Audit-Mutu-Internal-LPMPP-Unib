...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.addEventListener('DOMContentLoaded', function() {
            // Menonaktifkan interaksi setelah memilih radio button
            const radios = document.querySelectorAll('.jawaban-radio');
            radios.forEach(function(radio) {
                // Jika radio sudah dipilih, buat tidak bisa diubah
                if (radio.checked) {
                    radio.setAttribute('disabled', 'true');
                }

                // Event listener untuk mencegah perubahan pada pilihan yang sudah dipilih
