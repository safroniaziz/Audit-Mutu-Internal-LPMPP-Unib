                        ...
                        <div class="mb-4">
                            <div class="alert alert-info d-flex align-items-center p-5">
                                ...
                                <div class="d-flex flex-column">
                                    <h4 class="mb-1 text-dark">Nilai Tingkat Kesuksesan</h4>
                                    <div class="d-flex flex-wrap gap-3 mt-2">
                                        <span class="badge bg-success">4 - Sangat sesuai</span>
                                        <span class="badge bg-primary">3 - Sesuai</span>
                                        <span class="badge bg-warning">2 - Kurang sesuai</span>
                                        <span class="badge bg-danger">1 - Tidak sesuai</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            @foreach($evaluasis as $evaluasi)
                                @if($evaluasi->is_nilai)
                                    <div class="mb-4">
                                        <div class="d-flex align-items-start">
                                            <div class="number-circle primary me-3">{{ $questionNumber++ }}</div>
                                            <div class="flex-grow-1">
                                                <label class="form-label fw-semibold text-dark">{{ $evaluasi->evaluasi }}</label>
                                                <div class="d-flex gap-4 mt-2">
                                                    @for($i = 4; $i >= 1; $i--)
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="nilai_{{ $evaluasi->id }}_{{ $i }}">
                                                                {{ $i }}
                                                            </label>
                                                        </div>
                                                    @endfor
                                ...
                                @else
                                    ...
                                    <h5 class="fw-bold mb-4">{{ $evaluasi->evaluasi }}</h5>
                                    @php $questionNumber = 1; @endphp
                                @endif
                            @endforeach

                            <div class="separator my-5"></div>
                            <h5 class="fw-bold mb-4">Masukan</h5>

                            <div class="mb-4">
                                <div class="d-flex align-items-start">
                                    <div class="number-circle success me-3">1</div>
                                    <div class="flex-grow-1">
                                        <label for="materi_instrumen" class="form-label fw-semibold">Materi/instrumen Audit:</label>
                                        <textarea class="form-control" id="materi_instrumen" name="materi_instrumen" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-start">
                                    <div class="number-circle success me-3">2</div>
                                    <div class="flex-grow-1">
                                        <label for="pelaksanaan_audit" class="form-label fw-semibold">Pelaksanaan Audit:</label>
                                        <textarea class="form-control" id="pelaksanaan_audit" name="pelaksanaan_audit" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-start">
                                    <div class="number-circle success me-3">3</div>
                                    <div class="flex-grow-1">
                                        <label for="saran_teraudit" class="form-label fw-semibold">Saran untuk teraudit:</label>
                                        <textarea class="form-control" id="saran_teraudit" name="saran_teraudit" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
