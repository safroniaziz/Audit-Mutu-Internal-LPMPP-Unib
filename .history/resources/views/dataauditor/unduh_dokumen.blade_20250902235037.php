...
@section('dashboardProfile')
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach($kriteriaScores as $index => $kriteria)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td><span class="badge bg-success">{{ $kriteria['kode_kriteria'] }}</span></td>
                                        <td>{{ $kriteria['nama_kriteria'] }}</td>
                                        <td>
                                            <span class="badge bg-primary">{{ number_format($kriteria['rata_rata'], 2) }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    <!-- New Sections: IKSS, Referensi, Pernyataan Ketua, Pernyataan Anggota -->
    <div class="row mt-4">
        <!-- IKSS Section -->
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">IKSS (Indikator Kinerja Sasaran Strategis)</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach($pengajuanAmis->ikssAuditee as $index => $ikssAuditee)
                                    <tr>
                                        ...
                                        <td><span class="badge bg-primary">{{ $ikssAuditee->instrumen->target }}</span></td>
                                        <td><span class="badge bg-info">{{ $ikssAuditee->realisasi }}</span></td>
                                        <td>
                                            @if($ikssAuditee->visitasi->isNotEmpty())
                                                @php
                                                    $ketidakSesuaian = $ikssAuditee->visitasi->first()->ketidak_sesuaian;
                                                    $badgeClass = match($ketidakSesuaian) {
                                                        'sudah_sesuai' => 'bg-success',
                                                        'observasi' => 'bg-warning',
                                                        'kts_minor' => 'bg-orange',
                                                        'kts_mayor' => 'bg-danger',
                                                        default => 'bg-secondary'
                                                    };
                                                @endphp
                                                <span class="badge {{ $badgeClass }}">{{ ucwords(str_replace('_', ' ', $ketidakSesuaian)) }}</span>
                                            @else
                                                <span class="badge bg-secondary">Belum Dinilai</span>
                                            @endif
                                        </td>
                                        <td>
                                            @if($ikssAuditee->status_target)
                                                <span class="badge bg-success">Target Tercapai</span>
                                            @else
                                                <span class="badge bg-danger">Target Tidak Tercapai</span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Referensi (Butir Mutu)</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            <thead class="table-warning">
                                <tr>
                                    <th>No</th>
                                    <th>KTS/OB (Initial Auditor)</th>
                                    <th>Referensi (Butir Mutu)</th>
                                    <th>Pernyataan</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($visitasiData as $index => $visitasi)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>
                                            @php
                                                $ketidakSesuaian = $visitasi['ketidak_sesuaian'];
                                                $badgeClass = match($ketidakSesuaian) {
                                                    'sudah_sesuai' => 'bg-success',
                                                    'observasi' => 'bg-warning',
                                                    'kts_minor' => 'bg-orange',
                                        ...
                                        <td>{{ $visitasi['indikator'] }}</td>
                                        <td>{{ $visitasi['pernyataan'] }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    <!-- Pernyataan Ketua dan Anggota Section -->
    <div class="row mt-4">
        <!-- Pernyataan Ketua -->
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Pernyataan Ketua Auditor</h5>
                </div>
                <div class="card-body">
                    @if($pernyataanKetua->isNotEmpty())
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                <thead class="table-primary">
                                    <tr>
                                ...
                                <tbody>
                                    @foreach($pernyataanKetua as $index => $pernyataan)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $pernyataan['indikator'] }}</td>
                                            <td>{{ $pernyataan['pernyataan'] }}</td>
                                            <td>{{ $pernyataan['kelebihan'] }}</td>
                                            <td>{{ $pernyataan['peluang_peningkatan'] }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    @else
                        <div class="alert alert-info">
                            ...
                            Belum ada pernyataan dari ketua auditor.
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Pernyataan Anggota Auditor</h5>
                </div>
                <div class="card-body">
                    @if($pernyataanAnggota->isNotEmpty())
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                <thead class="table-success">
                                    <tr>
                                ...
                                <tbody>
                                    @foreach($pernyataanAnggota as $index => $pernyataan)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $pernyataan['indikator'] }}</td>
                                            <td>{{ $pernyataan['pernyataan'] }}</td>
                    ...
                    @else
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i>
                            Belum ada pernyataan dari anggota auditor.
                        </div>
                    @endif
                </div>
            </div>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Saran Perbaikan</h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach($visitasiData as $index => $visitasi)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $visitasi['indikator'] }}</td>
                                        <td>{{ $visitasi['kelebihan'] }}</td>
                                        <td>{{ $visitasi['peluang_peningkatan'] }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
