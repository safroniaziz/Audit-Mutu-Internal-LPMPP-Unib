                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <span class="">SASARAN STRATEGIS {{ $indikatorGroups->first()->first()->instrumen->indikatorKinerja->satuanStandar->kode_satuan ?? '-' }}</span>
                                                        <span class="text-muted fs-7 fw-semibold fw-bold fs-5 text-gray-900">{{ $satuanStandardNama ?? 'Sasaran Strategis Tidak Ditemukan' }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
