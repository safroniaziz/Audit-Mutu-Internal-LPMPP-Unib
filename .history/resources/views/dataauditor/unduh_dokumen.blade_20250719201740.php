                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                @if($pengajuan->catatan_visitasi)
                                    ...
                                    <a href="{{ route('auditor.audit.cetak.viewBeritaAcara', [$pengajuan->id]) }}" target="_blank" class="btn btn-sm btn-info px-4">
    ...
    <div class="modal fade" id="beritaAcaraModal" tabindex="-1" aria-labelledby="beritaAcaraModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('auditor.audit.cetak.beritaAcara',[$pengajuan->id]) }}" method="POST">
                    @csrf
