                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 audit-table">
                                <thead>
                                    <tr class="fw-bold text-muted">
                                        <th class="min-w-300px">Nama Instrumen</th>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <span class="fw-bold fs-6">{{ $satuanStandardNama ?? 'Sasaran Strategis Tidak Ditemukan' }}</span>
                                                        <span class="text-muted fs-7">Sasaran Strategis</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge badge-light-primary">{{ $indikatorGroups->count() }} indikator</span>
                                            </td>
                                        </tr>
                                        ...
                                        @foreach($indikatorGroups as $indikatorKinerjaNama => $ikssGroup)
                                                    ...
                                                    <div class="d-flex align-items-center ps-6">
                                                        <div class="symbol symbol-25px me-3">
                                                            <span class="symbol-label bg-info text-white">
                                                                <i class="ki-duotone ki-chart-line fs-7">
                                                                    <span class="path1"></span>
                                                                    <span class="path2"></span>
                                                                </i>
                                                            </span>
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <span class="fw-bold fs-7 text-gray-800">{{ $indikatorKinerja->kode_ikss }}</span>
                                                            <span class="text-muted fs-8">{{ $indikatorKinerjaNama }}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <span class="text-muted fs-7">{{ $completedCount }}/{{ $totalCount }}</span>
                                                </td>
                                            </tr>
                                            ...
                                            @foreach($ikssGroup as $ikss)
                                                @if($ikss->instrumen)
                                                    <tr class="level-item">
                                                        <td>
                                                            <div class="d-flex align-items-center ps-12">
                                                                <div class="symbol symbol-20px me-3">
                                                                    <span class="symbol-label bg-light-secondary text-secondary">
                                                                        <i class="ki-duotone ki-document fs-8">
                                                                            <span class="path1"></span>
                                                                            <span class="path2"></span>
                                                                        </i>
                                                                    </span>
                                                                </div>
                                                                <span class="fs-7 text-gray-700">{{ $ikss->instrumen->indikator }}</span>
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
