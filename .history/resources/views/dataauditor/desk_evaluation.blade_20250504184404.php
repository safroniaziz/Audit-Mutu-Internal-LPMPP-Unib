                                    ...
                                    <div class="card mb-5 {{ $allEvaluated ? 'border-success' : '' }}">
                                        <div class="card-header {{ $allEvaluated ? 'bg-success-subtle' : 'bg-light' }} pt-4">
                                            <div class="d-flex justify-content-between align-items-start flex-wrap">
                                                <h4 class="mb-0 me-3">ID IKSS: {{ $kodeIkss }} – {{ $firstIkss->instrumen->indikatorKinerja->tujuan }}</h4>
                                                @if($allEvaluated)
                                                    <span class="badge bg-success align-self-center">✅ Semua Instrumen Sudah Dievaluasi</span>
                                                @endif
                                            </div>
                                        </div>
                                                ...
                                                <div class="instrument-container mb-4 {{ $index > 0 ? 'mt-5 pt-4 border-top' : '' }}">
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="mt-3">
                                                            ...
                                                            <textarea rows="2" class="form-control" name="deskripsi[{{ $ikssAuditee->id }}]" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $deskEvaluation[$ikssAuditee->id]->deskripsi : '' }}</textarea>
                                                        </div>
                                                        <div class="mt-3">
                                                            <h6>Pertanyaan</h6>
