                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="tujuan_pengembangan" id="tujuan{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->tujuan_pengembangan == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="lingkup_audit" id="lingkup{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->lingkup_audit == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="materi_tujuan" id="materi{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->materi_tujuan == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="materi_dipahami" id="dipahami{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->materi_dipahami == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="materi_disiapkan" id="disiapkan{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->materi_disiapkan == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="teknik_audit" id="teknik{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->teknik_audit == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="waktu_audit" id="waktu{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->waktu_audit == $i ? 'checked' : '' }}>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="obyektif" id="obyektif{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->obyektif == $i ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="komunikatif" id="komunikatif{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->komunikatif == $i ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="terbuka" id="terbuka{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->terbuka == $i ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="profesional" id="profesional{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->profesional == $i ? 'checked' : '' }}>
