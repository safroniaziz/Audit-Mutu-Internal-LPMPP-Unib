        ...
        <div class="card-body">
            ...
            @if($dataIkss->isNotEmpty())
                ...
                <div class="wizard-nav">
                    @foreach($groupedIkss as $kodeIkss => $ikssGroup)
                        @php
                            $isCompleted = $ikssCompletionStatus[$kodeIkss]['is_completed'];
                        ...
                        <div class="wizard-step {{ $stepClass }}" data-step="{{ $kodeIkss }}">
                            ...
                            <div class="step-label">{{ $firstIkss->instrumen->indikatorKinerja->kode_ikss }}</div>
                            <div class="step-desc">
                                {{ $ikssCompletionStatus[$kodeIkss]['completed'] }}/{{ $ikssCompletionStatus[$kodeIkss]['total'] }}
                                Instrumen
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="wizard-sections">
                        @foreach($groupedIkss as $kodeIkss => $ikssGroup)
                            @php
                                ...
                                $isLast = $loop->last;
                                $isActive = $kodeIkss == $activeStep;
                                $status = $ikssCompletionStatus[$kodeIkss];
                            ...
                            <div class="wizard-content {{ $isActive ? 'active' : '' }}" id="step-{{ $kodeIkss }}">
                                <div class="alert {{ $isCompleted ? 'alert-success' : 'alert-danger' }} d-flex flex-column flex-sm-row p-5 mb-10">
                                    ...
                                    <div class="d-flex flex-column pe-0 pe-sm-10">
                                        ...
                                        <div class="fs-6">
                                            <div class="fw-semibold text-gray-700">{{ $firstIkss->instrumen->indikatorKinerja->kode_ikss }} - {{ $firstIkss->instrumen->indikatorKinerja->tujuan }}</div>
