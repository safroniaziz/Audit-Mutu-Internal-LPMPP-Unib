...
@section('dashboardProfile')
    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body pt-0">
            ...
            <!-- Jaring Laba-laba Nilai Auditor -->
            <div class="card card-bordered shadow-sm mb-8">
                ...
                <div class="card-body pt-0">
                    @if($evaluasiSubmissions->count() > 0 || $jawabanKuisioner->count() > 0)
                        <!-- Chart Container -->
                        <div class="row g-6">
                            <div class="col-lg-8">
                            ...
                            <div class="col-lg-4">
                                <!-- Informasi Dataset -->
                                <div class="mb-6">
                                    <h6 class="fw-bold text-dark mb-3">Jenis Instrumen</h6>
                                    <div class="d-flex flex-column gap-3">
                                        <div class="d-flex align-items-center p-3 bg-light-primary rounded">
                                            ...
                                            <span class="fs-7 fw-semibold">Instrumen RSB (Evaluasi)</span>
                                        </div>
                                        <div class="d-flex align-items-center p-3 bg-light-danger rounded">
                                            <div class="symbol symbol-20px me-3">
                                                <div class="symbol-label bg-danger"></div>
                                            </div>
                                            <span class="fs-7 fw-semibold">Instrumen Prodi (Kuisioner)</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Statistik Singkat -->
                                <div class="mb-6">
                                    <h6 class="fw-bold text-dark mb-3">Statistik</h6>
                                    @php
                                        ...
                                        $totalNilaiProdi = $jawabanKuisioner->count();
                                        $rataRataProdi = $totalNilaiProdi > 0 ? round($totalNilaiProdi / $totalNilaiProdi, 2) : 0;
                                    @endphp
                                    <div class="d-flex flex-column gap-3">
                                        <div class="d-flex justify-content-between">
                                            <span class="fs-7 text-muted">RSB (Evaluasi):</span>
                                            <span class="fw-bold text-primary">{{ $evaluasiSubmissions->count() }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <span class="fs-7 text-muted">Prodi (Kuisioner):</span>
                                            <span class="fw-bold text-danger">{{ $jawabanKuisioner->count() }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <span class="fs-7 text-muted">Total Data:</span>
                                            <span class="fw-bold text-dark">{{ $evaluasiSubmissions->count() + $jawabanKuisioner->count() }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    @else
                        <div class="alert alert-info text-center py-8">
                            ...
                            <p class="text-muted mb-0">Lakukan evaluasi RSB dan kuisioner prodi terlebih dahulu untuk melihat jaring laba-laba nilai auditor.</p>
                        </div>
                    @endif
                </div>
            </div>
