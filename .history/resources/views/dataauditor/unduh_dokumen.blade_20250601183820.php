            ...
            <div class="modal-content">
                ...
                <form action="{{ route('auditor.audit.evaluasiAmi',[$pengajuan->id]) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-4">
                            <h6 class="fw-bold mb-3">Nilai Tingkat Kesuksesan</h6>
                            <div class="d-flex flex-column gap-2">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="badge bg-success-subtle text-success px-3">1</span>
                                    <span class="text-gray-700">Sangat sesuai</span>
                                </div>
                                <div class="d-flex align-items-center gap-2">
                                    <span class="badge bg-primary-subtle text-primary px-3">2</span>
                                    <span class="text-gray-700">Sesuai</span>
                                </div>
                                <div class="d-flex align-items-center gap-2">
                                    <span class="badge bg-warning-subtle text-warning px-3">3</span>
                                    <span class="text-gray-700">Kurang sesuai</span>
                                </div>
                                <div class="d-flex align-items-center gap-2">
                                    <span class="badge bg-danger-subtle text-danger px-3">4</span>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="nilai[1]" id="tujuan{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '1')->first()?->nilai == $i ? 'checked' : '' }}>
                                            <label class="form-check-label" for="tujuan{{ $i }}">{{ $i }}</label>
                                        </div>
                                        @endfor
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="nilai[2]" id="lingkup{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '2')->first()?->nilai == $i ? 'checked' : '' }}>
                                            <label class="form-check-label" for="lingkup{{ $i }}">{{ $i }}</label>
                                        </div>
                                        @endfor
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="nilai[3]" id="materi{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '3')->first()?->nilai == $i ? 'checked' : '' }}>
                                            <label class="form-check-label" for="materi{{ $i }}">{{ $i }}</label>
                                        </div>
                                        @endfor
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="nilai[4]" id="dipahami{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '4')->first()?->nilai == $i ? 'checked' : '' }}>
                                            <label class="form-check-label" for="dipahami{{ $i }}">{{ $i }}</label>
                                        </div>
                                        @endfor
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="nilai[5]" id="disiapkan{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '5')->first()?->nilai == $i ? 'checked' : '' }}>
                                            <label class="form-check-label" for="disiapkan{{ $i }}">{{ $i }}</label>
                                        </div>
                                        @endfor
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="nilai[6]" id="teknik{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '6')->first()?->nilai == $i ? 'checked' : '' }}>
                                            <label class="form-check-label" for="teknik{{ $i }}">{{ $i }}</label>
                                        </div>
                                        @endfor
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="nilai[7]" id="waktu{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '7')->first()?->nilai == $i ? 'checked' : '' }}>
                                            <label class="form-check-label" for="waktu{{ $i }}">{{ $i }}</label>
                                        </div>
                                        @endfor
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nilai[8.a]" id="obyektif{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '8.a')->first()?->nilai == $i ? 'checked' : '' }}>
                                                <label class="form-check-label" for="obyektif{{ $i }}">{{ $i }}</label>
                                            </div>
                                            @endfor
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nilai[8.b]" id="komunikatif{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '8.b')->first()?->nilai == $i ? 'checked' : '' }}>
                                                <label class="form-check-label" for="komunikatif{{ $i }}">{{ $i }}</label>
                                            </div>
                                            @endfor
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nilai[8.c]" id="terbuka{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '8.c')->first()?->nilai == $i ? 'checked' : '' }}>
                                                <label class="form-check-label" for="terbuka{{ $i }}">{{ $i }}</label>
                                            </div>
                                            @endfor
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nilai[8.d]" id="profesional{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->where('nomor', '8.d')->first()?->nilai == $i ? 'checked' : '' }}>
                                                <label class="form-check-label" for="profesional{{ $i }}">{{ $i }}</label>
                                            </div>
                                            @endfor
                                        </div>
                                    </div>
