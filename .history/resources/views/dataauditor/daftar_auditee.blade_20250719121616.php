                                    ...
                                    <div class="d-flex flex-column">
                                                    ...
                                                    @foreach($auditee->auditors as $debugAuditor)
                                                        @php
                                                            ...
                                                            $masukanCount = \App\Models\EvaluasiMasukan::where('pengajuan_ami_id', $auditee->id)
                                                                ...
                                                                ->count();
                                                        @endphp
                                                        <strong>{{ $debugAuditor->auditor->name }}:</strong><br>
                                                        &nbsp;&nbsp;is_setuju: {{ $debugAuditor->is_setuju ? 'Yes' : 'No' }},
                                                        is_setuju_visitasi: {{ $debugAuditor->is_setuju_visitasi ? 'Yes' : 'No' }},
                                                        is_setuju_indikator_prodi: {{ $debugAuditor->is_setuju_indikator_prodi ? 'Yes' : 'No' }}<br>
                                                        &nbsp;&nbsp;Evaluasi: {{ $evalCount }}, Masukan: {{ $masukanCount }}<br>
                                                    @endforeach
                                                </small>
                                            </div>
                                        @endif
                                        ...
                                        @forelse ($auditee->auditors as $auditor)
                                            @php
                                                ...
                                                // Additional checks for data completeness (for debug purposes)
                                            ...
                                            @if(config('app.debug'))
                                                ...
                                                <div class="alert alert-warning p-1 mb-1">
                                                    <small>
                                                        ...
                                                        is_setuju: {{ $auditor->is_setuju ? 'Yes' : 'No' }},
                                                        is_setuju_visitasi: {{ $auditor->is_setuju_visitasi ? 'Yes' : 'No' }},
                                                        is_setuju_indikator_prodi: {{ $auditor->is_setuju_indikator_prodi ? 'Yes' : 'No' }}<br>
