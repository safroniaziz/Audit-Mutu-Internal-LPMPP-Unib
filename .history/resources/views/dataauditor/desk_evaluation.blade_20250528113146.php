...
@push('styles')
    <style>
        ...
        /* When all steps are completed, make all steps accessible */
        .wizard-nav.all-completed .wizard-step {
            cursor: pointer;
            opacity: 1;
        }

        .wizard-nav.all-completed .wizard-step:hover {
            opacity: 1;
            color: #009EF7 !important;
        }

        .wizard-nav.all-completed .wizard-step:hover .step-number {
            background: #009EF7 !important;
            color: #FFFFFF !important;
            border-color: #009EF7 !important;
        }

        .wizard-nav.all-completed .wizard-step:hover .step-label,
        .wizard-nav.all-completed .wizard-step:hover .step-desc {
            color: #009EF7 !important;
        }
...
<script>
    $(document).ready(function() {
        ...
        if ($('.wizard-step.completed').length === $('.wizard-step').length) {
            $('.wizard-nav').addClass('all-completed');
        }
