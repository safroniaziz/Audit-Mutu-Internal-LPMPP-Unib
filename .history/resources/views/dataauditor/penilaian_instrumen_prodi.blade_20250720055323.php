        ...
        const completionHtml = `
            <div class="text-center py-10">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn-success btn-lg" id="approve-penilaian-btn" data-id="{{ $pengajuan->id }}">
                        <i class="bi bi-check-circle me-2"></i>
                        Setujui
                    </button>
                    <a href="{{ route('auditor.audit.daftarAuditee') }}" class="btn btn-primary btn-lg">
                        <i class="fas fa-arrow-left me-2"></i>
