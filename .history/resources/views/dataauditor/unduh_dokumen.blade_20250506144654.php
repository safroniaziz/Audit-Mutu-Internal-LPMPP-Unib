...
@section('dashboardProfile')
    ...
    <!-- Modal Laporan AMI - Professional Clean Design -->
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('auditor.audit.laporanAmi', [$pengajuan->id]) }}" method="POST">
                ...
                <div class="modal-body" style="padding: 1.5rem;">
                    <h6 style="color: #495057; margin-bottom: 1.25rem; font-weight: 500;">Evaluasi Sistem Penjaminan Mutu Internal</h6>
                                            ...
                                            <div style="display: flex; gap: 15px;">
                                                @foreach ($item['opsi'] as $opsi)
                                                    <div class="form-check" style="margin: 0;">
                                                        ...
                                                        <label class="form-check-label" for="{{ $item['name'] }}_{{ $opsi }}" style="color: #212529;">
                                                            {{ $opsi }}
                                                        </label>
                                                    </div>
                                                @endforeach
                ...
                <div class="modal-footer" style="background-color: #f8f9fa; border-top: 1px solid #dee2e6;">
                    <button type="button" class="btn btn-light" style="border: 1px solid #ced4da;" data-bs-dismiss="modal">
                        Tutup
                    </button>
                    <button type="submit" class="btn btn-primary">
                        Cetak Laporan
