        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="laporanAmiModalLabel">
                    <i class="fas fa-file-alt me-2"></i>Cetak Laporan Audit Mutu Internal
                </h5>
                    ...
                    <div class="container-fluid">
                        <div class="card mb-4">
                            <div class="card-header bg-light">
                                <h6 class="mb-0">Evaluasi Sistem Penjaminan Mutu Internal</h6>
                            </div>
                            <div class="card-body">
                                @php
                                    $pertanyaan = [
                                                    ...
                                                    <td>
                                                        <div class="btn-group w-100" role="group">
                                                            @foreach ($item['opsi'] as $opsi)
                                                                <input type="radio" class="btn-check" name="{{ $item['name'] }}" id="{{ $item['name'] }}_{{ $opsi }}" value="{{ $opsi }}" required>
                                                                <label class="btn btn-outline-primary btn-sm" for="{{ $item['name'] }}_{{ $opsi }}">{{ $opsi }}</label>
                                                            @endforeach
                                                        </div>
                                                    </td>
                                                </tr>
