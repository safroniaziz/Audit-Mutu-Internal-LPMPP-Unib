                                    ...
                                    @if($evaluasi->is_nilai)
                                        <div class="mb-4 ms-4">
                                            <div class="position-relative">
                                                <div class="position-absolute" style="left: -2rem; top: 0.3rem;">
                                                ...
                                                <div class="evaluation-content">
                                                    ...
                                                    <div class="d-flex gap-5 mt-3 ms-2">
                                                        @for($i = 1; $i <= 4; $i++)
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-4 ms-4">
                                <div class="position-relative">
                                    ...
                                    <div class="input-group-content">
                                        <label for="materi_instrumen" class="form-label fw-semibold text-dark">1. Materi/instrumen Audit:</label>
                                        <textarea class="form-control bg-light" id="materi_instrumen" name="materi_instrumen" rows="3" placeholder="Isi disini..."></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4 ms-4">
                                <div class="position-relative">
                                    ...
                                    <div class="input-group-content">
                                        <label for="pelaksanaan_audit" class="form-label fw-semibold text-dark">2. Pelaksanaan Audit:</label>
                                        <textarea class="form-control bg-light" id="pelaksanaan_audit" name="pelaksanaan_audit" rows="3" placeholder="Isi disini..."></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-4 ms-4">
                                <div class="position-relative">
                                    ...
                                    <div class="input-group-content">
                                        <label for="saran_teraudit" class="form-label fw-semibold text-dark">3. Saran untuk teraudit:</label>
                                        <textarea class="form-control bg-light" id="saran_teraudit" name="saran_teraudit" rows="3" placeholder="Isi disini..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
