                                ...
                                <tbody class="text-gray-600">
                                    @forelse($auditess as $index => $auditee)
                                        <tr class="{{ $auditee->audit_status['status'] === 'new' ? 'table-primary' : '' }}">
                                            ...
                                            <td>
                                                @forelse ($auditee->auditors as $auditor)
                                                    <div class="d-flex align-items-start mb-2">
                                                        <div class="symbol symbol-24px me-2 flex-shrink-0">
                                                            <span class="symbol-label bg-light-{{ $auditor->role === 'ketua' ? 'danger' : 'info' }}">
                                                                <i class="fas fa-user-tie fs-1 text-{{ $auditor->role === 'ketua' ? 'danger' : 'info' }}"></i>
                                                            </span>
                                                        </div>
                                                        <div class="d-flex flex-column flex-grow-1 min-w-0">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-24px me-2 flex-shrink-0">
                                                            <span class="symbol-label bg-light-warning">
                                                                <i class="fas fa-user-slash fs-1 text-warning"></i>
                                                            </span>
                                                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-start">
                                                    <div class="symbol symbol-28px me-2 flex-shrink-0">
                                                        <span class="symbol-label bg-light-{{ $auditee->audit_status['color'] }}">
                                                            <i class="{{ $auditee->audit_status['icon'] }} fs-1 text-{{ $auditee->audit_status['color'] }}"></i>
                                                        </span>
                                                    </div>
                                                    <div class="d-flex flex-column flex-grow-1 min-w-0">
