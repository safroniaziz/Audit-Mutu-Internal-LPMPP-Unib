                            ...
                            <div class="card-body">
                                @foreach($evaluasis as $evaluasi)
                                    @if($evaluasi->is_nilai)
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">{{ $evaluasi->evaluasi }}</label>
                                            <div class="d-flex gap-3 mt-2">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="nilai_{{ $evaluasi->id }}_{{ $i }}">{{ $i }}</label>
                                                </div>
                                                @endfor
                                            </div>
                                        </div>
                                    @else
                                        <h6 class="fw-bold mb-4">{{ $evaluasi->evaluasi }}</h6>
                                    @endif
                                @endforeach
                            </div>
                        </div>
