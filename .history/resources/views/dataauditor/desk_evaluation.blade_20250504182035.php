                                            ...
                                            <div class="mb-5">
                                                ...
                                                <div class="mb-4">
                                                    <div class="mt-3">
                                                        ...
                                                        <textarea rows="1" class="form-control" name="penilaian_rencana[{{ $ikssAuditee->id }}]" rows="4" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $deskEvaluation[$ikssAuditee->id]->penilaian_rencana : '' }}</textarea>
                                                    </div>
                                                    <div class="mt-3">
                                                        <h6>Pertanyaan</h6>
                                                        <textarea rows="1" class="form-control" name="penilaian_akar[{{ $ikssAuditee->id }}]" rows="4" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $deskEvaluation[$ikssAuditee->id]->penilaian_akar : '' }}</textarea>
                                                    </div>
                                                    <div class="mt-3">
                                                        <h6>Nilai</h6>
                                                        <textarea rows="1" class="form-control" name="penilaian_akar[{{ $ikssAuditee->id }}]" rows="4" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $deskEvaluation[$ikssAuditee->id]->nilai : '' }}</textarea>
                                                    </div>
                                                <hr class="my-5">
                                            </div>
                                        </div>
