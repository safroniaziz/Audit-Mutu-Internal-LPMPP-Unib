                    ...
                    <div class="d-flex flex-column flex-grow-1">
                        ...
                        @if($inactivePeriods->count() > 0)
                            <div class="mt-3 p-3 bg-warning bg-opacity-10 border border-warning border-opacity-25 rounded">
                                ...
                                <strong>Perhatian:</strong> {{ $inactivePeriods->count() }} auditee belum dapat diaudit karena jadwal audit sudah berakhir.
                        ...
                        <div class="card shadow-sm border-0 bg-light-warning">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <span class="text-muted d-block fs-7 fw-semibold">Dalam Proses</span>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 audit-card"
                            ...
                            <div class="card h-100 shadow-sm hover-elevate-up {{ $auditee->overall_audit_status === 'new' ? 'border-primary border-2' : '' }}">
                                ...
                                <div class="card-body py-3">
                                    ...
                                    <!--begin::Jadwal Audit Info Row-->
                                    <div class="row g-3 mb-4">
                                        <div class="col-12">
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-30px me-2">
                                                    <span class="symbol-label bg-light-{{ $auditee->is_audit_period_active ? 'success' : 'warning' }}">
                                                        <i class="fas fa-clock text-{{ $auditee->is_audit_period_active ? 'success' : 'warning' }} fs-6"></i>
                                                    </span>
                                                </div>
                                                <div class="d-flex flex-column">
                                                    <span class="text-muted fw-semibold fs-8">Jadwal Audit</span>
                                                    <span class="fw-bold fs-7 text-dark">
                                                        {{ $auditee->is_audit_period_active ? 'Aktif' : 'Sudah Berakhir' }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
