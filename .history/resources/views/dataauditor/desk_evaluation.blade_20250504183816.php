                                                ...
                                                <div class="instrument-container mb-4 {{ $index > 0 ? 'mt-5 pt-4 border-top' : '' }}">
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="mt-3">
                                                            ...
                                                            <textarea rows="2" class="form-control" name="penilaian_rencana[{{ $ikssAuditee->id }}]" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $deskEvaluation[$ikssAuditee->id]->penilaian_rencana : '' }}</textarea>
                                                        </div>
                                                        <div class="mt-3">
                                                            <h6>Pertanyaan</h6>
                                                            <textarea rows="2" class="form-control" name="penilaian_akar[{{ $ikssAuditee->id }}]" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $deskEvaluation[$ikssAuditee->id]->penilaian_akar : '' }}</textarea>
                                                        </div>
                                                        <div class="mt-3">
                                                            <h6>Nilai</h6>
