                    ...
                    <div class="card-body">
                        @if($deskEvaluation->isNotEmpty())
                            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                                ...
                                <div class="d-flex justify-content-between align-items-center py-4 mb-6 border rounded px-4">
                                    <div class="me-10">
                                    ...
                                    <form action="{{ route('auditor.audit.approveDeskEvaluation', $pengajuan->id) }}" method="POST">
                                        @csrf
