                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <input class="form-check-input" type="radio" name="point_3" id="materi{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_3 == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="point_4" id="dipahami{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_4 == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="point_5" id="disiapkan{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_5 == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="point_6" id="teknik{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_6 == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="point_7" id="waktu{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_7 == $i ? 'checked' : '' }}>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="point_8a" id="obyektif{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_8a == $i ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="point_8b" id="komunikatif{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_8b == $i ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="point_8c" id="terbuka{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_8c == $i ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mt-2">
                                            @for($i = 1; $i <= 4; $i++)
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="point_8d" id="profesional{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_8d == $i ? 'checked' : '' }}>
