                ...
                <form action="{{ route('auditor.audit.laporanAmi', [$pengajuan->id]) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            @php
                                $pertanyaan = [
                                    ['name' => 'dokumentasi', 'label' => '1. Sistem dokumentasi cukup lengkap dan terstruktur untuk mendukung pelaksanaan Sistem Penjaminan Mutu Internal.', 'opsi' => ['Ya', 'Tidak', 'Lainnya']],
                                    ['name' => 'konsistensi', 'label' => '2. Program studi telah menjalankan Sistem Penjaminan Mutu Internal secara konsisten dan berkelanjutan.', 'opsi' => ['Ya', 'Tidak', 'Lainnya']],
                                    ['name' => 'temuan', 'label' => '3. Temuan pada periode audit ini adalah', 'opsi' => ['Mayor', 'Minor', 'Observasi']],
                                    ['name' => 'ptk', 'label' => '4. PTK pada temuan audit sebelumnya telah ditindak-lanjuti secara efektif', 'opsi' => ['Ya', 'Tidak']],
                                    ['name' => 'komitmen_kaprodi', 'label' => '5. Kaprodi menunjukkan komitmennya terhadap implementasi Sistem Penjaminan Mutu Internal untuk tercapainya kepuasan stakeholder', 'opsi' => ['Ya', 'Tidak', 'Lainnya']],
                                ];
                            @endphp

                            @foreach ($pertanyaan as $item)
                                <div class="row mb-3">
                                    <label class="col-md-12 fw-bold">{{ $item['label'] }}</label>
                                    <div class="col-md-12">
                                        <div class="d-flex flex-wrap gap-3">
                                            @foreach ($item['opsi'] as $opsi)
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="{{ $item['name'] }}" value="{{ $opsi }}" required>
