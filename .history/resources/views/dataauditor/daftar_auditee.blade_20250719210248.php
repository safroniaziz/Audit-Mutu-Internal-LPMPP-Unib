                    ...
                    <div class="d-flex flex-column flex-grow-1">
                        ...
                        @if($inactivePeriods->count() > 0)
                            <div class="mt-3 p-3 bg-warning bg-opacity-10 border border-warning border-opacity-25 rounded">
                                ...
                                <strong>Perhatian:</strong> {{ $inactivePeriods->count() }} auditee belum dapat diaudit karena periode audit belum aktif.
                                Tombol "Mulai Audit" dan "Lanjutkan" akan aktif setelah periode audit dimulai.
                            </div>
                        @endif
                    </div>
                </div>
