                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <span class="text-muted fs-7 fw-semibold">{{ $satuanStandardNama ?? 'Sasaran Strategis Tidak Ditemukan' }}</span>
                                                        <span class="fw-bold fs-5 text-gray-900 ">SASARAN STRATEGIS {{ $indikatorGroups->first()->first()->instrumen->indikatorKinerja->satuanStandar->kode_satuan ?? '-' }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
