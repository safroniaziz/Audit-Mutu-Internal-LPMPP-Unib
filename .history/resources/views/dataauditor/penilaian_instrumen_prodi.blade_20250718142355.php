                    ...
                    if (data.success) {
                        Swal.fire({
                            ...
                            setTimeout(() => {
                                ...
                                const activeContent = document.querySelector('.kriteria-content.active');
                                if (activeContent) {
                                    console.log('Found active content, scrolling...');
                                    activeContent.scrollIntoView({ behavior: 'smooth', block: 'start' });
                                } else {
                                    console.log('Active content not found, trying alternative scroll...');
                                    // Alternative scroll to the kriteria section
                                    const kriteriaSection = document.querySelector('.kriteria-content');
                                    if (kriteriaSection) {
                                        kriteriaSection.scrollIntoView({ behavior: 'smooth', block: 'start' });
                                    }
                                }
                            }, 300);
                        });
