...
@section('menuUnduhDokumen')
    @foreach($pengajuanAmis->auditors as $penugasan)
        @if($penugasan->role == 'ketua' && $penugasan->auditor_id == Auth::id())
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditor.audit.unduhDokumen') ? 'active' : '' }}" href="{{ route('auditor.audit.unduhDokumen', [$pengajuanAmis->id]) }}">
