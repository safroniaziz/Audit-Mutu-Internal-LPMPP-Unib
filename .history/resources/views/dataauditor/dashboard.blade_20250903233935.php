                        ...
                        <div class="row">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" class="form-control form-control-lg form-control-solid" value="{{ Auth::user()->unitKerja ? Auth::user()->unitKerja->nama_unit_kerja : '-' }}" readonly />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="nama_ketua" class="form-control form-control-lg form-control" placeholder="Nama Ketua" value="{{ Auth::user()->unitKerja && Auth::user()->unitKerja->nama_ketua ? Auth::user()->unitKerja->nama_ketua : '-' }}" />
                                </div>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="nip_ketua" class="form-control form-control-lg form-control" placeholder="NIP Ketua" value="{{ Auth::user()->unitKerja && Auth::user()->unitKerja->nip_ketua ? Auth::user()->unitKerja->nip_ketua : '-' }}" />
                                </div>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="jenjang" class="form-select form-select-lg form-select-solid">
                                        <option value="">Pilih Jenjang</option>
                                        <option value="D3" {{ Auth::user()->unitKerja && Auth::user()->unitKerja->jenjang == 'D3' ? 'selected' : '' }}>D3</option>
                                        <option value="D4" {{ Auth::user()->unitKerja && Auth::user()->unitKerja->jenjang == 'D4' ? 'selected' : '' }}>D4</option>
                                        <option value="S1" {{ Auth::user()->unitKerja && Auth::user()->unitKerja->jenjang == 'S1' ? 'selected' : '' }}>S1</option>
                                        <option value="S2" {{ Auth::user()->unitKerja && Auth::user()->unitKerja->jenjang == 'S2' ? 'selected' : '' }}>S2</option>
                                        <option value="S3" {{ Auth::user()->unitKerja && Auth::user()->unitKerja->jenjang == 'S3' ? 'selected' : '' }}>S3</option>
                                    </select>
                                </div>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="website" class="form-control form-control-lg form-control" placeholder="Website" value="{{ Auth::user()->unitKerja && Auth::user()->unitKerja->website ? Auth::user()->unitKerja->website : '-' }}" />
                                </div>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="no_hp" class="form-control form-control-lg form-control" placeholder="No HP" value="{{ Auth::user()->unitKerja && Auth::user()->unitKerja->no_hp ? Auth::user()->unitKerja->no_hp : '-' }}" />
                                </div>
                            </div>
                            <!--end::Input group-->
...
@push('scripts')
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        // Show error message
                        toastr.error(response.message || 'Terjadi kesalahan saat menyimpan data', 'Error!');
                    }
                },
        ...
        function resetForm() {
            ...
            toastr.info('Form telah direset ke nilai awal', 'Info');
        }
    </script>
@endpush
