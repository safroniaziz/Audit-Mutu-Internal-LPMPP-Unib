    ...
    <div class="document-container">
        ...
        <table class="pendahuluan" style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 12px; margin-top:10px;">
            <tbody>
                ...
                <tr style="">
                    <td c style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">Telp</td>
                    <td c style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
