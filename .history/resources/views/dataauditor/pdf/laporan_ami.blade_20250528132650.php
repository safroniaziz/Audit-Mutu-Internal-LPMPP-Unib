        ...
        <table class="pendahuluan" style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 12px; margin-top:10px;">
            <tbody>
                <tr>
                    ...
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" colspan="4">{{ $pengajuanAmis->auditee->fakultas }}</td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" colspan="4">{{ $pengajuanAmis->auditee->nama_unit_kerja }}</td>
                </tr>
                <tr style="">
                ...
                <tr>
                    ...
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">{{ $pengajuanAmis->auditee->nama_ketua }}</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">Telp</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">{{ $pengajuanAmis->auditee->no_hp }}</td>
                </tr>
                <tr style="">
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">Tanggal Audit</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" colspan="4">{{ $pengajuanAmis->waktu }}</td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">
                        @foreach($pengajuanAmis->auditors as $penugasan)
                            @if($penugasan->role == 'ketua')
                ...
                <tr style="">
                    <td colspan="3" style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">Telp</td>
                    <td colspan="3" style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
                    <td colspan="3" style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">
                        @foreach($pengajuanAmis->auditors as $penugasan)
                            @if($penugasan->role == 'pendamping')
                                {{ $penugasan->auditor->unitKerja ? $penugasan->auditor->unitKerja->no_hp : '-' }}
                            @endif
            ...
            <tbody>
                @foreach ($sortedGrouped as $index => $group)
                    <tr>
                        ...
                        <td style="padding: 10px; border: 1px solid #ddd; text-align:center;">
                            @if($group['has_data'])
                                {{ number_format($group['total_nilai_ketua'], 2) }}
                            @else
                        ...
                        <td style="padding: 10px; border: 1px solid #ddd; text-align:center;">
                            @if($group['has_data'])
                                {{ number_format($group['total_nilai_anggota'], 2) }}
                            @else
                                <span style="color:red;">-</span>
                            @endif
                        </td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align:center;">
                            @if($group['has_data'])
                                {{ number_format($group['total_nilai'], 2) }}
                            @else
                                <span style="color:red;">-</span>
                            @endif
                        </td>
                        ...
                        <td style="padding: 10px; border: 1px solid #ddd; text-align:center;">
                            @if($group['has_data'])
                                {{ number_format($group['rata_rata'], 2) }}
                            @else
                                <span style="color:red;">-</span>
                            @endif
                        </td>
