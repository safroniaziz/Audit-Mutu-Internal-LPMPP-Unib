...
<body>
    ...
    <div class="document-container">
        ...
        <table class="pendahuluan" style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 12px; margin-top:10px;">
            <tbody>
                <tr>
                    ...
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" colspan="4">Keguruan dan Ilmu Pendidikan</td>
                </tr>
                <tr>
                ...
                <tr style="">
                    ...
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" colspan="4">-</td>
                </tr>
                <tr>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">Ketua Program Studi</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">Nama Ketua Prodi</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">Telp</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">097878786756</td>
                </tr>
                <tr style="">
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">Tanggal Audit</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" colspan="4">6 Mei 2025</td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" rowspan="2">Ir. BAMBANG SUMANTRI, M.Si.</td>
                    ...
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">Nama Prodi</td>
                </tr>
                <tr style="">
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">Telp</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
                ...
                <tr>
                    ...
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">:</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; height: 80px;"></td>
        ...
        <p>Hari/Tanggal Audit : 6 Mei 2025</p>
        ...
        <table class="tujuanAudit" style="width: 100%; border-collapse: collapse; margin-top: 5px;">
            ...
            <tbody>
                @foreach ($pengajuanAmis->ikssAuditee as $index => $ikssAuditee)
                    <tr>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">{{ $index+1 }}</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">{{ $ikssAuditee->visitasi->ketidak_sesuaian }}</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">{{ $ikssAuditee->instrumen->indikator }}</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">{{ $ikssAuditee->visitasi->pernyataan }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
            ...
            <tbody>
                @foreach ($pengajuanAmis->ikssAuditee as $index => $ikssAuditee)
                    <tr>
                        ...
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">{{ $ikssAuditee->visitasi->kelebihan }}</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">{{ $ikssAuditee->visitasi->peluang_peningkatan }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <table class="tujuanAudit" style="width: 100%; border-collapse: collapse; margin-top: 5px;">
            <thead>
                <tr>
                    ...
                    <th colspan="4" style="padding: 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Penilaian Auditor</th>
                </tr>
                <tr>
                    <th style="padding: 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Ketua</th>
                    <th style="padding: 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Anggota</th>
                    <th style="padding: 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Total</th>
                    <th style="padding: 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Rata-Rata</th>
                </tr>
            </thead>
            <tbody>
                    <tr>
                        ...
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">1</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">1</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left; text-align:center;">1</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left; text-align:center;">1</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left; text-align:center;">1</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left; text-align:center;">1</td>
                    </tr>
