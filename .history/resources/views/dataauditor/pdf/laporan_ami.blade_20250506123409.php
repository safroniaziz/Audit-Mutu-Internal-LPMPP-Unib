        ...
        <table class="tujuanAudit" style="width: 100%; border-collapse: collapse; margin-top: 5px;">
            <thead>
                <tr>
                    ...
                    <th colspan="3" style="padding: 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Penilaian Auditor</th>
                </tr>
                <tr>
                    <th>Ketua</th>
                    <th>Anggota</th>
