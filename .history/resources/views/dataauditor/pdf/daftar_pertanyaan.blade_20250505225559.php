...
<body>
    ...
    <div class="document-container">
        ...
        <div class="header">
            <h1>DAFTAR PERTANYAAN VISITASI OLEH AUDITOR</h1>
        ...
        <table class="details-table" style="width: 100%; border-collapse: collapse;">
            <tbody>
                <tr>
                    ...
                    <td style="width: 33%; vertical-align: top;">Senin, 5 Mei 2025</td>

                    <td style="width: 15%; vertical-align: top;">Auditee</td>
                    <td style="width: 2%; vertical-align: top;">:</td>
                    <td style="width: 33%; vertical-align: top;">Nama Auditee</td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top; text-align:center" colspan="3">Auditor</td>
                ...
                <tr>
                    ...
                    <td style="vertical-align: top;">Auditor Ketua</td>
                    <td style="vertical-align: top;">:</td>
                    <td style="vertical-align: top;">Nama Auditor Ketua</td>

                </tr>
                <tr>
                    <td style="vertical-align: top;">Fakultas/Prodi</td>
                    <td style="vertical-align: top;">:</td>
                    <td style="vertical-align: top;">Nama Fakultas/Prodi</td>

                    <td style="vertical-align: top;">Auditor Pendamping 1</td>
                    <td style="vertical-align: top;">:</td>
                    <td  style="vertical-align: top;">Nama Auditor Pendamping 1</td>
                </tr>
                <tr>
                    <td style="vertical-align: top;" rowspan="2">Lingkup Audit</td>
                    <td style="vertical-align: top;">:</td>
                    <td style="vertical-align: top;">[Isi Lingkup Audit]</td>

                    <td style="vertical-align: top;">Auditor Pendamping 2</td>
                    <td style="vertical-align: top;">:</td>
                    <td  style="vertical-align: top;">Nama Auditor Pendamping 2</td>
                </tr>
            </tbody>
        </table>
