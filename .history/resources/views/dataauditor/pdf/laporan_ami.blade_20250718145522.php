    ...
    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; height: 80px; min-width: 120px;">
        ...
        <table class="tujuanAudit" style="width: 100%; border-collapse: collapse; margin-top: 5px;">
            <thead>
                <tr>
                    <th style="padding: 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">No</th>
                    <th style="padding: 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Kriteria</th>
                    <th style="padding: 10px; border: 1px solid #ddd; text-align: center; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Skor Auditor 1</th>
                    <th style="padding: 10px; border: 1px solid #ddd; text-align: center; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Skor Auditor 2</th>
                    <th style="padding: 10px; border: 1px solid #ddd; text-align: center; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Total</th>
            ...
            <tbody>
                @foreach ($kriteriaScores as $index => $kriteria)
                    <tr>
                        ...
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">
                            <strong>{{ $kriteria['kode_kriteria'] }}.</strong> {{ $kriteria['kriteria'] }}
                        </td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">
                            @if($kriteria['auditor1_count'] > 0)
                                {{ number_format($kriteria['auditor1_score'], 2) }}
                            @else
                                <span style="color: red;">-</span>
                            @endif
                        </td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">
                            @if($kriteria['auditor2_count'] > 0)
                                {{ number_format($kriteria['auditor2_score'], 2) }}
                            @else
                                <span style="color: red;">-</span>
                            @endif
                        </td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">
                            @if($kriteria['total_score'] > 0)
                                {{ number_format($kriteria['total_score'], 2) }}
                            @else
                                <span style="color: red;">-</span>
                            @endif
                        </td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">
                            @if($kriteria['average_score'] > 0)
                                {{ number_format($kriteria['average_score'], 2) }}
                            @else
                                <span style="color: red;">-</span>
                            @endif
                        </td>
