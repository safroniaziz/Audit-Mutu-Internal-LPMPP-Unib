...
<head>
    ...
    <style>
        /* Menggunakan font fallback sistem tanpa import */
        body {
        ...
        /* Menerapkan font sistem secara universal */
        * {
            font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue", Arial, sans-serif;
        }
...
<body>
    <div class="document-container">
        ...
        <div style="font-family: Arial, Helvetica, sans-serif !important;font-size: 16px;
            font-weight: 500;
            margin-top: 30px;
            color: #00447c;
            border-bottom: 2px solid #00447c;
            padding-bottom: 8px;
            position: relative;
            font-family: 'Roboto', sans-serif !important;">Audit Prodi/Fakultas: Nama Program Studi/Fakultas</div>
