...
<body>
    ...
    <table class="header-table">
        <tr>
            <td style="width: 25%; text-align: center;">
                <img src="{{ public_path('images/logo.png') }}" alt="Logo" width="80"><br>
            ...
            <td style="width: 25%;">
                Kode/No : UNIB/SPMI/STD.D-F-09<br>
                Tanggal : 5 Mei 2025<br>
                Revisi : 0<br>
    ...
    <div class="section">Telah/tidak dapat melaksanakan Audit Mutu Internal (AMI):</div>

    <table class="header-table" style="width: 100%; border: 1px solid #000; border-collapse: collapse; margin-bottom: 20px;">
        <tr>
            <td rowspan="2" style="width: 20%; border: 1px solid #000; text-align: center;">
                <img src="{{ public_path('images/logo.png') }}" alt="Logo" width="90"><br>
            </td>
            <td style="width: 40%; border: 1px solid #000; text-align: center; font-weight: bold;">
                UNIVERSITAS<br>BENGKULU
            </td>
    ...
    <table class="ttd">
        ...
        <tr>
            <td>(Prof. Dr. KAMALUDIN, S.E.,<br>M.M.)</td>
            <td>(x)</td>
        </tr>
    </table>
