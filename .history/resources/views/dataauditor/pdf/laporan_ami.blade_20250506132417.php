            ...
            <tbody>
                @foreach ($pengajuanAmis->ikssAuditee as $index => $ikssAuditee)
                    <tr>
                        ...
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">kelebihan }}</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">peluang_peningkatan }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
