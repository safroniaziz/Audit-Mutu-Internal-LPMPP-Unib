        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 70%;">Instrumen Indikator Kinerja</th>
                    <th style="text-align: center;">Pertanyaan</th>
                    <th style="text-align: center;">Hasil Observasi (Catatan Audit)</th>
                    <th style="text-align: center; width: 10%;">S</th> <!-- Diperlebar -->
                    <th style="text-align: center; width: 10%;">TS</th> <!-- Diperlebar -->
                    <th style="text-align: center; width: 15%;">Catatan</th> <!-- Diperlebar -->
                </tr>
            </thead>
            <tbody>
                <tr>
