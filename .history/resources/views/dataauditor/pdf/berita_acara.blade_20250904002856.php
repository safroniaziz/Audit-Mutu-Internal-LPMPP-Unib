...
<body>
    ...
    <div class="document-container">
        <table class="header-table" style="margin-top: 0;">
            ...
            <tr>
                <td class="info-cell">
                    <strong>Tanggal:</strong> {{ now()->isoFormat('D MMMM Y') }} WIB
                </td>
            </tr>
            <tr>
                ...
                <td class="info-cell">
                    <strong>Siklus:</strong> {{ $periode->siklus ?? 'N/A' }}
                </td>
            </tr>
            <tr>
        ...
        <div class="header">
            ...
            <p>{{ $periode->nomor_surat ?? 'UNIB/SPMI/STD.D-F-09' }}</p>
            @if($periode && $periode->tahun_ami)
                <p style="font-size: 14px; margin-top: 5px; color: #666;">Tahun AMI: {{ $periode->tahun_ami }}</p>
            @endif
        </div>

        <!-- Deskripsi -->
        <div class="section">
            Dengan ini dinyatakan bahwa pada tanggal <strong>{{ now()->isoFormat('D MMMM Y') }}</strong>, telah dilaksanakan Audit Mutu Internal (AMI) oleh:
        </div>
        ...
        <div class="footer">
            <p>Dibuat pada {{ now()->isoFormat('dddd, D MMMM Y HH:mm') }} WIB</p>
