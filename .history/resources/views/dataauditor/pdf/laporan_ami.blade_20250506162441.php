        ...
        <table class="pendahuluan" style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 12px; margin-top:10px;">
            <tbody>
                <tr>
                    ...
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" colspan="4">PTK ({{  }})</td>
                </tr>
                <tr>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">2</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" colspan="4">Pemantauan PTK ({{  }})</td>
                </tr>
                <tr>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">3</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" colspan="4">Rekap Data EDPS ({{  }})</td>
                </tr>
                <tr>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;">4</td>
                    <td style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 6px;" colspan="4">Daftar Hadir ({{  }})</td>
                </tr>
            </tbody>
        </table>
