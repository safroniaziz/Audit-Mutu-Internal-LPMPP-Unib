            ...
            <thead>
                ...
                <thead>
                    <tr>
                        ...
                        <th style="padding: 10px; border: 1px solid #ddd;">Kode IKSS</th>
                        <th style="padding: 10px; border: 1px solid #ddd;">Indikator</th>

                        {{-- Looping Ketua --}}
                        @php
                            $nilaiKetua = $pengajuanAmis->auditors->firstWhere('pivot.role', 'ketua');
                            $nilaiAnggota = $pengajuanAmis->auditors->firstWhere('pivot.role', 'pendamping');
                        @endphp

                        <th style="padding: 10px; border: 1px solid #ddd;">
                            {{ $nilaiKetua?->name ?? 'Ketua' }}
                        </th>
                        <th style="padding: 10px; border: 1px solid #ddd;">
                            {{ $nilaiAnggota?->name ?? 'Anggota' }}
                        </th>

                        <th style="padding: 10px; border: 1px solid #ddd;">Total</th>
                        <th style="padding: 10px; border: 1px solid #ddd;">Rata-rata</th>
                    </tr>
                </thead>
                ...
                @foreach ($pengajuanAmis->ikssAuditee as $index => $ikssAuditee)
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px; border: 1px solid #ddd; text-align:center;">
                            @if($nilaiKetua)
                                {{ $nilaiKetua->auditor->name }}<br>
                                <strong>Nilai:</strong> {{ $nilaiKetua->nilai }}
                            @endif
                        </td>
                        ...
                        <td style="padding: 10px; border: 1px solid #ddd; text-align:center;">
                            @if($nilaiAnggota)
                                {{ $nilaiAnggota->auditor->name }}<br>
                                <strong>Nilai:</strong> {{ $nilaiAnggota->nilai }}
                            @endif
                        </td>
