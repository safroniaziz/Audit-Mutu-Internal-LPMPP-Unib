...
<body>
    ...
    <div class="document-container">
        ...
        <table class="lingkupAudit" style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            <thead>
                <tr>
                    <th style="padding: 3px 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px;font-family: 'Roboto', sans-serif !important;color:white; font-weight: bold;">No</th>
                    <th style="padding: 3px 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px;font-family: 'Roboto', sans-serif !important;color:white; font-weight: bold;">Tujuan Audit</th>
                </tr>
            </thead>
            <tbody>
