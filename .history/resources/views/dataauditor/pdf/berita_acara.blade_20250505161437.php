...
<body>
    ...
    <table class="bordered header-table" style="margin-bottom: 25px;">
        <tr>
            <img src="{{ public_path('assets/src/images/logo_unib.png') }}" ... >
            <td rowspan="4" style="width: 20%; vertical-align: middle; text-align: center;">
                <img src="' . public_path('assets/src/images/logo_unib.png') . '" alt="Logo" class="logo">
            </td>
            <td rowspan="2" style="width: 40%; vertical-align: middle; text-align: center;">
                UNIVERSITAS<br>BENGKULU
            </td>
            <td style="width: 40%; text-align: left; font-weight: normal; height: 40px;">
                Kode/No : UNIB/<br>SPMI/STD.D-F-09
            </td>
        </tr>
        <tr>
            <td style="text-align: left; font-weight: normal; height: 40px;">
                Tanggal : 5 Mei 2025
            </td>
        </tr>
        <tr>
    ...
    <table class="details-table">
        ...
        <tr>
            <td colspan="2" class="highlight"><strong>&nbsp;Telah melaksanakan Audit Mutu Internal (AMI):</strong></td>
        </tr>
        <tr class="separator">
            <td colspan="2"></td>
        </tr>
