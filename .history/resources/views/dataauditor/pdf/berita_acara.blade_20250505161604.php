    ...
    <table class="bordered header-table" style="margin-bottom: 25px; border-collapse: collapse; width: 100%;">
        <tr>
            <td rowspan="4" style="width: 20%; vertical-align: middle; text-align: center; border: 1px solid #ddd; padding: 5px;">
                <img src="{{ public_path('assets/src/images/logo_unib.png') }}" alt="Logo" class="logo" style="max-width: 100px; max-height: 50px;">
            </td>
            ...
            <td style="width: 40%; text-align: left; font-weight: normal; height: 40px; border: 1px solid #ddd; padding: 5px;">
                Kode/No : UNIB/<br>SPMI/STD.D-F-09
            </td>
        </tr>
        <tr>
            <td style="text-align: left; font-weight: normal; height: 40px; border: 1px solid #ddd; padding: 5px;">
                Tanggal : 5 Mei 2025
            </td>
        </tr>
        <tr>
