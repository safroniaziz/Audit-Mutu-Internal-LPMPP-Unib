...
<body>
    ...
    <div class="header">
        ...
        <p>Senin, 05 Mei 2025 09:00 - 11:00</p>
    </div>

    <div class="section-title">Detail Rapat</div>
    <table>
        <tr>
            <th>Nama Rapat</th>
            <td>Rapat Evaluasi Proyek Semester I</td>
        </tr>
        <tr>
            <th>Tempat Rapat</th>
            <td>Ruang Sidang Utama, Gedung A</td>
        </tr>
        <tr>
            <th>Pembahasan</th>
            <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer non feugiat urna.</td>
        </tr>
    </table>

    <div class="section-title">Anggota Rapat</div>
    <table>
        <thead>
            <tr>
                <th>No</th>
