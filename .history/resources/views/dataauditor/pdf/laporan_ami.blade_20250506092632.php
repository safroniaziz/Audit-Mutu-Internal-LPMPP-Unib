...
<body>
    ...
    <div class="document-container">
        ...
        <div class="section-title">3. LINGKUP AUDIT</div>
        ...
        <table class="lingkupAudit" style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            <thead>
                <tr>
                    <th style="padding: 8px 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px;font-family: 'Roboto', sans-serif !important;color:white; font-weight: bold;">No</th>
                    <th style="padding: 8px 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px;font-family: 'Roboto', sans-serif !important;color:white; font-weight: bold;">Tujuan Audit</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($lingkupAudits as $index => $lingkupAudit)
                    <tr>
                        <td style="padding: 3px 10px; border: 1px solid #ddd; text-align: left;">{{ $index + 1 }}</td>
                        <td style="padding: 3px 10px; border: 1px solid #ddd; text-align: left;">{{ $lingkupAudit->lingkup_audit }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
