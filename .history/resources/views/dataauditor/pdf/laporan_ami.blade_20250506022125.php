        ...
        <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 12px; margin-top:10px;">
            <tbody>
                <tr style="background-color: #f8f8f8;">
                    <td style="width: 20%; border: 1px solid #ccc; padding: 6px;">Fakultas</td>
                    <td style="width: 2%; border: 1px solid #ccc; padding: 6px;">:</td>
                    <td style="border: 1px solid #ccc; padding: 6px;" colspan="4">Keguruan dan Ilmu Pendidikan</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #ccc; padding: 6px;">Program Studi</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">:</td>
                    <td style="border: 1px solid #ccc; padding: 6px;" colspan="4">Keguruan dan Ilmu Pendidikan</td>
                </tr>
                <tr style="background-color: #f8f8f8;">
                    <td style="border: 1px solid #ccc; padding: 6px;">Alamat</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">:</td>
                    <td style="border: 1px solid #ccc; padding: 6px;" colspan="4">-</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #ccc; padding: 6px;">Ketua Program Studi</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">:</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">Nama Ketua Prodi</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">Telp</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">:</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">097878786756</td>
                </tr>
                <tr style="background-color: #f8f8f8;">
                    <td style="border: 1px solid #ccc; padding: 6px;">Tanggal Audit</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">:</td>
                    <td style="border: 1px solid #ccc; padding: 6px;" colspan="4">6 Mei 2025</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #ccc; padding: 6px;" rowspan="2">Ketua Auditor</td>
                    <td style="border: 1px solid #ccc; padding: 6px;" rowspan="2">:</td>
                    <td style="border: 1px solid #ccc; padding: 6px;" rowspan="2">Ir. BAMBANG SUMANTRI, M.Si.</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">Fakultas/Prodi</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">:</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">Nama Prodi</td>
                </tr>
                <tr style="background-color: #f8f8f8;">
                    <td style="border: 1px solid #ccc; padding: 6px;">Telp</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">:</td>
                ...
                <tr>
                    <td style="border: 1px solid #ccc; padding: 6px;">Tanda Tangan Ketua Auditor</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">:</td>
                    <td style="border: 1px solid #ccc; padding: 20px;"></td>
                    <td style="border: 1px solid #ccc; padding: 6px;">Tanda Tangan Kaprodi</td>
                    <td style="border: 1px solid #ccc; padding: 6px;">:</td>
                    <td style="border: 1px solid #ccc; padding: 20px;"></td>
                </tr>
            </tbody>
