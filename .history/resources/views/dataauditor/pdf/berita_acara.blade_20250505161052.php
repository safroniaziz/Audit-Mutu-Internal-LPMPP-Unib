...
<body>
    ...
    <table class="bordered header-table" style="margin-bottom: 25px;">
        <tr>
            <td rowspan="2" style="width: 20%; vertical-align: middle; text-align: center;">
                <img src="{{ asset('assets/src/images/logo_unib.png') }}" alt="Logo" class="logo">
            </td>
            <td rowspan="2" style="width: 40%; vertical-align: middle; text-align: center; font-weight: bold;">
                UNIVERSITAS<br>BENGKULU
            </td>
            <td style="width: 40%; font-weight: normal;">Kode/No : UNIB/<br>SPMI/STD.D-F-09</td>
        </tr>
        <tr>
            <td style="font-weight: normal;">Tanggal : 5 Mei 2025</td>
        </tr>
        <tr>
            ...
            <td style="font-weight: normal;">Revisi : 0</td>
        </tr>
        <tr>
            <td style="font-weight: bold;">Berita Acara Audit Mutu Internal</td>
        </tr>
    </table>
