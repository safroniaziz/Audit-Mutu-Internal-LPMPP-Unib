...
<body>
    ...
    <div class="document-container">
        ...
        @php
            ...
            $ssUrl = $qcBase . '?width=800&height=600&backgroundColor=white&c=' . urlencode(json_encode($ssConfig, JSON_UNESCAPED_SLASHES));
        @endphp
        @if(!empty($ssLabels))
        ...
        @php
            ...
            $qcBase = 'https://quickchart.io/chart';
            $prodiUrl = $qcBase . '?width=800&height=600&backgroundColor=white&c=' . urlencode(json_encode($prodiConfig, JSON_UNESCAPED_SLASHES));
        @endphp
