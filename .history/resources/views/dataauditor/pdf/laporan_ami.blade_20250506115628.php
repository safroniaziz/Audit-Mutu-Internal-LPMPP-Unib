        ...
        <table class="tujuanAudit" style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            <thead>
                <tr>
                    ...
                    <th style="padding: 10px; border: 1px solid #ddd; text-align: left; background-color: #00447c; font-size:12px; font-family: 'Roboto', sans-serif !important; color:white; font-weight: bold;">Kegiatan Audit
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td style="padding: 10px; border: 1px solid #ddd; text-align: left;">Jam</td>
