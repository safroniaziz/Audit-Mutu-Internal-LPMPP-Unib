    ...
    foreach ($groupedData as $indikatorId => $indikatorData) {
        foreach ($indikatorData['kriterias'] as $kriteriaId => $kriteriaData) {
            foreach ($kriteriaData['instrumens'] as $instrumenProdi) {
                ...
                if ($instrumenProdi->nilaiAuditorForPengajuan && $instrumenProdi->nilaiAuditorForPengajuan->count() > 0) {
                    $completedInstrumen++;
                }
            }
        }
                                                        ...
                                                        <div class="card-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="nilai[{{ $instrumenProdi->id }}]" class="form-select" required>
                                                                    ...
                                                                    <option value="1" {{ ($instrumenProdi->nilaiAuditorForPengajuan && $instrumenProdi->nilaiAuditorForPengajuan->first() && $instrumenProdi->nilaiAuditorForPengajuan->first()->nilai == 1) ? 'selected' : '' }}>1 - Sangat Kurang</option>
                                                                    <option value="2" {{ ($instrumenProdi->nilaiAuditorForPengajuan && $instrumenProdi->nilaiAuditorForPengajuan->first() && $instrumenProdi->nilaiAuditorForPengajuan->first()->nilai == 2) ? 'selected' : '' }}>2 - Kurang</option>
                                                                    <option value="3" {{ ($instrumenProdi->nilaiAuditorForPengajuan && $instrumenProdi->nilaiAuditorForPengajuan->first() && $instrumenProdi->nilaiAuditorForPengajuan->first()->nilai == 3) ? 'selected' : '' }}>3 - Baik</option>
                                                                    <option value="4" {{ ($instrumenProdi->nilaiAuditorForPengajuan && $instrumenProdi->nilaiAuditorForPengajuan->first() && $instrumenProdi->nilaiAuditorForPengajuan->first()->nilai == 4) ? 'selected' : '' }}>4 - Sangat Baik</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label fw-semibold">Catatan (Opsional)</label>
                                                                <textarea name="catatan[{{ $instrumenProdi->id }}]" class="form-control" rows="3" placeholder="Tambahkan catatan jika diperlukan...">{{ $instrumenProdi->nilaiAuditorForPengajuan && $instrumenProdi->nilaiAuditorForPengajuan->first() ? $instrumenProdi->nilaiAuditorForPengajuan->first()->catatan : '' }}</textarea>
                                                            </div>
