                                    ...
                                    <table class="table table-hover align-middle table-row-dashed fs-6 gy-4 mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="border-bottom border-gray-200 hover-bg-light">
                                                ...
                                                <td class="text-end pe-4">
                                                    <a href="{{ route('auditor.audit.daftarPertanyaan') }}" class="btn btn-sm btn-primary px-4">
                                                        <i class="fas fa-print me-2"></i> Cetak
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr class="hover-bg-light">
                                                ...
                                                <td class="text-end pe-4">
                                                    <a href="{{ route('auditor.audit.laporanAmi') }}" class="btn btn-sm btn-primary px-4">
                                                        <i class="fas fa-print me-2"></i> Cetak
                                                    </a>
                                                </td>
                                            </tr>
    ...
    <div class="modal fade" id="beritaAcaraModal" tabindex="-1" aria-labelledby="beritaAcaraModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('auditor.audit.beritaAcara') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="evaluasiAmiModal" tabindex="-1" aria-labelledby="evaluasiAmiModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('auditor.audit.evaluasiAmi') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-4">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Evaluasi AMI Form
        const evaluasiAmiForm = document.querySelector('#evaluasiAmiModal form');
        if (evaluasiAmiForm) {
