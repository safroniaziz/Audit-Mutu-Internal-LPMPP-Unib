        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form id="evaluasiAmiForm" action="{{ route('auditor.audit.evaluasiAmi',[$pengajuan->id]) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-4">
                            <div class="alert alert-light-info d-flex flex-column p-5 mb-10">
                                <div class="d-flex align-items-center border-bottom border-info pb-5 mb-5">
                                    <i class="fas fa-info-circle fs-2x text-info me-4"></i>
                                    <h4 class="text-dark fw-bold m-0">Nilai Tingkat Kesuksesan</h4>
                                </div>
                                <div class="d-flex flex-wrap gap-5 justify-content-center">
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-circle badge-lg bg-success me-2">4</span>
                                        <span class="fw-semibold">Sangat sesuai</span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-circle badge-lg bg-primary me-2">3</span>
                                        <span class="fw-semibold">Sesuai</span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-circle badge-lg bg-warning me-2">2</span>
                                        <span class="fw-semibold">Kurang sesuai</span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span class="badge badge-circle badge-lg bg-danger me-2">1</span>
                                        <span class="fw-semibold">Tidak sesuai</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            @foreach($evaluasis as $evaluasi)
                                @if($evaluasi->is_nilai)
                                    <div class="mb-8 hover-elevate-up">
                                        <div class="d-flex align-items-center">
                                            <div class="d-flex align-items-center justify-content-center bg-light-primary rounded-circle w-35px h-35px me-3">
                                                <span class="text-primary fw-bold">{{ $questionNumber++ }}</span>
                                            </div>
                                            <label class="form-label fw-bold fs-6 text-dark mb-0">{{ $evaluasi->evaluasi }}</label>
                                        </div>
                                        <div class="ms-9 mt-3">
                                            <div class="d-flex gap-8">
                                                @for($i = 4; $i >= 1; $i--)
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label fw-semibold" for="nilai_{{ $evaluasi->id }}_{{ $i }}">
                                                            {{ $i }}
                                                        </label>
                                                    </div>
                                                @endfor
                                ...
                                @else
                                    ...
                                    <h4 class="fw-bolder mb-8 d-flex align-items-center text-dark">
                            ...
                            <div class="mb-8 hover-elevate-up">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center justify-content-center bg-light-success rounded-circle w-35px h-35px me-3">
                                        <span class="text-success fw-bold">1</span>
                                    </div>
                                    <label for="materi_instrumen" class="form-label fw-bold fs-6 text-dark mb-0">Materi/instrumen Audit:</label>
                                </div>
                                <div class="ms-9 mt-3">
                                    <textarea class="form-control form-control-solid" id="materi_instrumen" name="materi_instrumen" rows="3" placeholder="Tuliskan materi/instrumen audit disini..."></textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-8 hover-elevate-up">
                                <div class="d-flex align-items-center">
                                    ...
                                    <label for="pelaksanaan_audit" class="form-label fw-bold fs-6 text-dark mb-0">Pelaksanaan Audit:</label>
                                </div>
                                <div class="ms-9 mt-3">
                                    <textarea class="form-control form-control-solid" id="pelaksanaan_audit" name="pelaksanaan_audit" rows="3" placeholder="Tuliskan pelaksanaan audit disini..."></textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-8 hover-elevate-up">
                                <div class="d-flex align-items-center">
                                    ...
                                    <label for="saran_teraudit" class="form-label fw-bold fs-6 text-dark mb-0">Saran untuk teraudit:</label>
                                </div>
                                <div class="ms-9 mt-3">
                                    <textarea class="form-control form-control-solid" id="saran_teraudit" name="saran_teraudit" rows="3" placeholder="Tuliskan saran untuk teraudit disini..."></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        if (form) {
            form.addEventListener('submit', function(e) {
                ...
                for (const [name, isChecked] of Object.entries(radioGroups)) {
                    if (!isChecked) {
                        isValid = false;
                        const radioGroup = form.querySelector(`input[name="${name}"]`).closest('.content-box');
            ...
            form.querySelectorAll('input[type="radio"]').forEach(radio => {
                radio.addEventListener('change', function() {
                    ...
                    if (contentBox) {
                        contentBox.classList.remove('border-danger');
                    }
                });
            });
