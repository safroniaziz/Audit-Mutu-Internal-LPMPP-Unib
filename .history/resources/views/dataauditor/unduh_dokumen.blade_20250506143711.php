...
@section('dashboardProfile')
    ...
    <div class="modal fade" id="laporanAmiModal" tabindex="-1" aria-labelledby="laporanAmiModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg"> {{-- ditambahkan modal-lg biar muat --}}
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="laporanAmiModalLabel">Cetak Laporan Audit Mutu Internal</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('auditor.audit.laporanAmi', [$pengajuan->id]) }}" method="POST">
                    ...
                    <div class="modal-body">
                        {{-- Pertanyaan 1 --}}
                        <div class="mb-3">
                            <label class="form-label fw-bold">1. Sistem dokumentasi cukup lengkap dan terstruktur untuk mendukung pelaksanaan Sistem Penjaminan Mutu Internal.</label><br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="dokumentasi" value="Ya" required>
                                <label class="form-check-label">Ya</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="dokumentasi" value="Tidak">
                                <label class="form-check-label">Tidak</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="dokumentasi" value="Lainnya">
                        ...
                        {{-- Pertanyaan 2 --}}
                        <div class="mb-3">
                            <label class="form-label fw-bold">2. Program studi telah menjalankan Sistem Penjaminan Mutu Internal secara konsisten dan berkelanjutan.</label><br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="konsistensi" value="Ya" required>
                                <label class="form-check-label">Ya</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="konsistensi" value="Tidak">
                                <label class="form-check-label">Tidak</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="konsistensi" value="Lainnya">
                                <label class="form-check-label">Lainnya</label>
                            </div>
                        </div>
                        ...
                        {{-- Pertanyaan 3 --}}
                        <div class="mb-3">
                            <label class="form-label fw-bold">3. Temuan pada periode audit ini adalah:</label><br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="temuan" value="Mayor" required>
                                <label class="form-check-label">Mayor</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="temuan" value="Minor">
                                <label class="form-check-label">Minor</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="temuan" value="Observasi">
                        ...
                        {{-- Pertanyaan 4 --}}
                        <div class="mb-3">
                            <label class="form-label fw-bold">4. PTK pada temuan audit sebelumnya telah ditindak-lanjuti secara efektif.</label><br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ptk" value="Ya" required>
                                <label class="form-check-label">Ya</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ptk" value="Tidak">
                                <label class="form-check-label">Tidak</label>
                            </div>
                        </div>
                        ...
                        {{-- Pertanyaan 5 --}}
                        <div class="mb-3">
                            <label class="form-label fw-bold">5. Kaprodi menunjukkan komitmennya terhadap implementasi Sistem Penjaminan Mutu Internal untuk tercapainya kepuasan stakeholder.</label><br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="komitmen_kaprodi" value="Ya" required>
                                <label class="form-check-label">Ya</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="komitmen_kaprodi" value="Tidak">
                                <label class="form-check-label">Tidak</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="komitmen_kaprodi" value="Lainnya">
                                <label class="form-check-label">Lainnya</label>
                            </div>
                        </div>
                    </div>
