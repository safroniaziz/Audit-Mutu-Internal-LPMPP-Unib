...
@section('dashboardProfile')
    ...
    <!-- Modal Laporan AMI - Premium Professional Design -->
        ...
        <div class="modal-content" style="border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
            ...
            <form action="{{ route('auditor.audit.laporanAmi', [$pengajuan->id]) }}" method="POST">
                                            ...
                                            <div style="display: flex; gap: 15px;">
                                                @foreach ($item['opsi'] as $opsi)
                                                    <div class="form-check" style="margin: 0;">
                                                        ...
                                                        <label class="form-check-label" for="{{ $item['name'] }}_{{ $opsi }}" style="color: #212529; font-size: 0.9rem;">
                                                            {{ $opsi }}
                                                        </label>
                                                    </div>
                                                @endforeach
                ...
                <div class="modal-footer" style="background-color: #f8f9fa; border-top: 1px solid #dee2e6; padding: 0.75rem 1.5rem;">
                    <button type="button" class="btn btn-light" style="border: 1px solid #ced4da; font-size: 0.875rem; padding: 0.375rem 0.75rem;" data-bs-dismiss="modal">
                        Tutup
                    </button>
                    <button type="submit" class="btn btn-primary" style="font-size: 0.875rem; padding: 0.375rem 0.75rem;">
