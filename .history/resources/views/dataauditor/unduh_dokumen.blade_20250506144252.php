...
@section('dashboardProfile')
    ...
    <!-- Modal Laporan AMI dengan UX yang Diperbaiki -->
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('auditor.audit.laporanAmi', [$pengajuan->id]) }}" method="POST">
                @csrf
                <div class="modal-body">
                    <h6 class="border-bottom pb-2 mb-3">Evaluasi Sistem Penjaminan Mutu Internal</h6>
                    ...
                    <table class="table table-striped">
                        <tbody>
                            ...
                            @foreach ($pertanyaan as $index => $item)
                                <tr>
                                    <td class="fw-bold" width="5%">{{ $index + 1 }}.</td>
