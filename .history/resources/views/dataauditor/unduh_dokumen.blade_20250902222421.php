                ...
                <div class="card-body pt-0">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-6">
                                    ...
                                    @php
                                        ...
                                        $nilaiTertinggi = $evaluasiSubmissions->max('nilai');
                                        $nilaiTerendah = $evaluasiSubmissions->min('nilai');
                                    @endphp
                                    <div class="d-flex flex-column gap-3">
                                        <div class="d-flex justify-content-between">
                                            <span class="fs-7 text-muted">Rata-rata:</span>
                                            <span class="fw-bold text-primary">{{ $rataRata }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <span class="fs-7 text-muted">Tertinggi:</span>
                                            <span class="fw-bold text-success">{{ $nilaiTertinggi }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <span class="fs-7 text-muted">Terendah:</span>
                                            <span class="fw-bold text-danger">{{ $nilaiTerendah }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between">
                    ...
                    @else
                        <div class="alert alert-info text-center py-8">
                            ...
                            <p class="text-muted mb-0">Lakukan evaluasi terlebih dahulu untuk melihat jaring laba-laba nilai auditor.</p>
                        </div>
                    @endif
                </div>
            </div>
