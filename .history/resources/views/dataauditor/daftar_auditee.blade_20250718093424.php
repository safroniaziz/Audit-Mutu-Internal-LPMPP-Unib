                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5">
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-250px">Nama Auditee</th>
                                        <th class="min-w-180px">Tim Auditor</th>
                                        <th class="min-w-100px">Jenjang</th>
                                        <th class="min-w-180px">Status Audit</th>
                                ...
                                <tbody class="text-gray-600">
                                    @forelse($auditess as $index => $auditee)
                                        <tr class="{{ $auditee->audit_status['status'] === 'new' ? 'table-primary' : '' }}">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-28px me-2 flex-shrink-0">
                                                            <span class="symbol-label bg-light-warning">
                                                                <i class="fas fa-user-slash fs-2 text-warning"></i>
                                                            </span>
                                                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-start">
                                                    <div class="symbol symbol-32px me-2 flex-shrink-0">
