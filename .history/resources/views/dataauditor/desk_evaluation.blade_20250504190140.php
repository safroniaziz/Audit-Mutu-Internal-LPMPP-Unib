                        ...
                        @if($deskEvaluation->isNotEmpty())
                            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <div class="fw-bold">
                                        <h4 class="text-gray-900 fw-bolder">Desk Evaluation sudah selesai</h4>
                                        <div class="fs-6 text-gray-700">Silahkan Klik Tombol Setujui, sehingga anda dapat lanjut ke tahap visitasi.</div>
                                    </div>
                                </div>
                            </div>
                        @else
