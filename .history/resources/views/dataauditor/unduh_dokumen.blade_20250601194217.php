                    ...
                    <div class="modal-body">
                                        ...
                                        <div class="mb-4 ms-4">
                                            <div class="position-relative">
                                                <div class="position-absolute" style="left: -2.5rem; top: 0;">
                                                    <div class="d-flex align-items-center justify-content-center rounded-circle bg-primary text-white" style="width: 24px; height: 24px; font-size: 12px;">
                                                        {{ $questionNumber++ }}
                                                    </div>
                                                </div>
                                                <div class="evaluation-content bg-white p-4 rounded-3 shadow-sm border border-gray-200">
                                                    ...
                                                    <div class="d-flex gap-5 mt-3">
                                                        @for($i = 1; $i <= 4; $i++)
                                                            <div class="form-check custom-option">
                                                                ...
                                                                <label class="form-check-label rounded-2 px-3 py-2" for="nilai_{{ $evaluasi->id }}_{{ $i }}"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-4 ms-4">
                                <div class="position-relative">
                                    <div class="position-absolute" style="left: -2.5rem; top: 0;">
                                        <div class="d-flex align-items-center justify-content-center rounded-circle bg-success text-white" style="width: 24px; height: 24px; font-size: 12px;">
                                            1
                                        </div>
                                    </div>
                                    <div class="input-group-content bg-white p-4 rounded-3 shadow-sm border border-gray-200">
