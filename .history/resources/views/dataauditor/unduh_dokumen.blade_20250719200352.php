                ...
                <div class="d-flex flex-stack mb-5">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column">
                            <h2 class="mb-1 text-dark fw-bold">Unduh Dokumen</h2>
                    ...
                    <div class="d-flex gap-3">
                        <a href="{{ route('auditor.audit.penilaianInstrumenProdi', $pengajuan->id) }}" class="btn btn-light-primary">
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <button type="button" class="btn btn-sm btn-primary px-4" data-bs-toggle="modal" data-bs-target="#evaluasiAmiModal">
                                    <i class="fas fa-edit me-2"></i> {{ $evaluasiSubmissions->count() > 0 ? 'Update' : 'Isi' }}
                                </button>
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <button type="button" class="btn btn-sm btn-primary px-4" data-bs-toggle="modal" data-bs-target="#laporanAmiModal">
                                    <i class="fas fa-edit me-2"></i> {{ $jawabanKuisioner->count() > 0 ? 'Update' : 'Isi' }}
                                </button>
