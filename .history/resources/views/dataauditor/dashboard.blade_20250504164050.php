...
@section('dashboardProfile')
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <!--begin::Card header-->
        <!--begin::Card body-->
        <form id="kt_account_profile_details_form_edit" action="{{ route('auditor.lengkapiProfil') }}" class="form" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#kt_account_profile_details_form_edit').submit(function(event) {
