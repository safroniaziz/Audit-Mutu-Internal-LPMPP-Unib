                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="fakultas" class="form-control form-control-lg form-control" disabled placeholder="Nama Fakultas" value="{{ Auth::user()->unitKerja && Auth::user()->unitKerja->fakultas ? Auth::user()->unitKerja->fakultas : '-' }}" />
                            </div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="nama_ketua" class="form-control form-control-lg form-control" disabled placeholder="Nama Ketua" value="{{ Auth::user()->unitKerja->nama_ketua }}" />
                            </div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="nip_ketua" class="form-control form-control-lg form-control" disabled placeholder="NIP Ketua" value="{{ Auth::user()->unitKerja->nip_ketua }}" />
                            </div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select name="jenjang" aria-label="pilih jenjang" disabled data-control="select2" data-placeholder="Pilih Jenjang..." class="form-select form-select form-select-lg fw-semibold">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="website" class="form-control form-control-lg form-control" disabled placeholder="Website" value="{{ Auth::user()->unitKerja->website }}" />
                            </div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="email" name="email" class="form-control form-control-lg form-control" disabled placeholder="E-mail" value="{{ Auth::user()->email }}" />
                            </div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="no_hp" class="form-control form-control-lg form-control" disabled placeholder="No HP" value="{{ Auth::user()->unitKerja->no_hp }}" />
                            </div>
                        </div>
                        <!--end::Input group-->
                    </div>
