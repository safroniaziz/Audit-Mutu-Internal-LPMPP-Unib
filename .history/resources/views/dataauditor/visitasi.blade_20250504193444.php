                                                ...
                                                <div class="instrument-container mb-4 {{ $index > 0 ? 'mt-5 pt-4 border-top' : '' }}">
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="mt-3">
                                                            ...
                                                            <textarea rows="2" class="form-control" name="deskripsi[{{ $ikssAuditee->id }}]" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $visitasi[$ikssAuditee->id]->ketidak_sesuaian : '' }}</textarea>
                                                        </div>
                                                        <div class="mt-3">
                                                            <h6>Pernyataan</h6>
                                                            <textarea rows="2" class="form-control" name="pertanyaan[{{ $ikssAuditee->id }}]" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $visitasi[$ikssAuditee->id]->pernyataan : '' }}</textarea>
                                                        </div>

                                                        <div class="mt-3">
                                                            <h6>Kelebihan</h6>
                                                            <textarea rows="2" class="form-control" name="pertanyaan[{{ $ikssAuditee->id }}]" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $visitasi[$ikssAuditee->id]->kelebihan : '' }}</textarea>
                                                        </div>

                                                        <div class="mt-3">
                                                            <h6>Peluang Peningkatan</h6>
                                                            <textarea rows="2" class="form-control" name="pertanyaan[{{ $ikssAuditee->id }}]" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $visitasi[$ikssAuditee->id]->peluang_peningkatan : '' }}</textarea>
                                                        </div>
