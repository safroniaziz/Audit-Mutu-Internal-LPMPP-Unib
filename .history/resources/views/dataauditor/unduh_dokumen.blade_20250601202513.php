                        ...
                        <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-45px me-5">
                                            <span class="symbol-label bg-info">
                                                <i class="fas fa-info-circle text-inverse-info fs-1"></i>
                                            </span>
                                        </div>
                                ...
                                <div class="card-body py-5">
                                    <div class="row g-5 g-xl-8">
                                        <div class="col-xl-3 col-sm-6">
                                            <div class="bg-white px-6 py-8 rounded-2 shadow-sm">
                                                <span class="text-success fs-1 d-block my-2 fw-bold">4</span>
                                                <span class="fw-semibold fs-6">Sangat sesuai</span>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-sm-6">
                                            <div class="bg-white px-6 py-8 rounded-2 shadow-sm">
                                                <span class="text-primary fs-1 d-block my-2 fw-bold">3</span>
                                                <span class="fw-semibold fs-6">Sesuai</span>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-sm-6">
                                            <div class="bg-white px-6 py-8 rounded-2 shadow-sm">
                                                <span class="text-warning fs-1 d-block my-2 fw-bold">2</span>
                                                <span class="fw-semibold fs-6">Kurang sesuai</span>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-sm-6">
                                            <div class="bg-white px-6 py-8 rounded-2 shadow-sm">
                                                <span class="text-danger fs-1 d-block my-2 fw-bold">1</span>
                                                <span class="fw-semibold fs-6">Tidak sesuai</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="ms-12">
                                                <div class="row g-4">
                                                    @for($i = 4; $i >= 1; $i--)
                                                        <div class="col-xl-3 col-sm-6">
                                                            <label class="btn btn-outline btn-outline-dashed btn-outline-default d-flex text-start p-6 h-100 {{ isset($evaluasiSubmissions[$evaluasi->id]) && $evaluasiSubmissions[$evaluasi->id]->nilai == $i ? 'active' : '' }}" for="nilai_{{ $evaluasi->id }}_{{ $i }}">
                                                                ...
                                                                <span class="ms-5">
                                                                    <span class="fs-2 fw-bolder text-dark d-block">{{ $i }}</span>
                            ...
                            <div class="card card-bordered shadow-sm mb-8 hover-elevate-up">
                                <div class="card-body">
                                    ...
                                    <div class="ms-12">
                                        <textarea class="form-control form-control-lg form-control-solid" id="materi_instrumen" name="materi_instrumen" rows="3" placeholder="Tuliskan materi/instrumen audit disini..."></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-bordered shadow-sm mb-8 hover-elevate-up">
                                <div class="card-body">
                                    ...
                                    <div class="ms-12">
                                        <textarea class="form-control form-control-lg form-control-solid" id="pelaksanaan_audit" name="pelaksanaan_audit" rows="3" placeholder="Tuliskan pelaksanaan audit disini..."></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-bordered shadow-sm mb-8 hover-elevate-up">
                                <div class="card-body">
                                    ...
                                    <div class="ms-12">
                                        <textarea class="form-control form-control-lg form-control-solid" id="saran_teraudit" name="saran_teraudit" rows="3" placeholder="Tuliskan saran untuk teraudit disini..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<style>
    ...
    .btn.btn-outline.btn-outline-dashed:hover:not(.active) {
    ...
    .form-control-lg.form-control-solid:focus {
