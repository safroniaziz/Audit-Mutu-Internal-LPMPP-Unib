                ...
                <div class="ms-auto">
                    @foreach($pengajuan->auditors as $penugasan)
                        @if($penugasan->role == 'ketua' && $penugasan->user_id == Auth::id())
                            @if($isAllCompleted)
                                @if(isset($pengajuan->penilaian_prodi_approved) && $pengajuan->penilaian_prodi_approved)
                                    <a href="{{ route('auditor.audit.dashboard', $pengajuan->id) }}" class="btn btn-sm px-4 btn-success">
                                        <i class="fas fa-arrow-right me-2"></i> Lanjut ke Dashboard
                                    </a>
                                @else
