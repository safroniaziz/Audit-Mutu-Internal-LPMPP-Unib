                    ...
                    <div class="row">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="nama_ketua" class="form-control form-control-lg form-control-solid" placeholder="Nama Prodi" value="{{ Auth::user()->unitKerja->nama_unit_kerja }}" />
                            </div>
                        </div>
