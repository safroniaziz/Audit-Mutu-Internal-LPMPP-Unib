                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        @forelse ($auditee->auditors as $auditor)
                                            @php
                                                ...
                                                // Auditor is considered completed if they have submitted both evaluasi and masukan
                                                // OR if they have completed all stages (desk evaluation, visitasi, evaluasi, masukan)
