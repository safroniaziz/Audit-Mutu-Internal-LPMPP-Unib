                                        ...
                                        <div class="card-body">
                                            <div class="mb-5">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="mt-3">
                                                        <h6>Penilaian Auditor</h6>
                                                        <textarea class="form-control" name="penilaian_akar[{{ $ikssAuditee->id }}]" rows="4" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $deskEvaluation[$ikssAuditee->id]->nilai : '' }}</textarea>
                                                    </div>
