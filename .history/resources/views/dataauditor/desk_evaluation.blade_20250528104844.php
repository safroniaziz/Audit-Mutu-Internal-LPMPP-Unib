                ...
                <div class="alert {{ $allCompleted ? 'alert-success' : 'alert-danger' }} d-flex align-items-start p-5 mb-10">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="fs-6 text-gray-700">
                            ...
                            <div class="mt-4">
                                <div class="fw-semibold text-gray-600">Progress Evaluasi:</div>
                                <div class="d-flex align-items-center mt-2">
                                    <div class="flex-grow-1 bg-light-primary rounded h-6px me-3">
                                        <div class="bg-{{ $allCompleted ? 'success' : 'primary' }} rounded h-6px" role="progressbar"
                                    ...
                                    <span class="fw-semibold text-gray-700">{{ number_format($progressPercentage, 1) }}%</span>
                                </div>
                            </div>
                        </div>
                    </div>
