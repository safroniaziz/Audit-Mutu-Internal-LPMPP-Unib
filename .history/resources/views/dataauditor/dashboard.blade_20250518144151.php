...
@push('styles')
    <style>
        ...
        .document-card:hover {
            ...
            box-shadow: 0 0.5rem 1.5rem rgba(0, 120, 250, 0.1) !important;
        }
...
<div class="row g-5 g-xl-8">
    ...
    <div class="col-xl-12">
        <!--begin::Alert-->
        <div class="alert alert-info d-flex align-items-center p-5 mb-5 border-0 border-start border-5 border-primary">
            <div class="me-4">
                ...
                <div class="fs-6 text-gray-700">
                    <p class="mt-4">
                        ...
                        <span class="fw-semibold text-primary">
                            Silakan lanjutkan dengan melaksanakan audit sesuai penugasan yang telah diberikan.
                        </span>
                    </p>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row g-5">
                    <!--begin::Document Item-->
                    <div class="col-md-6">
                        <div class="card overlay overflow-hidden shadow-sm h-100 document-card">
                            <div class="card-body p-0">
                                <div class="overlay-wrapper">
                                    <img src="assets/media/svg/files/pdf.svg" class="card-img-top w-100 bg-light p-8" alt="PDF" style="height: 120px; object-fit: contain;">
                                </div>
                                <div class="overlay-layer bg-dark bg-opacity-25 d-none">
                                    <div class="d-flex flex-column align-items-center justify-content-center h-100">
                                        <a href="#" class="btn btn-sm btn-icon btn-white btn-download" data-file="panduan-audit.pdf">
                            ...
                            <div class="card-footer bg-light p-4">
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-muted fs-7">PDF • 2.4 MB • 20 Apr 2024</span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <span class="badge badge-light-danger">Dokumen Wajib</span>
                                    <a href="#" class="btn btn-sm btn-icon btn-light-primary btn-active-primary btn-download" data-file="panduan-audit.pdf">
                    ...
                    <div class="col-md-6">
                        <div class="card overlay overflow-hidden shadow-sm h-100 document-card">
                            <div class="card-body p-0">
                                <div class="overlay-wrapper">
                                    <img src="assets/media/svg/files/excel.svg" class="card-img-top w-100 bg-light p-8" alt="Excel" style="height: 120px; object-fit: contain;">
                                </div>
                                <div class="overlay-layer bg-dark bg-opacity-25 d-none">
                                    <div class="d-flex flex-column align-items-center justify-content-center h-100">
                                        <a href="#" class="btn btn-sm btn-icon btn-white btn-download" data-file="template-audit.xlsx">
                                            <i class="bi bi-download fs-2 text-primary"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer bg-light p-4">
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-muted fs-7">XLSX • 1.8 MB • 15 Apr 2024</span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <span class="badge badge-light-success">Versi Terbaru</span>
                                    <a href="#" class="btn btn-sm btn-icon btn-light-primary btn-active-primary btn-download" data-file="template-audit.xlsx">
                                        <i class="bi bi-download fs-4"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card overlay overflow-hidden shadow-sm h-100 document-card">
                            <div class="card-body p-0">
                                <div class="overlay-wrapper">
                                    <img src="assets/media/svg/files/doc.svg" class="card-img-top w-100 bg-light p-8" alt="Word" style="height: 120px; object-fit: contain;">
                                </div>
                                <div class="overlay-layer bg-dark bg-opacity-25 d-none">
                                    <div class="d-flex flex-column align-items-center justify-content-center h-100">
                                        <a href="#" class="btn btn-sm btn-icon btn-white btn-download" data-file="sop-audit.docx">
                                            <i class="bi bi-download fs-2 text-primary"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer bg-light p-4">
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-muted fs-7">DOCX • 3.2 MB • 10 Apr 2024</span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <span class="badge badge-light-primary">Update 2024</span>
                                    <a href="#" class="btn btn-sm btn-icon btn-light-primary btn-active-primary btn-download" data-file="sop-audit.docx">
                                        <i class="bi bi-download fs-4"></i>
                                    </a>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Tambahan untuk efek hover pada card dokumen
            ...
            // Download functionality (yang sudah ada)
        });
