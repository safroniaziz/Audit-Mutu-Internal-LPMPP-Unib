...
<div class="row g-5 g-xl-8">
    ...
    <div class="card overlay overflow-hidden shadow-sm h-100 document-card position-relative">
        <!-- Optional: Badge kategori atau status -->
        <div class="position-absolute top-0 start-0 m-3">
            <span class="badge bg-primary">#AMI</span>
        </div>

        <div class="card-body p-0">
            <!-- BAGIAN ATAS - LEBIH INFORMATIF -->
            <div class="overlay-wrapper bg-light d-flex flex-column align-items-center justify-content-center text-center px-3 py-4" style="height: 140px;">
                <i class="bi bi-file-earmark-pdf text-danger" style="font-size: 3.5rem;"></i>
                <div class="mt-2">
                    <span class="fw-semibold text-dark">Panduan Audit 2024</span>
                </div>
                <div class="text-muted fs-7">PDF • 2.4 MB</div>
            </div>
        ...
        <div class="card-footer bg-light p-4">
            <div class="d-flex flex-column">
                ...
                <span class="text-muted fs-7">20 Apr 2024</span>
            </div>
