                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @endif
                                                                @if($ikssAuditee->url_sumber)
                                                                    <div class="mb-2">
                                                                        <a href="{{ $ikssAuditee->url_sumber }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                                                            <i class="fas fa-link"></i> Lihat URL Sumber
                                                                        </a>
                                                                    </div>
                                                                @endif
                                                            </td>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <select class="form-select @error('nilai.'.$ikssAuditee->id) is-invalid @enderror"
                                                        ...
                                                        <option value="0" {{ ($hasEvaluation && $deskEvaluation[$ikssAuditee->id]->nilai == '0') || old('nilai.'.$ikssAuditee->id) == '0' ? 'selected' : '' }}>0 - Tidak Ada</option>
                                                        <option value="1" {{ ($hasEvaluation && $deskEvaluation[$ikssAuditee->id]->nilai == '1') || old('nilai.'.$ikssAuditee->id) == '1' ? 'selected' : '' }}>1 - Kurang</option>
                                                        <option value="2" {{ ($hasEvaluation && $deskEvaluation[$ikssAuditee->id]->nilai == '2') || old('nilai.'.$ikssAuditee->id) == '2' ? 'selected' : '' }}>2 - Cukup</option>
                                                        <option value="3" {{ ($hasEvaluation && $deskEvaluation[$ikssAuditee->id]->nilai == '3') || old('nilai.'.$ikssAuditee->id) == '3' ? 'selected' : '' }}>3 - Baik</option>
                                                        <option value="4" {{ ($hasEvaluation && $deskEvaluation[$ikssAuditee->id]->nilai == '4') || old('nilai.'.$ikssAuditee->id) == '4' ? 'selected' : '' }}>4 - Sangat Baik</option>
                                                    </select>
