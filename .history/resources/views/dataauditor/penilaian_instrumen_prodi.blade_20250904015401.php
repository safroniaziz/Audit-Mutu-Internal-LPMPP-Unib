                ...
                $completedKriteriaInstrumen = 0;
                            ...
                            if (isset($indikatorData2['kriterias'][$kriteriaId])) {
                                ...
                                foreach ($indikatorData2['kriterias'][$kriteriaId]['instrumens'] as $instrumenProdi) {
                                    // Check if auditor has given nilai for this instrumen
                                    // More robust check: ensure nilaiAuditor exists, has count > 0, and has valid nilai
                                    if ($instrumenProdi->nilaiAuditor &&
                                        $instrumenProdi->nilaiAuditor->count() > 0 &&
                                        $instrumenProdi->nilaiAuditor->first()->nilai !== null &&
                                        $instrumenProdi->nilaiAuditor->first()->nilai > 0) {
