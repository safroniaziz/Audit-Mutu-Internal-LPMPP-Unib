                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="nama_ketua" class="form-control form-control-lg form-control" placeholder="Nama Ketua" value="{{ Auth::user()->unitKerja ? Auth::user()->unitKerja->nama_ketua : '-' }}" />
                                </div>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="nip_ketua" class="form-control form-control-lg form-control" placeholder="NIP Ketua" value="{{ Auth::user()->unitKerja ? Auth::user()->unitKerja->nip_ketua : '-' }}" />
                                </div>
                            </div>
                            <!--end::Input group-->
                ...
                <div class="card-body">
                    ...
                    <div class="row g-5">
                        @if ($dokumenAmis->count())
                            ...
                            <!--begin::Print Assignment Letter-->
                            <div class="col-md-12">
                                <div class="card h-100 d-flex flex-column justify-content-center align-items-center shadow-sm document-card-action">
                                    <div class="text-center p-10">
                                        <i class="bi bi-file-earmark-text text-primary fs-3x my-3"></i>
                                        <div class="fs-4 fw-bold text-dark mb-2">Cetak Surat Tugas</div>
                                        <div class="fs-7 text-muted mb-5">Cetak surat tugas audit dalam format PDF</div>
                                        <a href="{{ route('auditor.surat-tugas', ['id' => $pengajuanAmis->id]) }}" target="_blank" class="btn btn-primary btn-sm px-4 py-2">
                                            <i class="bi bi-printer me-1"></i> Cetak Surat Tugas
                                        </a>
                                    </div>
                                </div>
                            </div>
