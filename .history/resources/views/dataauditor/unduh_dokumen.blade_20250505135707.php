                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-3">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Berita Acara</td>
                                                <td class="text-end">
                                                    <a href="{{ route('cetak.beritaAcara') }}" class="btn btn-sm btn-primary">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="{{ route('cetak.evaluasiAmi') }}" class="btn btn-sm btn-primary">
                                                        <i class="fas fa-print me-1"></i> Cetak
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="{{ route('cetak.daftarPertanyaan') }}" class="btn btn-sm btn-primary">
                                                        <i class="fas fa-print me-1"></i> Cetak
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="{{ route('cetak.laporanAmi') }}" class="btn btn-sm btn-primary">
                                                        <i class="fas fa-print me-1"></i> Cetak
                                                    </a>
                                                </td>
                                            </tr>
