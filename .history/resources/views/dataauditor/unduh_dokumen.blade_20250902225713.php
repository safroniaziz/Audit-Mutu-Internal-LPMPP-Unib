                        ...
                        <div class="card-body pt-0">
                            ...
                            @else
                                <div class="alert alert-warning text-center py-8">
                                    ...
                                    <h5 class="text-dark mb-2">Belum Ada Data Kuisioner</h5>
                                    <p class="text-muted mb-3">Data kuisioner prodi belum diisi oleh auditor.</p>
                                    <div class="d-flex flex-column gap-2">
                                        <small class="text-muted">
                                            <i class="fas fa-info-circle me-1"></i>
                                            Total Kuisioner Master: {{ $kuisioners->count() }}
                                        </small>
                                        <small class="text-muted">
                                            <i class="fas fa-info-circle me-1"></i>
                                            Total Jawaban Tersimpan: {{ $jawabanKuisioner->count() }}
                                        </small>
                                        <small class="text-muted">
                                            <i class="fas fa-info-circle me-1"></i>
                        ...
                        <div class="card-body pt-0">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-row-dashed table-row-gray-300 align-middle">
                                        <thead>
                                            <tr class="fw-bold text-muted bg-light">
                                                <th width="5%" class="ps-4">No</th>
                                                <th width="70%">Pertanyaan Kuisioner</th>
                                                <th width="15%" class="text-center">Jawaban</th>
                                                <th width="10%" class="text-center">Status</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($jawabanKuisioner as $index => $jawaban)
                                                @php
                                                    $kuisioner = $kuisioners->firstWhere('id', $jawaban->kuisioner_id);
                                                    $opsi = $jawaban->opsi;
                                                @endphp
                                                <tr>
                                                    <td class="ps-4">
                                                    ...
                                                    <td>
                                                        <span class="text-dark fw-semibold">{{ $kuisioner->pertanyaan ?? 'Pertanyaan tidak ditemukan' }}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <span class="badge badge-lg badge-light-info">{{ $opsi->opsi ?? 'Jawaban tidak ditemukan' }}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <span class="badge badge-lg badge-light-success">Selesai</span>
                                                    </td>
                            ...
                            @else
                                <div class="alert alert-info text-center py-8">
                                    <i class="fas fa-table fs-1 text-info mb-3"></i>
                                    <h5 class="text-dark mb-2">Belum Ada Data Kuisioner</h5>
                                    <p class="text-muted mb-0">Lakukan pengisian kuisioner prodi terlebih dahulu untuk melihat detail nilai.</p>
                                </div>
                            @endif
                        </div>
                    </div>
