                                    ...
                                    @foreach($groupedData as $satuanStandardNama => $indikatorGroups)
                                        ...
                                        <tr class="level-header">
                                            ...
                                            <td class="text-center">
                                                <span class="text-muted fs-7">{{ $indikatorGroups->count() }} indikator</span>
                                            </td>
                                        </tr>
                                        ...
                                        @foreach($indikatorGroups as $indikatorKinerjaNama => $ikssGroup)
                                            ...
                                            <tr class="level-subheader">
                                                ...
                                                <td class="text-center">
                                                    <span class="text-muted fs-7">{{ $totalCount }} item</span>
                                                </td>
                                            </tr>
                                            ...
                                            @foreach($ikssGroup as $ikss)
                                                @if($ikss->instrumen)
                                                    <tr class="level-item">
                                                        ...
                                                        <td class="text-center">
                                                            <span class="status-indicator {{ $ikss->status == 1 ? 'status-completed' : 'status-pending' }}"
                                                                  title="{{ $ikss->status == 1 ? 'Selesai' : 'Belum selesai' }}">
                                                            </span>
                                                        </td>
                                                    </tr>
                                                @endif
