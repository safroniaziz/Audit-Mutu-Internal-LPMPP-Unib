                                        ...
                                        <div class="card bg-light-primary border-primary">
                                            <div class="card-header bg-primary text-white">
                                                <h6 class="mb-0 text-white">
                                                    <i class="fas fa-star me-2"></i>Penilaian Auditor
                                                </h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="nilai[{{ $instrumenProdi->id }}]" class="form-select" required>
                                                                ...
                                                                <option value="1" {{ ($instrumenProdi->nilaiAuditor && $instrumenProdi->nilaiAuditor->first() && $instrumenProdi->nilaiAuditor->first()->nilai == 1) ? 'selected' : '' }}>1 - Sangat Kurang</option>
                                                                <option value="2" {{ ($instrumenProdi->nilaiAuditor && $instrumenProdi->nilaiAuditor->first() && $instrumenProdi->nilaiAuditor->first()->nilai == 2) ? 'selected' : '' }}>2 - Kurang</option>
                                                                <option value="3" {{ ($instrumenProdi->nilaiAuditor && $instrumenProdi->nilaiAuditor->first() && $instrumenProdi->nilaiAuditor->first()->nilai == 3) ? 'selected' : '' }}>3 - Baik</option>
                                                                <option value="4" {{ ($instrumenProdi->nilaiAuditor && $instrumenProdi->nilaiAuditor->first() && $instrumenProdi->nilaiAuditor->first()->nilai == 4) ? 'selected' : '' }}>4 - Sangat Baik</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="catatan[{{ $instrumenProdi->id }}]" class="form-control" rows="3" placeholder="Tambahkan catatan jika diperlukan...">{{ $instrumenProdi->nilaiAuditor && $instrumenProdi->nilaiAuditor->first() ? $instrumenProdi->nilaiAuditor->first()->catatan : '' }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
