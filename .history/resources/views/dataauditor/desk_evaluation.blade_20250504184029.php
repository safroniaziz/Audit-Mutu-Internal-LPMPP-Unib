                                            ...
                                            @foreach ($ikssGroup as $index => $ikssAuditee)
                                                ...
                                                <div class="instrument-container mb-4 {{ $index > 0 ? 'mt-5 pt-4 border-top' : '' }}">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="mt-3">
                                                            <h6>Pertanyaan</h6>
                                                            <textarea rows="2" class="form-control" name="pertanyaan[{{ $ikssAuditee->id }}]" {{ $hasEvaluation ? 'disabled' : '' }}>{{ $hasEvaluation ? $deskEvaluation[$ikssAuditee->id]->penilaian_akar : '' }}</textarea>
                                                        </div>
                                                        <div class="mt-3">
                                                            <h6>Nilai</h6>
