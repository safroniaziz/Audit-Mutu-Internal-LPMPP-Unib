        ...
        @foreach($auditee->auditors as $penugasan)
            @if($penugasan->role == 'ketua' && $penugasan->user_id == Auth::id())
                <li class="nav-item mt-2">
                    <a href="{{ route('auditor.audit.penilaianInstrumenProdi', $auditee->id) }}" class="nav-link text-active-primary ms-0 me-10 py-5">
...
@section('menuUnduhDokumen')
    @foreach($auditess as $auditee)
        @foreach($auditee->auditors as $penugasan)
            @if($penugasan->role == 'ketua' && $penugasan->user_id == Auth::id())
                <li class="nav-item mt-2">
                    <a href="{{ route('auditor.audit.unduhDokumen', $auditee->id) }}" class="nav-link text-active-primary ms-0 me-10 py-5">
