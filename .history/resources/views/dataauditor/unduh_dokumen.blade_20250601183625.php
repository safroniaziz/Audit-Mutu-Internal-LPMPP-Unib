                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="point_1" id="tujuan{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_1 == $i ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-3 mt-2">
                                        @for($i = 1; $i <= 4; $i++)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="point_2" id="lingkup{{ $i }}" value="{{ $i }}" {{ isset($evaluasiAuditor) && $evaluasiAuditor->point_2 == $i ? 'checked' : '' }}>
