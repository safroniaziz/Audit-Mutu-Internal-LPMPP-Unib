        ...
        <table class="tableData">
            <tbody>
                <tr>
                    ...
                    <th style="width: 28%">Hasil Observasi (Catatan Audit)</th>
                    <th style="width: 4%; text-align:center;">S</th>
                    <th style="width: 4%; text-align:center;">TS</th>
            ...
            <tbody>
                @foreach ($pengajuanAmis->ikssAuditee as $index => $ikssAuditee)
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">{!! $isSesuai ? '&check;' : '&nbsp;' !!}</td>
                        <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">{!! (!$isSesuai && !empty($visitasiItem?->ketidak_sesuaian)) ? '&check;' : '&nbsp;' !!}</td>
