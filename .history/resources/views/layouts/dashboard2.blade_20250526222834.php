                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                @php
                                                    ...
                                                    foreach ($allSatuanStandar as $ss) {
                                                        // Simply check if there are any IKSS entries for this SS
                                                        $ikssEntries = App\Models\IkssAuditee::whereHas('instrumen.indikatorKinerja', function($query) use ($ss) {
                                                        ...
                                                        $hasFilledIkss = $ikssEntries > 0;

                                                        $debugInfo[$ss->kode_satuan] = [
                                                            'entries_in_db' => $ikssEntries,
                                                            'is_complete' => $hasFilledIkss
                                                        ];
