                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                @php
                                                    ...
                                                    foreach ($allSatuanStandar as $ss) {
                                                        // Get count of all instruments for this SS
                                                        $totalInstruments = App\Models\InstrumenIkss::whereHas('indikatorKinerja', function($query) use ($ss) {
                                                            $query->where('satuan_standar_id', $ss->id);
                                                        })->count();

                                                        // Get count of filled instruments for this SS
