							...
							<div class="header-menu d-flex align-items-stretch w-100">
								...
								<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-500 menu-bullet-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                                        class="menu-item {{ Route::is('auditee.dashboard') || Route::is('auditee.dashboard.*') || Route::is('mahasiswa.kelas_saya.*') ? 'show' : '' }}">
                                        <!--begin:Menu link-->
                                    ...
                                    <div class="card mb-5 mb-xl-10">
                                        <div class="card-body pt-9 pb-0">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                        ...
                                                        <div class="d-flex my-4">
                                                            <a href="{{ route('auditee.dashboard.pengaturan_profil') }}" class="btn btn-sm btn-primary me-2" >
                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                <!--begin::Nav item-->
                                                <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.dashboard.kelas_saya')
                                                    ...
                                                    href="{{ route('auditee.dashboard.kelas_saya') }}">Kelas Saya</a>
                                                </li>
                                                ...
                                                <!--begin::Nav item-->
                                                <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.dashboard.pengaturan_profil') ? 'active' : '' }}"
                                                       href="{{ route('auditee.dashboard.pengaturan_profil') }}">Pengaturan Profil</a>
                                                </li>
                                                <!--end::Nav item-->

                                                <!--begin::Nav item-->
                                                <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.dashboard.aktivitas') ? 'active' : '' }}"
                                                       href="{{ route('auditee.dashboard.aktivitas') }}">Catatan Aktivitas</a>
                                                </li>
                                                <!--end::Nav item-->
                                                ...
                                                {{-- <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('account.logs') ? 'active' : '' }}"
                                                        href="{{ route('auditee.dashboard.diskusi') }}">Diskusi</a>
                                                </li> --}}
                                                <!--end::Nav item-->
                                            </ul>
                                            <!--begin::Navs-->
