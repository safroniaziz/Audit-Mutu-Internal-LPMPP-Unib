							...
							<div class="app-navbar gap-2">
								...
								<div class="app-navbar-item">
									...
									<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-500 menu-bullet-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
										...
										<!--begin::Menu item-->
										<div class="menu-item me-lg-1">
											<a class="menu-link py-3 {{ Route::is('auditee.pengajuanAmi*') ? 'active' : '' }}" href="{{ route('auditee.pengajuanAmi') }}">
                                        ...
                                        <div class="card-body pt-9 pb-0">
                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                @elseif (Route::is('auditee.pengajuanAmi*'))
                                                    ...
                                                    <li class="nav-item mt-2">
                                                        <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.perjanjian-kinerja.index') ? 'active' : '' }}"
                                                        href="{{ route('auditee.perjanjian-kinerja.index') }}">
                                                            <i class="fas fa-file-signature me-2"></i> Perjanjian Kinerja
                                                        </a>
                                                    </li>

                                                    <li class="nav-item mt-2">
                                                        <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.pengajuanAmi.pemilihanIkss') ? 'active' : '' }}"
                                                    ...
                                                    <li class="nav-item mt-2">
                                                        <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.pengajuanAmi.unggahSiklus') ? 'active' : '' }}"
                                                        href="{{ route('auditee.pengajuanAmi.unggahSiklus') }}">
