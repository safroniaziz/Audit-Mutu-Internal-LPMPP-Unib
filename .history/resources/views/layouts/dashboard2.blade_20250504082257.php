                                                            ...
                                                            <div class="d-flex flex-wrap">
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-2 fw-bold" data-kt-countup="false" data-kt-countup-value="4500" data-kt-countup-prefix="$">
                                                                            {{ Auth::user()->unitKerja->website ? Auth::user()->unitKerja->website : 'koperasiamanahsejati.unib.ac.id' }}
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Number-->
                                                                    <!--begin::Label-->
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-2 fw-bold">
                                                                            {{ Auth::user()->unitKerja->email ? Auth::user()->unitKerja->email : 'koperasiamanahsejati.unib.ac.id' }}
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Number-->
                                                                    <!--begin::Label-->
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-2 fw-bold">
                                                                            {{ Auth::user()->unitKerja->no_hp ? Auth::user()->unitKerja->no_hp : 'koperasiamanahsejati.unib.ac.id' }}
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Number-->
                                                                    <!--begin::Label-->
                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.dashboard') ? 'active' : '' }}"
                                                       href="{{ route('auditee.dashboard') }}">Dashboard</a>
                                                </li>
                                                {{-- <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.dashboard') ? 'active' : '' }}"
