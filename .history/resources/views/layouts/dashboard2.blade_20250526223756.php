                                        ...
                                        <div class="card-body pt-9 pb-0">
                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                @php
                                                    ...
                                                    // Count how many SS have at least one IKSS entry
                                                    $ssWithEntries = 0;
                                                    $debugInfo = [];

                                                    foreach ($allSatuanStandar as $ss) {
                                                        $hasEntries = App\Models\IkssAuditee::whereHas('instrumen.indikatorKinerja', function($query) use ($ss) {
                                                    ...
                                                    // Only enable menu if ALL SS have entries
                                                    $sudahMengisiIkss = ($ssWithEntries === $totalSS);
                                                ...
                                                @if(config('app.env') === 'local')
                                                    <div class="alert alert-info">
                                                        ...
                                                        <p>SS with entries: {{ $ssWithEntries }}</p>
                                                        <pre>{{ json_encode($debugInfo, JSON_PRETTY_PRINT) }}</pre>
                                                        <p>Menu Enabled: {{ $sudahMengisiIkss ? 'Yes' : 'No' }}</p>
                                                    </div>
                                                @endif
