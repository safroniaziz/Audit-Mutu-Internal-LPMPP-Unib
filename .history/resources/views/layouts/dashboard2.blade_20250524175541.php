							...
							<div class="d-flex flex-stack align-items-stretch flex-grow-1 flex-lg-grow-0">
								...
								<div class="d-flex align-items-center me-7">
									...
									<a href="{{ route('auditee.dashboard') }}" class="d-flex align-items-center logo-background">
										<img alt="Logo" src="{{ asset('assets/src/images/logo_unib.png') }}" class="h-30px h-lg-55px" />
									</a>
									<!--end::Logo-->
								</div>
								<!--end::Logo wrapper-->
								...
								<div class="app-navbar-item" id="kt_header_user_menu_toggle">
									...
									<div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 ps-3 pe-1" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										...
										<div class="symbol symbol-30px symbol-md-40px">
                                            <img src="{{ asset('assets/src/images/profile.png') }}" alt="User Photo" />
										</div>
										<!--end::Symbol-->
									</div>
									<!--end::User info-->
						...
						<div class="app-container container-xxl app-container-fit-mobile d-flex align-items-stretch" id="kt_app_header_secondary_container">
							...
							<div class="header-menu d-flex align-items-stretch w-100">
								...
								<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-500 menu-bullet-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                                    ...
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary pb-4 {{ request()->routeIs('auditee.pengajuanAmi') ? 'active' : '' }}" href="{{ route('auditee.pengajuanAmi') }}">
                                            <i class="bi bi-person-lines-fill me-2"></i> Kelengkapan Profil
                                    ...
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary pb-4 {{ request()->routeIs('auditee.perjanjian-kinerja.*') ? 'active' : '' }}"
                                           href="{{ $completionPercentage == 100 ? route('auditee.perjanjian-kinerja.index') : '#' }}"
                                           @if($completionPercentage < 100) style="opacity: 0.5; cursor: not-allowed;" @endif>
                                            <i class="bi bi-file-earmark-text me-2"></i> Perjanjian Kinerja
                                    ...
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary pb-4 {{ request()->routeIs('auditee.pengajuanAmi.pemilihanIkss') ? 'active' : '' }}"
                                           href="{{ ($completionPercentage == 100 && $hasPerjanjianKinerja) ? route('auditee.pengajuanAmi.pemilihanIkss') : '#' }}"
                                           @if($completionPercentage < 100 || !$hasPerjanjianKinerja) style="opacity: 0.5; cursor: not-allowed;" @endif>
                                            <i class="bi bi-list-check me-2"></i> Pemilihan IKSS
                                            @if($sudahMengisiIkss)
                                                <i class="bi bi-check-circle-fill text-success ms-2"></i>
                                            @endif
                                        </a>
                                    ...
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary pb-4 {{ request()->routeIs('auditee.pengajuanAmi.pengisianInstrumen') ? 'active' : '' }}"
                                           href="{{ ($completionPercentage == 100 && $hasPerjanjianKinerja && $sudahMengisiIkss) ? route('auditee.pengajuanAmi.pengisianInstrumen') : '#' }}"
                                           @if($completionPercentage < 100 || !$hasPerjanjianKinerja || !$sudahMengisiIkss) style="opacity: 0.5; cursor: not-allowed;" @endif>
                                            <i class="bi bi-pencil-square me-2"></i> Pengisian Instrumen
                                            @if($sudahMengisiInstrumen)
                                                <i class="bi bi-check-circle-fill text-success ms-2"></i>
                                            @endif
                                        </a>
                                    </li>
                                    ...
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary pb-4 {{ request()->routeIs('auditee.pengajuanAmi.unggahSiklus') ? 'active' : '' }}"
                                           href="{{ ($completionPercentage == 100 && $hasPerjanjianKinerja && $sudahMengisiIkss && $sudahMengisiInstrumen) ? route('auditee.pengajuanAmi.unggahSiklus') : '#' }}"
                                           @if($completionPercentage < 100 || !$hasPerjanjianKinerja || !$sudahMengisiIkss || !$sudahMengisiInstrumen) style="opacity: 0.5; cursor: not-allowed;" @endif>
                                            <i class="bi bi-upload me-2"></i> Unggah Siklus
                                        </a>
                                    </li>
                                    <!--end::Nav item-->
                                        ...
                                        <div class="card-body pt-9 pb-0">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                                ...
                                                                <i class="ki-duotone ki-geolocation fs-4 me-1">
                                                                    <span class="path1"></span>
                                                                    <span class="path2"></span>
                                                                </i>{{ Auth::user()->unitKerja->nama_ketua }}</a>
                                                            ...
                                                            <div class="d-flex flex-wrap">
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-6 fw-normal {{ Auth::user()->unitKerja->website ? '' : 'text-danger' }}"
                                                                            data-kt-countup="false"
                                                                            data-kt-countup-value="4500"
                                                                            data-kt-countup-prefix="$"
                                                                        >
                                                                            {{ Auth::user()->unitKerja->website ?: 'belum dilengkapi' }}
                                                                        </div>
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    <!--begin::Number-->
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-6 fw-normal {{ Auth::user()->unitKerja->no_hp ? '' : 'text-danger' }}">
                                                                            {{ Auth::user()->unitKerja->no_hp ?: 'belum dilengkapi' }}
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Number-->
                                                                    <!--begin::Label-->
                                                                    <div class="fw-semibold fs-6 text-gray-500">Kontak</div>
                                                                    <!--end::Label-->
                                                                </div>
                                                                <!--end::Stat-->
                                                            </div>
                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                @php
                                                    ...
                                                    $sudahMengisiIkss = App\Models\IkssAuditee::where('auditee_id', $unitKerjaId)
                                                ...
                                                @elseif (Route::is('auditee.pengajuanAmi*'))
                                                    ...
                                                    <li class="nav-item mt-2">
                                                        <div class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-html="true"
                                                            ...
                                                            <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.pengajuanAmi.pemilihanIkss') ? 'active' : '' }} {{ $completionPercentage < 100 ? 'disabled' : '' }}"
                                                               href="{{ $completionPercentage < 100 ? 'javascript:void(0);' : route('auditee.pengajuanAmi.pemilihanIkss') }}"
                                                    ...
                                                    <li class="nav-item mt-2">
                                                        <div class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-html="true"
                                                             title="{{ !$sudahMengisiIkss ? '<strong>Tidak dapat diakses</strong><br>Selesaikan pemilihan IKSS terlebih dahulu' : '' }}">
