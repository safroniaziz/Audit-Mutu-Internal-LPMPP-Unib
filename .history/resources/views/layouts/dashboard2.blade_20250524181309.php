					...
					<div class="app-header-secondary app-header-mobile-drawer" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_secondary_toggle" data-kt-sticky="true" data-kt-sticky-name="app-header-secondary-sticky" data-kt-sticky-offset="{default: 'false', lg: '300px'}" data-kt-swapper="true" data-kt-swapper-mode="append" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header'}">
						...
						<div class="app-container container-xxl app-container-fit-mobile d-flex align-items-stretch" id="kt_app_header_secondary_container">
							...
							<div class="header-menu d-flex align-items-stretch w-100">
								<!--begin::Menu-->
								<div class="menu menu-lg-rounded menu-column menu-state-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-500 menu-bullet-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                                    <!--begin::Menu item-->
                                    <div class="menu-item me-lg-1">
                                        <a class="menu-link py-3" href="{{ route('auditee.dashboard') }}">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item me-lg-1">
                                        <a class="menu-link py-3" href="{{ route('auditee.pengajuanAmi') }}">
                                            <span class="menu-title">Pengajuan AMI</span>
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                                ...
                                                @elseif (Route::is('auditee.pengajuanAmi*'))
                                                    ...
                                                    <li class="nav-item mt-2">
                                                        <div class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-html="true"
                                                            ...
                                                            <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.perjanjian-kinerja.index') ? 'active' : '' }} {{ $completionPercentage < 100 ? 'disabled' : '' }}"
                                                               href="{{ $completionPercentage < 100 ? 'javascript:void(0);' : route('auditee.perjanjian-kinerja.index') }}"
                                                    ...
                                                    <li class="nav-item mt-2">
                                                        <div class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-html="true"
                                                            ...
                                                            <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.pengajuanAmi.pemilihanIkss') ? 'active' : '' }} {{ !$sudahMengisiIkss ? 'disabled' : '' }}"
                                                               href="{{ !$sudahMengisiIkss ? 'javascript:void(0);' : route('auditee.pengajuanAmi.pemilihanIkss') }}"
                                                        ...
                                                        <div class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-html="true"
                                                            ...
                                                            <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.pengajuanAmi.unggahSiklus') ? 'active' : '' }} {{ !$sudahMengisiInstrumen ? 'disabled' : '' }}"
                                                               ...
                                                               style="{{ !$sudahMengisiInstrumen ? 'pointer-events: none; color: grey;' : '' }}">
                                                                <i class="fas fa-upload me-2"></i> Unggah Siklus
                                                            </a>
                                                        </div>
                                                    </li>
                                                @endif
