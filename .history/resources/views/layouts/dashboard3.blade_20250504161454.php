						...
						<div class="app-container container-xxl app-container-fit-mobile d-flex align-items-stretch" id="kt_app_header_secondary_container">
							...
							<div class="header-menu d-flex align-items-stretch w-100">
								...
								<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-500 menu-bullet-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                                    ...
                                    {{-- <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                                        class="menu-item
                                        {{ Route::is('auditor.pengajuanAmi') || Route::is('auditor.pengajuanAmi.*') ? 'show' : '' }}
                                         ">
                                        <!--begin:Menu link-->
                                        <a href="{{ route('auditor.pengajuanAmi') }}" class="menu-link py-3">
                                            <span class="menu-title">
                                        ...
                                        <div class="card-body pt-9 pb-0">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                        ...
                                                        <div class="d-flex my-4">
                                                            ...
                                                            @endphp
                                                            {{-- <a href="{{ route('auditor.pengajuanAmi') }}"
                                                            ...
                                                            <div class="d-flex flex-wrap">
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-6 fw-normal {{ Auth::user()->unitKerja->nama_unit_kerja ? '' : 'text-danger' }}"
                                                                            data-kt-countup="false"
                                                                            data-kt-countup-value="4500"
                                                                            data-kt-countup-prefix="$"
                                                                        >
                                                                            {{ Auth::user()->unitKerja->nama_unit_kerja ?: 'belum dilengkapi' }}
                                                                        </div>
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    ...
                                                                    <!--end::Number-->
                                                                    <!--begin::Label-->
                                                                    <div class="fw-semibold fs-6 text-gray-500">Auditor</div>
                                                                    <!--end::Label-->
                                                                </div>
                                                                <!--end::Stat-->
                                                            </div>
                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                <!--begin::Nav item-->
                                                    ...
                                                    {{-- <li class="nav-item mt-2">
                                                        <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditor.pengajuanAmi') ? 'active' : '' }}"
                                                        href="{{ route('auditor.pengajuanAmi') }}">
                                                ...
                                                {{-- <li class="nav-item mt-2">
                                                    ...
                                                    {{-- href="{{ route('auditor.dashboard') }}">Kelas Saya</a>
                                                </li> --}}
                                                ...
                                                {{-- <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditor.dashboard') ? 'active' : '' }}"
                                                       href="{{ route('auditor.dashboard') }}">Pengaturan Profil</a>
                                                </li> --}}
                                                <!--end::Nav item-->
                                                ...
                                                {{-- <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditor.dashboard') ? 'active' : '' }}"
                                                       href="{{ route('auditor.dashboard') }}">Catatan Aktivitas</a>
                                                </li> --}}
                                                <!--end::Nav item-->
                                                ...
                                                {{-- <li class="nav-item mt-2">
                                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('account.logs') ? 'active' : '' }}"
                                                        href="{{ route('auditor.dashboard') }}">Diskusi</a>
                                                </li> --}}
                                                <!--end::Nav item-->
                                            </ul>
                                            <!--begin::Navs-->
