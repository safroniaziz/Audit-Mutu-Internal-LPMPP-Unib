...
<base href="../" />
	...
	<body id="kt_app_body" data-kt-app-header-stacked="true" data-kt-app-header-primary-enabled="true" data-kt-app-header-secondary-enabled="true" data-kt-app-toolbar-enabled="true" class="app-default">
        ...
        @if(Auth::check() && Auth::user()->hasRole('Auditee'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                        ...
                        if (typeof Swal !== 'undefined') {
                            Swal.fire({
                                ...
                                html: '<div class="text-start">' +
                                    ...
                                    '<i class="fas fa-list-alt me-2"></i>Daftar IKSS Baru (8 Instrumen):' +
                                    '</h5>' +
                                    '<div class="accordion" id="ikssAccordion">' +
                                    '<div class="card mb-2">' +
                                    '<div class="card-header bg-light">' +
                                    '<strong>IKSS 1.4.3 - Langganan Jurnal Online (1 Instrumen)</strong>' +
                                    '</div>' +
                                    '<div class="card-body py-2">' +
                                    '<small>• Langganan Jurnal Online</small>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="card mb-2">' +
                                    '<div class="card-header bg-light">' +
                                    '<strong>IKSS 1.5.1 - Tes TOEFL (1 Instrumen)</strong>' +
                                    '</div>' +
                                    '<div class="card-body py-2">' +
                                    '<small>• Tes TOEFL</small>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="card mb-2">' +
                                    '<div class="card-header bg-light">' +
                                    '<strong>IKSS 1.5.2 - Mahasiswa Berprestasi (4 Instrumen)</strong>' +
                                    '</div>' +
                                    '<div class="card-body py-2">' +
                                    '<small>• Sosialisasi dan Diseminasi Program Mahasiswa Berprestasi<br>' +
                                    '• Seleksi Program Mahasiswa Berprestasi<br>' +
                                    '• Pembinaan Mahasiswa Berprestasi<br>' +
                                    '• Pemilihan Pengurus UKM/Ormawa</small>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="card mb-3">' +
                                    '<div class="card-header bg-light">' +
                                    ...
                                    '</div>' +
                                    '<div class="card-body py-2">' +
                                    '<small>• Sosialisasi dan Diseminasi Student Mobility Program<br>' +
                                    '• Pemberangkatan Mahasiswa Mengikuti Student Mobility Program</small>' +
                                    '</div>' +
                                    '</div>' +
                                    '</div>' +
                                    '<div class="alert alert-info py-2">' +
                                    '<small><i class="fas fa-info-circle me-1"></i>' +
                                    'Total: <strong>8 instrumen baru</strong> telah ditambahkan. ' +
                                    'Silakan pilih IKSS yang relevan dengan unit kerja Anda.</small>' +
                                    '</div>' +
                                    '</div>',
                                icon: 'info',
                                width: '600px',
