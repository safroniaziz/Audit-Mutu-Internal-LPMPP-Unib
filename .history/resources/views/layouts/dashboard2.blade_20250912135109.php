...
<base href="../" />
	...
	<body id="kt_app_body" data-kt-app-header-stacked="true" data-kt-app-header-primary-enabled="true" data-kt-app-header-secondary-enabled="true" data-kt-app-toolbar-enabled="true" class="app-default">
        ...
        <!-- Modal Informasi IKSS Baru -->
        @if(Auth::check() && Auth::user()->role == 'auditee')
        <div class="modal fade" id="ikssNewInfoModal" tabindex="-1" aria-labelledby="ikssNewInfoModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h1 class="modal-title fs-4 text-white" id="ikssNewInfoModalLabel">
                            <i class="fas fa-info-circle me-2"></i>Informasi Penting: Tambahan IKSS Terbaru
                        </h1>
                    </div>
                    <div class="modal-body">
                        <div class="alert alert-warning border-0 mb-4">
                            <div class="d-flex align-items-center">
                                <i class="fas fa-exclamation-triangle fs-2x text-warning me-3"></i>
                                <div>
                                    <h5 class="mb-1">Perhatian untuk Semua Auditee!</h5>
                                    <p class="mb-0">Terdapat penambahan IKSS baru yang perlu Anda pilih untuk periode audit ini.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accordion" id="ikssAccordion">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#ikss143">
                                            <strong>IKSS 1.4.3 - Langganan Jurnal Online</strong>
                                        </button>
                                    </h2>
                                    <div id="ikss143" class="accordion-collapse collapse" data-bs-parent="#ikssAccordion">
                        ...
                        <div class="alert alert-info border-0">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <h6 class="mb-2">Untuk Auditee yang Sudah Menyelesaikan Semua Tahapan:</h6>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <strong>Ibu Tiara Eka Putri</strong>
                                    </div>
                                    <div class="d-flex align-items-center mt-1">
                                        <i class="fas fa-phone me-2"></i>
                                        <a href="tel:081373155834" class="text-decoration-none">
                                            <strong>081373155834</strong>
                                        </a>
                                    </div>
                                    <p class="mb-0 mt-2 text-muted">Beliau akan membantu melakukan reset agar Anda dapat memilih IKSS kembali.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('auditee.pengajuanAmi.pemilihanIkss') }}" class="btn btn-primary">
                            <i class="fas fa-arrow-right me-2"></i>Ke Halaman Pemilihan IKSS
                        </a>
                    </div>
                </div>
            </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Show modal for auditee users on first visit
                @if(Auth::check() && Auth::user()->role == 'auditee')
