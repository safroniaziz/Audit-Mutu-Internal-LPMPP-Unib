                                                    ...
                                                    <div class="d-flex flex-wrap flex-stack">
                                                        ...
                                                        <div class="d-flex flex-column flex-grow-1 pe-8">
                                                            ...
                                                            <div class="d-flex flex-wrap">
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-6 fw-normal">
                                                                            {{ Auth::user()->unitKerja && Auth::user()->unitKerja->nama_ketua ? Auth::user()->unitKerja->nama_ketua : 'Belum diisi' }}
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Number-->
                                                                    <!--end::Label-->
                                                                    <div class="fw-semibold fs-6 text-gray-500">Nama Ketua</div>
                                                                    <!--end::Label-->
                                                                </div>
                                                                <!--end::Stat-->
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-6 fw-normal">
                                                                            {{ Auth::user()->unitKerja && Auth::user()->unitKerja->nip_ketua ? Auth::user()->unitKerja->nip_ketua : 'Belum diisi' }}
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Number-->
                                                                    <!--end::Label-->
                                                                    <div class="fw-semibold fs-6 text-gray-500">NIP Ketua</div>
                                                                    <!--end::Label-->
                                                                </div>
                                                                <!--end::Stat-->
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-6 fw-normal">
                                                                            {{ Auth::user()->unitKerja && Auth::user()->unitKerja->jenjang ? Auth::user()->unitKerja->jenjang : 'Belum diisi' }}
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Number-->
                                                                    <!--end::Label-->
                                                                    <div class="fw-semibold fs-6 text-gray-500">Jenjang</div>
                                                                    <!--end::Label-->
                                                                </div>
                                                                <!--end::Stat-->
                                                        ...
                                                        <div class="d-flex flex-wrap mt-4">
                                                            ...
                                                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="fs-6 fw-normal">
                                                                        {{ Auth::user()->unitKerja && Auth::user()->unitKerja->no_hp ? Auth::user()->unitKerja->no_hp : 'Belum diisi' }}
                                                                    </div>
                                                                </div>
                                                                <!--end::Number-->
                                                                <!--end::Label-->
