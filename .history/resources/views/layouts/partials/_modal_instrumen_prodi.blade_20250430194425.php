...
@push('scripts')
    <script>
        $(document).ready(function () {
            ('#indikator_instrumen_id').on('change', function () {
                let indikatorId = $(this).val();

                if (indikatorId) {
                    $.ajax({
                        url: '/get-kriteria/' + indikatorId,  // Gantilah dengan route yang sesuai
                        type: 'GET',
                        success: function (response) {
                            let kriteriaSelect = $('#indikator_instrumen_kriteria_id');
                            kriteriaSelect.empty();  // Hapus option sebelumnya
                            kriteriaSelect.append('<option disabled selected>-- pilih kriteria instrumen --</option>');

                            // Tambahkan kriteria dari response
                        ...
                        error: function (xhr) {
                            ...
                            Swal.fire({
                                ...
                                text: 'Terjadi kesalahan dalam memuat kriteria. Silakan coba lagi.'
                            });
                        }
                    });
                }
