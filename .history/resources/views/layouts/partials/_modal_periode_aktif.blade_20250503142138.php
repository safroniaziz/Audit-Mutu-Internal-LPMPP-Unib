    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header px-10">
                <h2 class="fw-bold">Tambah Periode Aktif</h2>
            </div>
            <div class="modal-body d-flex flex-column scroll-y px-10" style="flex-grow: 1;">
                <form id="kt_modal_form" class="form d-flex flex-column" style="flex-grow: 1;">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <input type="text" id="tahun_ami" name="tahun_ami" class="form-control form-control-solid" placeholder="Pilih Tahun" />
                    </div>
...
@push('scripts')
    ...
    onReady: function (selectedDates, dateStr, instance) {
        instance.currentYearElement.readOnly = false;
    }
});
