            ...
            <div class="modal-body">
                <form id="formPenugasanAuditor">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="auditor1" name="auditor1" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="auditor2" name="auditor2" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="auditor3" name="auditor3">
