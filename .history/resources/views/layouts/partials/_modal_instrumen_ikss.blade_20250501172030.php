            ...
            <div class="modal-body d-flex flex-column scroll-y px-10" style="flex-grow: 1;">
                <form id="kt_modal_form" class="form d-flex flex-column" style="flex-grow: 1;">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <input type="text" name="indikator" class="form-control" maxlength="10">
                    </div>

                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Satuan:</label>
                        <input type="text" name="satuan" class="form-control" maxlength="255">
                    </div>

                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Pertanyaan:</label>
                        <input type="text" name="pertanyaan" class="form-control" maxlength="255">
                    </div>
                    ...
                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Is Wajib (1 atau 0):</label>
                        <input type="text" name="is_wajib" class="form-control" maxlength="255">
                    </div>
