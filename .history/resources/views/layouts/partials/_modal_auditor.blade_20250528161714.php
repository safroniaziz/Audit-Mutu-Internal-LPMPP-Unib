...
<script>
    ...
    function resetUploadTtd(e) {
        ...
        dropZone.innerHTML = `
            <input type="file" name="ttd" id="ttdInput" accept=".png,.jpg,.jpeg" style="display: none;" onchange="handleFileChange(event)" />
            <div class="upload-content" onclick="openFileDialog()">
                <div class="upload-icon">
                    <i class="ki-duotone ki-cloud-add fs-3x text-primary mb-3">
                        <span class="path1"></span>
                ...
                <h4 class="fw-bold text-gray-800 mb-2">Drop ttd di sini</h4>
                <p class="text-muted fs-7 mb-0">atau klik untuk pilih file</p>
            </div>`;
    ...
    $(document).ready(function() {
        ...
        resetUploadTtd(); // Initialize the upload zone
