    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            window.populateModal = function(data) {
                ...
                // Handle is_wajib and jenjang last to ensure proper visibility
                $('#is_wajib').val(data.is_wajib ? '1' : '0').trigger('change');

                // If is_wajib is true, show and set jenjang value after a short delay
                if (data.is_wajib) {
                    setTimeout(() => {
            ...
            $('#is_wajib').change(function() {
                if ($(this).val() === '1') {
                    ...
                    // Reset jenjang value when switching to not wajib
