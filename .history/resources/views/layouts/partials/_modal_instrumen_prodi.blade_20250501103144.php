    ...
    <script>
        $(document).ready(function () {
            $('select[name="indikator_instrumen_id"]').on('change', function () {
                ...
                // Simpan referensi ke ID kriteria yang perlu dipilih
                let kriteriaIdToSelect = @json(isset($data) ? $data->indikator_instrumen_kriteria_id : null);
                ...
                if (indikatorId) {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            // Set nilai kriteria jika ada
                            if (kriteriaIdToSelect) {
                                console.log("Attempting to select kriteria ID:", kriteriaIdToSelect);
                                kriteriaSelect.val(kriteriaIdToSelect);

                                // Jika masih tidak berhasil, coba dengan pendekatan lain
                                if (kriteriaSelect.val() === null) {
                                    kriteriaSelect.find('option[value="' + kriteriaIdToSelect + '"]').prop('selected', true);
                                }
