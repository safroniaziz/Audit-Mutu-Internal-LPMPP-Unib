            ...
            <div class="modal-body d-flex flex-column scroll-y px-10" style="flex-grow: 1;">
                <form id="kt_modal_form" class="form d-flex flex-column" style="flex-grow: 1;">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <textarea name="uraian" id="kt_docs_ckeditor_uraian" class="form-control" rows="3" required></textarea>
                    </div>

                    <div class="fv-row mb-5">
                        <label class="form-label">Penyebab Tidak Tercapai:</label>
                        <textarea name="penyebab_tidak_tercapai" id="kt_docs_ckeditor_penyebab" class="form-control" rows="3"></textarea>
                    </div>

                    <div class="fv-row mb-5">
                        <label class="form-label">Rencana Perbaikan:</label>
                        <textarea name="rencana_perbaikan" id="kt_docs_ckeditor_rencana" class="form-control" rows="3"></textarea>
                    </div>

                    <div class="fv-row mb-5">
                        <label class="form-label">Indikator Penilaian:</label>
                        <textarea name="indikator_penilaian" id="kt_docs_ckeditor_penilaian" class="form-control" rows="3"></textarea>
                    </div>
