        ...
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column scroll-y px-10" style="flex-grow: 1;">
                <form id="kt_modal_form" class="form d-flex flex-column" style="flex-grow: 1;">
                    ...
                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Elemen:</label>
                    ...
                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Sumber Data:</label>
                        <input type="text" name="sumber_data" class="form-control" required />
                    </div>

                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Metode Perhitungan:</label>
                    ...
                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Realisasi:</label>
                        <input type="text" name="realisasi" class="form-control" required />
                    </div>

                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Standar Digunakan:</label>
                    ...
                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Penyebab Tidak Tercapai:</label>
                        <textarea name="penyebab_tidak_tercapai" id="kt_docs_ckeditor_penyebab" class="form-control"></textarea>
                    </div>

                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Rencana Perbaikan:</label>
                        <textarea name="rencana_perbaikan" id="kt_docs_ckeditor_rencana" class="form-control"></textarea>
                    </div>

                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Indikator Penilaian:</label>
