                ...
                <form id="kt_modal_form" class="form d-flex flex-column" style="flex-grow: 1;">
                    ...
                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">
                            Kode Indikator Instrumen: <small class="text-danger" style="font-size: 0.8rem;">Contoh G jika fakultas teknik, g1a jika prodi informatika</small>
                        </label>
                    ...
                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Jenis Indikator Instrumen:</label>
                        <select name="jenis_unit_kerja" class="form-control">
                            <option disabled selected>-- pilih jenis Indikator Instrumen --</option>
