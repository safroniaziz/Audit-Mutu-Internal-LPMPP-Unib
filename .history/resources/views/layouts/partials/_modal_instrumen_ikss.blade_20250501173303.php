            ...
            <div class="modal-body d-flex flex-column scroll-y px-10" style="flex-grow: 1;">
                <form id="kt_modal_form" class="form d-flex flex-column" style="flex-grow: 1;">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <textarea name="indikator" id="kt_docs_ckeditor_indikator" class="form-control">{{ ('indikator') }}</textarea>
                    </div>

                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Satuan:</label>
                        <textarea name="satuan" id="kt_docs_ckeditor_satuan" class="form-control">{{ ('satuan') }}</textarea>
                    </div>

                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Pertanyaan:</label>
                        <textarea name="pertanyaan" id="kt_docs_ckeditor_pertanyaan" class="form-control">{{ ('pertanyaan') }}</textarea>
                    </div>
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <textarea name="sumber" id="kt_docs_ckeditor_sumber" class="form-control">{{ ('sumber') }}</textarea>
                    </div>

                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Uraian:</label>
                        <textarea name="uraian" id="kt_docs_ckeditor_uraian" class="form-control">{{ ('uraian') }}</textarea>
                    </div>

                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Penilaian:</label>
                        <textarea name="penilaian" id="kt_docs_ckeditor_penilaian" class="form-control">{{ ('penilaian') }}</textarea>
                    </div>
