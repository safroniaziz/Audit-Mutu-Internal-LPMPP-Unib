                                                ...
                                                @elseif (Route::is('auditee.pengajuanAmi*'))
                                                    ...
                                                    <li class="nav-item mt-2">
                                                        <div class="d-inline-block">
                                                            <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.pengajuanAmi.perjanjianKinerja') ? 'active' : '' }}"
                                                               href="{{ route('auditee.pengajuanAmi.perjanjianKinerja') }}">
                                                    ...
                                                    <li class="nav-item mt-2">
                                                        @php
                                                            ...
                                                            $hasPerjanjianKinerja = App\Models\PengajuanAmi::where('auditee_id', Auth::user()->unit_kerja_id)
                                                                ->where('periode_id', $periodeAktif->id)
                                                                ->whereNotNull('file_perjanjian_kinerja')
                                                                ->exists();
                                                        @endphp
