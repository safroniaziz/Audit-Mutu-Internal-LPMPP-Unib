                                                            ...
                                                            <div class="d-flex flex-wrap">
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-6 fw-normal {{ Auth::user()->unitKerja && Auth::user()->unitKerja->website ? '' : 'text-danger' }}"
                                                                            data-kt-countup="false"
                                                                            data-kt-countup-value="4500"
                                                                            data-kt-countup-prefix="$"
                                                                        >
                                                                            {{ Auth::user()->unitKerja && Auth::user()->unitKerja->website ? Auth::user()->unitKerja->website : 'belum dilengkapi' }}
                                                                        </div>
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    <!--begin::Number-->
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="fs-6 fw-normal {{ Auth::user()->unitKerja && Auth::user()->unitKerja->no_hp ? '' : 'text-danger' }}">
                                                                            {{ Auth::user()->unitKerja && Auth::user()->unitKerja->no_hp ? Auth::user()->unitKerja->no_hp : 'belum dilengkapi' }}
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Number-->
                                                                    <!--begin::Label-->
