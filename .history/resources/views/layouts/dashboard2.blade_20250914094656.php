                    ...
                    if (typeof Swal !== 'undefined') {
                        Swal.fire({
                            ...
                            html: '<div style="text-align: left;">' +
                                  '<p><strong>Mulai tanggal 1 Oktober 2025, terdapat penambahan IKSS baru:</strong></p>' +
                                  '<ul style="margin: 10px 0; padding-left: 20px;">' +
                                    '<li>IKSS Tata Kelola</li>' +
                                    '<li>IKSS Keuangan</li>' +
                                    '<li>IKSS Sumber Daya</li>' +
                                  '</ul>' +
                                  '<div class="alert alert-warning" style="margin: 15px 0; padding: 10px; border-radius: 5px; background-color: #fff3cd; border: 1px solid #ffeaa7;">' +
                                    '<strong>⚠️ Perhatian:</strong> Jika Anda sudah menyelesaikan tahap audit, silakan hubungi admin untuk penambahan IKSS baru.' +
                                  '</div>' +
                                  '<div class="alert alert-info" style="margin: 15px 0; padding: 10px; border-radius: 5px; background-color: #d1ecf1; border: 1px solid #74c0fc;">' +
                                    '<strong>📞 Kontak:</strong> Ibu Tiara Eka Putri - 081373155834' +
                                  '</div>' +
                                  '</div>',
                            icon: 'info',
