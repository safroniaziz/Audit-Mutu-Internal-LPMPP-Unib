                                                            ...
                                                            <a href="{{ route('auditee.dashboard') }}"
                                                               class="btn btn-sm {{ $completionPercentage === 100 ? 'btn-primary' : 'btn-warning' }} me-2">
                                                                ...
                                                                <span class="indicator-label">
                                                                    {{ $completionPercentage === 100 ? 'Edit Profil' : 'Lengkapi Profil (' . $completionPercentage . '%)' }}
                                                                </span>
                                                                <!--end::Indicator label-->
                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                @elseif (Route::is('auditee.pengajuanAmi*'))
                                                    <li class="nav-item mt-2">
                                                        ...
                                                        href="{{ route('auditee.pengajuanAmi') }}">Kelengkapan Profil</a>
                                                    </li>

                                                    <li class="nav-item mt-2">
                                                        <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('auditee.pengajuanAmi.pemilihanIkss') ? 'active' : '' }}"
                                                        href="{{ route('auditee.pengajuanAmi.pemilihanIkss') }}">Pemilihan IKSS</a>
                                                    </li>
                                                @endif
