                                            ...
                                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                                ...
                                                @elseif (Route::is('auditee.pengajuanAmi*'))
                                                    ...
                                                    <li class="nav-item mt-2">
                                                        ...
                                                        data-bs-toggle="{{ $completionPercentage < 100 ? 'tooltip' : '' }}"
                                                        data-bs-placement="right"
                                                        title="{{ $completionPercentage < 100 ? 'Lengkapi profil terlebih dahulu' : '' }}">
                                                    ...
                                                    <li class="nav-item mt-2">
                                                        ...
                                                        href="{{ !$sudahMengisiIkss ? '#' : route('auditee.pengajuanAmi.pengisianInstrumen') }}"
                                                        style="{{ !$sudahMengisiIkss ? 'pointer-events: none; color: grey;' : '' }}"
                                                        data-bs-toggle="{{ !$sudahMengisiIkss ? 'tooltip' : '' }}"
                                                        data-bs-placement="right"
                                                        title="{{ !$sudahMengisiIkss ? 'Selesaikan pemilihan IKSS terlebih dahulu' : '' }}">
