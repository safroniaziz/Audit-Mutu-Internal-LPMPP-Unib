    ...
    <div class="app-navbar flex-shrink-0">
        ...
        <div class="app-navbar-item ms-1 ms-md-4">
            ...
            <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-40px h-40px position-relative"
                 ...
                 title="Activity Log - Riwayat Aktivitas">
                ...
                <div class="position-absolute top-0 start-100 translate-middle bg-success rounded-circle h-8px w-8px animation-pulse"
