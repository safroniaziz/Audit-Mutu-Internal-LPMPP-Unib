<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    ...
    <div class="bg-white rounded-xl p-1 shadow-md transition-transform duration-300 hover:scale-105">
        <img alt="Logo" src="{{ asset('assets/src/images/pppep.png') }}" class="h-12" />
    </div>
    <div class="hidden app-sidebar-logo-default lg:flex flex-col">
        <span class="text-white text-xl font-bold tracking-widest" style="text-shadow: 0 0 8px rgba(255,255,255,0.3)">LPMPP UNIB</span>
        <span class="text-white text-xs font-light -mt-1" style="text-shadow: 0 0 4px rgba(255,255,255,0.2)">Sistem Informasi Audit Mutu Internal</span>
    </div>
</a>
