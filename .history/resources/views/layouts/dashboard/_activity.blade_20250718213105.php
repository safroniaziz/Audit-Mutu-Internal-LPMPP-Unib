    ...
    <div class="card shadow-none border-0 rounded-0 h-100">
        ...
        <div class="card-header activity-log-header" id="kt_activities_header">
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex flex-column">
                    <h3 class="card-title fw-bold text-white mb-0">Activity Log</h3>
                    <span class="text-white-50 fs-7">Riwayat Aktivitas SIAMI</span>
                </div>
            </div>
        ...
        <div class="card-body position-relative p-0" id="kt_activities_body">
            ...
            <div id="kt_activities_scroll" class="position-relative scroll-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_activities_body" data-kt-scroll-dependencies="#kt_activities_header, #kt_activities_footer" data-kt-scroll-offset="5px">
                ...
                <div class="p-6 border-bottom border-white border-opacity-10">
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="text-center p-3 rounded bg-white bg-opacity-10">
                                <div class="fs-2 fw-bold text-white" id="total-activities">0</div>
                                <div class="fs-7 text-white-50">Total Aktivitas</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-center p-3 rounded bg-white bg-opacity-10">
                                <div class="fs-2 fw-bold text-success" id="unread-activities">0</div>
                                <div class="fs-7 text-white-50">Belum Dibaca</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6" id="activity-list">
                    ...
                    <div class="text-center py-8" id="activity-loading">
                        ...
                        <div class="text-white-50 mt-3">Memuat aktivitas...</div>
                    </div>
                    <!--end::Loading State-->
                    ...
                    <div class="text-center py-8" id="activity-empty" style="display: none;">
                        <div class="symbol symbol-60px mx-auto mb-4">
                            <div class="symbol-label bg-white bg-opacity-10">
                                <i class="fas fa-inbox fs-2 text-white-50"></i>
                            </div>
                        </div>
                        <h4 class="text-white mb-2">Belum Ada Aktivitas</h4>
                        <p class="text-white-50">Aktivitas akan muncul di sini saat Anda menggunakan sistem</p>
                    </div>
                    <!--end::Empty State-->
                    ...
                    <div id="activity-items-container">
                        ...
                        <div class="activity-item d-flex align-items-start p-3 rounded mb-3 unread">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start mb-1">
                                    <h6 class="text-white fw-semibold mb-0">Penugasan Auditor Baru</h6>
                                    <span class="badge bg-success fs-8">Baru</span>
                                </div>
                                <p class="text-white-50 fs-7 mb-1">Auditor John Doe ditugaskan untuk audit Fakultas Teknik</p>
                        ...
                        <div class="activity-item d-flex align-items-start p-3 rounded mb-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start mb-1">
                                    <h6 class="text-white fw-semibold mb-0">Dokumen Audit Diunggah</h6>
                                </div>
                                <p class="text-white-50 fs-7 mb-1">Laporan audit periode 2024 telah diunggah</p>
                                <div class="activity-time">
                                    <i class="fas fa-clock me-1"></i>
                                    1 jam yang lalu
                                </div>
                        ...
                        <div class="activity-item d-flex align-items-start p-3 rounded mb-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start mb-1">
                                    <h6 class="text-white fw-semibold mb-0">Status Audit Diperbarui</h6>
                                </div>
                                <p class="text-white-50 fs-7 mb-1">Status audit Fakultas Ekonomi berubah menjadi "Selesai"</p>
                                <div class="activity-time">
                                    <i class="fas fa-clock me-1"></i>
                                    3 jam yang lalu
                                </div>
                        ...
                        <div class="activity-item d-flex align-items-start p-3 rounded mb-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start mb-1">
                                    <h6 class="text-white fw-semibold mb-0">Tim Auditor Dibentuk</h6>
                                </div>
                                <p class="text-white-50 fs-7 mb-1">Tim auditor untuk audit Fakultas Hukum telah dibentuk</p>
                                <div class="activity-time">
                                    <i class="fas fa-clock me-1"></i>
                                    1 hari yang lalu
                                </div>
