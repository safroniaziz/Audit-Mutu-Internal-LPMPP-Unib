<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    ...
    <div style="background-color: rgba(255,255,255,0.8); padding: 8px; border-radius: 8px;" class="d-flex align-items-center">
        <img alt="Logo" src="{{ asset('assets/src/images/pppep.png') }}" class="h-50px app-sidebar-logo-default me-3" />
        <div class="d-flex flex-column">
            <span style="font-size: 1.5rem; font-weight: bold; text-transform: uppercase; color: #000;">LPMPP UNIB</span>
            <span style="font-size: 0.75rem; color: #333; margin-top: -4px;">Sistem Informasi Audit Mutu Internal</span>
        </div>
    </div>
</a>
