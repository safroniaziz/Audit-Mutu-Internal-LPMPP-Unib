<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    ...
    <div class="relative rounded-full p-2 bg-gradient-to-br from-yellow-400 via-white to-blue-300 shadow-xl transition-transform duration-300 group-hover:scale-105">
        <img src="{{ asset('assets/src/images/pppep.png') }}" alt="Logo" class="h-12 w-12 object-contain rounded-full shadow-md" />
        <span class="absolute -top-1 -right-1 bg-white text-yellow-500 text-xs font-bold px-1.5 py-0.5 rounded-full shadow-sm animate-pulse">⭐</span>
    </div>
</a>
