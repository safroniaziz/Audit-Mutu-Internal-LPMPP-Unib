            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_unker_table">
                        <thead>
                            <tr class="text-start fw-bold fs-7 text-uppercase border-bottom border-gray-200">
                                ...
                                <th class="min-w-50px ps-3 text-dark">No</th>
                                <th class="min-w-125px text-dark">Kode Unker</th>
                                <th class="min-w-175px text-dark">Nama Unker</th>
                                <th class="min-w-125px text-dark">Jenis Unker</th>
                                <th class="min-w-100px text-dark">Jenjang</th>
                                <th class="min-w-150px text-dark">Fakultas</th>
                                <th class="min-w-125px text-center text-dark">Aksi</th>
                            </tr>
                        </thead>
