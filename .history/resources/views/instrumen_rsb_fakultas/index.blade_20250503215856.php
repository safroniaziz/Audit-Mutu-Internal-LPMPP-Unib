            ...
            $(document).on('click', '.detail-rsbFakultas', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#instrumen_ikss_id').empty().append('<option value="">-- pilih Indikator Rsb --</option>');
                        ...
                        if (countAvailable === 0) {
                            $('#instrumen_ikss_id').append('<option value="" disabled>Semua Indikator sudah terpasang</option>');
                        }
