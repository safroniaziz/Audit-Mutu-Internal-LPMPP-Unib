                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div id="empty-indikator-message" class="alert alert-info d-none">
                                    Fakultas ini belum memiliki Indikator Kinerja.
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        $('#satuan_standar_id').on('change', function () {
            ...
            let unitKerjaId = $('#unit_kerja_id').val(); // pastikan ini ada di modal/form
        ...
        function updateMainTable(unitKerjaId) {
            ...
            $(document).on('click', '.detail-rsbFakultas', function() {
                ...
                $('#indikator_kinerja_id').html('<option value="">Memuat data...</option>');
