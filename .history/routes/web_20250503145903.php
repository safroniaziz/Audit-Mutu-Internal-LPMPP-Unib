...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('periode-aktif')->name('periodeAktif.')->group(function () {
        ...
        Route::post('/atur-jadwal', [PeriodeAktifController::class, 'store'])->name('aturJadwal.store');
        Route::post('/atur-jadwal', [JadwalController::class, 'store'])->name('aturJadwal.store');
    });
});
