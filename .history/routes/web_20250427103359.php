...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('auditor')->name('auditor.')->group(function () {
        ...
        Route::delete('/{auditor}/hapus-permanen/', [AuditorController::class, 'destroyPermanent'])->name('hapus_permanen');
        Route::delete('/{id}/hapus-permanen/', [AuditorController::class, 'destroyPermanent'])->name('auditor.hapus_permanen');
    });
});
