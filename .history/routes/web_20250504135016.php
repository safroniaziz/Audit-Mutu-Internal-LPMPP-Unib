...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::prefix('auditee')->name('auditee.')->group(function () {
            ...
            Route::get('/unggah_siklus', [AuditeePengajuanAmiController::class, 'pengisianInstrumen'])->name('pengajuanAmi.pengisianInstrumen');
            Route::post('/submit-all-siklus', [AuditeePengajuanAmiController::class, 'submitAllInstrumen'])->name('submitAllInstrumen');
        });
    });
