    ...
    Route::middleware('role:Auditor')->group(function () {
        Route::prefix('auditor')->name('auditor.')->group(function () {
            ...
            Route::prefix('audit')->name('audit.')->group(function () {
                ...
                Route::get('/visitasi/{pengajuan}', [AuditorAuditController::class, 'deskEvaluation'])->name('deskEvaluation');
                Route::post('/visitasi', [AuditorAuditController::class, 'submitDeskEvaluation'])->name('submitDeskEvaluation');
                Route::post('/visitasi/{pengajuan}/approve', [AuditorAuditController::class, 'approveDeskEvaluation'])->name('approveDeskEvaluation');
            });
        });
