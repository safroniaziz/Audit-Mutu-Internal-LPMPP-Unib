...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('indikator-kinerja')->name('indikatorKinerja.')->group(function () {
        ...
        Route::get('/{instrumen}/edit', [IkssController::class, 'edit'])->name('edit');
        Route::put('/{instrumen}', [IkssController::class, 'update'])->name('update');
        Route::delete('/{instrumen}', [IkssController::class, 'nonaktifkan'])->name('nonaktifkan');
        ...
        Route::get('/indikator/{indikatorId}/kriteria', [IkssController::class, 'getKriteriaByIndikator']) ->name('getKriteriaByIndikator');
        Route::get('/instrumen-prodi/{id}', [IkssController::class, 'show'])->name('show');
    });
