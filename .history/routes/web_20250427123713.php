...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('auditor')->name('auditor.')->group(function () {
        ...
        Route::delete('/{auditor}', [AuditorController::class, 'nonaktifkan'])->name('nonaktifkan');
        Route::post('/nonaktifkan-selected', [AuditorController::class, 'nonaktifkanSelected'])->name('nonaktifkanSelected');
