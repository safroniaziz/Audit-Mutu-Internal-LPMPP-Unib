...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::middleware('role:Administrator')->group(function () {
        ...
        Route::prefix('rsb-fakultas')->name('rsbFakultas.')->group(function () {
            ...
            Route::get('/{unitKerja}/modal', [PenugasanAuditorController::class, 'modal'])->name('modal');
            Route::post('/tambah', [PenugasanAuditorController::class, 'tambahIndikator'])->name('tambahIndikator');
            Route::delete('/hapus', [PenugasanAuditorController::class, 'hapusIndikator'])->name('hapusIndikator');
            Route::get('/get-indikator-by-satuan/{id}', [PenugasanAuditorController::class, 'getIndikatorBySatuan'])->name('bySatuan');
        });
