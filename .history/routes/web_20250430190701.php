...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('instrumen-prodi')->name('instrumenProdi.')->group(function () {
        Route::get('/', [InstrumenProdi::class, 'index'])->name('index');
        Route::post('/', [InstrumenProdi::class, 'store'])->name('store');
        Route::get('/{instrumen}/edit', [InstrumenProdi::class, 'edit'])->name('edit');
        Route::put('/{instrumen}', [InstrumenProdi::class, 'update'])->name('update');
        Route::delete('/{instrumen}', [InstrumenProdi::class, 'nonaktifkan'])->name('nonaktifkan');
        Route::post('/delete-selected', [InstrumenProdi::class, 'nonaktifkanSelected'])->name('nonaktifkanSelected');
        Route::put('/auditor/{id}/restore', [InstrumenProdi::class, 'restore'])->name('restore');
        Route::delete('/{id}/hapus-permanen/', [InstrumenProdi::class, 'destroyPermanent'])->name('hapus_permanen');
    });
