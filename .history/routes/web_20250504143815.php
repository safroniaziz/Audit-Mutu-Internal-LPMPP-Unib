...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::middleware('role:Administrator')->group(function () {
        ...
        Route::prefix('rsb-fakultas')->name('rsbFakultas.')->group(function () {
            Route::get('/', [PenugasanAuditor::class, 'index'])->name('index');
            Route::get('/{unitKerja}/modal', [PenugasanAuditor::class, 'modal'])->name('modal');
            Route::post('/tambah', [PenugasanAuditor::class, 'tambahIndikator'])->name('tambahIndikator');
            Route::delete('/hapus', [PenugasanAuditor::class, 'hapusIndikator'])->name('hapusIndikator');
            Route::get('/get-indikator-by-satuan/{id}', [PenugasanAuditor::class, 'getIndikatorBySatuan'])->name('bySatuan');
        });
