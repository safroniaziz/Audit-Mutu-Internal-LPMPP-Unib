...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::middleware(['auth', 'role:auditee'])->group(function () {
            Route::prefix('auditee')->name('auditee.')->group(function () {
                Route::get('/pengajuan_ami', [AuditeePengajuanAmiController::class, 'index'])->name('auditee.pengajuanAmi');
                Route::put('/lengkapiProfil', [AuditeePengajuanAmiController::class, 'lengkapiProfil'])->name('auditee.pengajuanAmi.lengkapiProfil');

                Route::get('/perjanjian_kinerja', [AuditeePengajuanAmiController::class, 'perjanjianKinerja'])->name('auditee.pengajuanAmi.perjanjianKinerja');
                Route::post('/upload-perjanjian-kinerja', [AuditeePengajuanAmiController::class, 'uploadPerjanjianKinerja'])->name('auditee.pengajuanAmi.uploadPerjanjianKinerja');

                Route::get('/pemilihan_ikss', [AuditeePengajuanAmiController::class, 'pemilihanIkss'])->name('auditee.pengajuanAmi.pemilihanIkss');
                Route::post('/simpan-ikss', [AuditeePengajuanAmiController::class, 'saveIkss'])->name('auditee.pengajuanAmi.saveIkss');
                Route::post('/save-ikss-ss', [AuditeePengajuanAmiController::class, 'saveIkssSS'])->name('auditee.pengajuanAmi.saveIkssSS');

                Route::get('/pengisian_instrumen', [AuditeePengajuanAmiController::class, 'pengisianInstrumen'])->name('auditee.pengajuanAmi.pengisianInstrumen');
                Route::post('/submit-all-instrumen', [AuditeePengajuanAmiController::class, 'submitAllInstrumen'])->name('auditee.submitAllInstrumen');

                Route::get('/unggah_siklus', [AuditeePengajuanAmiController::class, 'unggahSiklus'])->name('auditee.pengajuanAmi.unggahSiklus');
                Route::post('/submit-all-siklus', [AuditeePengajuanAmiController::class, 'submitAllSiklus'])->name('auditee.submitAllSiklus');

                Route::post('/upload-files', [AuditeePengajuanAmiController::class, 'uploadFiles'])->name('auditee.uploadFiles');
                Route::delete('/file/{id}', [AuditeePengajuanAmiController::class, 'destroy'])->name('auditee.file.delete');
            });
        });
    });
