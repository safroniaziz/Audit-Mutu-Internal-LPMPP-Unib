...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('indikator-instrumen')->name('indikatorInstrumen.')->group(function () {
        ...
        Route::get('/{indikatorInstrumen}/edit', [AuditorController::class, 'edit'])->name('edit');
        Route::put('/{indikatorInstrumen}', [AuditorController::class, 'update'])->name('update');
        Route::delete('/{indikatorInstrumen}', [AuditorController::class, 'destroy'])->name('destroy');
