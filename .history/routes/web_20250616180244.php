    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::middleware(['auth', 'role:Auditee'])->group(function () {
            Route::prefix('auditee')->name('auditee.')->group(function () {
                ...
                Route::get('/laporan', [AuditeeLaporanAmiController::class, 'index'])->name('laporanAmi');
                Route::get('/laporan-ami/{pengajuan}/unduh-dokumen', [AuditeeLaporanAmiController::class, 'unduhDokumen'])->name('laporanAmi.unduhDokumen');
                Route::get('/laporan-ami/{pengajuan}/berita-acara', [AuditeeLaporanAmiController::class, 'beritaAcara'])->name('laporanAmi.beritaAcara');
                Route::get('/laporan-ami/{pengajuan}/evaluasi', [AuditeeLaporanAmiController::class, 'evaluasiAmi'])->name('laporanAmi.evaluasiAmi');
                Route::get('/laporan-ami/{pengajuan}/daftar-pertanyaan', [AuditeeLaporanAmiController::class, 'daftarPertanyaan'])->name('laporanAmi.daftarPertanyaan');
                Route::get('/laporan-ami/{pengajuan}/laporan', [AuditeeLaporanAmiController::class, 'laporanAmi'])->name('laporanAmi.laporan');
                Route::get('/{id}/laporan-ami', [AuditeeLaporanAmiController::class, 'laporanAmi'])->name('laporanAmi.laporan');
            });
        });
    });
