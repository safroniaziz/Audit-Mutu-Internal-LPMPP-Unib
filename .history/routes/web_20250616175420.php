    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::middleware(['auth', 'role:Auditee'])->group(function () {
            Route::prefix('auditee')->name('auditee.')->group(function () {
                ...
                Route::get('/laporan-ami', [App\Http\Controllers\Auditee\LaporanAmiController::class, 'index'])->name('laporanAmi');
                Route::get('/laporan-ami/download/{id}', [App\Http\Controllers\Auditee\LaporanAmiController::class, 'download'])->name('laporanAmi.download');
            });
        });
    });
