...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('rsb-prodi')->name('rsbProdi.')->group(function () {
        ...
        Route::post('/tambah', [RsbProdiController::class, 'tambahInstrumen'])->name('tambahInstrumen');
        Route::delete('/hapus', [RsbProdiController::class, 'hapusInstrumen'])->name('hapusInstrumen');
        Route::get('/get-indikator-by-satuan/{id}', [RsbProdiController::class, 'getIndikatorBySatuan'])->name('bySatuan');
        Route::get('/get-instrumen-by-indikator/{id}', [RsbProdiController::class, 'getInstrumenByIndikator'])->name('byIndikator');
    });
    ...
    Route::prefix('rsb-fakultas')->name('rsbFakultas.')->group(function () {
        ...
        Route::post('/tambah', [RsbFakultasController::class, 'tambahInstrumen'])->name('tambahInstrumen');
        Route::delete('/hapus', [RsbFakultasController::class, 'hapusInstrumen'])->name('hapusInstrumen');
        Route::get('/get-indikator-by-satuan/{id}', [RsbFakultasController::class, 'getIndikatorBySatuan'])->name('bySatuan');
        Route::get('/get-instrumen-by-indikator/{id}', [RsbFakultasController::class, 'getInstrumenByIndikator'])->name('byIndikator');
    });

    Route::prefix('auditor')->name('auditor.')->group(function () {
        Route::get('/', [PeriodeAktif::class, 'index'])->name('index');
        Route::post('/', [PeriodeAktif::class, 'store'])->name('store');
        Route::get('/{auditor}/edit', [PeriodeAktif::class, 'edit'])->name('edit');
        Route::put('/{auditor}', [PeriodeAktif::class, 'update'])->name('update');
        Route::delete('/{auditor}', [PeriodeAktif::class, 'destroy'])->name('destroy');
        Route::post('/delete-selected', [PeriodeAktif::class, 'destroySelected'])->name('destroySelected');
        Route::put('/auditor/{id}/restore', [PeriodeAktif::class, 'restore'])->name('restore');
        Route::delete('/{id}/hapus-permanen/', [PeriodeAktif::class, 'destroyPermanent'])->name('hapus_permanen');
    });
});
