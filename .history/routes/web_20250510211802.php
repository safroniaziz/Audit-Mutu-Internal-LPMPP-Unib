...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::middleware('role:Administrator')->group(function () {
        ...
        Route::prefix('lingkup-audit')->name('lingkupAudit.')->group(function () {
            Route::get('/', [Dokumen::class, 'index'])->name('index');
            Route::post('/', [Dokumen::class, 'store'])->name('store');
            Route::get('/{lingkupAudit}/edit', [Dokumen::class, 'edit'])->name('edit');
            Route::put('/{lingkupAudit}', [Dokumen::class, 'update'])->name('update');
            Route::delete('/{lingkupAudit}', [Dokumen::class, 'nonaktifkan'])->name('nonaktifkan');
            Route::post('/delete-selected', [Dokumen::class, 'nonaktifkanSelected'])->name('nonaktifkanSelected');
            Route::put('/auditor/{id}/restore', [Dokumen::class, 'restore'])->name('restore');
            Route::delete('/{id}/hapus-permanen/', [Dokumen::class, 'destroyPermanent'])->name('hapus_permanen');
        });
