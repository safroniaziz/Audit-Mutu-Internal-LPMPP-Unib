    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::middleware(['auth', 'role:Auditee'])->group(function () {
            Route::prefix('auditee')->name('auditee.')->group(function () {
                ...
                Route::get('/laporan-ami/unduh-dokumen/{pengajuan}', [AuditeeLaporanAmiController::class, 'unduhDokumen'])->name('laporanAmi.unduhDokumen');
                Route::get('/laporan-ami/berita-acara/{pengajuan}', [AuditeeLaporanAmiController::class, 'beritaAcara'])->name('laporanAmi.beritaAcara');
                Route::get('/laporan-ami/evaluasi/{pengajuan}', [AuditeeLaporanAmiController::class, 'evaluasiAmi'])->name('laporanAmi.evaluasiAmi');
                Route::get('/laporan-ami/daftar-pertanyaan/{pengajuan}', [AuditeeLaporanAmiController::class, 'daftarPertanyaan'])->name('laporanAmi.daftarPertanyaan');
                Route::get('/laporan-ami/laporan/{pengajuan}', [AuditeeLaporanAmiController::class, 'laporanAmi'])->name('laporanAmi.laporan');
            });
        });
    });
