...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::middleware('role:Administrator')->group(function () {
        ...
        Route::prefix('penugasan-auditor')->name('penugasanAuditor.')->group(function () {
            ...
            Route::get('/get-auditors', [App\Http\Controllers\AuditorController::class, 'getAuditors']);
Route::post('/save-penugasan-auditor', [App\Http\Controllers\AuditorController::class, 'savePenugasanAuditor']);
        });
