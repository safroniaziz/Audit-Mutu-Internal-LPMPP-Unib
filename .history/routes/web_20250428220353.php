...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('indikator-instrumen')->name('indikatorInstrumen.')->group(function () {
        Route::get('/', [Indikatorinstrumen::class, 'index'])->name('index');
        Route::post('/', [Indikatorinstrumen::class, 'store'])->name('store');
        Route::get('/{indikator}/edit', [Indikatorinstrumen::class, 'edit'])->name('edit');
        Route::put('/{indikator}', [Indikatorinstrumen::class, 'update'])->name('update');
        Route::delete('/{indikator}', [Indikatorinstrumen::class, 'nonaktifkan'])->name('nonaktifkan');
        Route::post('/delete-selected', [Indikatorinstrumen::class, 'nonaktifkanSelected'])->name('nonaktifkanSelected');
        Route::put('/auditor/{id}/restore', [Indikatorinstrumen::class, 'restore'])->name('restore');
        Route::delete('/{id}/hapus-permanen/', [Indikatorinstrumen::class, 'destroyPermanent'])->name('hapus_permanen');
    });
