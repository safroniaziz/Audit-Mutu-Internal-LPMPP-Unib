...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::delete('/perjanjian-kinerja/{id}', [PerjanjianKinerjaController::class, 'destroy'])->name('perjanjian-kinerja.destroy');
        Route::get('/perjanjian-kinerja/{id}/download', [PerjanjianKinerjaController::class, 'download'])->name('perjanjian-kinerja.download');
    });
