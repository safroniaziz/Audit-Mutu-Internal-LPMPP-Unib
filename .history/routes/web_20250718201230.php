...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::middleware('role:Administrator')->group(function () {
        ...
        Route::prefix('penugasan-auditor')->name('penugasan-auditor.')->group(function () {
            Route::get('/', [PenugasanAuditorController::class, 'index'])->name('index');
            Route::get('/get-auditors', [PenugasanAuditorController::class, 'getAuditors'])->name('getAuditors');
            Route::post('/save-penugasan-auditor', [PenugasanAuditorController::class, 'savePenugasanAuditor'])->name('savePenugasanAuditor');
            Route::get('/get-existing-assignments/{id}', [PenugasanAuditorController::class, 'getExistingAssignments'])->name('getExistingAssignments');
            Route::post('/update-penugasan-auditor', [PenugasanAuditorController::class, 'updatePenugasanAuditor'])->name('updatePenugasanAuditor');
            ...
            Route::get('/debug/{id}', function($id) {
                $penugasan = \App\Models\PengajuanAmi::with(['auditors.auditor'])->findOrFail($id);
                ...
                return response()->json([
                    ...
                    'all_roles_in_db' => $allRoles->map(function($item) {
                        return [
