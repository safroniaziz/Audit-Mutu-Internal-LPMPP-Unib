    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::middleware(['auth', 'role:Auditee'])->group(function () {
            Route::prefix('auditee')->name('auditee.')->group(function () {
                ...
                Route::get('/pengisian_instrumen_prodi', [AuditeePengajuanAmiController::class, 'pengisianInstrumenProdi'])->name('pengajuanAmi.pengisianInstrumen');
                Route::post('/submit-instrumen-prodi/{instrumen_id}', [AuditeePengajuanAmiController::class, 'submitInstrumenProdi'])->name('pengajuanAmi.submitInstrumenSS');
