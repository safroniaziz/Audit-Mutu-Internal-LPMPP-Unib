...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('indikator-instrumen')->name('indikatorInstrumen.')->group(function () {
        ...
        Route::get('/{kriteria}/edit', [IndikatorInstrumenKriteria::class, 'edit'])->name('edit');
        Route::put('/{kriteria}', [IndikatorInstrumenKriteria::class, 'update'])->name('update');
        Route::delete('/{kriteria}', [IndikatorInstrumenKriteria::class, 'nonaktifkan'])->name('nonaktifkan');
