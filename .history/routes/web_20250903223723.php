...
// Test route DELETE tanpa parameter untuk debugging
Route::delete('/test-delete-no-param', function() {
    return response()->json(['message' => 'Test DELETE route tanpa parameter berhasil']);
});

// Test route DELETE dengan parameter sederhana untuk debugging
Route::delete('/test-delete-param/{id}', function($id) {
    return response()->json([
        'message' => 'Test DELETE route dengan parameter berhasil',
        'parameter' => $id
    ]);
});

// Test route GET dengan parameter untuk debugging (karena DELETE bermasalah)
Route::get('/test-get-param/{id}', function($id) {
    return response()->json([
        'message' => 'Test GET route dengan parameter berhasil',
        'parameter' => $id
    ]);
});

// Test route POST dengan parameter untuk debugging (karena DELETE bermasalah)
Route::post('/test-post-param/{id}', function($id) {
    return response()->json([
        'message' => 'Test POST route dengan parameter berhasil',
        'parameter' => $id
    ]);
});
...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::middleware('role:Administrator')->group(function () {
        ...
        Route::prefix('auditee')->name('auditee.')->group(function () {
            ...
            Route::put('/{id}/ubah-password', [AuditeeController::class, 'ubahPassword'])->name('ubahPassword');
        });
        ...
        Route::prefix('periode-aktif')->name('periodeAktif.')->group(function () {
            ...
            Route::get('/{id}/edit', [PeriodeAktifController::class, 'edit'])->name('edit');
            Route::put('/{id}', [PeriodeAktifController::class, 'update'])->name('update');
            Route::delete('/{id}', [PeriodeAktifController::class, 'nonaktifkan'])->name('nonaktifkan');
        ...
        Route::prefix('penugasan-auditor')->name('penugasanAuditor.')->group(function () {
            ...
            Route::get('/get-filtered-data', [PenugasanAuditorController::class, 'getFilteredData'])->name('getFilteredData');
            Route::get('/get-auditors', [PenugasanAuditorController::class, 'getAuditors']);
            Route::get('/get-existing-assignments/{id}', [PenugasanAuditorController::class, 'getExistingAssignments']);
        ...
        Route::prefix('laporan')->name('laporan.')->group(function () {
            ...
            Route::get('/get-filtered-data', [LaporanHasilAuditController::class, 'getFilteredData'])->name('getFilteredData');
    ...
    Route::middleware(['role:Auditee'])->group(function () {
        ...
        Route::prefix('auditee')->name('auditee.')->group(function () {
            ...
            // Password Routes
            Route::get('/ubah-password', [PasswordController::class, 'showAuditeeForm'])->name('password.form');
            Route::post('/ubah-password', [PasswordController::class, 'updateAuditeePassword'])->name('password.update');
        });
    });
    ...
    Route::post('/penilaian_instrumen_prodi/{pengajuan}/save-active-kriteria', [AuditorAuditController::class, 'saveActiveKriteria'])->name('saveActiveKriteria');
            ...
            // Password Routes
            Route::get('/ubah-password', [PasswordController::class, 'showAuditorForm'])->name('password.form');
            Route::post('/ubah-password', [PasswordController::class, 'updateAuditorPassword'])->name('password.update');
        });
    });
