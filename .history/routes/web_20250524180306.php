...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:Auditee')->group(function () {
        Route::prefix('auditee')->name('auditee.')->group(function () {
            ...
            Route::get('/perjanjian-kinerja', [AuditeePengajuanAmiController::class, 'perjanjianKinerjaIndex'])->name('perjanjian-kinerja.index');
            Route::post('/perjanjian-kinerja', [AuditeePengajuanAmiController::class, 'perjanjianKinerjaStore'])->name('perjanjian-kinerja.store');
            Route::get('/perjanjian-kinerja/download/{id}', [AuditeePengajuanAmiController::class, 'perjanjianKinerjaDownload'])->name('perjanjian-kinerja.download');
            Route::delete('/perjanjian-kinerja/{id}', [AuditeePengajuanAmiController::class, 'perjanjianKinerjaDestroy'])->name('perjanjian-kinerja.destroy');
