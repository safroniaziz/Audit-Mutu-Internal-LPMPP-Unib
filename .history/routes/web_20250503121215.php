...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('rsb-prodi')->name('rsbProdi.')->group(function () {
        ...
        Route::delete('/get-indikator-by-satuan/{id}', [RsbProdiController::class, 'getByIndikator'])->name('byIndikator');
        Route::delete('/get-instrumen-by-indikator/{id}', [RsbProdiController::class, 'getByIndikator'])->name('byIndikator');
    });
});
