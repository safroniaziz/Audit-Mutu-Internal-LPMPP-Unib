...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('kriteria-instrumen')->name('kriteriaInstrumen.')->group(function () {
        Route::get('/', [IndikatorInstrumenKri::class, 'index'])->name('index');
        Route::post('/', [IndikatorInstrumenKri::class, 'store'])->name('store');
        Route::get('/{kriteria}/edit', [IndikatorInstrumenKri::class, 'edit'])->name('edit');
        Route::put('/{kriteria}', [IndikatorInstrumenKri::class, 'update'])->name('update');
        Route::delete('/{kriteria}', [IndikatorInstrumenKri::class, 'nonaktifkan'])->name('nonaktifkan');
        Route::post('/delete-selected', [IndikatorInstrumenKri::class, 'nonaktifkanSelected'])->name('nonaktifkanSelected');
        Route::put('/auditor/{id}/restore', [IndikatorInstrumenKri::class, 'restore'])->name('restore');
        Route::delete('/{id}/hapus-permanen/', [IndikatorInstrumenKri::class, 'destroyPermanent'])->name('hapus_permanen');
    });
