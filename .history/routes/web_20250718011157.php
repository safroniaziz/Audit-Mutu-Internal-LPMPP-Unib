...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Debug route untuk cek session dan authentication
    Route::get('/debug-session', function () {
        return response()->json([
            ...
            'session_data' => \Illuminate\Support\Facades\Session::all(),
            'csrf_token' => csrf_token(),
        ]);
    })->name('debug.session');

    Route::middleware(['check.role:Auditee', 'handle.ajax'])->group(function () {
        Route::prefix('auditee')->name('auditee.')->group(function () {
            ...
            Route::put('/lengkapiProfil', [AuditeePengajuanAmiController::class, 'lengkapiProfil'])->name('pengajuanAmi.lengkapiProfil')->withoutMiddleware(['web']);
