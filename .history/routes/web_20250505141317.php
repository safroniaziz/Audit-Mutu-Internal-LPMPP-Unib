        ...
        Route::prefix('auditor')->name('auditor.')->group(function () {
            ...
            Route::prefix('audit')->name('audit.')->group(function () {
                ...
                Route::prefix('cetak')->name('cetak.')->group(function () {
                    Route::get('/berita-acara', [AuditorAuditController::class, 'beritaAcara'])->name('beritaAcara');
                    Route::get('/evaluasi', [AuditorAuditController::class, 'evaluasiAmi'])->name('evaluasiAmi');
                    Route::get('/daftar-pertanyaan', [AuditorAuditController::class, 'daftarPertanyaan'])->name('daftarPertanyaan');
                    Route::get('/laporan-ami', [AuditorAuditController::class, 'laporanAmi'])->name('laporanAmi');
                });
