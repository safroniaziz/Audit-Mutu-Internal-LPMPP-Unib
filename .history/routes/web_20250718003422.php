...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::prefix('auditee')->name('auditee.')->group(function () {
            ...
            Route::put('/test-lengkapiProfil', [AuditeePengajuanAmiController::class, 'lengkapiProfil'])->name('test.lengkapiProfil')->withoutMiddleware(['auth', 'verified', 'role:Auditee']);
