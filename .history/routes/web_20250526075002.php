...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::middleware(['auth', 'role:auditee'])->group(function () {
            Route::prefix('auditee/pengajuan-ami')->name('auditee.pengajuanAmi.')->group(function () {
                Route::get('/', [AuditeePengajuanAmiController::class, 'index'])->name('index');
                Route::put('/lengkapi-profil', [AuditeePengajuanAmiController::class, 'lengkapiProfil'])->name('lengkapiProfil');

                Route::get('/perjanjian-kinerja', [AuditeePengajuanAmiController::class, 'perjanjianKinerja'])->name('perjanjianKinerja');
                Route::post('/upload-perjanjian-kinerja', [AuditeePengajuanAmiController::class, 'uploadPerjanjianKinerja'])->name('uploadPerjanjianKinerja');

                Route::get('/pemilihan-ikss', [AuditeePengajuanAmiController::class, 'pemilihanIkss'])->name('pemilihanIkss');
                Route::post('/save-ikss', [AuditeePengajuanAmiController::class, 'saveIkss'])->name('saveIkss');
                Route::post('/save-ikss-ss', [AuditeePengajuanAmiController::class, 'saveIkssSS'])->name('saveIkssSS');

                Route::get('/pengisian-instrumen', [AuditeePengajuanAmiController::class, 'pengisianInstrumen'])->name('pengisianInstrumen');
                Route::post('/submit-all-instrumen', [AuditeePengajuanAmiController::class, 'submitAllInstrumen'])->name('submitAllInstrumen');

                Route::get('/unggah-siklus', [AuditeePengajuanAmiController::class, 'unggahSiklus'])->name('unggahSiklus');
