        ...
        Route::prefix('auditor')->name('auditor.')->group(function () {
            ...
            Route::prefix('audit')->name('audit.')->group(function () {
                ...
                Route::prefix('cetak')->group(function () {
                    Route::post('/berita-acara', [AuditorAuditController::class, 'beritaAcara'])->name('beritaAcara');
                    Route::post('/evaluasi', [AuditorAuditController::class, 'evaluasiAmi'])->name('evaluasiAmi');
                    Route::post('/daftar-pertanyaan', [AuditorAuditController::class, 'daftarPertanyaan'])->name('daftarPertanyaan');
                    Route::post('/laporan-ami', [AuditorAuditController::class, 'laporanAmi'])->name('laporanAmi');
                });
