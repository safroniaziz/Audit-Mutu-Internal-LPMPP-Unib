...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('periode-aktif')->name('periodeAktif.')->group(function () {
        ...
        Route::delete('/{instrumenIkss}', [PeriodeAktifController::class, 'nonaktifkan'])->name('nonaktifkan');
        Route::delete('/{periodeAktif}', [PeriodeAktifController::class, 'destroy'])->name('destroy');
