...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('auditor')->name('auditor.')->group(function () {
        ...
        Route::delete('/{adminauditoristrator}', [AuditorController::class, 'destroy'])->name('destroy');
        ...
        Route::delete('/auditor/hapus-permanen/{id}', [AuditorController::class, 'destroyPermanent'])->name('auditor.hapus_permanen');
        Route::delete('/auditor/hapus-permanen/{auditor}', [AuditorController::class, 'destroyPermanent'])->name('auditor.hapus_permanen');
