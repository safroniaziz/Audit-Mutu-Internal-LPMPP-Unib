...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('rsb-prodi')->name('rsbProdi.')->group(function () {
        ...
        Route::get('/{rsbProdi}/edit', [RsbProdiController::class, 'edit'])->name('edit');
        Route::put('/{rsbProdi}', [RsbProdiController::class, 'update'])->name('update');
        Route::delete('/{rsbProdi}', [RsbProdiController::class, 'nonaktifkan'])->name('nonaktifkan');
