...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('indikator-instrumen')->name('indikatorInstrumen.')->group(function () {
        ...
        Route::get('/{indikatorInstrumen}/edit', [IndikatorInstrumenController::class, 'edit'])->name('edit');
        Route::put('/{indikatorInstrumen}', [IndikatorInstrumenController::class, 'update'])->name('update');
        Route::delete('/{indikatorInstrumen}', [IndikatorInstrumenController::class, 'destroy'])->name('nonaktifkan');
        Route::post('/delete-selected', [IndikatorInstrumenController::class, 'destroySelected'])->name('nonaktifkanSelected');
