    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::middleware(['auth', 'role:Auditee'])->group(function () {
            Route::prefix('auditee')->name('auditee.')->group(function () {
                ...
                Route::prefix('laporan')->name('laporan.')->group(function () {
                    Route::get('/', [Auditee::class, 'index'])->name('index');
                    Route::get('/{id}/detail', [Auditee::class, 'show'])->name('detail');
                    Route::get('/{id}/daftar_pertanyaan', [Auditee::class, 'daftarPertanyaan'])->name('daftarPertanyaan');
                    Route::get('/{id}/berita-acara', [Auditee::class, 'beritaAcara'])->name('beritaAcara');
                    Route::get('/{id}/evaluasi-ami', [Auditee::class, 'evaluasiAmi'])->name('evaluasiAmi');
                    Route::get('/{id}/laporan-ami', [Auditee::class, 'laporanAmi'])->name('laporanAmi');
                });
            });
        });
    });
