...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('auditor')->name('periodeAktif.')->group(function () {
        Route::get('/', [PeriodeAktifController::class, 'index'])->name('index');
        Route::post('/', [PeriodeAktifController::class, 'store'])->name('store');
        Route::get('/{auditor}/edit', [PeriodeAktifController::class, 'edit'])->name('edit');
        Route::put('/{auditor}', [PeriodeAktifController::class, 'update'])->name('update');
        Route::delete('/{auditor}', [PeriodeAktifController::class, 'destroy'])->name('destroy');
        Route::post('/delete-selected', [PeriodeAktifController::class, 'destroySelected'])->name('destroySelected');
        Route::put('/auditor/{id}/restore', [PeriodeAktifController::class, 'restore'])->name('restore');
