...
Route::get('/', function () {
    ...
    return redirect()->route('login')->with('dokumenAmis', $dokumenAmis);
});

Route::get('/login', function () {
    $dokumenAmis = session('dokumenAmis', DokumenAmi::where('kategori_dokumen', 'umum')->get());
    return view('auth.login', compact('dokumenAmis'));
})->name('login');
