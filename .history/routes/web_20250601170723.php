...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::middleware('role:Administrator')->group(function () {
        ...
        Route::prefix('data-auditee')->name('evaluasiAuditee.')->group(function () {
            Route::get('/', [EvaluasiAuditeeController::class, 'index'])->name('index');
            Route::post('/', [EvaluasiAuditeeController::class, 'store'])->name('store');
            Route::get('/{auditee}/edit', [EvaluasiAuditeeController::class, 'edit'])->name('edit');
            Route::put('/{auditee}', [EvaluasiAuditeeController::class, 'update'])->name('update');
            Route::delete('/{auditee}', [EvaluasiAuditeeController::class, 'nonaktifkan'])->name('nonaktifkan');
