...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('indikator-instrumen')->name('indikatorInstrumen.')->group(function () {
        Route::get('/', [IndikatorInstrumenKriteria::class, 'index'])->name('index');
        Route::post('/', [IndikatorInstrumenKriteria::class, 'store'])->name('store');
        Route::get('/{indikator}/edit', [IndikatorInstrumenKriteria::class, 'edit'])->name('edit');
        Route::put('/{indikator}', [IndikatorInstrumenKriteria::class, 'update'])->name('update');
        Route::delete('/{indikator}', [IndikatorInstrumenKriteria::class, 'nonaktifkan'])->name('nonaktifkan');
        Route::post('/delete-selected', [IndikatorInstrumenKriteria::class, 'nonaktifkanSelected'])->name('nonaktifkanSelected');
        Route::put('/auditor/{id}/restore', [IndikatorInstrumenKriteria::class, 'restore'])->name('restore');
        Route::delete('/{id}/hapus-permanen/', [IndikatorInstrumenKriteria::class, 'destroyPermanent'])->name('hapus_permanen');
    });
