...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::middleware('role:Administrator')->group(function () {
        ...
        Route::prefix('rsb-fakultas')->name('rsbFakultas.')->group(function () {
            ...
            Route::post('/tambah', [RsbFakultasController::class, 'tambahIndikatorn'])->name('tambahIndikatorn');
            Route::delete('/hapus', [RsbFakultasController::class, 'hapusIndikatorn'])->name('hapusIndikatorn');
            Route::get('/get-indikator-by-satuan/{id}', [RsbFakultasController::class, 'getIndikatorBySatuan'])->name('bySatuan');
            Route::get('/get-Indikatorn-by-indikator/{id}', [RsbFakultasController::class, 'getIndikatornByIndikator'])->name('byIndikator');
        });
