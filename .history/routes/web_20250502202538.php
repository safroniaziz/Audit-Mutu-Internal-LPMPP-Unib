...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('administrator')->name('administrator.')->group(function () {
        ...
        Route::put('/administrator/{id}/ubah-password', [AdministratorController::class, 'ubahPassword'])->name('administrator.ubahPassword');
        Route::post('/{administrator}/ubah-password', [AdministratorController::class, 'ubahPassword'])->name('ubah_password');
    });
