        ...
        Route::prefix('auditor')->name('auditor.')->group(function () {
            ...
            Route::prefix('audit')->name('audit.')->group(function () {
                ...
                Route::prefix('cetak')->name('cetak.')->group(function () {
                    Route::get('/berita-acara', [AuditDokumenController::class, 'beritaAcara'])->name('beritaAcara');
                    Route::get('/evaluasi', [AuditDokumenController::class, 'evaluasiAmi'])->name('evaluasiAmi');
                    Route::get('/daftar-pertanyaan', [AuditDokumenController::class, 'daftarPertanyaan'])->name('daftarPertanyaan');
                    Route::get('/laporan-ami', [AuditDokumenController::class, 'laporanAmi'])->name('laporanAmi');
                });
