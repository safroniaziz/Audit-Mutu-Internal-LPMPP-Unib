...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('satuan-standar')->name('ikss.')->group(function () {
        Route::get('/', [SatuanStandarController::class, 'index'])->name('index');
        Route::post('/', [SatuanStandarController::class, 'store'])->name('store');
        Route::get('/{ikss}/edit', [SatuanStandarController::class, 'edit'])->name('edit');
        Route::put('/{ikss}', [SatuanStandarController::class, 'update'])->name('update');
        Route::delete('/{ikss}', [SatuanStandarController::class, 'nonaktifkan'])->name('nonaktifkan');
        ...
        Route::get('/ikss-prodi/{id}', [SatuanStandarController::class, 'show'])->name('show');
    });

    Route::prefix('indikator-kinerja')->name('ikss.')->group(function () {
        Route::get('/', [IkssController::class, 'index'])->name('index');
        Route::post('/', [IkssController::class, 'store'])->name('store');
        Route::get('/{ikss}/edit', [IkssController::class, 'edit'])->name('edit');
        Route::put('/{ikss}', [IkssController::class, 'update'])->name('update');
        Route::delete('/{ikss}', [IkssController::class, 'nonaktifkan'])->name('nonaktifkan');
        ...
        Route::get('/ikss-prodi/{id}', [IkssController::class, 'show'])->name('show');
    });
