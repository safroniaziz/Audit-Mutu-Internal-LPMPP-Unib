...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('jenis-instrumen')->name('jenisInstrumen.')->group(function () {
        Route::get('/', [AuditorController::class, 'index'])->name('index');
        Route::post('/', [AuditorController::class, 'store'])->name('store');
        Route::get('/{jenisInstrumen}/edit', [AuditorController::class, 'edit'])->name('edit');
        Route::put('/{jenisInstrumen}', [AuditorController::class, 'update'])->name('update');
        Route::delete('/{jenisInstrumen}', [AuditorController::class, 'destroy'])->name('destroy');
