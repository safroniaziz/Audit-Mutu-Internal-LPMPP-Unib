...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::prefix('auditee')->name('auditee.')->group(function () {
            ...
            Route::post('/simpan-instrumen', [AuditeePengajuanAmiController::class, 'saveInstrumen'])->name('saveInstrumen');
            Route::post('/submit-all-instrumen', [AuditeePengajuanAmiController::class, 'submitAllInstrumen'])->name('auditee.submit.all.instrumen');
        });
    });
