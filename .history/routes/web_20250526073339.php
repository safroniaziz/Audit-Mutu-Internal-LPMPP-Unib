...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::prefix('auditee')->name('auditee.')->group(function () {
            ...
            Route::post('/save-ikss', [AuditeePengajuanAmiController::class, 'saveIkss'])->name('auditee.saveIkss');
            Route::post('/save-ikss-ss', [AuditeePengajuanAmiController::class, 'saveIkssSS'])->name('auditee.saveIkssSS');
