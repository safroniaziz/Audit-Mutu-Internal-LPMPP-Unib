...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['role:Auditee'])->group(function () {
        ...
        Route::prefix('auditee')->name('auditee.')->group(function () {
            ...
            Route::put('/ubah-password', [PasswordController::class, 'updateAuditeePassword'])->name('password.update');
            Route::post('/ubah-password', [PasswordController::class, 'updateAuditeePassword'])->name('password.update.post');
        });
    });
    ...
    Route::post('/penilaian_instrumen_prodi/{pengajuan}/save-active-kriteria', [AuditorAuditController::class, 'saveActiveKriteria'])->name('saveActiveKriteria');
            ...
            Route::put('/ubah-password', [PasswordController::class, 'updateAuditorPassword'])->name('password.update');
        });
    });
