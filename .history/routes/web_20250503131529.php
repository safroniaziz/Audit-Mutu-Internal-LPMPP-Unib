...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('auditor')->name('auditor.')->group(function () {
        Route::get('/', [PeriodeAk::class, 'index'])->name('index');
        Route::post('/', [PeriodeAk::class, 'store'])->name('store');
        Route::get('/{auditor}/edit', [PeriodeAk::class, 'edit'])->name('edit');
        Route::put('/{auditor}', [PeriodeAk::class, 'update'])->name('update');
        Route::delete('/{auditor}', [PeriodeAk::class, 'destroy'])->name('destroy');
        Route::post('/delete-selected', [PeriodeAk::class, 'destroySelected'])->name('destroySelected');
        Route::put('/auditor/{id}/restore', [PeriodeAk::class, 'restore'])->name('restore');
        Route::delete('/{id}/hapus-permanen/', [PeriodeAk::class, 'destroyPermanent'])->name('hapus_permanen');
    });
});
