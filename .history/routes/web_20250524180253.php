...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:Auditee')->group(function () {
        ...
        Route::prefix('auditee/perjanjian-kinerja')->name('auditee.perjanjian-kinerja.')->middleware(['auth', 'role:Auditee'])->group(function () {
            ...
            Route::get('/download/{id}', [PerjanjianKinerjaController::class, 'download'])->name('download');
