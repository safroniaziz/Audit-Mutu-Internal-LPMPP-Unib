        ...
        Route::middleware(['auth', 'role:Auditee'])->group(function () {
            Route::prefix('auditee')->name('auditee.')->group(function () {
                ...
                Route::prefix('laporan')->name('laporan.')->group(function () {
                    ...
                    Route::get('/{id}/detail', [AuditeeLaporanAmiController::class, 'show'])->name('detail');
                    Route::get('/{id}/daftar_pertanyaan', [AuditeeLaporanAmiController::class, 'daftarPertanyaan'])->name('daftarPertanyaan');
                    Route::get('/{id}/berita-acara', [AuditeeLaporanAmiController::class, 'beritaAcara'])->name('beritaAcara');
                    Route::get('/{id}/evaluasi-ami', [AuditeeLaporanAmiController::class, 'evaluasiAmi'])->name('evaluasiAmi');
