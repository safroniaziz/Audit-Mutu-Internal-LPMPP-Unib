...
if (!function_exists('datetime_local_to_utc')) {
    function datetime_local_to_utc($dateTimeInput)
    {
        return \App\Helpers\TimezoneHelper::datetimeLocalToUtc($dateTimeInput);
    }
}
