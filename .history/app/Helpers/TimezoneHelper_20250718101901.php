...
class TimezoneHelper
{
    ...
    /**
     * Convert local time (Asia/Jakarta) to UTC for database storage
     *
     * @param string $localDateTime Format: Y-m-d\TH:i (from datetime-local input)
     * @return Carbon|null
     */
    public static function localToUtc($localDateTime)
    {
        ...
        return Carbon::createFromFormat('Y-m-d\TH:i', $localDateTime, self::TIMEZONE_LOCAL)->utc();
    }
