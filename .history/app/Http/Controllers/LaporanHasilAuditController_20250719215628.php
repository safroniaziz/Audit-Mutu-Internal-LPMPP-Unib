...
class LaporanHasilAuditController extends Controller
{
        ...
        private function getAuditStatus($pengajuan)
    {
        ...
        foreach ($pengajuan->auditors as $auditor) {
            ...
            // Debug per auditor
            Log::info("Auditor Debug: " . ($auditor->auditor->name ?? 'N/A'), [
                ...
                'isSetuju_bool' => $isSetuju,
                'isSetujuVisitasi_bool' => $isSetujuVisitasi,
                'isSetujuIndikatorProdi_bool' => $isSetujuIndikatorProdi,
                'auditorCompleted' => $auditorCompleted,
                'auditorInProgress' => $auditorInProgress,
        ...
        Log::info("Audit Status Debug for Pengajuan ID: " . $pengajuan->id, [
            ...
            'auditors_count' => $pengajuan->auditors->count(),
                        ...
                        return [
                            ...
                            'is_setuju_visitasi' => $auditor->is_setuju_visitasi,
                            'is_setuju_indikator_prodi' => $auditor->is_setuju_indikator_prodi,
                            'in_progress' => $auditorStarted && !$auditorCompleted,
                            'completed' => $auditorCompleted,
                            'started' => $auditorStarted
                        ];
                    })
        ]);
