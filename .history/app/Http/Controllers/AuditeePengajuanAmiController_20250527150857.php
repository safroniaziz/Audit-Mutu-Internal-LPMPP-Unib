...
class AuditeePengajuanAmiController extends Controller
{
    ...
    public function pengisianInstrumenProdi()
    {
        ...
        // Get indikator instrumen that are related to this prodi
        $indikatorInstrumens = IndikatorInstrumen::whereHas('prodis', function($query) use ($unitKerja) {
            $query->where('unit_kerjas.id', $unitKerja->id);
        })->with(['prodis'])->get();
return $indikatorInstrumens;
