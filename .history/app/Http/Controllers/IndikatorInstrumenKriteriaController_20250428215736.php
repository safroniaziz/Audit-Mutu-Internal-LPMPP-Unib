...
class IndikatorKriteriaController extends Controller
{
    public function index(){
        $indikators = Indikator::orderBy('created_at','desc')->withTrashed()->get();
    ...
    public function nonaktifkan(Indikator $indikator)
    {
        try {
            $indikator->delete();
            return response()->json([
    ...
    public function nonaktifkanSelected(Request $request)
    {
        try {
            $ids = $request->ids;
            Indikator::whereIn('id', $ids)->delete();
    ...
    {
        $indikator = Indikator::withTrashed()->findOrFail($id);
