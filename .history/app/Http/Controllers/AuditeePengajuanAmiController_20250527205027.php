    ...
    public function submitInstrumenProdi(Request $request, $kriteria_id)
    {
        try {
            ...
            foreach ($instrumenProdis as $instrumenProdi) {
                $nilai = $request->input("nilai.{$instrumenProdi->kriteriaInstrumen->indikator_instrumen_id}");
                $deskripsi = $request->input("deskripsi.{$instrumenProdi->kriteriaInstrumen->indikator_instrumen_id}");
                ...
                if ($request->hasFile("dokumen.{$instrumenProdi->kriteriaInstrumen->indikator_instrumen_id}")) {
                    foreach ($request->file("dokumen.{$instrumenProdi->kriteriaInstrumen->indikator_instrumen_id}") as $file) {
