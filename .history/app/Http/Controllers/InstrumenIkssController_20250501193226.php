...
class InstrumenIkssController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return response()->json([
            'indikator'  => $indikatorKinerja->tujuan,
            'tujuan'     => $indikatorKinerja->tujuan,
            'indikator'  => $indikatorKinerja->indikator,
            'satuan'     => $indikatorKinerja->satuan,
            'pertanyaan' => $indikatorKinerja->pertanyaan,
            'sumber'     => $indikatorKinerja->sumber,
            'uraian'     => $indikatorKinerja->uraian,
            'penilaian'  => $indikatorKinerja->penilaian,
        ]);
    }
