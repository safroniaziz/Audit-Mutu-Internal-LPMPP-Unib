...
class LaporanHasilAuditController extends Controller
{
    public function index(){
        ...
        $penugasanAuditors->each(function ($pengajuan) {
            ...
            // Debug: log auditor data for each pengajuan
            Log::info("Pengajuan ID: " . $pengajuan->id . " - Audit Status: " . $pengajuan->audit_status['label']);
            foreach ($pengajuan->auditors as $auditor) {
                Log::info("  Auditor: " . $auditor->auditor->name .
