...
class AuditeePengajuanAmiController extends Controller
{
    ...
    {
        Log::info('Starting validation for profile update', [
        ...
        try {
            ...
            $unitKerja = UnitKerja::where('id', Auth::user()->unit_kerja_id)->update([
                ...
                'nip_ketua' => $request->nip_ketua ?: null,
                'jenjang' => $request->jenjang,
                'website' => $request->website ?: null,
                'no_hp' => $request->no_hp ?: null,
            ]);

            Log::info('UnitKerja update result', ['updated' => $unitKerja]);
            ...
            Log::info('User update result', ['updated' => $auditee]);
