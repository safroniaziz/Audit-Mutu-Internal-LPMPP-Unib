...
class AuditorAuditController extends Controller
{
    ...
    public function submitDeskEvaluation(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'penilaian_akar' => 'required|array',
            'penilaian_akar.*' => 'required|string',
            ...
            'penilaian_akar.required' => 'Pertanyaan harus diisi',
            'penilaian_akar.array' => 'Format pertanyaan tidak valid',
            'penilaian_akar.*.required' => 'Pertanyaan tidak boleh kosong',
            ...
            foreach ($request->ikss_auditee_ids as $ikssAuditeeId) {
                ...
                if (!$existingEvaluation) {
                    ...
                    IkssAuditeeNilai::create([
                        ...
                        'deskripsi' => $request->penilaian_akar[$ikssAuditeeId],
                        'penilaia' => $request->penilaian_rencana[$ikssAuditeeId],
