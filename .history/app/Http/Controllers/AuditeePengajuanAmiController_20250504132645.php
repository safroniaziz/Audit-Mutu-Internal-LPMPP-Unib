...
class AuditeePengajuanAmiController extends Controller
{
    ...
    public function submitAllInstrumen(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'realisasi.*.required' => 'Realisasi wajib diisi untuk semua instrumen.',
            'realisasi.*.string' => 'Realisasi harus berupa teks.',

            // Akar penyebab
            'akar_penyebab.required' => 'Data akar penyebab wajib diisi.',
            'akar_penyebab.*.required' => 'Akar penyebab wajib diisi untuk semua instrumen.',
            'akar_penyebab.*.string' => 'Akar penyebab harus berupa teks.',

            // Rencana perbaikan
            'rencana_perbaikan.required' => 'Data rencana perbaikan wajib diisi.',
            'rencana_perbaikan.*.required' => 'Rencana perbaikan wajib diisi untuk semua instrumen.',
            'rencana_perbaikan.*.string' => 'Rencana perbaikan harus berupa teks.',

            // Bukti file
            'bukti_file.required' => 'Semua bukti file wajib diunggah.',
            'bukti_file.*.required' => 'Bukti file wajib diunggah untuk setiap instrumen.',
            'bukti_file.*.file' => 'Bukti file harus berupa file.',
            'bukti_file.*.mimes' => 'Format file harus pdf, doc, docx, xls, xlsx, jpg, jpeg, atau png.',
            'bukti_file.*.max' => 'Ukuran file maksimal adalah 10MB.',
        ]);
