...
class SatuanStandarController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'kode_satuan.required' => 'S harus diisi.',
        ...
        return response()->json([
            'message' => 'S berhasil ditambahkan!',
            'data' => $satuanStandar
        ]);
    }
    ...
    public function update(Request $request, SatuanStandar $satuanStandar)
    {
        $validator = Validator::make($request->all(), [
            ...
            'indikator_instrumen_id.required' => 'S harus diisi.',
            'indikator_instrumen_id.exists' => 'S tidak ditemukan.',
            'indikator_instrumen_kriteria_id.required' => 'Kriteria S harus diisi.',
            'indikator_instrumen_kriteria_id.exists' => 'Kriteria S tidak ditemukan.',
            '*.string' => ':attribute harus berupa teks.'
        ]);
    ...
    public function nonaktifkan(SatuanStandar $satuanStandar)
    {
        try {
            ...
            return response()->json([
                'message' => 'S berhasil dinonaktifkan!'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'message' => 'Gagal menghapus S!',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function nonaktifkanSelected(Request $request)
    {
        try {
            ...
            return response()->json([
                'message' => 'S terpilih berhasil dinonaktifkan!'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'message' => 'Gagal menghapus S terpilih!',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function restore($id)
    {
        ...
        return response()->json(['message' => 'S berhasil dipulihkan!']);
    }
    ...
    public function destroyPermanent($id)
    {
        try {
            ...
            if (!$satuanStandar->trashed()) {
                return response()->json([
                    'message' => 'S belum dinonaktifkan, tidak bisa dihapus permanen!'
                ], 400);
            }
            ...
            return response()->json([
                'message' => 'S berhasil dihapus permanen!'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'message' => 'Gagal menghapus S permanen!',
                'error' => $e->getMessage()
            ], 500);
        }
    }
