...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $stats = [
            ...
            'evaluasi_selesai' => 0, // Temporary fix - will check correct table
            'total_evaluasi' => 0, // Temporary fix - will check correct table
            'rata_rata_skor' => 0, // Temporary fix - will check correct table
