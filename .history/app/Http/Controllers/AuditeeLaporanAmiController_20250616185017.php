...
class AuditeeLaporanAmiController extends Controller
{
    public function index(){
        ...
        $jawabanKuisioner = KuisionerJawaban::with(['kuisioner', 'opsi'])
                        ->where('pengajuan_id', $penugasanAuditors->id)
                        ->get();
        ...
        $evaluasiSubmissions = EvaluasiSubmission::where('pengajuan_ami_id', $penugasanAuditors->id)
                                ->get()
                                ->keyBy('evaluasi_id');

        // Get masukan data
        $evaluasiMasukan = EvaluasiMasukan::where('pengajuan_ami_id', $penugasanAuditors->id)
