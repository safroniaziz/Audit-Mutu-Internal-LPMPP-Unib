...
class AuditorAuditController extends Controller
{
    ...
    public function submitVisitasi(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'peluang_peningkatan.required' => 'peluang_peningkatan harus diisi',
            'peluang_peningkatan.array' => 'Format peluang_peningkatan tidak valid',
            'peluang_peningkatan.*.required' => 'peluang_peningkatan tidak boleh kosong'
        ]);
