...
class PenugasanAuditorController extends Controller
{
        ...
        public function checkAuditActivities($pengajuanId)
    {
        try {
            ...
            $deskEvaluationCount = IkssAuditeeNilai::where('pengajuan_ami_id', $pengajuanId)->count();

            // Check for visitasi activities
            $visitasiCount = IkssAuditeeVisitasi::where('pengajuan_ami_id', $pengajuanId)->count();
