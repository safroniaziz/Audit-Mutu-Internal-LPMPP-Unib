...
class DokumenAmiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $dokumenAmi = DokumenAmi::create([
            ...
            'file_dokumen' => json_encode($fileData), // Store file data as JSON
            'size_dokumen' => array_sum(array_column($fileData, 'size')),
    ...
    public function update(Request $request, DokumenAmi $dokumenAmi)
    {
        ...
        if ($request->hasFile('file_dokumen')) {
            ...
            $dokumenAmi->file_dokumen = json_encode([$fileData]);
