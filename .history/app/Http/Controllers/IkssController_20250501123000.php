...
class IkssController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'kode-indika' => 'required|string|max:10',
            ...
            'kode-indika.required' => 'Kode kriteria harus diisi.',
            'kode-indika.string' => 'Kode kriteria harus berupa teks.',
            'kode-indika.max' => 'Kode kriteria tidak boleh lebih dari 10 karakter.',
        ...
        $kriteria = IndikatorKinerja::create([
            ...
            'kode-indika' => $request->kode-indika,
    ...
    public function update(Request $request, IndikatorKinerja $kriteria)
    {
        ...
        $kriteria->kode-indika = $request->kode-indika;
