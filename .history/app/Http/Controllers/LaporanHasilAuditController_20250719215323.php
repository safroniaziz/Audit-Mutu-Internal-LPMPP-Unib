...
class LaporanHasilAuditController extends Controller
{
        ...
        private function getAuditStatus($pengajuan)
    {
        ...
        foreach ($pengajuan->auditors as $auditor) {
            ...
            $auditorInProgress = $isSetuju || $isSetujuVisitasi || $isSetujuIndikatorProdi; // Minimal satu field true

            if ($auditorInProgress && !$auditorCompleted) {
        ...
        } elseif ($anyAuditorInProgress || !$allAuditorsCompleted) {
            return [
                'status' => 'in_progress',
                'label' => 'Dalam Proses',
                'color' => 'warning',
