...
class AuditeePengajuanAmiController extends Controller
{
    ...
    public function submitAllInstrumen(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'instrumen_ids.*' => 'exists:instrumens,id',
        ...
        try {
            foreach ($instrumenIds as $instrumenId) {
                ...
                $ikssAuditee->uraian = $request->input('uraian.' . $instrumenId, null);
                $ikssAuditee->akar_penyebab = $request->input('akar_penyebab.' . $instrumenId, null);
                $ikssAuditee->rencana_perbaikan = $request->input('rencana_perbaikan.' . $instrumenId, null);
