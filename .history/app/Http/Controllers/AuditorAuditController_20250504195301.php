        ...
        try {
            ...
            foreach ($request->ikss_auditee_ids as $ikssAuditeeId) {
                ...
                $mapping = [
                    ...
                    'KTS Mayor' => 'kts_mayor',
                    'KTS Minor' => 'kts_minor',
                    'Sudah Sesuai' => 'sudah_sesuai',
                ];

                $inputKetidakSesuaian = $request->ketidak_sesuaian[$ikssAuditeeId] ?? null;
                $mappedKetidakSesuaian = $mapping[$inputKetidakSesuaian] ?? null;
                ...
                if (!$existingEvaluation) {
                    ...
                    IkssAuditeeVisitasi::create([
                        ...
                        'ikss_auditee_id' => $ikssAuditeeId,
                        'auditor_id' => $auditorId,
                        'ketidak_sesuaian' => $mappedKetidakSesuaian,
