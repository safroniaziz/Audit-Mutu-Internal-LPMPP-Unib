...
class AuditeePengajuanAmiController extends Controller
{
    ...
    public function pemilihanIkss(){
        $dataIkssProdi = UnitKerja::with(['indikatorKinerjas.instrumen'])
...
{
    // Misal Anda menerima data dari form dan menyimpannya
    foreach($request->all() as $key => $value) {
        // Lakukan pengecekan dan simpan data berdasarkan key-nya
        // misalnya, simpan dalam tabel atau lakukan validasi
    }

    return redirect()->route('auditee.pengajuanAmi.pemilihanIkss')->with('success', 'Data berhasil disimpan!');
}
