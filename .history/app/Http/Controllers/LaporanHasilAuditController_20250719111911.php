...
class LaporanHasilAuditController extends Controller
{
    ...
    public function show($id)
    {
        ...
        // Cek penugasan auditor untuk pengajuan ini
        $penugasanAuditors = \App\Models\PenugasanAuditor::where('pengajuan_ami_id', $id)->get();
        ...
        foreach ($allKuisionerJawaban as $jawaban) {
            // Cari penugasan auditor berdasarkan penugasan_auditor_id
            $penugasan = \App\Models\PenugasanAuditor::with('auditor')
