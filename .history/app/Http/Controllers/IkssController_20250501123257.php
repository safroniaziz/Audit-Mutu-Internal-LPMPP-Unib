...
class IkssController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'kode_indikator' => 'required|string|max:10',
            ...
            'kode_indikator.string' => 'Kode indikator harus berupa teks.',
            'kode_indikator.max' => 'Kode indikator tidak boleh lebih dari 10 karakter.',
    ...
    public function update(Request $request, IndikatorKinerja $kriteria)
    {
        $validator = Validator::make($request->all(), [
            ...
            'kode_indikator.required' => 'Kode kriteria harus diisi.',
            'kode_indikator.string' => 'Kode kriteria harus berupa teks.',
            'kode_indikator.max' => 'Kode kriteria tidak boleh lebih dari 10 karakter.',
        ...
        $kriteria->kode_indikator = $request->kode_indikator;
