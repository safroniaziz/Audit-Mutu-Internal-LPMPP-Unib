...
class AuditeePengajuanAmiController extends Controller
{
    ...
    public function submitAllInstrumen(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'realisasi.required' => 'Semua realisasi wajib diisi.',
            'akar_penyebab.required' => 'Semua akar penyebab wajib diisi.',
            'rencana_perbaikan.required' => 'Semua rencana perbaikan wajib diisi.',
