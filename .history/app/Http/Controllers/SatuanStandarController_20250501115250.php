...
class SatuanStandarController extends Controller
{
    ...
    public function update(Request $request, SatuanStandar $satuanStandar)
    {
        $validator = Validator::make($request->all(), [
            ...
            'indikator_instrumen_id.required' => 'Satuan Standar harus diisi.',
            'indikator_instrumen_id.exists' => 'Satuan Standar tidak ditemukan.',
            'indikator_instrumen_kriteria_id.required' => 'Kriteria Satuan Standar harus diisi.',
            'indikator_instrumen_kriteria_id.exists' => 'Kriteria Satuan Standar tidak ditemukan.',
            '*.string' => ':attribute harus berupa teks.'
        ]);
