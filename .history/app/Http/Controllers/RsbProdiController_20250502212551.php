...
class RsbProdiController extends Controller
{
    public function index(){
        $programStudis = UnitKerja::with(['kriteriaInstrumen'])->orderBy('created_at','desc')->withTrashed()->get();
        return view('instrumen_prodi.index',[
            'instrumens'    =>  $instrumens,
        ]);
    }

    public function getKriteriaByIndikator($indikatorId)
    {
        $kriteria = IndikatorInstrumenKriteria::where('indikator_instrumen_id', $indikatorId)->get();
