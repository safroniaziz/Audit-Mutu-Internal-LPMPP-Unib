...
class LaporanHasilAuditController extends Controller
{
    ...
    private function getAuditStatus($pengajuan)
    {
        ...
        // Debug logging
        Log::info("Checking audit status for pengajuan ID: " . $pengajuan->id);
            ...
            Log::info("Auditor ID: " . $auditor->user_id .
                      ", Role: " . $auditor->role .
                      ", is_setuju: " . ($isSetuju ? 'true' : 'false') .
                      ", is_setuju_visitasi: " . ($isSetujuVisitasi ? 'true' : 'false') .
                      ", is_setuju_indikator_prodi: " . ($isSetujuIndikatorProdi ? 'true' : 'false') .
                      ", auditorCompleted: " . ($auditorCompleted ? 'true' : 'false') .
                      ", auditorStarted: " . ($auditorStarted ? 'true' : 'false'));
            ...
            if (!$auditorCompleted) {
                ...
                Log::info("Final result - allAuditorsCompleted: " . ($allAuditorsCompleted ? 'true' : 'false') .
                  ", anyAuditorStarted: " . ($anyAuditorStarted ? 'true' : 'false'));
