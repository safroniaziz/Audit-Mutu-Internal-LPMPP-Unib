...
class AuditeePengajuanAmiController extends Controller
{
    ...
    public function submitAllInstrumen(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            // Validasi array terlebih dahulu
            ...
            // Validasi isi array (akan ditampilkan jika array valid)
            ...
            // Pesan error untuk array secara keseluruhan
            ...
            // Pesan error untuk validasi isi array (akan ditampilkan jika array valid)
            'realisasi.*.required' => 'Seluruh realisasi wajib diisi.',
            'uraian.*.required' => 'Seluruh uraian wajib diisi.',
            'akar_penyebab.*.required' => 'Seluruh akar penyebab wajib diisi.',
            'rencana_perbaikan.*.required' => 'Seluruh rencana perbaikan wajib diisi.',
            'bukti_file.*.required' => 'Seluruh bukti file wajib diunggah.',
        ...
        // Untuk mendapatkan hanya satu pesan error untuk setiap jenis validasi,
        // Anda bisa menggunakan errors()->first()
        if ($validator->fails()) {
