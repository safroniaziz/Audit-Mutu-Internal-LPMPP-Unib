...
class IndikatorInstrumenKriteriaKriteriaController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'indikator_instrumen_id' => 'required|exists:indikator_instrumens,id',  // Validasi ID indikator_instrumen
            'kode_kriteria' => 'required|string|max:10',  // Validasi kode_kriteria (string dan maksimal 10 karakter)
            'nama_kriteria' => 'required|string|max:255',  // Validasi nama_kriteria (string dan maksimal 255 karakter)
        ], [
