...
class AuditeePengajuanAmiController extends Controller
{
    ...
    public function lengkapiProfil(Request $request)
    {
        ...
        Log::info('LengkapiProfil request data:', $request->all());
        ...
        try {
            Log::info('Updating UnitKerja with ID: ' . Auth::user()->unit_kerja_id);
            ...
            Log::info('UnitKerja update result: ' . $unitKerja);

            // Now create or link the User
            Log::info('Updating User with ID: ' . Auth::user()->id);
            ...
            Log::info('User update result: ' . $auditee);
            ...
            Log::error('Exception in lengkapiProfil: ' . $e->getMessage());
