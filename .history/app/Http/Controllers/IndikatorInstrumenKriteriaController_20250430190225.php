...
class IndikatorInstrumenKriteriaController extends Controller
{
    public function index(){
        $indikators = IndikatorInstrumen::get();
        $kriterias = IndikatorInstrumenKriteria::with(['indiaktorInstrumen'])->orderBy('created_at','desc')->withTrashed()->get();
