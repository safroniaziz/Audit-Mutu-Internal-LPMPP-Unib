...
class InstrumenProdiController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'indikator_instrumen_kriteria_id.required' => 'Kriteria indikator instrumen harus diisi.',
            'indikator_instrumen_kriteria_id.exists' => 'Kriteria indikator instrumen tidak ditemukan.',
