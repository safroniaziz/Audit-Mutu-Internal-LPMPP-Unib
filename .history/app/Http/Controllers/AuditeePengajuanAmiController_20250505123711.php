...
class AuditeePengajuanAmiController extends Controller
{
    ...
    public function uploadFiles(Request $request)
    {
        ...
        $sudah = PengajuanAmi::where('auditee_id',$request->auditee_id)->where('periode_id',$periodeAktif->id)->first();
        if (!$sudah) {
// Membuat pengajuan AMI terlebih dahulu
$pengajuanAmi = PengajuanAmi::create([
