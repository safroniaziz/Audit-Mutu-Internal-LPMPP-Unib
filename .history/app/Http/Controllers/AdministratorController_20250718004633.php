...
class AdministratorController extends Controller
{
    ...
    {
        $roleExists = Role::where('name', 'Administrator')->where('guard_name', 'web')->exists();

        $administrators = $roleExists
            ? User::role('Administrator')->orderBy('created_at', 'desc')->withTrashed()->get()
            : collect();
