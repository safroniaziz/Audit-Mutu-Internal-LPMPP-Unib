...
class RsbFakultasController extends Controller
{
    public function index(){
        $fakultas = UnitKerja::withCount(['instrumenIkss'])->where('jenis_unit_kerja','fakultas')->get();
    ...
    {
        $unitKerja = UnitKerja::with('instrumenIkss')->where('jenis_unit_kerja','fakultas')->findOrFail($unitKerjaId);
    ...
    {
        $indikators = IndikatorKinerja::where()->where('satuan_standar_id', $id)->get();
