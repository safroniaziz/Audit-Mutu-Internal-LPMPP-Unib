...
class AuditeeLaporanAmiController extends Controller
{
    public function index(){
        ...
        $evaluasiSubmissions = EvaluasiSubmission::whereIn('pengajuan_ami_id', $penugasanAuditors->pluck('id'))
            ->get()
            ->keyBy('evaluasi_id');

        $evaluasiMasukan = EvaluasiMasukan::whereIn('pengajuan_ami_id', $penugasanAuditors->pluck('id'))
            ->get()
            ->keyBy('pengajuan_ami_id');
    ...
    public function show($id)
    {
        ...
        $evaluasiSubmissions = EvaluasiSubmission::where('pengajuan_ami_id', $id)
            ->get()
            ->keyBy('evaluasi_id');
    ...
    public function evaluasiAmi($id)
    {
        ...
        $evaluasiMasukan = EvaluasiMasukan::where('pengajuan_ami_id', $id)
            ->first();
