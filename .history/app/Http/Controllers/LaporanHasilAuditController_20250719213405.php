    ...
    private function getAuditStatus($pengajuan)
    {
        ...
        foreach ($pengajuan->auditors as $auditor) {
            ...
            \Log::info("Auditor ID: " . $auditor->user_id .
                      ", Role: " . $auditor->role .
                      ", is_setuju: " . ($auditor->is_setuju ? 'true' : 'false') .
                      ", is_setuju_visitasi: " . ($auditor->is_setuju_visitasi ? 'true' : 'false') .
                      ", is_setuju_indikator_prodi: " . ($auditor->is_setuju_indikator_prodi ? 'true' : 'false') .
