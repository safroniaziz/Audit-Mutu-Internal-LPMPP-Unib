    ...
    public function submitInstrumenProdi(Request $request, $kriteria_id)
    {
        try {
            ...
            foreach ($instrumenProdis as $instrumenProdi) {
                $indikatorId = $instrumenProdi->kriteriaInstrumen->indikator_instrumen_id;
                $nilai = $request->input("nilai.{$indikatorId}");
                $deskripsi = $request->input("deskripsi.{$indikatorId}");
                $realisasi = $request->input("realisasi.{$indikatorId}");
                $akarPenyebab = $request->input("akar_penyebab.{$indikatorId}");
                $rencanaPerbaikan = $request->input("rencana_perbaikan.{$indikatorId}");
                ...
                if ($request->hasFile("dokumen.{$indikatorId}")) {
                    $file = $request->file("dokumen.{$indikatorId}")[0]; // Get the first file
