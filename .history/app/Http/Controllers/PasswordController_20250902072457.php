...
class PasswordController extends Controller
{
    ...
    public function updateAuditeePassword(Request $request)
    {
        ...
        try {
            ...
            // Logout user dan clear session dengan cara yang lebih robust
            Auth::logout();
            Session::flush();
            Session::regenerate();
            
            // Clear semua cookie session
            Cookie::queue(Cookie::forget(session_name()));
            
            // Clear cache dan regenerate session ID
