...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        echo "📝 Adding new prodi users...\n";
            ...
            // Format username: S1 Pendidikan Fisika -> S1_PendidikanFisika
            $parts = explode(' ', $userData['name']);
            $jenjang = array_shift($parts); // S1, S2, S3
            $namaProdi = str_replace(' ', '', implode(' ', $parts)); // PendidikanFisika
            $username = $jenjang . '_' . $namaProdi;
            ...
            if (!$existingUser) {
                ...
                if ($unitKerja) {
                    ...
                    $baseEmail = strtolower(str_replace([' ', ','], '', $userData['name']));
                    $email = $baseEmail . '@mail.com';
                $counter = 1;
        ...
        foreach ($prodiUsers as $user) {
            ...
            $jenjang = array_shift($parts); // S1, S2, S3
            $namaProdi = str_replace(' ', '', implode(' ', $parts)); // IlmuEkonomi
