...
class UnitKerjaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            ['id' => 5,  'kode_unit_kerja' => 'A1D', 'nama_unit_kerja' => 'PENDIDIKAN Fiologi',                    'jenis_unit_kerja' => 'Prodi',    'jenjang' => 'S1',  'fakultas' => 'Fakultas Keguruan Dan Ilmu Pendidikan', 'created_at' => now(), 'updated_at' => now()],
