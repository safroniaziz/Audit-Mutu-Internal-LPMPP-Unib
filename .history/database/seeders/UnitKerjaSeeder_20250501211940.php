...
class UnitKerjaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            ['id' => 10, 'kode_unit_kerja' => 'A1J', 'nama_unit_kerja' => 'PENDIDIKAN L',                 'jenis_unit_kerja' => 'Prodi',    'jenjang' => 'S1',  'fakultas' => 'Fakultas Keguruan Dan Ilmu Pendidikan', 'created_at' => now(), 'updated_at' => now()],
