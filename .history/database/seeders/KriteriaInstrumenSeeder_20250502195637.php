...
class KriteriaInstrumenSeeder extends Seeder
{
    ...
    {
        $data = array(
            array('id' => '1', 'indikator_instrumen_id' => '6', 'kode_kriteria' => 'A1', 'nama_kriteria' => 'Visi, Misi, Tujuan dan Strategi'),
            array('id' => '2', 'indikator_instrumen_id' => '3', 'kode_kriteria' => NULL, 'nama_kriteria' => 'Tata Pamong, Tata Kelola, dan Kerjasama'),
            array('id' => '3', 'indikator_instrumen_id' => '6', 'kode_kriteria' => 'A2', 'nama_kriteria' => 'TEST'),
            array('id' => '4', 'indikator_instrumen_id' => '3', 'kode_kriteria' => 'C1', 'nama_kriteria' => 'Kriteria 1'),
            array('id' => '5', 'indikator_instrumen_id' => '3', 'kode_kriteria' => 'C2', 'nama_kriteria' => 'Kriteria 2'),
            array('id' => '6', 'indikator_instrumen_id' => '3', 'kode_kriteria' => 'C3', 'nama_kriteria' => 'Kriteria 3'),
            array('id' => '7', 'indikator_instrumen_id' => '6', 'kode_kriteria' => 'C4', 'nama_kriteria' => 'Kriteria 4'),
            array('id' => '8', 'indikator_instrumen_id' => '3', 'kode_kriteria' => 'C5', 'nama_kriteria' => 'Kriteria 5'),
            array('id' => '9', 'indikator_instrumen_id' => '3', 'kode_kriteria' => 'C6', 'nama_kriteria' => 'Kriteria 6'),
            array('id' => '10', 'indikator_instrumen_id' => '3', 'kode_kriteria' => 'C7', 'nama_kriteria' => 'Kriteria 7'),
            array('id' => '11', 'indikator_instrumen_id' => '3', 'kode_kriteria' => 'C8', 'nama_kriteria' => 'Kriteria 8'),
            array('id' => '12', 'indikator_instrumen_id' => '4', 'kode_kriteria' => 'abc', 'nama_kriteria' => 'abc'),
            array('id' => '13', 'indikator_instrumen_id' => '4', 'kode_kriteria' => 'def', 'nama_kriteria' => 'xxx'),
